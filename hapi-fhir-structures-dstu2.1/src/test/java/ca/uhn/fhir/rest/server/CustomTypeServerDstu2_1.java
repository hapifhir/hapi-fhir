...
public class CustomTypeServerDstu2_1 {
	...
	private static final org.slf4j.Logger ourLog =
				org.slf4j.LoggerFactory.getLogger(CustomTypeServerDstu2_1.class);
	...
	public void testCreateWithIdInUrl() throws Exception {
		...
		assertEquals(
					"Can not create resource with ID \"2\", ID must not be supplied on a create (POST)"
						+ " operation (use an HTTP PUT / update operation if you wish to supply an ID)",
