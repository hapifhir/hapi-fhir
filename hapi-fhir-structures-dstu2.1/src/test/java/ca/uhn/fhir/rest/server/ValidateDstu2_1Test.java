...
public class ValidateDstu2_1Test {
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(ValidateDstu2_1Test.class);
    ...
    public void testValidateBlankMode() throws Exception {
        ...
        httpPost.setEntity(
                new StringEntity(
                        encodedResource, ContentType.create(Constants.CT_FHIR_XML, "UTF-8")));
    ...
    public void testValidateWithOptions() throws Exception {
        ...
        params.addParameter()
                .setName("mode")
                .setValue(new StringType(ValidationModeEnum.CREATE.getCode()));
