...
public class OperationServerDstu2_1Test {
    ...
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(OperationServerDstu2_1Test.class);
    ...
    public void testConformance() {
        ...
        Conformance p =
                myFhirClient.fetchConformance().ofType(Conformance.class).prettyPrint().execute();
        ...
        //		OperationDefinition def = (OperationDefinition)
        // ops.get(opNames.indexOf("OP_TYPE")).getDefinition().getResource();
        OperationDefinition def =
                myFhirClient
                        .read()
                        .resource(OperationDefinition.class)
                        .withId(
                                ops.get(opNames.indexOf("OP_TYPE"))
                                        .getDefinition()
                                        .getReferenceElement())
                        .execute();
    ...
    public void testOperationDefinition() {
        OperationDefinition def =
                myFhirClient
                        .read()
                        .resource(OperationDefinition.class)
                        .withId("OperationDefinition/Patient-t-OP_TYPE")
                        .execute();
    ...
    public void testInstanceEverythingHapiClient() throws Exception {
        ourCtx.newRestfulGenericClient("http://localhost:" + ourPort)
                .operation()
    ...
    public void testInstanceEverythingPost() throws Exception {
        ...
        // Try with a POST
        HttpPost httpPost =
                new HttpPost("http://localhost:" + ourPort + "/Patient/123/$everything");
        httpPost.setEntity(
    ...
    public void testOperationCantUseGetIfItIsntIdempotent() throws Exception {
        ...
        assertEquals(
                Constants.STATUS_HTTP_405_METHOD_NOT_ALLOWED,
    ...
    public void testOperationWrongParameterType() throws Exception {
        ...
        HttpPost httpPost =
                new HttpPost("http://localhost:" + ourPort + "/Patient/123/$OP_INSTANCE");
        httpPost.setEntity(
                new StringEntity(inParamsStr, ContentType.create(Constants.CT_FHIR_XML, "UTF-8")));
        ...
        try {
            ...
            assertThat(
                    response,
                    containsString(
                            "Request has parameter PARAM1 of type IntegerType but method expects"
                                    + " type StringType"));
    ...
    public void testOperationOnInstanceAndType_Instance() throws Exception {
        ...
        HttpPost httpPost =
                new HttpPost("http://localhost:" + ourPort + "/Patient/123/$OP_INSTANCE_OR_TYPE");
        httpPost.setEntity(
                new StringEntity(inParamsStr, ContentType.create(Constants.CT_FHIR_XML, "UTF-8")));
        HttpResponse status = ourClient.execute(httpPost);
    ...
    public void testOperationOnInstanceAndType_Type() throws Exception {
        ...
        HttpPost httpPost =
                new HttpPost("http://localhost:" + ourPort + "/Patient/$OP_INSTANCE_OR_TYPE");
        httpPost.setEntity(
                new StringEntity(inParamsStr, ContentType.create(Constants.CT_FHIR_XML, "UTF-8")));
        CloseableHttpResponse status = ourClient.execute(httpPost);
    ...
    public void testOperationOnTypeReturnBundle() throws Exception {
        ...
        HttpPost httpPost =
                new HttpPost("http://localhost:" + ourPort + "/Patient/$OP_TYPE_RET_BUNDLE");
        httpPost.setEntity(
                new StringEntity(inParamsStr, ContentType.create(Constants.CT_FHIR_XML, "UTF-8")));
        HttpResponse status = ourClient.execute(httpPost);
    ...
    public void testOperationWithBundleProviderResponse() throws Exception {
        HttpGet httpPost =
                new HttpGet(
                        "http://localhost:"
                                + ourPort
                                + "/$OP_INSTANCE_BUNDLE_PROVIDER?_pretty=true");
        HttpResponse status = ourClient.execute(httpPost);
    ...
    public void testOperationWithGetUsingParams() throws Exception {
        HttpGet httpGet =
                new HttpGet("http://localhost:" + ourPort + "/Patient/$OP_TYPE?PARAM1=PARAM1val");
    ...
    public void testOperationWithGetUsingParamsFailsWithNonPrimitive() throws Exception {
        HttpGet httpGet =
                new HttpGet(
                        "http://localhost:"
                                + ourPort
                                + "/Patient/$OP_TYPE?PARAM1=PARAM1val&PARAM2=foo");
        HttpResponse status = ourClient.execute(httpGet);
        ...
        assertThat(
                response,
                containsString(
                        "Can not invoke operation $OP_TYPE using HTTP GET because parameter PARAM2"
    ...
    public void testOperationWithProfileDatatypeParams2() throws Exception {
        ...
        HttpPost httpPost =
                new HttpPost("http://localhost:" + ourPort + "/Patient/$OP_PROFILE_DT2");
        httpPost.setEntity(
                new StringEntity(inParamsStr, ContentType.create(Constants.CT_FHIR_XML, "UTF-8")));
        HttpResponse status = ourClient.execute(httpPost);
    ...
    public void testOperationWithProfileDatatypeUrl() throws Exception {
        HttpGet httpPost =
                new HttpGet("http://localhost:" + ourPort + "/Patient/$OP_PROFILE_DT?PARAM1=123");
        HttpResponse status = ourClient.execute(httpPost);
    ...
    public void testOperationWrongParamType() throws Exception {
        ...
        assertThat(
                response,
                containsString(
                        "Request has parameter PARAM1 of type IntegerType but method expects type"
                                + " StringType"));
    }
    ...
    public static class PatientProvider implements IResourceProvider {
        ...
        public Bundle opProfileType(@OperationParam(name = "PARAM1") Money theParam1) {
            // @formatter:on
        ...
        public Bundle opProfileType(@OperationParam(name = "PARAM1") UnsignedIntType theParam1) {
            // @formatter:on
        ...
        public Parameters opTypeOnlyString(@OperationParam(name = "PARAM1") StringType theParam1) {
            // @formatter:on
