...
public class ServerMimetypeDstu2_1Test {
    ...
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(ServerMimetypeDstu2_1Test.class);
    ...
    public void testCreateWithXmlLegacyNoAcceptHeader() throws Exception {
        ...
        String expectedResponseContent =
                "<Patient xmlns=\"http://hl7.org/fhir\"><id value=\"1\"/><meta><versionId"
                        + " value=\"1\"/></meta><name><family value=\"FAMILY\"/></name></Patient>";

        HttpPost httpPost = new HttpPost("http://localhost:" + ourPort + "/Patient");
        httpPost.setEntity(
                new StringEntity(
                        enc, ContentType.parse(Constants.CT_FHIR_XML + "; charset=utf-8")));
    ...
    public void testCreateWithXmlNewWithAcceptHeaderReturnsOperationOutcome() throws Exception {
        ...
        String enc = ourCtx.newXmlParser().encodeResourceToString(p);
        String expectedResponseContent =
                "<OperationOutcome xmlns=\"http://hl7.org/fhir\"><issue><diagnostics"
                        + " value=\"FAMILY\"/></issue></OperationOutcome>";
    ...
    public void testCreateWithJsonLegacyNoAcceptHeader() throws Exception {
        ...
        httpPost.setEntity(
                new StringEntity(
                        enc, ContentType.parse(Constants.CT_FHIR_JSON + "; charset=utf-8")));
        HttpResponse status = ourClient.execute(httpPost);
