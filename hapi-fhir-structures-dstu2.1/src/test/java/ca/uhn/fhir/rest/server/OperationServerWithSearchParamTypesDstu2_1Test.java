...
public class OperationServerWithSearchParamTypesDstu2_1Test {
    ...
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(OperationServerWithSearchParamTypesDstu2_1Test.class);
    ...
    public void testGenerateConformance() throws Exception {
        ...
        OperationDefinition andListDef =
                sc.readOperationDefinition(
                        new IdType("OperationDefinition/Patient-t-andlist"),
        ...
        andListDef =
                sc.readOperationDefinition(
                        new IdType("OperationDefinition/Patient-t-andlist-withnomax"),
                        createRequestDetails(rs));
        ...
        OperationDefinition orListDef =
                sc.readOperationDefinition(
                        new IdType("OperationDefinition/Patient-t-orlist"),
                        createRequestDetails(rs));
        ...
        orListDef =
                sc.readOperationDefinition(
                        new IdType("OperationDefinition/Patient-t-orlist-withnomax"),
                        createRequestDetails(rs));
        def = ourCtx.newXmlParser().setPrettyPrint(true).encodeResourceToString(orListDef);
        ourLog.info(def);
        // @formatter:off
