...
public class ReadDstu2_1Test {
    ...
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(ReadDstu2_1Test.class);
    ...
    public void testRead() throws Exception {
        ...
        HttpGet httpGet =
                new HttpGet("http://localhost:" + ourPort + "/Patient/2?_format=xml&_pretty=true");
        ...
        assertThat(
                ...
                stringContainsInOrder(
                        ...
                        "<meta>",
                        "<profile"
                            + " value=\"http://example.com/StructureDefinition/patient_with_extensions\"/>",
                        "</meta>",
