...
public class SearchPostDstu2_1Test {
	...
	private static final org.slf4j.Logger ourLog =
				org.slf4j.LoggerFactory.getLogger(SearchPostDstu2_1Test.class);
	...
	public void testSearchWithMixedParamsNoInterceptorsYesParams() throws Exception {
		...
		try {
				...
				assertEquals(
						1, ourLastName.getValuesAsQueryTokens().get(0).getValuesAsQueryTokens().size());
				assertEquals(
						"Smith",
						ourLastName
	...
	public static class DummyPatientResourceProvider implements IResourceProvider {
		...
		public List search(
				...
				retVal.add(
						(Patient)
									new Patient()
												.addName(new HumanName().addFamily("FAMILY"))
												.setId("foo"));
				return retVal;
		}
		// @formatter:on
