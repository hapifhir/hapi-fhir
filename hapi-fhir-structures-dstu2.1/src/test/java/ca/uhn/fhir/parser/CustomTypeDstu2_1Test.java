...
public class CustomTypeDstu2_1Test {
	...
	private static final org.slf4j.Logger ourLog =
				org.slf4j.LoggerFactory.getLogger(CustomTypeDstu2_1Test.class);
	...
	public void testCustomTypeWithCustomDatatype() {
		...
		CustomResource364Dstu21 parsedResource =
					parser.parseResource(CustomResource364Dstu21.class, xml);
		assertEquals(
					"2016-05-13",
