...
public class ReportObservationDstu2_1 extends Observation {
	...
	/**
	* Each extension is defined in a field. Any valid HAPI Data Type can be used for the field
	* type. Note that the [name=""] attribute in the @Child annotation needs to match the name for
	* the bean accessor and mutator methods.
	*/
