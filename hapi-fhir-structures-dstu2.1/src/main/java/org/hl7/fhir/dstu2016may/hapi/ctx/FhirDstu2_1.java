...
public class FhirDstu2_1 implements IFhirVersion {
	...
	public InputStream getFhirVersionPropertiesFile() {
		InputStream str = FhirDstu2_1.class.getResourceAsStream("/org/hl7/fhir/dstu2016may/hapi/fhirversion.properties");
		if (str == null) {
			str = FhirDstu2_1.class.getResourceAsStream("/org/hl7/fhir/dstu2016may/hapi/fhirversion.properties");
		}
		if (str == null) {
