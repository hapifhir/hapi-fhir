...
/**
 * A Hamcrest matcher for junit assertions. Matches on level, partial message, and/or a portion of
 * the message contained by a throwable, if present.
 */
public class LogbackEventMatcher extends CustomTypeSafeMatcher<ILoggingEvent> {
	@Nullable private final Level myLevel;
	@Nullable private final String myLogMessage;
	@Nullable private final String myThrownMessage;
	...
	public LogbackEventMatcher(
				@Nullable Level theLevel,
				@Nullable String thePartialString,
				@Nullable String theThrownMessage) {
	...
	private LogbackEventMatcher(
				...
				Level theLevel,
				String thePartialString,
				String theThrownMessage) {
	...
	private static String makeDescription(
		...
		if (thePartialString != null) {
				msg =
						msg
									+ " and throwable with error message containing string \""
									+ theThrownMessage
									+ "\"";
		}
		return msg;
