 ...
 *
 * <p>The empty constructor will capture all log events, or you can name a log root to limit the
 * noise.
 */
public class LogbackCaptureTestExtension implements BeforeEachCallback, AfterEachCallback {
	...
	*/
	...
	public List<ILoggingEvent> filterLoggingEventsWithPredicate(
				Predicate<ILoggingEvent> theLoggingEventPredicate) {
	...
	public static Matcher<ILoggingEvent> eventWithMessageContains(
