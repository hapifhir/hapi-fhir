...
public class RestServerDstu3Helper extends BaseRestServerHelper
    ...
    public static class MyPlainProvider implements IPointcutLatch {
        private final PointcutLatch myPointcutLatch =
                new PointcutLatch("Transaction Counting Provider");
        private final List<IBaseBundle> myTransactions =
        ...
        public void clear() {
            if (!myTransactionLatchEnabled) {
                throw new IllegalStateException(
                        "Can't call clear() on a provider that doesn't use a latch");
            }
            ...
            public MethodOutcome update(
                ...
                if (myFailNextPut) {
                    throw new PreconditionFailedException(
                            Msg.code(2251) + "Failed update operation");
                }
