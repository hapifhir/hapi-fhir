...
public abstract class BaseFhirVersionParameterizedTest {
        ...
        switch (theFhirVersion) {
            ...
            default:
                throw new RuntimeException(
                        Msg.code(2114) + "Unknown FHIR Version param provided: " + theFhirVersion);
        }
    }
    ...
    protected class FhirVersionParams {
        ...
        public FhirVersionParams(
                BaseRestServerHelper theBaseRestServerHelper, FhirContext theFhirContext) {
