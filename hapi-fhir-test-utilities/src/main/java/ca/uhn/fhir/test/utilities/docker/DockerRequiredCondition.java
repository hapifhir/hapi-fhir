...
/**
 * Execution condition which will skip test classes that require docker if it is not present on the
 * host machine
 */
public class DockerRequiredCondition implements ExecutionCondition {
	...
	public static final String UNAVAILABLE_MSG =
				"It appears as though docker is not installed on the host machine!";

	@Override
	public ConditionEvaluationResult evaluateExecutionCondition(
				ExtensionContext theExtensionContext) {
		try {
