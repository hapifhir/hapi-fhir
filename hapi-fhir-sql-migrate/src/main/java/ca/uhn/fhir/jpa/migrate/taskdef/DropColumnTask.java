...
public class DropColumnTask extends BaseTableColumnTask {
    ...
    public void doExecute() throws SQLException {
        ...
        if (getDriverType().equals(DriverTypeEnum.MYSQL_5_7)
            ...
            // Some DBs such as MYSQL and Maria DB require that foreign keys depending on the column
            // be dropped before the column itself is dropped.
            logInfo(
                    ourLog,
            ...
            Set<String> foreignKeys =
                    JdbcUtils.getForeignKeysForColumn(
                            getConnectionProperties(), getColumnName(), getTableName());
            if (foreignKeys != null) {
