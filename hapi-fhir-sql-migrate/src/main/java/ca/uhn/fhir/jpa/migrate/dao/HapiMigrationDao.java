...
public class HapiMigrationDao {
	...
	public HapiMigrationDao(
				DataSource theDataSource, DriverTypeEnum theDriverType, String theMigrationTablename) {
	...
	*/
	public boolean save(HapiMigrationEntity theEntity) {
		...
		int changedRecordCount =
					myJdbcTemplate.update(insertRecordStatement, theEntity.asPreparedStatementSetter());
	...
	public boolean createMigrationTableIfRequired() {
		...
		myJdbcTemplate.update(
					myMigrationQueryBuilder.insertPreparedStatement(),
					entity.asPreparedStatementSetter());
	...
	*/
	public boolean deleteLockRecord(Integer theLockPid, String theLockDescription) {
		int recordsChanged =
					myJdbcTemplate.update(
								myMigrationQueryBuilder.deleteLockRecordStatement(
										theLockPid, theLockDescription));
	...
	public Optional<HapiMigrationEntity> findFirstByPidAndNotDescription(
		...
		String query =
					myMigrationQueryBuilder.findByPidAndNotDescriptionQuery(
								theLockPid, theLockDescription);
