...
public final class ColumnTypeToDriverTypeToSqlType {
	...
	static Map<ColumnTypeEnum, Map<DriverTypeEnum, String>> myColumnTypeToDriverTypeToSqlType =
				new HashMap<>();
	...
	public static Map<ColumnTypeEnum, Map<DriverTypeEnum, String>>
	...
	private static void setColumnType(
		...
		Map<DriverTypeEnum, String> columnSqlType =
					myColumnTypeToDriverTypeToSqlType.computeIfAbsent(
								theColumnType, k -> new HashMap<>());
