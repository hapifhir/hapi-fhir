...
public class MigrationQueryBuilder {
    ...
    public MigrationQueryBuilder(DriverTypeEnum theDriverType, String theMigrationTablename) {
        ...
        myVersionCol =
                myTable.addColumn(
                        "\"version\"", Types.VARCHAR, HapiMigrationEntity.VERSION_MAX_SIZE);

        myDescriptionCol =
                myTable.addColumn(
                        "\"description\"", Types.VARCHAR, HapiMigrationEntity.DESCRIPTION_MAX_SIZE);
        ...
        myScriptCol =
                myTable.addColumn("\"script\"", Types.VARCHAR, HapiMigrationEntity.SCRIPT_MAX_SIZE);
        myScriptCol.notNull();
        ...
        myInstalledByCol =
                myTable.addColumn(
                        "\"installed_by\"",
                        Types.VARCHAR,
                        HapiMigrationEntity.INSTALLED_BY_MAX_SIZE);
        ...
        return new SelectQuery()
                ...
                .addCondition(
                        BinaryCondition.notEqualTo(
                                myInstalledRankCol, HapiMigrationEntity.CREATE_TABLE_PID))
                .addAllColumns()
                .validate()
                .toString();
    }
