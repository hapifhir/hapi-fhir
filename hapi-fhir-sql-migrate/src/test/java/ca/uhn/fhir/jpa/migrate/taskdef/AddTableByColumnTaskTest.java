...
public class AddTableByColumnTaskTest extends BaseTest {
    ...
    @MethodSource("data")
    public void testAddTable(Supplier<TestDatabaseDetails> theTestDatabaseDetails)
            throws SQLException {
        ...
        assertThat(
                ...
                containsInAnyOrder("FOO_TABLE", "TGT_TABLE"));
        Set<String> indexes =
                JdbcUtils.getIndexNames(getConnectionProperties(), "FOO_TABLE").stream()
    ...
    private static class MyMigrationTasks extends BaseMigrationTasks<VersionEnum> {
        public MyMigrationTasks() {
            ...
            Builder.BuilderAddTableByColumns fooTable =
                    v.addTableByColumns("4", "FOO_TABLE", "PID");
            ...
            fooTable.addForeignKey("8", "FK_REF")
                    .toColumn("COL_REF")
                    .references("TGT_TABLE", "PID");
