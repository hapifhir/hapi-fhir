...
class MetadataSourceTest {
	...
	@Mock DriverTypeEnum.ConnectionProperties myConnectionProperties;
	@Mock JdbcTemplate myJdbcTemplate;
	...
	@CsvSource({
		...
		"ORACLE_12C,Oracle Database 19c Express Edition Release 11.2.0.2.0 - 64bit"
					+ " Production,false",
	...
	void isOnlineIndexSupported(
				DriverTypeEnum theType, String theEdition, boolean theSupportedFlag) {
		...
		assertEquals(
					theSupportedFlag, myMetadataSource.isOnlineIndexSupported(myConnectionProperties));
	}
}
