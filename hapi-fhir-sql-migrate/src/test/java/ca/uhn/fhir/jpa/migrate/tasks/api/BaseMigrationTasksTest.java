...
public class BaseMigrationTasksTest {
    ...
    public void testValidateVersionWrongOrder() {
        ...
        try {
            ...
            assertEquals(
                    Msg.code(51)
                            + "Migration version 1.20191029.1 found after migration version"
                            + " 1.20191029.2.  Migrations need to be in order by version number.",
                    e.getMessage());
        }
    }
    ...
    public void testValidateSameVersion() {
        ...
        try {
            ...
            assertEquals(
                    Msg.code(51)
                            + "Migration version 1.20191029.1 found after migration version"
                            + " 1.20191029.1.  Migrations need to be in order by version number.",
                    e.getMessage());
        }
    }
    ...
    public void testValidateWrongDateOrder() {
        ...
        try {
            ...
            assertEquals(
                    Msg.code(51)
                            + "Migration version 1.20191028.1 found after migration version"
                            + " 1.20191029.1.  Migrations need to be in order by version number.",
                    e.getMessage());
        }
    }
