...
public class BaseTaskTest {
    ...
    public void testValidateVersionShort() {
        ...
        try {
            ...
            assertEquals(
                    Msg.code(62)
                            + "The version 123.4 does not match the expected pattern "
    ...
    public void testValidateVersionNoPeriod() {
        ...
        try {
            ...
            assertEquals(
                    Msg.code(62)
                            + "The version 123456789 does not match the expected pattern "
                            + BaseTask.MIGRATION_VERSION_PATTERN,
                    e.getMessage());
        }
    }
    ...
    public void testValidateVersionTooManyPeriods() {
        ...
        try {
            ...
            assertEquals(
                    Msg.code(62)
                            + "The version 12345678.9.1 does not match the expected pattern "
                            + BaseTask.MIGRATION_VERSION_PATTERN,
                    e.getMessage());
        }
    }
