...
public class JdbcUtilsTest {
    ...
    @Mock DataSource myDataSource;
    @Mock Connection myConnection;
    @Mock DatabaseMetaData myDatabaseMetaData;
    @Mock ResultSet myResultSet;
    ...
    public void testGetColumnType_verifyTypeMappings() throws SQLException {
        ...
        testGetColumnType_verifyTypeMapping(
                Types.TIMESTAMP_WITH_TIMEZONE, ColumnTypeEnum.DATE_TIMESTAMP);
    ...
    private void testGetColumnType_verifyTypeMapping(
            int theExistingDataType, ColumnTypeEnum theExpectedColumnType) throws SQLException {
    ...
    public void testGetIndexNames_verifyNullHandling() throws SQLException {
        ...
        when(myDatabaseMetaData.getTables("Catalog", "Schema", null, null))
