...
public abstract class BaseTest {
    ...
    public static Stream<Supplier<TestDatabaseDetails>> data() {
        ...
        // H2
        retVal.add(
                new Supplier<TestDatabaseDetails>() {
                    @Override
                    public TestDatabaseDetails get() {
                        ...
                        dataSource.setDriverClassName(
                                DriverTypeEnum.H2_EMBEDDED.getDriverClassName());
                        ...
                        return new TestDatabaseDetails(
                                url, connectionProperties, dataSource, migrator);
                    }
        ...
        retVal.add(
                new Supplier<TestDatabaseDetails>() {
                    ...
                    public TestDatabaseDetails get() {
                        ourLog.info(
                                "Derby: {}", DriverTypeEnum.DERBY_EMBEDDED.getDriverClassName());
                        ...
                        String url =
                                "jdbc:derby:memory:"
                                        ...
                                        + ";create=true";
                        DriverTypeEnum.ConnectionProperties connectionProperties =
                                DriverTypeEnum.DERBY_EMBEDDED.newConnectionProperties(
                                        url, "SA", "SA");
                        BasicDataSource dataSource = new BasicDataSource();
                        dataSource.setUrl(url);
                        dataSource.setUsername("SA");
                        dataSource.setPassword("SA");
                        dataSource.setDriverClassName(
                                DriverTypeEnum.DERBY_EMBEDDED.getDriverClassName());
                        HapiMigrator migrator =
                                new HapiMigrator(
                                        SchemaMigrator.HAPI_FHIR_MIGRATION_TABLENAME,
                                        dataSource,
    ...
    protected List<Map<String, Object>> executeQuery(
            @Language("SQL") String theSql, Object... theArgs) {
        return myConnectionProperties
                .getTxTemplate()
                .execute(
                        t -> {
