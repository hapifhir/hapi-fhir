...
public class ExecuteRawSqlTaskTest extends BaseTest {
	...
	public void testExecuteSql(Supplier<TestDatabaseDetails> theTestDatabaseDetails) {
		...
		tasks.forVersion(VersionEnum.V4_0_0)
					.executeRawSql(
								"2001.01", "INSERT INTO SOMETABLE (PID, TEXTCOL) VALUES (123, 'abc')");
	...
	public void testExecuteSql_AllowedToFail(Supplier<TestDatabaseDetails> theTestDatabaseDetails) {
		...
		tasks.forVersion(VersionEnum.V4_0_0)
					.executeRawSql(
								"2001.01",
								"INSERT INTO SOMETABLE (PID_BAD_COLUMN, TEXTCOL) VALUES (123, 'abc')")
					.failureAllowed();
	...
	@ParameterizedTest(name = "{index}: {0}")
	@MethodSource("data")
	public void testDriverTypeBasedRawSqlExecution(
		...
		driverToSql.put(
					...
					"INSERT INTO SOMETABLE (PID, TEXTCOL) VALUES (123, 'abc')");
		driverToSql.put(
					DriverTypeEnum.DERBY_EMBEDDED,
					"INSERT INTO SOMETABLE (PID, TEXTCOL) VALUES (456, 'def')");
		tasks.forVersion(VersionEnum.V4_0_0).executeRawSql("2001.01", driverToSql);
