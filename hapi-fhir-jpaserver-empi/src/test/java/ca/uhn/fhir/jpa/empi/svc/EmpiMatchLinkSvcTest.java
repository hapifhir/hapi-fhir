...
public class EmpiMatchLinkSvcTest extends BaseEmpiR4Test {
	...
	public void testWhenMatchOccursOnPersonThatHasBeenManuallyNOMATCHedThatItIsBlocked() {
		...
		myEmpiLinkSvc.updateLink(janePerson, unmatchedJane, EmpiMatchResult.NO_MATCH, EmpiLinkSourceEnum.MANUAL, createContextForCreate());
	...
	public void testWhenPOSSIBLE_MATCHOccursOnPersonThatHasBeenManuallyNOMATCHedThatItIsBlocked() {
		...
		myEmpiLinkSvc.updateLink(janePerson, unmatchedPatient, EmpiMatchResult.NO_MATCH, EmpiLinkSourceEnum.MANUAL, createContextForCreate());
	...
	public void testMATCHResultWithMultipleCandidatesCreatesPOSSIBLE_DUPLICATELinksAndNoPersonIsCreated() {
		...
		myEmpiLinkSvc.updateLink(person, janePatient2, EmpiMatchResult.NEW_PERSON_MATCH, EmpiLinkSourceEnum.AUTO, createContextForCreate());
	...
	public void testManualMatchesGenerateAssuranceLevel4() {
		Patient patient = createPatientAndUpdateLinks(buildJanePatient());
		Person janePerson = getPersonFromTarget(patient);
		myEmpiLinkSvc.updateLink(janePerson, patient, EmpiMatchResult.NEW_PERSON_MATCH, EmpiLinkSourceEnum.MANUAL, createContextForCreate());
