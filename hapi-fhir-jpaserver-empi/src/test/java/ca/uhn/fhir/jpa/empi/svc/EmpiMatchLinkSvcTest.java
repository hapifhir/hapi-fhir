...
public class EmpiMatchLinkSvcTest extends BaseEmpiR4Test {
	...
	public void testWhenMatchOccursOnPersonThatHasBeenManuallyNOMATCHedThatItIsBlocked() {
		...
		myEmpiLinkSvc.updateLink(janePerson, unmatchedJane, EmpiMatchResultEnum.NO_MATCH, false, false, EmpiLinkSourceEnum.MANUAL, createContextForCreate());
	...
	public void testWhenPOSSIBLE_MATCHOccursOnPersonThatHasBeenManuallyNOMATCHedThatItIsBlocked() {
		...
		myEmpiLinkSvc.updateLink(janePerson, unmatchedPatient, EmpiMatchResultEnum.NO_MATCH, false, false, EmpiLinkSourceEnum.MANUAL, createContextForCreate());
	...
	public void testMATCHResultWithMultipleCandidatesCreatesPOSSIBLE_DUPLICATELinksAndNoPersonIsCreated() {
		...
		myEmpiLinkSvc.updateLink(person, janePatient2, EmpiMatchResultEnum.MATCH, false, false, EmpiLinkSourceEnum.AUTO, createContextForCreate());
	...
	public void testManualMatchesGenerateAssuranceLevel4() {
		Patient patient = createPatientAndUpdateLinks(buildJanePatient());
		Person janePerson = getPersonFromTarget(patient);
		myEmpiLinkSvc.updateLink(janePerson, patient, EmpiMatchResultEnum.MATCH, false, false, EmpiLinkSourceEnum.MANUAL, createContextForCreate());
