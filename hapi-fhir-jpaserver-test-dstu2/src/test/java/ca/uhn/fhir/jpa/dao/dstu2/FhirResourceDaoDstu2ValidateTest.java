...
public class FhirResourceDaoDstu2ValidateTest extends BaseJpaDstu2Test {
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(FhirResourceDaoDstu2ValidateTest.class);
    ...
    private OperationOutcome doTestValidateResourceContainingProfileDeclaration(
        ...
        Bundle vss =
                loadResourceFromClasspath(
                        Bundle.class, "/org/hl7/fhir/instance/model/valueset/valuesets.xml");
        ...
        StructureDefinition sd =
                loadResourceFromClasspath(
                        ...
                        "/org/hl7/fhir/instance/model/profile/devicemetricobservation.profile.xml");
        sd.setId(new IdDt());
        sd.setUrl("http://example.com/foo/bar/" + methodName);
        myStructureDefinitionDao.create(sd, mySrd);

        Observation input = new Observation();
        ResourceMetadataKeyEnum.PROFILES.put(
                input, Collections.singletonList(new IdDt(sd.getUrl())));
    ...
    public void testValidateResourceContainingProfileDeclarationInvalid() {
        ...
        ResourceMetadataKeyEnum.PROFILES.put(
                input, Collections.singletonList(new IdDt(profileUri)));
