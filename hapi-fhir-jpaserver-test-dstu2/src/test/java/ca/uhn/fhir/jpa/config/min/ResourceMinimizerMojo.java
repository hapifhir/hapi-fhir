...
public class ResourceMinimizerMojo {
    ...
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(ResourceMinimizerMojo.class);
    ...
    public void execute() throws Exception {
        ...
        Collection<File> files =
                FileUtils.listFiles(targetDirectory, new String[] {"xml", "json"}, true);
    ...
    private void minimizeResource(IBaseResource theInput) {
        ...
        BaseRuntimeElementCompositeDefinition<?> element =
                (BaseRuntimeElementCompositeDefinition)
                        myCtx.getElementDefinition(theInput.getClass());
    ...
    public static void main(String[] args) throws Exception {
        ...
        m.targetDirectory =
                new File(
                        "./hapi-fhir-validation-resources-dstu3/src/main/resources/org/hl7/fhir/dstu3/model/profile");
        m.fhirVersion = "DSTU3";
        m.execute();
        byteCount += m.getByteCount();
        fileCount += m.getFileCount();
        ...
        m.targetDirectory =
                new File(
                        "./hapi-fhir-validation-resources-dstu3/src/main/resources/org/hl7/fhir/dstu3/model/valueset");
        m.fhirVersion = "DSTU3";
        m.execute();
        byteCount += m.getByteCount();
        ...
        m.targetDirectory =
                new File(
                        "./hapi-fhir-validation-resources-r4/src/main/resources/org/hl7/fhir/r4/model/profile");
        m.fhirVersion = "R4";
        m.execute();
        byteCount += m.getByteCount();
        fileCount += m.getFileCount();
        ...
        m.targetDirectory =
                new File(
                        "./hapi-fhir-validation-resources-r4/src/main/resources/org/hl7/fhir/r4/model/valueset");
        m.fhirVersion = "R4";
        m.execute();
        byteCount += m.getByteCount();
        fileCount += m.getFileCount();
