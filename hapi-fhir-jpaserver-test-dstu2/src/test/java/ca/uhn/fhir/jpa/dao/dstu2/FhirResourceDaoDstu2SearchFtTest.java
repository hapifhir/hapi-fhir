...
public class FhirResourceDaoDstu2SearchFtTest extends BaseJpaDstu2Test {
    ...
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(FhirResourceDaoDstu2SearchFtTest.class);
    ...
    public void testEverythingInstanceWithContentFilter() {
        ...
        actual =
                toUnqualifiedVersionlessIds(
                        myPatientDao.patientInstanceEverything(
                                request, mySrd, everythingParams, ptId1));
        ...
        actual =
                toUnqualifiedVersionlessIds(
                        myPatientDao.patientInstanceEverything(
                                request, mySrd, new PatientEverythingParameters(), ptId1));
    ...
    public void testEverythingTypeWithContentFilter() {
        ...
        actual =
                toUnqualifiedVersionlessIds(
                        myPatientDao.patientTypeEverything(request, mySrd, everythingParams, null));
        assertThat(actual, containsInAnyOrder(ptId1, obsId1, devId1));
