...
public class BaseSearchSvc {
	...
	@Mock protected SearchBuilderFactory<JpaPid> mySearchBuilderFactory;
	@Spy protected HapiTransactionService myTransactionService = new MockHapiTransactionService();
	@Mock protected SearchBuilder mySearchBuilder;

	@Mock protected IFhirResourceDao<?> myCallingDao;

	@Mock protected DaoRegistry myDaoRegistry;

	@Mock protected BeanFactory myBeanFactory;

	@Spy protected JpaStorageSettings myStorageSettings = new JpaStorageSettings();
	...
	public static class ResultIterator extends BaseIterator<JpaPid>
