...
public class ResourceProviderMeaningfulOutcomeMessageR4Test extends BaseResourceProviderR4Test {
	...
	public void testCreateUpdateDelete() {
		...
		assertThat(
					oo.getIssueFirstRep().getDiagnostics(),
					matchesHapiMessage("deleteResourceAlreadyDeleted"));
		assertEquals(
	...
	public void testCreateUpdateDelete_InTransaction() {
		...
		Bundle input =
					(Bundle)
								new BundleBuilder(myFhirContext)
		...
		assertThat(
					oo.getIssueFirstRep().getDiagnostics(),
					matchesHapiMessage("successfulUpdateNoChange"));
		assertEquals(
					StorageResponseCodeEnum.SUCCESSFUL_UPDATE_NO_CHANGE.name(),
					oo.getIssueFirstRep().getDetails().getCodingFirstRep().getCode());
		assertEquals(
	...
	public void testConditionalCreate_NoMatch_InTransaction() {
		...
		assertThat(
					oo.getIssueFirstRep().getDiagnostics(),
					matchesPattern(
								"Successfully conditionally created resource \".*\". No existing resources"
										+ " matched URL \"Patient\\?active=true\". Took [0-9]+ms."));
		assertEquals(
	...
	public void testConditionalCreate_WithMatch_InTransaction() {
		...
		assertThat(
					oo.getIssueFirstRep().getDiagnostics(),
					matchesHapiMessage("successfulCreateConditionalWithMatch"));
		assertEquals(
	...
	public void testConditionalUpdate_WithMatchAndChange() {
		...
		assertThat(
					oo.getIssueFirstRep().getDiagnostics(),
					matchesHapiMessage(
								"successfulUpdateConditionalWithMatch", "successfulTimingSuffix"));
		assertEquals(
	...
	public void testConditionalUpdate_WithMatchNoChange() {
		...
		assertThat(
					oo.getIssueFirstRep().getDiagnostics(),
					matchesHapiMessage(
								"successfulUpdateConditionalNoChangeWithMatch", "successfulTimingSuffix"));
		assertEquals(
	...
	public void testConditionalUpdate_WithMatchAndChange_InTransaction() {
		...
		assertThat(
					oo.getIssueFirstRep().getDiagnostics(),
					matchesHapiMessage("successfulUpdateConditionalWithMatch"));
		assertEquals(
					StorageResponseCodeEnum.SUCCESSFUL_UPDATE_WITH_CONDITIONAL_MATCH.name(),
					oo.getIssueFirstRep().getDetails().getCodingFirstRep().getCode());
		assertEquals(
	...
	public void testPatch_WithChanges_InTransaction() {
		...
		Bundle response = myClient.transaction().withBundle((Bundle) bb.getBundle()).execute();
		OperationOutcome oo =
	...
	public void testPatch_NoChanges_InTransaction() {
		...
		assertThat(
					oo.getIssueFirstRep().getDiagnostics(),
					matchesHapiMessage("successfulPatchNoChange"));
		assertEquals(
					StorageResponseCodeEnum.SUCCESSFUL_PATCH_NO_CHANGE.name(),
					oo.getIssueFirstRep().getDetails().getCodingFirstRep().getCode());
		assertEquals(
	...
	public void testPatch_Conditional_MatchWithChanges_InTransaction() {
		...
		assertThat(
					oo.getIssueFirstRep().getDiagnostics(),
					matchesHapiMessage("successfulPatchConditional"));
		assertEquals(
					StorageResponseCodeEnum.SUCCESSFUL_CONDITIONAL_PATCH.name(),
					oo.getIssueFirstRep().getDetails().getCodingFirstRep().getCode());
		assertEquals(
	...
	public void testPatch_Conditional_MatchNoChanges_InTransaction() {
		...
		assertThat(
					oo.getIssueFirstRep().getDiagnostics(),
					matchesHapiMessage("successfulPatchConditionalNoChange"));
		assertEquals(
					StorageResponseCodeEnum.SUCCESSFUL_CONDITIONAL_PATCH_NO_CHANGE.name(),
					oo.getIssueFirstRep().getDetails().getCodingFirstRep().getCode());
		assertEquals(
	...
	public void testMultiDelete_NoneFound() {
		...
		assertThat(
					oo.getIssueFirstRep().getDiagnostics(),
					matchesHapiMessage("unableToDeleteNotFound"));
		assertEquals(
