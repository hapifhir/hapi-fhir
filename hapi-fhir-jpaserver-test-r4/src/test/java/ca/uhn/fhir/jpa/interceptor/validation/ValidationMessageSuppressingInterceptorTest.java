...
public class ValidationMessageSuppressingInterceptorTest extends BaseResourceProviderR4Test {
    ...
    public void after() throws Exception {
        ...
        myInterceptorRegistry.unregisterInterceptorsIf(
                t -> t instanceof RepositoryValidatingInterceptor);
        myInterceptorRegistry.unregisterInterceptorsIf(
                t -> t instanceof ValidationMessageSuppressingInterceptor);
    }
    ...
    public void testDaoValidation() throws IOException {
        ...
        Observation inputObs =
                loadResource(
                        myFhirContext, Observation.class, "/r4/uscore/observation-pulseox.json");

        MethodOutcome result =
                myObservationDao.validate(inputObs, null, input, null, null, null, null);

        ValidationMessageSuppressingInterceptor interceptor =
                new ValidationMessageSuppressingInterceptor();
        ...
        // Without suppression
        {
            Observation inputObs =
                    loadResource(
                            myFhirContext,
                            Observation.class,
                            "/r4/uscore/observation-pulseox.json");
            try {
                myClient.create()
                        .resource(inputObs)
                        .execute()
    ...
    public void testRepositoryValidation() {
        ...
        List<IRepositoryValidatingRule> rules =
        ...
        RepositoryValidatingInterceptor repositoryValidatingInterceptor =
                new RepositoryValidatingInterceptor();
