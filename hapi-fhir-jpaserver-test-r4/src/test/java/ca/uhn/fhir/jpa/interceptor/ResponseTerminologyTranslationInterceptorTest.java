...
public class ResponseTerminologyTranslationInterceptorTest extends BaseResourceProviderR4Test {
	...
	public void testMapConcept_MappingFound() {
		...
		assertThat(
					...
					Matchers.contains(
								...
								"[system=http://example.com/my_code_system2, code=34567, display=Target"
										+ " Code 34567]"));
	}
	...
	public void testMapConcept_MultipleMappingsFound() {
		...
		assertThat(
					...
					Matchers.contains(
								"[system=http://example.com/my_code_system, code=12345, display=null]",
								"[system=http://example.com/my_code_system3, code=56789, display=Target"
										+ " Code 56789]",
								"[system=http://example.com/my_code_system3, code=67890, display=Target"
										+ " Code 67890]"));
	}
	...
	public void testMapConcept_MappingNotNeeded() {
		...
		assertThat(
					...
					Matchers.contains(
								"[system=http://example.com/my_code_system, code=12345, display=null]",
								"[system=http://example.com/my_code_system2, code=9999, display=Display"
										+ " 9999]"));
	}
	...
	public void testBulkExport_TerminologyTranslation_NoMapping() {
		...
		List<String> codingList =
					List.of("{\"system\":\"http://example.com/my_code_system\",\"code\":\"12345\"}");
