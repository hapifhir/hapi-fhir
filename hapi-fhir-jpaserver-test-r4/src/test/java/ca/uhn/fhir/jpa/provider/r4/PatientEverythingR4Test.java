...
public class PatientEverythingR4Test extends BaseResourceProviderR4Test {
	...
	public void testEverythingReturnsCorrectResources() throws Exception {
		...
		Bundle bundle =
				fetchBundle(myServerBase + "/" + patId + "/$everything?_format=json&_count=100", EncodingEnum.JSON);
	...
	public void testEverythingPagesWithCorrectEncodingJson() throws Exception {
		...
		Bundle bundle =
				fetchBundle(myServerBase + "/" + patId + "/$everything?_format=json&_count=1", EncodingEnum.JSON);
	...
	public void testEverythingWithLargeResultSetDoesNotNpe() throws IOException {
		...
		Bundle bundle =
				fetchBundle(myServerBase + "/" + patId + "/$everything?_format=json&_count=250", EncodingEnum.JSON);
		do {
