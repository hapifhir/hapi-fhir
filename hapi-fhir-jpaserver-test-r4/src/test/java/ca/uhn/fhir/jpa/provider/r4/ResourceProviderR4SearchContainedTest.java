...
public class ResourceProviderR4SearchContainedTest extends BaseResourceProviderR4Test {
    ...
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(ResourceProviderR4SearchContainedTest.class);
    ...
    public void after() throws Exception {
        ...
        myStorageSettings.setCountSearchResultsUpTo(
                new JpaStorageSettings().getCountSearchResultsUpTo());
        ...
        myStorageSettings.setIndexOnContainedResources(
                new JpaStorageSettings().isIndexOnContainedResources());
    }
        ...
        try (CloseableHttpResponse response = ourHttpClient.execute(new HttpGet(uri))) {
            ...
            assertThat(
                    ...
                    containsString(
                            ">"
                                    + Msg.code(984)
                                    + "Searching with _contained mode enabled is not enabled on"
                                    + " this server"));
        }
    }
    ...
    public void testContainedSearchByDate() throws Exception {
        ...
        uri =
                myServerBase
                        + "/Observation?subject.family=Smith&subject.birthdate=eq2000-01-01&_contained=true";
        oids = searchAndReturnUnqualifiedVersionlessIdValues(uri);
        ...
        uri =
                myServerBase
                        + "/Observation?subject.family=Smith&subject.birthdate=eq2000-02-01&_contained=true";
        oids = searchAndReturnUnqualifiedVersionlessIdValues(uri);
    ...
    public void testContainedSearchByNumber() throws Exception {
...

        {
            ...
            ourLog.debug(
                    "Input: {}",
                    myFhirContext.newJsonParser().setPrettyPrint(true).encodeResourceToString(imp));
            ...
            ourLog.debug(
                    ...
                    myFhirContext
                            .newJsonParser()
                            .setPrettyPrint(true)
                            .encodeResourceToString(createdImp));
        }

        {
            ...
            IIdType cid2 =
                    myClinicalImpressionDao.create(imp, mySrd).getId().toUnqualifiedVersionless();
        ...
        // -- Search by number
        String uri =
                myServerBase + "/ClinicalImpression?investigation.probability=2&_contained=true";
    ...
    public void testContainedSearchByQuantity() throws Exception {
        ...
        IIdType eid1;
        {
            ...
            ourLog.debug(
                    ...
                    myFhirContext
                            .newJsonParser()
                            .setPrettyPrint(true)
                            .encodeResourceToString(createdEncounter));
        }

        {
            ...
            IIdType eid2 =
                    myEncounterDao.create(encounter, mySrd).getId().toUnqualifiedVersionless();
        ...
        String uri =
                myServerBase
                        + "/Encounter?reason-reference.combo-value-quantity=200&_contained=true";
        ...
        uri =
                myServerBase
                        + "/Encounter?reason-reference.combo-value-quantity=le400&_contained=true";
    ...
    public void testContainedSearchByToken() throws Exception {
        ...
        String uri =
                myServerBase
                        + "/Encounter?reason-reference.code=http://"
                        + UrlUtil.escapeUrlParam("loinc.org|2345-7")
                        + "&_contained=true";
        List<String> eids = searchAndReturnUnqualifiedVersionlessIdValues(uri);
    ...
    public void testContainedSearchByComposite() throws Exception {
        ...
        String uri =
                myServerBase
                        + "/Encounter?reason-reference.combo-code-value-quantity=http://"
                        + UrlUtil.escapeUrlParam("loinc.org|2345-8$300")
                        + "&_contained=true";
        List<String> eids = searchAndReturnUnqualifiedVersionlessIdValues(uri);
        ...
        uri =
                myServerBase
                        + "/Encounter?reason-reference.combo-code-value-quantity=http://"
                        + UrlUtil.escapeUrlParam("loinc.org|2345-7$300")
                        + "&_contained=true";
        eids = searchAndReturnUnqualifiedVersionlessIdValues(uri);
    ...
    public void testContainedSearchByUri() throws Exception {
...

        {
            ...
            ourLog.debug(
                    ...
                    myFhirContext
                            .newJsonParser()
                            .setPrettyPrint(true)
                            .encodeResourceToString(createdObs));
        }
        ...
        uri =
                myServerBase
                        + "/Observation?based-on.instantiates-uri=http://www.hl7.com,http://www2.hl7.com";
        oids = searchAndReturnUnqualifiedVersionlessIdValues(uri);
...

        {
            ...
            ourLog.debug(
                    ...
                    myFhirContext
                            .newJsonParser()
                            .setPrettyPrint(true)
                            .encodeResourceToString(updatedObs));
        }
    ...
    public List<String> searchAndReturnUnqualifiedVersionlessIdValues(String uri)
            throws IOException {
        List<String> ids;
