...
public class ExpandResourcesStepJpaTest extends BaseJpaR4Test {
    ...
    @Autowired private ExpandResourcesStep myExpandResourcesStep;

    @Mock private IJobDataSink<ExpandedResourcesList> mySink;
    @Captor private ArgumentCaptor<ExpandedResourcesList> myWorkChunkCaptor;
    ...
    public void testBulkExportExpandResourcesStep(
            JpaStorageSettings.TagStorageModeEnum theTagStorageMode, int theExpectedSelectQueries) {
        // Setup
                ...
                IntStream.range(0, count)
                        ...
                        .map(
                                t -> {
                                    ...
                                    p.getMeta()
                                            .addTag()
                                            .setSystem("http://static")
                                            .setCode("tag")
                                            .setUserSelected(true)
                                            .setVersion("1");
                                    p.getMeta()
                                            .addTag()
                                            .setSystem("http://dynamic")
                                            .setCode("tag" + t)
                                            .setUserSelected(true)
                                            .setVersion("1");
        ...
        StepExecutionDetails<BulkExportJobParameters, ResourceIdList> details =
                new StepExecutionDetails<>(params, resourceList, jobInstance, chunkId);
        ...
        assertThat(
                expandedResourceList.getStringifiedResources().get(0),
                containsString(
                        "{\"system\":\"http://static\",\"version\":\"1\",\"code\":\"tag\",\"userSelected\":true}"));
        assertThat(
                expandedResourceList.getStringifiedResources().get(1),
                containsString(
                        "{\"system\":\"http://static\",\"version\":\"1\",\"code\":\"tag\",\"userSelected\":true}"));
    ...
    public void testPostFetchFiltering() {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            nonMatchingPatient
                    .getMeta()
                    .addTag()
                    .setSystem("http://tag-system")
                    .setCode("other-tag-value");
            Long nonMatchingId =
                    myPatientDao.create(nonMatchingPatient, mySrd).getId().getIdPartAsLong();
        ...
        List<Long> resourceIds =
                myWorkChunkCaptor.getValue().getStringifiedResources().stream()
                        .map(
                                t ->
                                        myFhirContext
                                                .newJsonParser()
        ...
        assertThat(
                ...
                resourceIds,
                containsInAnyOrder(matchingIds.toArray(new Long[0])));
    }
    ...
    public void testPostFetchFiltering_NoFiltersForGivenResourceType() {
        ...
        assertThat(
                resourceIds.toString(),
                resourceIds,
                containsInAnyOrder(allIds.toArray(new Long[0])));
    }
}
