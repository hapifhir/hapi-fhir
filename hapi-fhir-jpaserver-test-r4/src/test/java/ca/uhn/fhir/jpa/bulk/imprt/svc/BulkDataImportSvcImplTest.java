...
public class BulkDataImportSvcImplTest extends BaseJpaR4Test {
    ...
    @Autowired private IBulkDataImportSvc mySvc;
    @Autowired private IBulkImportJobDao myBulkImportJobDao;
    @Autowired private IBulkImportJobFileDao myBulkImportJobFileDao;
    ...
    public void testCreateNewJob() {
        ...
        runInTransaction(
                () -> {
                    ...
                    List<BulkImportJobFileEntity> files =
                            myBulkImportJobFileDao.findAllForJob(jobId);
    ...
    public void testCreateNewJob_InvalidJob_NoContents() {
        ...
        try {
            ...
            assertEquals(
                    Msg.code(1766) + "Job File Contents mode must not be null", e.getMessage());
        }
    }
    ...
    public void testAddFilesToJob_WrongStatus() {
        ...
        try {
            ...
            assertEquals(
                    Msg.code(1769) + "bijob id ABCDEFG has status RUNNING and can not be added to",
                    e.getMessage());
        }
    }
