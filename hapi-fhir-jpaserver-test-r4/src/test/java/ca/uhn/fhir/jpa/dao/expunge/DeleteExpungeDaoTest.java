...
class DeleteExpungeDaoTest extends BaseJpaR4Test {
    ...
    public void testDeleteExpungeThrowExceptionIfForeignKeyLinksExists() {
        ...
        DeleteMethodOutcome outcome =
                myOrganizationDao.deleteByUrl(
                        "Organization?" + JpaConstants.PARAM_DELETE_EXPUNGE + "=true", mySrd);
    ...
    public void testDeleteWithExpungeFailsIfConflictsAreGeneratedByMultiplePartitions() {
        ...
        assertThat(
                job.getErrorMessage(),
                containsString("DELETE with _expunge=true failed.  Unable to delete "));
    }
    ...
    public void testDeleteExpungeRespectsExpungeBatchSize() {
        ...
        DeleteMethodOutcome outcome =
                myPatientDao.deleteByUrl(
                        "Patient?" + JpaConstants.PARAM_DELETE_EXPUNGE + "=true", mySrd);
        ...
        //		assertEquals(30,
        // job.getExecutionContext().getLong(SqlExecutorWriter.ENTITY_TOTAL_UPDATED_OR_DELETED));
        //		assertEquals(10,
        // job.getExecutionContext().getLong(PidReaderCounterListener.RESOURCE_TOTAL_PROCESSED));
    }
