...
public class GraphQLR4Test extends BaseResourceProviderR4Test {
    ...
    public void testInstance_Read_Patient() throws IOException {
        ...
        try (CloseableHttpResponse response = ourHttpClient.execute(httpGet)) {
            ...
            assertEquals(
                    TestUtil.stripWhitespace(DATA_PREFIX + expected + DATA_SUFFIX),
    ...
    public void testType_Introspect_Patient() throws IOException {
        ...
        for (int i = 0; i < 3; i++) {
            try (CloseableHttpResponse response = ourHttpClient.execute(httpGet)) {
                ...
                assertThat(
                        resp,
                        not(containsString("{\"kind\":\"OBJECT\",\"name\":\"Observation\",")));
                assertThat(
                        resp,
                        not(containsString("\"name\":\"Observation\",\"args\":[{\"name\":\"id\"")));
                assertThat(
                        resp,
                        not(
                                containsString(
                                        "\"name\":\"ObservationList\",\"args\":[{\"name\":\"_filter\"")));
                assertThat(
                        resp,
                        not(
                                containsString(
                                        "\"name\":\"ObservationConnection\",\"fields\":[{\"name\":\"count\"")));
                assertThat(resp, containsString("\"name\":\"Patient\",\"args\":[{\"name\":\"id\""));
                assertThat(
                        resp,
                        containsString("\"name\":\"PatientList\",\"args\":[{\"name\":\"_filter\""));
            }
        }
    }
        ...
        for (int i = 0; i < 3; i++) {
            try (CloseableHttpResponse response = ourHttpClient.execute(httpGet)) {
                ...
                assertThat(
                        ...
                        not(
                                containsString(
                                        "{\"kind\":\"OBJECT\",\"name\":\"Query\",\"fields\":[{\"name\":\"PatientList\"")));
                assertThat(
                        resp,
                        containsString("\"name\":\"Observation\",\"args\":[{\"name\":\"id\""));
                assertThat(
                        resp,
                        containsString(
                                "\"name\":\"ObservationList\",\"args\":[{\"name\":\"_filter\""));
                ...
                assertThat(
                        resp,
                        not(containsString("\"name\":\"Patient\",\"args\":[{\"name\":\"id\"")));
                assertThat(
                        resp,
                        not(
                                containsString(
                                        "\"name\":\"PatientList\",\"args\":[{\"name\":\"_filter\"")));
            }
        }
    }
    ...
    public void testRoot_Read_Patient() throws IOException {
        ...
        HttpGet httpGet =
                new HttpGet(myServerBase + "/$graphql?query=" + UrlUtil.escapeUrlParam(query));
