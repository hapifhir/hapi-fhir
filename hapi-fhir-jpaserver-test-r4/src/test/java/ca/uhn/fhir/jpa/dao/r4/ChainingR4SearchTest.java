...
public class ChainingR4SearchTest extends BaseJpaR4Test {
    ...
    @Test
    public void
            testShouldResolveATwoLinkChainWithStandAloneResourcesWithoutContainedResourceIndexing()
                    throws Exception {
...

        {
            ...
            // Create a dummy record so that an unconstrained query doesn't pass the test due to
            // returning the only record
    ...
    @Test
    public void
            testShouldNotResolveATwoLinkChainWithAContainedResourceWhenContainedResourceIndexingIsTurnedOff()
                    throws Exception {
        // setup
        IIdType oid1;
    ...
    public void testShouldResolveATwoLinkChainWithQualifiersWithAContainedResource()
            throws Exception {
        // TODO: This test fails because of a known limitation in qualified searches over contained
        // resources.
        //       Type information for intermediate resources in the chain is not being retained in
        // the indexes.
        // setup
        myStorageSettings.setIndexOnContainedResources(true);
    ...
    @Test
    public void
            testShouldResolveAThreeLinkChainWhereAllResourcesStandAloneWithoutContainedResourceIndexing()
                    throws Exception {
    ...
    @Test
    public void
            testShouldResolveAThreeLinkChainWithAContainedResourceAtTheEndOfTheChain_CommonReference()
                    throws Exception {
    ...
    @Test
    public void
            testShouldResolveAThreeLinkChainWithAContainedResourceAtTheBeginningOfTheChain_CommonReference()
                    throws Exception {
    ...
    @Test
    public void
            testShouldNotResolveAThreeLinkChainWithAllContainedResourcesWhenRecursiveContainedIndexesAreDisabled()
                    throws Exception {
    ...
    @Test
    public void
            testShouldResolveAThreeLinkChainWithQualifiersWithAContainedResourceAtTheEndOfTheChain()
                    throws Exception {
        // This is the case that is most relevant to SMILE-2899
    ...
    @Test
    public void
            testShouldResolveAFourLinkChainWhereTheFirstReferenceAndTheLastReferenceAreContained()
                    throws Exception {
    ...
    public void testShouldThrowAnExceptionForAFiveLinkChain() throws Exception {
        ...
        try {
            ...
            assertEquals(
                    Msg.code(2007)
                            + "The search chain subject.organization.partof.partof.name is too"
                            + " long. Only chains up to three references are supported.",
                    e.getMessage());
        }
    }
    ...
    public void testQueryStructure() throws Exception {
        ...
        // With indexing of contained resources turned off, we should not see UNION clauses in the
        // query
        ...
        countUnionStatementsInGeneratedQuery(
                "/Observation?patient.organization.partof.name=Smith", 0);

        // With indexing of contained resources turned on, we take the UNION of several subselects
        // that handle the different patterns of containment
        //  Keeping in mind that the number of clauses is one greater than the number of UNION
        // keywords,
        //  this increases as the chain grows longer according to the Fibonacci sequence: (2, 3, 5,
        // 8, 13)
        myStorageSettings.setIndexOnContainedResources(true);
        ...
        countUnionStatementsInGeneratedQuery(
                "/Observation?patient.organization.partof.name=Smith", 4);

        // With recursive indexing of contained resources turned on, even more containment patterns
        // are considered
        ...
        countUnionStatementsInGeneratedQuery(
                "/Observation?patient.organization.partof.name=Smith", 7);

        // If a reference in the chain has multiple potential target resource types, the number of
        // subselects increases
        // Note: This previously had 3 unions but 2 of the selects within were duplicates of each
        // other
    ...
    private List<String> searchAndReturnUnqualifiedVersionlessIdValues(String theUrl)
            throws IOException {
