...
public class FhirResourceDaoR4SourceTest extends BaseJpaR4Test {
    ...
    public final void after() {
        ...
        myStorageSettings.setStoreMetaSourceInformation(
                new JpaStorageSettings().getStoreMetaSourceInformation());
    }
    ...
    public void testSourceStoreAndSearch() {
        ...
        assertThat(
                ...
                containsInAnyOrder(pt0id.getValue(), pt1id.getValue()));
    ...
    @Test
    public void
            testSearchSource_whenSameSourceForMultipleResourceTypes_willMatchSearchResourceTypeOnly() {
    ...
    public void testSourceDisabled() {
        ...
        try {
            ...
            assertEquals(
                    e.getMessage(),
                    Msg.code(1216) + "The _source parameter is disabled on this server");
        }
    }
    ...
    public static void assertConflictException(
            String theResourceType, ResourceVersionConflictException e) {
        assertThat(
                e.getMessage(),
                matchesPattern(
                        "Unable to delete [a-zA-Z]+/[0-9]+ because at least one resource has a"
                                + " reference to this resource. First reference found was resource "
                                + theResourceType
                                + "/[0-9]+ in path [a-zA-Z]+.[a-zA-Z]+"));
    }
}
