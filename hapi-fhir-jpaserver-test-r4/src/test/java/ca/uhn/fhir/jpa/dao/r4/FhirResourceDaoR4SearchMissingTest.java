...
public class FhirResourceDaoR4SearchMissingTest extends BaseJpaR4Test {
    private static final Logger ourLog =
            LoggerFactory.getLogger(FhirResourceDaoR4SearchMissingTest.class);
    ...
    public void testIndexMissingFieldsDisabledDontAllowInSearch_NonReference() {
        ...
        try {
            ...
            assertEquals(
                    Msg.code(985) + ":missing modifier is disabled on this server", e.getMessage());
        }
    }
    ...
    @Test
    public void
            testIndexMissingFieldsDisabledDontCreateIndexesWithNormalizedQuantitySearchSupported() {
    ...
    @Test
    public void
            testIndexMissingFieldsDisabledDontCreateIndexesWithNormalizedQuantityStorageSupported() {
    ...
    public void testSearchResourceReferenceMissingChain() {
        ...
        map.add(
                ...
                new ReferenceParam("Organization", "name:missing", "true"));
