...
public class FhirPatchApplyR4Test {
	...
	public void testInvalidOperation() {
		...
		operation.addPart().setName("type").setValue(new CodeType("foo"));
	...
	public void testInsertToInvalidIndex() {
		...
		operation.addPart().setName("path").setValue(new StringType("Patient.identifier"));
		operation.addPart().setName("index").setValue(new IntegerType(2));
		...
		try {
				...
				assertEquals(
						Msg.code(1270)
									+ "Invalid insert index 2 for path Patient.identifier - Only have 0"
									+ " existing entries",
						e.getMessage());
		}
	}
	...
	public void testInsertToInvalidIndex_minimum() {
		...
		operation.addPart().setName("type").setValue(new CodeType("insert"));
		operation.addPart().setName("path").setValue(new StringType("Patient.identifier"));
		operation.addPart().setName("index").setValue(new IntegerType(-1));
		...
		try {
				...
				assertEquals(
						Msg.code(1270)
									+ "Invalid insert index -1 for path Patient.identifier - Only have 0"
									+ " existing entries",
						e.getMessage());
		}
	}
	...
	public void testMoveFromInvalidIndex() {
		...
		Parameters.ParametersParameterComponent operation = patch.addParameter();
		operation.setName("operation");
		operation.addPart().setName("type").setValue(new CodeType("move"));
		operation.addPart().setName("path").setValue(new StringType("Patient.identifier"));
		operation.addPart().setName("source").setValue(new IntegerType(2));
		operation.addPart().setName("destination").setValue(new IntegerType(1));
		...
		try {
				...
				assertEquals(
						Msg.code(1268)
									+ "Invalid move source index 2 for path Patient.identifier - Only have"
									+ " 0 existing entries",
						e.getMessage());
		}
	}
	...
	public void testMoveFromInvalidIndex_minimum() {
		...
		operation.addPart().setName("type").setValue(new CodeType("move"));
		operation.addPart().setName("path").setValue(new StringType("Patient.identifier"));
		operation.addPart().setName("source").setValue(new IntegerType(-1));
		operation.addPart().setName("destination").setValue(new IntegerType(1));
		...
		try {
				...
				assertEquals(
						Msg.code(1268)
									+ "Invalid move source index -1 for path Patient.identifier - Only have"
									+ " 0 existing entries",
						e.getMessage());
		}
	}
	...
	public void testMoveToInvalidIndex() {
		...
		operation.addPart().setName("type").setValue(new CodeType("move"));
		operation.addPart().setName("path").setValue(new StringType("Patient.identifier"));
		operation.addPart().setName("source").setValue(new IntegerType(0));
		operation.addPart().setName("destination").setValue(new IntegerType(1));
		...
		try {
				...
				assertEquals(
						Msg.code(1269)
									+ "Invalid move destination index 1 for path Patient.identifier - Only"
									+ " have 0 existing entries",
						e.getMessage());
		}
	}
	...
	public void testDeleteItemWithExtension() {
		...
		assertEquals(
					"{\"resourceType\":\"Patient\",\"identifier\":[{\"system\":\"sys\",\"value\":\"val\"}],\"active\":true}",
	...
	public void testDeleteExtensionFromListByFilter() {
		...
		patient.addExtension()
					...
					.addExtension(
								new Extension()
										...
										.setValue(
													new CodeableConcept()
																.addCoding(new Coding("sys", "123", "Abc"))));
		patient.addExtension()
					.setUrl("url2")
					.addExtension(
								new Extension()
										...
										.setValue(
													new CodeableConcept()
																.addCoding(new Coding("sys", "234", "Def"))))
		...
		patient.addExtension()
					...
					.addExtension(
								new Extension()
										...
										.setValue(
													new CodeableConcept()
																.addCoding(new Coding("sys", "345", "Ghi"))))
		...
		assertEquals(
					"{\"resourceType\":\"Patient\",\"extension\":[{\"url\":\"url1\",\"extension\":[{\"url\":\"text\",\"valueString\":\"first"
						+ " text\"},{\"url\":\"code\",\"valueCodeableConcept\":{\"coding\":[{\"system\":\"sys\",\"code\":\"123\",\"display\":\"Abc\"}]}}]},{\"url\":\"url3\",\"extension\":[{\"url\":\"text\",\"valueString\":\"third"
						+ " text\"},{\"url\":\"code\",\"valueCodeableConcept\":{\"coding\":[{\"system\":\"sys\",\"code\":\"345\",\"display\":\"Ghi\"}]}},{\"url\":\"detail\",\"valueInteger\":12}]}],\"active\":true}",
					ourCtx.newJsonParser().encodeResourceToString(patient));
	}
	...
	public void testInsertToNonZeroIndex() {
		...
		operation.setName("operation");
		operation.addPart().setName("type").setValue(new CodeType("insert"));
		operation.addPart().setName("path").setValue(new StringType("Questionnaire.item"));
		operation.addPart().setName("index").setValue(new IntegerType(1));
		operation = patch.addParameter();
		operation.setName("operation");
		operation.addPart().setName("type").setValue(new CodeType("insert"));
		...
		operation.addPart().setName("value").setValue(new StringType("2"));

		operation = patch.addParameter();
		operation.setName("operation");
		operation.addPart().setName("type").setValue(new CodeType("insert"));
		operation.addPart().setName("path").setValue(new StringType("Questionnaire.item[1].code"));
		operation.addPart().setName("index").setValue(new IntegerType(0));
		operation
					.addPart()
					.setName("value")
		...
		operation.setName("operation");
		operation.addPart().setName("type").setValue(new CodeType("insert"));
		operation.addPart().setName("path").setValue(new StringType("Questionnaire.item[1].text"));
		operation.addPart().setName("index").setValue(new IntegerType(0));
		operation.addPart().setName("value").setValue(new StringType("Test Item 2"));
		...
		assertEquals(
					"{\"resourceType\":\"Questionnaire\",\"item\":[{\"linkId\":\"1\",\"code\":[{\"system\":\"https://smilecdr.com/fhir/document-type\",\"code\":\"CLINICAL\"}],\"text\":\"Test"
						+ " item\"},{\"linkId\":\"2\",\"code\":[{\"system\":\"http://smilecdr.com/fhir/document-type\",\"code\":\"ADMIN\"}],\"text\":\"Test"
						+ " Item 2\"}]}",
					ourCtx.newJsonParser().encodeResourceToString(patient));
	}
	...
	public void testAddExtensionWithChoiceType() {
		...
		Parameters patch = new Parameters();
		Parameters.ParametersParameterComponent addOperation =
					createPatchAddOperation("Patient", "extension", null);
		addOperation
					.addPart()
					.setName("value")
					.addPart(
		...
		assertThat(
					patient.getExtension().get(0).getUrl(),
					is(equalTo("http://foo/fhir/extension/foo")));
		assertThat(
					patient.getExtension().get(0).getValueAsPrimitive().getValueAsString(),
					is(equalTo("foo")));
	}

	private Parameters.ParametersParameterComponent createPatchAddOperation(
				String thePath, String theName, Type theValue) {
		return createPatchOperation("add", thePath, theName, theValue, null);
	}

	private Parameters.ParametersParameterComponent createPatchReplaceOperation(
				String thePath, Type theValue) {
		return createPatchOperation("replace", thePath, null, theValue, null);
	}

	private Parameters.ParametersParameterComponent createPatchInsertOperation(
				String thePath, Type theValue) {
		return createPatchOperation("replace", thePath, null, theValue, null);
	}

	@Nonnull
	private Parameters.ParametersParameterComponent createPatchOperation(
				String theType, String thePath, String theName, Type theValue, Integer theIndex) {
		Parameters.ParametersParameterComponent operation =
					new Parameters.ParametersParameterComponent();
		operation.setName("operation");
		operation.addPart().setName("type").setValue(new CodeType(theType));
		operation.addPart().setName("path").setValue(new StringType(thePath));

		if (theName != null) {
				operation.addPart().setName("name").setValue(new StringType(theName));
		}
		if (theValue != null) {
				operation.addPart().setName("value").setValue(theValue);
		}
		if (theIndex != null) {
				operation.addPart().setName("index").setValue(new IntegerType(theIndex));
		}
		return operation;
	}

	public static String extractPartValuePrimitive(
				Parameters theDiff, int theIndex, String theParameterName, String thePartName) {
		Parameters.ParametersParameterComponent component =
					theDiff.getParameter().stream()
								.filter(t -> t.getName().equals(theParameterName))
								.collect(Collectors.toList())
								.get(theIndex);
		Parameters.ParametersParameterComponent part =
					component.getPart().stream()
	...
	@Nullable
	public static <T extends IBase> T extractPartValue(
				Parameters theDiff,
				int theIndex,
				String theParameterName,
				String thePartName,
				Class<T> theExpectedType) {
		Parameters.ParametersParameterComponent component =
					theDiff.getParameter().stream()
								.filter(t -> t.getName().equals(theParameterName))
								.collect(Collectors.toList())
	...
	// This implements the official HL7 test suite, as defined in
	// http://hl7.org/fhir/R4/test-cases.zip. There may be some overlap with the cases above.
	@ParameterizedTest
	@CsvSource(
				textBlock =
						"""
		...
		""")
	public void testHL7Cases(
				String theName, String theInputResource, String thePatch, String theOutputResource)
				throws Exception {
		...
		new XmlExpectationsHelper()
					.assertXmlEqual(theOutputResource, parser.encodeResourceToString(patient));
