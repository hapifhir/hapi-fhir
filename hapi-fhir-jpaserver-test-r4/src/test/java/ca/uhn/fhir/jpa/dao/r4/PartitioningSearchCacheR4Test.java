...
public class PartitioningSearchCacheR4Test extends BasePartitioningR4Test {
    private static final Logger ourLog =
            LoggerFactory.getLogger(PartitioningSearchCacheR4Test.class);
...

        {
            ...
            PersistedJpaBundleProvider outcome =
                    (PersistedJpaBundleProvider)
                            myPatientDao.search(new SearchParameterMap(), mySrd);
    ...
    public void testSearch_MultiplePartitions_UseCache() {
...

        {
            ...
            assertThat(
                    ids,
                    containsInAnyOrder(patientId11, patientId12, patientIdNull1, patientIdNull2));
        }
