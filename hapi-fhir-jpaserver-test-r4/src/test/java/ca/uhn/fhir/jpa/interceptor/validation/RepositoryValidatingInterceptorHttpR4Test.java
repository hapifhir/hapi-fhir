...
public class RepositoryValidatingInterceptorHttpR4Test extends BaseJpaR4Test {
	...
	private static final Logger ourLog =
				LoggerFactory.getLogger(RepositoryValidatingInterceptorHttpR4Test.class);
	@Autowired protected ObservationResourceProvider myObservationResourceProvider;
	private RepositoryValidatingInterceptor myValInterceptor;

	@RegisterExtension
	protected RestfulServerExtension myRestfulServerExtension =
	...
	public void testValidationIsSkippedOnAutoCreatedPlaceholderReferencesIfConfiguredToDoSo() {
		...
		String operationOutcomeEncoded =
					myFhirContext
								.newJsonParser()
								.setPrettyPrint(true)
		...
		assertThat(
					operationOutcomeEncoded, containsString("All observations should have a subject"));
	}
