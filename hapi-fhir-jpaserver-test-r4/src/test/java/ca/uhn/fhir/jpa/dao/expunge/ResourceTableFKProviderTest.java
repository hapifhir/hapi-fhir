...
class ResourceTableFKProviderTest extends BaseJpaR4Test {
    ...
    @Autowired ResourceTableFKProvider myResourceTableFKProvider;
    ...
    public void testWeHaveAllForeignKeys() throws SQLException {
            ...
            for (String nextTargetTable : tableNames) {
                ...
                ResultSet crossRefs =
                        metadata.getCrossReference(
                                null, null, sourceTable, null, null, nextTargetTable);
                while (crossRefs.next()) {
                    ...
                    ResourceForeignKey foreignKey =
                            new ResourceForeignKey(fkTableName, fkColumnName);
        ...
        // If this assertion fails, it means hapi-fhir has added a new foreign-key dependency to
        // HFJ_RESOURCE.  To fix
