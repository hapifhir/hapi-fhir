...
public class ResourceProviderQuestionnaireResponseR4Test extends BaseResourceProviderR4Test {
    ...
    public void before() throws Exception {
        ...
        myServer.getRestfulServer()
                ...
                .registerInterceptor(ourValidatingInterceptor);
    }
    ...
    /**
     * Test added to verify <a
     * href="https://github.com/hapifhir/hapi-fhir/issues/2843">https://github.com/hapifhir/hapi-fhir/issues/2843</a>
     */
    @Test
    public void
            testSearch_withIncludeQuestionnaire_shouldReturnWithCanonicalReferencedQuestionnaire() {
        String questionnaireCanonicalUrl =
                "https://hapi.fhir.org/baseR4/Questionnaire/xl-54127-6-hapi";
        Questionnaire questionnaire = new Questionnaire();
                ...
                myClient.search()
                        .byUrl(
                                "QuestionnaireResponse?_id="
                                        + qrIdType.toUnqualifiedVersionless()
    ...
    public void testValidateQuestionnaireResponseWithNoIdForCreate() throws Exception {
        ...
        String input =
                "{\"resourceType\":\"Parameters\",\"parameter\":[{\"name\":\"mode\",\"valueString\":\"create\"},{\"name\":\"resource\",\"resource\":{\"resourceType\":\"QuestionnaireResponse\",\"questionnaire\":\"http://fhirtest.uhn.ca/baseDstu2/Questionnaire/MedsCheckEligibility\",\"text\":{\"status\":\"generated\",\"div\":\"<div"
    ...
    public void testValidateQuestionnaireResponseWithNoIdForUpdate() throws Exception {
        ...
        String input =
                "{\"resourceType\":\"Parameters\",\"parameter\":[{\"name\":\"mode\",\"valueString\":\"update\"},{\"name\":\"resource\",\"resource\":{\"resourceType\":\"QuestionnaireResponse\",\"questionnaire\":\"http://fhirtest.uhn.ca/baseDstu2/Questionnaire/MedsCheckEligibility\",\"text\":{\"status\":\"generated\",\"div\":\"<div"
                    + " xmlns=\\\"http://www.w3.org/1999/xhtml\\\">!-- populated from the rendered"
                    + " HTML below"
                    + " --></div>\"},\"status\":\"completed\",\"authored\":\"2017-02-10T00:02:58.098Z\"}}]}";
        HttpPost post =
