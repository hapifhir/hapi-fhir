...
public class FilesystemBinaryStorageSvcImplTest {
	...
	private static final Logger ourLog =
				LoggerFactory.getLogger(FilesystemBinaryStorageSvcImplTest.class);
	private File myPath;
	...
	public void testStoreAndRetrieve() throws IOException {
		...
		StoredDetails outcome =
					mySvc.storeBlob(
								...
								null,
								contentType,
								new ByteArrayInputStream(SOME_BYTES),
	...
	public void testFetchBlobUnknown() throws IOException {
		try {
				...
				assertEquals(
						Msg.code(1327) + "Unknown blob ID: 1111111 for resource ID Patient/123",
						e.getMessage());
		}
	}
