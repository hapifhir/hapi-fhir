...
public class JobInstanceRepositoryTest extends BaseJpaR4Test {
    ...
    @Autowired private IJobPersistence myJobPersistenceSvc;
    ...
    public void testSearchByJobParamsWithoutStatuses() {
        List<Batch2JobInstanceEntity> instances =
                runInTransaction(
                        () ->
                                myJobInstanceRepository.findInstancesByJobIdAndParams(
    ...
    public void testServiceLogicIsCorrectWithStatuses() {
        ...
        FetchJobInstancesRequest request =
                new FetchJobInstancesRequest(
                        JOB_DEFINITION_ID, PARAMS, StatusEnum.IN_PROGRESS, StatusEnum.COMPLETED);
