...
public class SearchParamExtractorR4Test implements ITestDataBuilder {
    ...
    private final FhirContextSearchParamRegistry mySearchParamRegistry =
            new FhirContextSearchParamRegistry(ourCtx);
    ...
    public void testParamWithOrInPath() {
        ...
        SearchParamExtractorR4 extractor =
                new SearchParamExtractorR4(
                        new StorageSettings(),
        ...
        ResourceIndexedSearchParamToken token =
                (ResourceIndexedSearchParamToken) tokens.iterator().next();
    ...
    public void testName() {
        ...
        SearchParamExtractorR4 extractor =
                new SearchParamExtractorR4(
                        ...
                        ourCtx,
                        mySearchParamRegistry);
        ISearchParamExtractor.SearchParamSet<ResourceIndexedSearchParamString> stringSearchParams =
                extractor.extractSearchParamStrings(patient);
        List<String> nameValues =
                stringSearchParams.stream()
                        .filter(param -> "name".equals(param.getParamName()))
                        .map(ResourceIndexedSearchParamString::getValueExact)
                        .collect(Collectors.toList());
        assertThat(
                nameValues,
                containsInAnyOrder(
                        "Jimmy", "Jones", "King Jimmy Jones the Great", "King", "the Great"));
    }
    ...
    public void testTokenText_Enabled_Coding() {
        ...
        obs.getCode()
                ...
                .setCode("code")
                .setDisplay("Help Im a Bug");

        SearchParamExtractorR4 extractor =
                new SearchParamExtractorR4(
                        new StorageSettings(), myPartitionSettings, ourCtx, mySearchParamRegistry);

        List<BaseResourceIndexedSearchParam> tokens =
                extractor.extractSearchParamTokens(obs).stream()
    ...
    public void testTokenText_DisabledInSearchParam_Coding() {
        RuntimeSearchParam existingCodeSp =
                mySearchParamRegistry.getActiveSearchParams("Observation").get("code");
        RuntimeSearchParam codeSearchParam = new RuntimeSearchParam(existingCodeSp);
        codeSearchParam.addExtension(
                HapiExtensions.EXT_SEARCHPARAM_TOKEN_SUPPRESS_TEXT_INDEXING,
                new Extension(
                        HapiExtensions.EXT_SEARCHPARAM_TOKEN_SUPPRESS_TEXT_INDEXING,
    ...
    public void testTokenText_DisabledInStorageSettings_Coding() {
        ...
        SearchParamExtractorR4 extractor =
                new SearchParamExtractorR4(
                        storageSettings, myPartitionSettings, ourCtx, mySearchParamRegistry);
    ...
    public void testReferenceWithResolve() {
        ...
        RuntimeSearchParam param =
                mySearchParamRegistry.getActiveSearchParam("Encounter", "location");
        assertNotNull(param);
        ISearchParamExtractor.SearchParamSet<PathAndRef> links =
                extractor.extractResourceLinks(enc, false);
    ...
    public void testReferenceWithResolveMulti() {
        ...
        SearchParamExtractorR4 extractor =
                new SearchParamExtractorR4(
                        ...
                        mySearchParamRegistry);
        RuntimeSearchParam param =
                mySearchParamRegistry.getActiveSearchParam("Consent", Consent.SP_SOURCE_REFERENCE);
        assertNotNull(param);
        ISearchParamExtractor.SearchParamSet<PathAndRef> links =
                extractor.extractResourceLinks(consent, false);
        assertEquals(1, links.size());
    ...
    public void testExtractSearchParamTokenTest() {
        ...
        SearchParamExtractorR4 extractor =
                new SearchParamExtractorR4(
                        ...
                        mySearchParamRegistry);
        RuntimeSearchParam param =
                mySearchParamRegistry.getActiveSearchParam("Patient", Patient.SP_IDENTIFIER);
        assertNotNull(param);
        ISearchParamExtractor.SearchParamSet<BaseResourceIndexedSearchParam> params =
                extractor.extractSearchParamTokens(p, param);
        assertEquals(1, params.size());
        ResourceIndexedSearchParamToken paramValue =
                (ResourceIndexedSearchParamToken) params.iterator().next();
    ...
    public void testExtensionContainingReference() {
        ...
        RuntimeSearchParam sp =
                new RuntimeSearchParam(
                        null,
                        null,
                        "extpat",
                        "Patient SP",
        ...
        SearchParamExtractorR4 extractor =
                new SearchParamExtractorR4(
                        ...
                        mySearchParamRegistry);
        ISearchParamExtractor.SearchParamSet<PathAndRef> links =
                extractor.extractResourceLinks(patient, false);
        assertEquals(1, links.size());
    }
    ...
    public void testExtractComponentQuantityWithNormalizedQuantitySearchSupported() {
        ...
        SearchParamExtractorR4 extractor =
                new SearchParamExtractorR4(
                        storageSettings, new PartitionSettings(), ourCtx, mySearchParamRegistry);
        Set<ResourceIndexedSearchParamQuantityNormalized> links =
                extractor.extractSearchParamQuantityNormalized(o1);
        ourLog.info(
                "Links:\n  {}",
                links.stream().map(t -> t.toString()).collect(Collectors.joining("\n  ")));
    ...
    public void testExtractIdentifierOfType() {
        ...
        SearchParamExtractorR4 extractor =
                new SearchParamExtractorR4(
                        storageSettings, new PartitionSettings(), ourCtx, mySearchParamRegistry);
        List<ResourceIndexedSearchParamToken> list =
                extractor.extractSearchParamTokens(patient).stream()
        ...
        assertThat(
                list,
                containsInAnyOrder(
                        new ResourceIndexedSearchParamToken(
                                new PartitionSettings(), "Patient", "deceased", null, "false"),
                        new ResourceIndexedSearchParamToken(
                                new PartitionSettings(),
                                "Patient",
                                "identifier",
    ...
    class CompositeSearchParameter {
        SearchParamExtractorR4 myExtractor =
                new SearchParamExtractorR4(
                        myStorageSettings, new PartitionSettings(), ourCtx, mySearchParamRegistry);

        /**
         * Install a full definition of component-code-value-concept in the SP registry.
         *
         * <p>We can't use the base FhirContext SP definitions since @SearchParamDefinition only
         * includes the sub-SP ids, and lacks the composite sub-paths.
         *
        ...
        public void setUp() {
            String spJson =
				...
				""";
            SearchParameter sp =
                    (SearchParameter) getFhirContext().newJsonParser().parseResource(spJson);
            RuntimeSearchParam runtimeSP =
                    new SearchParameterCanonicalizer(getFhirContext())
                            .canonicalizeSearchParameter(sp);
            mySearchParamRegistry.addSearchParam(runtimeSP);
        }

        @Test
        void
                testExtractSearchParamComposites_componentCodeCode_producesOneCompositeComponentForEachElement() {
            ...
            Collection<ResourceIndexedSearchParamComposite> c =
                    myExtractor.extractSearchParamComposites(resource);

            assertThat(c, not(empty()));
            assertThat(
                    "Extracts standard R4 composite sp",
                    c,
                    hasItem(
                            hasProperty(
                                    "searchParamName", equalTo("component-code-value-concept"))));

            List<ResourceIndexedSearchParamComposite> components =
                    c.stream()
                            .filter(
                                    idx ->
                                            idx.getSearchParamName()
                                                    .equals("component-code-value-concept"))
                            .collect(Collectors.toList());
        ...
        void testExtractSearchParamComposites_componentCodeCode_yieldsTwoSubComponents() {
            ...
            // component-code-value-concept is two token params - component-code and
            // component-value-concept
            List<ResourceIndexedSearchParamComposite.Component> indexedComponentsOfElement =
                    componentCodeValueConcept.getComponents();
            assertThat(
                    "component-code-value-concept has two sub-params",
                    indexedComponentsOfElement,
                    hasSize(2));

            final ResourceIndexedSearchParamComposite.Component component0 =
                    indexedComponentsOfElement.get(0);
            assertThat(component0.getSearchParamName(), equalTo("component-code"));
            assertThat(
                    component0.getSearchParameterType(),
                    equalTo(RestSearchParameterTypeEnum.TOKEN));

            final ResourceIndexedSearchParamComposite.Component component1 =
                    indexedComponentsOfElement.get(1);
            assertThat(component1.getSearchParamName(), equalTo("component-value-concept"));
            assertThat(
                    component1.getSearchParameterType(),
                    equalTo(RestSearchParameterTypeEnum.TOKEN));
        }
        ...
        void testExtractSearchParamComposites_componentCodeCode_subValueExtraction() {
            ...
            ResourceIndexedSearchParamComposite.Component indexComponent0 =
                    spEntry.getComponents().get(0);
            ...
            ResourceIndexedSearchParamString tokenDisplayIdx0 =
