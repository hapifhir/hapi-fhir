...
public class SearchParamExtractorR4Test implements ITestDataBuilder {
	...
	public void testParamWithOrInPath() {
		...
		SearchParamExtractorR4 extractor = new SearchParamExtractorR4(
				new StorageSettings(), new PartitionSettings(), ourCtx, mySearchParamRegistry);
	...
	public void testName() {
		...
		List<String> nameValues = stringSearchParams.stream()
	...
	public void testTokenText_Enabled_Coding() {
		...
		SearchParamExtractorR4 extractor =
				new SearchParamExtractorR4(new StorageSettings(), myPartitionSettings, ourCtx, mySearchParamRegistry);

		List<BaseResourceIndexedSearchParam> tokens = extractor.extractSearchParamTokens(obs).stream()
	...
	public void testTokenText_DisabledInSearchParam_Coding() {
		...
		codeSearchParam.addExtension(
				...
				new Extension(HapiExtensions.EXT_SEARCHPARAM_TOKEN_SUPPRESS_TEXT_INDEXING, new BooleanType(true)));
	...
	public void testTokenText_DisabledInStorageSettings_Coding() {
		...
		SearchParamExtractorR4 extractor =
				new SearchParamExtractorR4(storageSettings, myPartitionSettings, ourCtx, mySearchParamRegistry);
	...
	public void testTokenText_DisabledInStorageSettingsButForcedInSearchParam_Coding() {
		...
		codeSearchParam.addExtension(
				HapiExtensions.EXT_SEARCHPARAM_TOKEN_SUPPRESS_TEXT_INDEXING,
				new Extension(HapiExtensions.EXT_SEARCHPARAM_TOKEN_SUPPRESS_TEXT_INDEXING, new BooleanType(false)));
		mySearchParamRegistry.addSearchParam(codeSearchParam);
	...
	public void testExtractComponentQuantityWithNormalizedQuantitySearchSupported() {
		...
		SearchParamExtractorR4 extractor =
				new SearchParamExtractorR4(storageSettings, new PartitionSettings(), ourCtx, mySearchParamRegistry);
	...
	public void testExtractComponentQuantityValueWithNormalizedQuantitySearchSupported() {
		...
		RuntimeSearchParam existingCodeSp =
				mySearchParamRegistry.getActiveSearchParams("Observation").get("component-value-quantity");
	...
	public void testExtractIdentifierOfType() {
		...
		SearchParamExtractorR4 extractor =
				new SearchParamExtractorR4(storageSettings, new PartitionSettings(), ourCtx, mySearchParamRegistry);
		List<ResourceIndexedSearchParamToken> list = extractor.extractSearchParamTokens(patient).stream()
		...
		assertThat(
				...
				containsInAnyOrder(
						...
						new ResourceIndexedSearchParamToken(
								new PartitionSettings(), "Patient", "identifier", "http://foo1", "bar1"),
						new ResourceIndexedSearchParamToken(
								new PartitionSettings(), "Patient", "identifier", "http://foo2", "bar2"),
						new ResourceIndexedSearchParamToken(
	...
	class CompositeSearchParameter {
		SearchParamExtractorR4 myExtractor =
				new SearchParamExtractorR4(myStorageSettings, new PartitionSettings(), ourCtx, mySearchParamRegistry);
		...
		public void setUp() {
			...
			RuntimeSearchParam runtimeSP =
					new SearchParameterCanonicalizer(getFhirContext()).canonicalizeSearchParameter(sp);
		...
		void testExtractSearchParamComposites_componentCodeCode_producesOneCompositeComponentForEachElement() {
			IBaseResource resource = buildResource(
					"Observation",
			...
			assertThat(
					...
					c,
					hasItem(hasProperty("searchParamName", equalTo("component-code-value-concept"))));
		...
		void testExtractSearchParamComposites_componentCodeCode_subValueExtraction() {
			...
			ResourceIndexedSearchParamToken tokenIdx0 =
					(ResourceIndexedSearchParamToken) indexComponent0.getParamIndexValues().stream()
			...
			ResourceIndexedSearchParamString tokenDisplayIdx0 =
					(ResourceIndexedSearchParamString) indexComponent0.getParamIndexValues().stream()
