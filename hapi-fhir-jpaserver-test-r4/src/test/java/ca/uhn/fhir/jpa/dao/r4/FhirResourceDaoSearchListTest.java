...
public class FhirResourceDaoSearchListTest extends BaseJpaR4Test {
    ...
    private void testQuery(String theQueryString, IIdType... theExpectedPatientIds) {
        SearchParameterMap map =
                myMatchUrlService.translateMatchUrl(
                        theQueryString, myFhirContext.getResourceDefinition("List"));
        ...
        Set<IIdType> ids =
                resources.stream().map(IBaseResource::getIdElement).collect(Collectors.toSet());
    ...
    public void testBoth() {
        ...
        String queryString =
                "_list=" + listIdString1 + "," + listIdString2 + "&_list=" + listIdString3;
    ...
    public void testAlternateSyntax() {
        ...
        // 	public HasParam(String theTargetResourceType, String theReferenceFieldName, String
        // theParameterName, String theParameterValue) {
