...
class RequestPartitionHelperSvcTest {
    ...
    @Mock PartitionSettings myPartitionSettings;
    @Mock IPartitionLookupSvc myPartitionLookupSvc;
    @Mock FhirContext myFhirContext;
    @Mock IInterceptorBroadcaster myInterceptorBroadcaster;

    @InjectMocks RequestPartitionHelperSvc mySvc = new RequestPartitionHelperSvc();
    ...
    public void determineReadPartitionForSystemRequest() {
        ...
        RequestPartitionId result =
                mySvc.determineReadPartitionForRequestForRead(
                        srd, "Patient", new IdType("Patient/123"));
    ...
    public void determineCreatePartitionForSystemRequest() {
        ...
        // execute
        RequestPartitionId result =
                mySvc.determineCreatePartitionForRequest(srd, resource, "Patient");
