...
public class FhirResourceDaoR4StandardQueriesNoFTTest extends BaseJpaTest {
    ...
    @Autowired FhirContext myFhirCtx;
    ...
    public class StringSearch {
        ...
        void searchTwoFields() {
            ...
            List<String> foundIds =
                    myTestDaoSearch.searchForIds("Patient?family=flint&given:exact=Fred");
        ...
        void sort() {
            ...
            String idBarney =
                    myDataBuilder
                            .createPatient(
                                    myDataBuilder.withGiven("Barney"),
                                    myDataBuilder.withFamily("Rubble"))
                            .getIdPart();
            String idCoolFred =
                    myDataBuilder
                            .createPatient(
                                    myDataBuilder.withGiven("Fred"),
                                    myDataBuilder.withFamily("Jones"))
                            .getIdPart();
            String idPolka =
                    myDataBuilder
                            .createPatient(
                                    myDataBuilder.withGiven("Polkaroo"),
                                    myDataBuilder.withFamily("Polkaroo"))
                            .getIdPart();
        ...
        void sortWithAge() {
            ...
            String idWilma =
                    b.createPatient(
                                    b.withGiven("Wilma"),
                                    b.withFamily("Flintstone"),
                                    b.withBirthdate("1945"))
                            .getIdPart();
            String idFred =
                    b.createPatient(
                                    b.withGiven("Fred"),
                                    b.withFamily("Flintstone"),
                                    b.withBirthdate("1940"))
                            .getIdPart();
            String idBarney =
                    b.createPatient(
                                    b.withGiven("Barney"),
                                    b.withFamily("Rubble"),
                                    b.withBirthdate("1941"))
                            .getIdPart();
            String idCoolFred =
                    b.createPatient(
                                    b.withGiven("Fred"),
                                    b.withFamily("Jones"),
                                    b.withBirthdate("1965"))
                            .getIdPart();
            String idPolka =
                    b.createPatient(
                                    b.withGiven("Polkaroo"),
                                    b.withFamily("Polkaroo"),
                                    b.withBirthdate("1980"))
                            .getIdPart();

            List<String> foundIds =
                    myTestDaoSearch.searchForIds("Patient?birthdate=lt1960&_sort=family,given");
    ...
    public class TokenSearch {
        ...
        public class Queries {
            ...
            public void systemAndCode() {
                ...
                assertNotFind(
                        "by same system, different code",
                        "/Observation?code=http://example.com|other");
                assertNotFind(
                        "by same code, different system",
                        "/Observation?code=http://example2.com|value");
                assertNotFind(
                        "by different code, different system",
                        "/Observation?code=http://example2.com|otherValue");
            }
            ...
            private void assertNotFind(String theMessage, String theUrl) {
                ...
                assertThat(
                        theMessage,
                        resourceIds,
                        not(hasItem(equalTo(myObservationId.getIdPart()))));
            }
            ...
            public class NotModifier {
                ...
                public void simple() {
                    withObservation(
                            myDataBuilder.withObservationCode("http://example.com", "value"));

                    assertFind(
                            "by same system, different code",
                            "/Observation?code:not=http://example.com|other");
                    assertFind(
                            "by same code, different system",
                            "/Observation?code:not=http://example2.com|value");
                    assertFind(
                            "by different code, different system",
                            "/Observation?code:not=http://example2.com|otherValue");
                    assertNotFind(
                            "by system and code", "/Observation?code:not=http://example.com|value");
                    assertNotFind(
                            "by system, any code", "/Observation?code:not=http://example.com|");
            ...
            public class TextModifier {
                ...
                public void systemAndCode() {
                    withObservation(
                            myDataBuilder.withObservationCode(
                                    "http://example.com", "value", "the display text"));
            ...
            public class Sorting {
                ...
                public void sortBySystemThenValue() {
                    String idAlphaM =
                            withObservation(
                                            myDataBuilder.withObservationCode(
                                                    "http://alpha.org", "Mvalue"))
                                    .getIdPart();
                    String idAlphaA =
                            withObservation(
                                            myDataBuilder.withObservationCode(
                                                    "http://alpha.org", "Avalue"))
                                    .getIdPart();
                    String idAlphaZ =
                            withObservation(
                                            myDataBuilder.withObservationCode(
                                                    "http://alpha.org", "Zvalue"))
                                    .getIdPart();

                    String idExD =
                            withObservation(
                                            myDataBuilder.withObservationCode(
                                                    "http://example.org", "DValue"))
                                    .getIdPart();
                    String idExA =
                            withObservation(
                                            myDataBuilder.withObservationCode(
                                                    "http://example.org", "AValue"))
                                    .getIdPart();
                    String idExM =
                            withObservation(
                                            myDataBuilder.withObservationCode(
                                                    "http://example.org", "MValue"))
                                    .getIdPart();
                    ...
                    allIds =
                            myTestDaoSearch.searchForIds(
                                    "/Observation?_sort=code&code=http://example.org|");
    ...
    public class NumericSearch {
        ...
        private IIdType withRiskAssessmentWithProbabilty(double theValue) {
            myResourceId =
                    myDataBuilder.createResource(
                            "RiskAssessment",
                            myDataBuilder.withResourcePrimitiveAttribute(
                                    "prediction.probabilityDecimal", theValue));
            return myResourceId;
        }
        ...
        public class Queries {
            ...
            public void eq() {
                ...
                // assertFind("when a little gt - default is approx",
                // "/RiskAssessment?probability=0.599");
                // assertFind("when a little lt - default is approx",
                // "/RiskAssessment?probability=0.601");
            ...
            private void assertNotFind(String theMessage, String theUrl) {
                List<String> resourceIds = myTestDaoSearch.searchForIds(theUrl);
                assertThat(
                        theMessage, resourceIds, not(hasItem(equalTo(myResourceId.getIdPart()))));
            }
        }
        ...
        public class Sorting {
            ...
            public void sortByNumeric() {
                ...
                List<String> allIds =
                        myTestDaoSearch.searchForIds("/RiskAssessment?_sort=probability");
    ...
    public class QuantitySearch {
        ...
        private IIdType withObservationWithValueQuantity(double theValue) {
            ...
            myResourceId =
                    myDataBuilder.createObservation(
                            myDataBuilder.withElementAt(
                                    "valueQuantity",
                                    myDataBuilder.withPrimitiveAttribute("value", theValue),
                                    myDataBuilder.withPrimitiveAttribute("unit", "mmHg"),
                                    myDataBuilder.withPrimitiveAttribute(
        ...
        public class Queries {
            ...
            public void eq() {
                ...
                // TODO we break the spec here.  Default search should be approx
                // assertFind("when a little gt - default is approx",
                // "/Observation?value-quantity=0.599");
                // assertFind("when a little lt - default is approx",
                // "/Observation?value-quantity=0.601");
