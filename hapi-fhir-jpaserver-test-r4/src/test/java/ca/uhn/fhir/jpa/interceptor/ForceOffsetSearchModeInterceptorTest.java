...
public class ForceOffsetSearchModeInterceptorTest extends BaseResourceProviderR4Test {
    ...
    public void testSearch_NoExplicitCount() {
        ...
        assertThat(
                outcome.getLink("next").getUrl(),
                containsString("Patient?_count=5&_offset=5&active=true"));
        ...
        assertThat(
                outcome.getLink("next").getUrl(),
                containsString("Patient?_count=5&_offset=10&active=true"));
