...
public class DiffProviderR4Test extends BaseResourceProviderR4Test {
    ...
    public void testMetaIgnoredByDefault() {
        ...
        ourLog.debug(
                myFhirContext.newJsonParser().setPrettyPrint(true).encodeResourceToString(diff));

        assertEquals(2, diff.getParameter().size());

        Assertions.assertEquals(
                "replace",
                FhirPatchApplyR4Test.extractPartValuePrimitive(diff, 0, "operation", "type"));
        Assertions.assertEquals(
                "Patient.text.div",
                FhirPatchApplyR4Test.extractPartValuePrimitive(diff, 0, "operation", "path"));
        Assertions.assertEquals(
                "<div xmlns=\"http://www.w3.org/1999/xhtml\"><table"
                        + " class=\"hapiPropertyTable\"><tbody></tbody></table></div>",
                FhirPatchApplyR4Test.extractPartValuePrimitive(
                        diff, 0, "operation", "previousValue"));
        Assertions.assertEquals(
                "<div xmlns=\"http://www.w3.org/1999/xhtml\"><div class=\"hapiHeaderText\"><b>SMITH"
                    + " </b></div><table class=\"hapiPropertyTable\"><tbody></tbody></table></div>",
                FhirPatchApplyR4Test.extractPartValuePrimitive(diff, 0, "operation", "value"));

        Assertions.assertEquals(
                "insert",
                FhirPatchApplyR4Test.extractPartValuePrimitive(diff, 1, "operation", "type"));
        Assertions.assertEquals(
                "Patient.name",
                FhirPatchApplyR4Test.extractPartValuePrimitive(diff, 1, "operation", "path"));
        Assertions.assertEquals(
                "0", FhirPatchApplyR4Test.extractPartValuePrimitive(diff, 1, "operation", "index"));
        Assertions.assertEquals(
                "SMITH",
                FhirPatchApplyR4Test.extractPartValue(
                                diff, 1, "operation", "value", HumanName.class)
                        .getFamily());
    }
    ...
    public void testLatestVersion_2_to_3() {
        ...
        Parameters diff =
                myClient.operation()
                        ...
                        .withParameter(
                                Parameters.class,
                                ProviderConstants.DIFF_INCLUDE_META_PARAMETER,
        ...
        Assertions.assertEquals(
                ...
                FhirPatchApplyR4Test.extractPartValuePrimitive(
                        diff, 0, "operation", "previousValue"));
        Assertions.assertEquals(
                "3", FhirPatchApplyR4Test.extractPartValuePrimitive(diff, 0, "operation", "value"));
        ...
        Assertions.assertEquals(
                "replace",
                FhirPatchApplyR4Test.extractPartValuePrimitive(diff, 2, "operation", "type"));
        Assertions.assertEquals(
                "Patient.text.div",
                FhirPatchApplyR4Test.extractPartValuePrimitive(diff, 2, "operation", "path"));
        Assertions.assertEquals(
                "<div xmlns=\"http://www.w3.org/1999/xhtml\"><table"
                        + " class=\"hapiPropertyTable\"><tbody></tbody></table></div>",
                FhirPatchApplyR4Test.extractPartValuePrimitive(
                        diff, 2, "operation", "previousValue"));
        Assertions.assertEquals(
                "<div xmlns=\"http://www.w3.org/1999/xhtml\"><div class=\"hapiHeaderText\"><b>SMITH"
                    + " </b></div><table class=\"hapiPropertyTable\"><tbody></tbody></table></div>",
        ...
        Assertions.assertEquals(
                "insert",
                FhirPatchApplyR4Test.extractPartValuePrimitive(diff, 3, "operation", "type"));
        Assertions.assertEquals(
                "Patient.name",
                FhirPatchApplyR4Test.extractPartValuePrimitive(diff, 3, "operation", "path"));
        Assertions.assertEquals(
                "0", FhirPatchApplyR4Test.extractPartValuePrimitive(diff, 3, "operation", "index"));
        Assertions.assertEquals(
                "SMITH",
                FhirPatchApplyR4Test.extractPartValue(
                                diff, 3, "operation", "value", HumanName.class)
                        .getFamily());
    }
    ...
    public void testExplicitFromVersion() {
        ...
        Parameters diff =
                myClient.operation()
                        ...
                        .withParameter(
                                Parameters.class,
                                ProviderConstants.DIFF_FROM_VERSION_PARAMETER,
                                new StringType("1"))
                        .andParameter(
                                ProviderConstants.DIFF_INCLUDE_META_PARAMETER,
                                new BooleanType(true))
    ...
    public void testDifferentResources_Versionless() {
        ...
        Assertions.assertEquals(
                ...
                FhirPatchApplyR4Test.extractPartValuePrimitive(
                        diff, 0, "operation", "previousValue"));
        Assertions.assertEquals(
                "B", FhirPatchApplyR4Test.extractPartValuePrimitive(diff, 0, "operation", "value"));
    }
    ...
    public void testDifferentResources_DifferentTypes() {
        try {
            myClient.operation()
                    ...
                    .andParameter(
                            ProviderConstants.DIFF_TO_PARAMETER, new IdType("Observation/456"))
                    .execute();
            fail();
            ...
            assertEquals(
                    "HTTP 400 Bad Request: "
                            + Msg.code(1129)
                            + "Unable to diff two resources of different types",
                    e.getMessage());
        }
    }
}
