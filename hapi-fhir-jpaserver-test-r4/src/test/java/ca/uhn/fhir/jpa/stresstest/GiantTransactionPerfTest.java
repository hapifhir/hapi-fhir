...
public class GiantTransactionPerfTest {
    ...
    @Mock private IInstanceValidatorModule myInstanceValidatorSvc;
    ...
    @Mock private ResourceChangeListenerCacheFactory myResourceChangeListenerCacheFactory;
    ...
    @Mock private IJpaStorageResourceParser myJpaStorageResourceParser;
    ...
    public void afterEach() {
        ...
        myStorageSettings.setAllowInlineMatchUrlReferences(
                new JpaStorageSettings().isAllowInlineMatchUrlReferences());
    }
    ...
    public void beforeEach() {
        ...
        when(myAppCtx.getBean(eq(IInstanceValidatorModule.class)))
                .thenReturn(myInstanceValidatorSvc);
        ...
        when(myResourceChangeListenerCacheFactory.newResourceChangeListenerCache(
                        any(), any(), any(), anyLong()))
                .thenAnswer(
                        t -> {
                            String resourceName = t.getArgument(0, String.class);
                            SearchParameterMap searchParameterMap =
                                    t.getArgument(1, SearchParameterMap.class);
                            IResourceChangeListener changeListener =
                                    t.getArgument(2, IResourceChangeListener.class);
                            long refreshInterval = t.getArgument(3, Long.class);
                            ResourceChangeListenerCache retVal =
                                    new ResourceChangeListenerCache(
                                            resourceName,
                                            changeListener,
                                            searchParameterMap,
                                            refreshInterval);
                            retVal.setResourceChangeListenerCacheRefresher(
        ...
        myResourceChangeListenerCacheRefresher.setResourceChangeListenerRegistry(
                myResourceChangeListenerRegistry);
        ...
        mySearchParamWithInlineReferencesExtractor.setSearchParamExtractorService(
                mySearchParamExtractorSvc);
        mySearchParamWithInlineReferencesExtractor.setSearchParamRegistry(mySearchParamRegistry);
        mySearchParamWithInlineReferencesExtractor.setDaoSearchParamSynchronizer(
        ...
        myEobDao.setSearchParamWithInlineReferencesExtractor(
        ...
        myEobDao.setExternallyStoredResourceServiceRegistryForUnitTest(
                new ExternallyStoredResourceServiceRegistry());
        myEobDao.start();
    ...
    public void testTransaction() {
        Bundle input =
                ClasspathUtil.loadResource(
                        ourFhirContext, Bundle.class, "/r4/large-transaction.json");
    ...
    public void testTransactionStressTest() {
        ...
        for (int i = 1; i < 10000; i++) {
            ...
            if (i % 5 == 0) {
                ourLog.info(
                        "Processed {} - {}/second", i, sw.formatThroughput(i, TimeUnit.SECONDS));
            }
    ...
    private static class MockResourceHistoryTableDao implements IResourceHistoryTableDao {
        ...
        @Override
        public ResourceHistoryTable findForIdAndVersionAndFetchProvenance(
                long theId, long theVersion) {
            throw new UnsupportedOperationException();
        }

        @Override
        public Slice<Long> findForResourceId(
        ...
        @Override
        public Slice<Long> findIdsOfPreviousVersionsOfResourceId(
                Pageable thePage, Long theResourceId) {
            throw new UnsupportedOperationException();
        }

        @Override
        public Slice<Long> findIdsOfPreviousVersionsOfResources(
                Pageable thePage, String theResourceName) {
            throw new UnsupportedOperationException();
        }
        ...
        @Nonnull
        @Override
        public <S extends ResourceHistoryTable> List<S> saveAllAndFlush(
        ...
        @Nonnull
        @Override
        public <S extends ResourceHistoryTable> List<S> findAll(
                @Nonnull Example<S> example, @Nonnull Sort sort) {
            throw new UnsupportedOperationException();
        }
    ...
    private static class MockRequestPartitionHelperSvc
