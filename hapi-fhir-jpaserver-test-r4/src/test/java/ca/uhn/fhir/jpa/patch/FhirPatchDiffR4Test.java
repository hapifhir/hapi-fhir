...
public class FhirPatchDiffR4Test {
    ...
    public void testReplaceIdentifier() {
        ...
        assertEquals(
                ...
                extractPartValuePrimitive(diff, 0, "operation", "path"));
        assertEquals("system-1", extractPartValuePrimitive(diff, 0, "operation", "value"));
        assertEquals("replace", extractPartValuePrimitive(diff, 0, "operation", "type"));
        assertEquals(
                "Patient.identifier[0].value",
                extractPartValuePrimitive(diff, 1, "operation", "path"));
    ...
    public void testModifyId() {
        ...
        assertEquals(
                "Patient.meta.versionId", extractPartValuePrimitive(diff, 1, "operation", "path"));
    ...
    public void testModifyId_OnlyVersionDifferent() {
        ...
        assertEquals("replace", extractPartValuePrimitive(diff, 0, "operation", "type"));
        assertEquals(
                "Patient.meta.versionId", extractPartValuePrimitive(diff, 0, "operation", "path"));
    ...
    public void testInsertIdentifier() {
        ...
        assertEquals(
                "system-1",
                extractPartValue(diff, 0, "operation", "value", Identifier.class).getSystem());
        assertEquals(
                "value-1",
                extractPartValue(diff, 0, "operation", "value", Identifier.class).getValue());
    ...
    public void testInsertContact() {
        ...
        assertEquals(
                "Patient.contact[0].name", extractPartValuePrimitive(diff, 1, "operation", "path"));
        assertEquals(
                "My Family",
    ...
    public void testDeleteIdentifier() {
        ...
        assertEquals("delete", extractPartValuePrimitive(diff, 0, "operation", "type"));
        assertEquals(
                "Patient.identifier[1]", extractPartValuePrimitive(diff, 0, "operation", "path"));
