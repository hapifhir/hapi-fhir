...
public class TerminologyLoaderSvcImgthlaTest extends BaseLoaderTest {
    ...
    @Mock private ITermCodeSystemStorageSvc myTermStorageSvc;
    ...
    public void testLoadImgthla() throws Exception {
        ...
        try {
            ...
            assertThat(
                    e.getMessage(),
                    containsString(
                            "HLA nomenclature terminology upload not yet fully implemented"));
        }

        // TODO:  verify the code system was loaded correctly (similarly to
        // TerminologyLoaderSvcLoincTest.testLoadLoinc)
    }
    ...
    public static void addImgthlaMandatoryFilesToZip(ZipCollectionBuilder theFiles)
            throws IOException {
