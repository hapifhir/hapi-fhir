...
/**
 * The on-enter actions are defined in {@link
 * ca.uhn.fhir.batch2.progress.JobInstanceStatusUpdater#handleStatusChange} {@link
 * ca.uhn.fhir.batch2.progress.InstanceProgress#updateStatus(JobInstance)} {@link
 * JobInstanceProcessor#cleanupInstance()}
 *
 * <p>For chunks: {@link ca.uhn.fhir.jpa.batch2.JpaJobPersistenceImpl#onWorkChunkCreate} {@link
 * JpaJobPersistenceImpl#onWorkChunkDequeue(String)} Chunk execution {@link
 * ca.uhn.fhir.batch2.coordinator.StepExecutor#executeStep}
 */
...
public class Batch2JobMaintenanceIT extends BaseJpaR4Test {
    ...
    private void assertJobMaintenanceCalledAtLeast(int theSize) {
        assertTrue(
                ...
                "Expected at least "
                        + theSize
                        + " calls to job maintenance but got "
                        + myStackTraceElements.size());
    }
    ...
    public void testFirstStepToSecondStepFasttrackingDisabled_singleChunkDoesNotFasttrack()
        ...
        IJobStepWorker<
                        Batch2JobMaintenanceIT.TestJobParameters,
                        VoidModel,
                        Batch2JobMaintenanceIT.FirstStepOutput>
                firstStep =
                        (step, sink) -> {
    ...
    static class SpringConfig {
        ...
        void fastScheduler() {
            ((JobMaintenanceServiceImpl) myJobMaintenanceService)
                    .setScheduledJobFrequencyMillis(200);
        }
    }
}
