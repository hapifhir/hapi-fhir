...
public class SystemProviderTransactionSearchR4Test extends BaseJpaR4Test {
    ...
    public void beforeStartServer() throws Exception {
        if (myRestServer == null) {
            ...
            MedicationRequestResourceProvider medicationRequestRp =
    ...
    public void testSearchByBatch() {
        ...
        Bundle b =
                ourClient
                        ...
                        .and(
                                MedicationRequest.MEDICATION.hasChainedProperty(
        ...
        b.addEntry()
                ...
                .setMethod(HTTPVerb.GET)
                .setUrl(
                        "MedicationRequest?intent=plan,order&medication.code=50580-0449-23&patient=P3000254749");
