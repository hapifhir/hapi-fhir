...
public class SubscriptionValidatingInterceptorTest {
    ...
    @Mock public DaoRegistry myDaoRegistry;
    ...
    public void testValidate_RestHook_NoType() {
        ...
        try {
            ...
            assertThat(
                    e.getMessage(), containsString("Subscription.channel.type must be populated"));
        }
    }
    ...
    public void testValidate_Cross_Partition_Subscription() {
        ...
        // No asserts here because the function should throw an UnprocessableEntityException
        // exception if the subscription
        // is invalid
    ...
    public void testValidate_Cross_Partition_System_Subscription_Without_Setting() {
        ...
        Mockito.verify(myRequestPartitionHelperSvc, never())
                .determineCreatePartitionForRequest(
                        isA(RequestDetails.class), isA(Patient.class), eq("Patient"));
    }
    ...
    public void testSubscriptionUpdate() {
        ...
        lenient()
                .when(requestDetails.getRestOperationType())
                .thenReturn(RestOperationTypeEnum.UPDATE);
