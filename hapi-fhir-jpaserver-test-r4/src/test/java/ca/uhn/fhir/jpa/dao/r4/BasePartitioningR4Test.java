...
public abstract class BasePartitioningR4Test extends BaseJpaR4SystemTest {
	...
	protected MockPartitioningInterceptor myPartitionInterceptor;
	...
	protected void unregisterPartitionInterceptor() {
		mySrdInterceptorService.unregisterInterceptorsIf(t -> t instanceof MockPartitioningInterceptor);
	}
	...
	protected void before() throws Exception {
		...
		myPartitionInterceptor = new MockPartitioningInterceptor();
