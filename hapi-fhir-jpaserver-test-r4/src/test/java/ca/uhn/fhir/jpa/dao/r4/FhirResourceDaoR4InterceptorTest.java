...
public class FhirResourceDaoR4InterceptorTest extends BaseJpaR4Test {
    ...
    /** Make sure that both JPA interceptors and RestfulServer interceptors can get called */
    @Test
    ...
    public void testPrestorageClientAssignedIdInterceptorCanDenyClientAssignedIds() {
        Object interceptor =
                new Object() {
                    ...
                    public void prestorageClientAssignedId(
