...
class BaseLoincHandlerTest {
    ...
    @Mock private ValueSet.ConceptSetComponent myInclude;

    @Mock private ValueSet.ConceptReferenceComponent myConceptReferenceComponent;
    ...
    public class WithVersion {
        ...
        void Top2000LabResultsHandlerTest() throws Exception {
            ...
            BaseLoincHandler loincHandler =
                    new BaseLoincTop2000LabResultsHandler(
                            null,
                            Lists.newArrayList(),
                            null,
                            null,
            ...
            when(myConceptReferenceComponent.setCode(any()))
                    .thenReturn(myConceptReferenceComponent);
