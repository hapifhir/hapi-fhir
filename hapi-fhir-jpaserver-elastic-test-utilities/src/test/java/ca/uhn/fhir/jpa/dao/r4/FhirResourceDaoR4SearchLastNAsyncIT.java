...
public class FhirResourceDaoR4SearchLastNAsyncIT extends BaseR4SearchLastN {
    ...
    private static final Logger ourLog =
            LoggerFactory.getLogger(FhirResourceDaoR4SearchLastNAsyncIT.class);
    ...
    public void before() throws Exception {
        ...
        // This will allow testing a common use case where result set is larger than first fetch
        // size but smaller than the normal query chunk size.
    ...
    public void testLastNChunking() {
        ...
        // 1 query to lookup up Search from cache, and 2 chunked queries to retrieve resources by
        // PID.
