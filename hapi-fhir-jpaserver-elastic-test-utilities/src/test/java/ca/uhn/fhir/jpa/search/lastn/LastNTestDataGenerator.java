...
public class LastNTestDataGenerator {
    ...
    public static final String CATEGORYFIRSTCODINGSYSTEM =
            "http://mycodes.org/fhir/observation-category";
    public static final String CATEGORYSECONDCODINGSYSTEM =
            "http://myalternatecodes.org/fhir/observation-category";
    public static final String CATEGORYTHIRDCODINGSYSTEM =
    ...
    public static final String SECONDCATEGORYTEXT =
            "Test Codeable Concept Field for for second category";
    ...
    public static final String THIRDCATEGORYTHIRDCODINGDISPLAY =
            "test-2nd-alt-vitals-panel display";
    public static final String OBSERVATIONSINGLECODEID = UUID.randomUUID().toString();
    public static final String OBSERVATION_CODE_CONCEPT_TEXT_1 =
            "Test Codeable Concept Field for First Code";
    public static final String OBSERVATION_CODE_CONCEPT_TEXT_2 =
            "Test Codeable Concept Field for Second Code";
    ...
    public static final String CODE_SECOND_CODING_SYSTEM =
            "http://mycodes.org/fhir/observation-code";
    ...
    public static ObservationJson createSingleObservationJson() {
        ...
        codeableConceptField.addCoding(
                CODEFIRSTCODINGSYSTEM, CODEFIRSTCODINGCODE, CODEFIRSTCODINGDISPLAY);
    ...
    private static List<CodeJson> createCategoryCodeableConcepts() {
        ...
        categoryCodeableConcept1.addCoding(
                CATEGORYSECONDCODINGSYSTEM,
                FIRSTCATEGORYSECONDCODINGCODE,
                FIRSTCATEGORYSECONDCODINGDISPLAY);
        categoryCodeableConcept1.addCoding(
                CATEGORYTHIRDCODINGSYSTEM,
                FIRSTCATEGORYTHIRDCODINGCODE,
                FIRSTCATEGORYTHIRDCODINGDISPLAY);
        ...
        categoryCodeableConcept2.addCoding(
                CATEGORYFIRSTCODINGSYSTEM,
                SECONDCATEGORYFIRSTCODINGCODE,
                SECONDCATEGORYFIRSTCODINGDISPLAY);
        categoryCodeableConcept2.addCoding(
                CATEGORYSECONDCODINGSYSTEM,
                SECONDCATEGORYSECONDCODINGCODE,
                SECONDCATEGORYSECONDCODINGDISPLAY);
        categoryCodeableConcept2.addCoding(
                CATEGORYTHIRDCODINGSYSTEM,
                SECONDCATEGORYTHIRDCODINGCODE,
                SECONDCATEGORYTHIRDCODINGDISPLAY);
        ...
        categoryCodeableConcept3.addCoding(
                ...
                THIRDCATEGORYFIRSTCODINGDISPLAY);
        categoryCodeableConcept3.addCoding(
                CATEGORYSECONDCODINGSYSTEM,
        ...
        return Arrays.asList(
                categoryCodeableConcept1, categoryCodeableConcept2, categoryCodeableConcept3);
    }
    ...
    public static List<ObservationJson> createMultipleObservationJson(List<Integer> thePatientIds) {
        ...
        codeJson2.addCoding(
                CODE_SECOND_CODING_SYSTEM, CODE_SECOND_CODING_CODE, CODE_SECOND_CODING_DISPLAY);

        List<CodeJson> categoryCodeableConcepts = createCategoryCodeableConcepts();
        // CategoryCodeableConcept 1 - with 3 codings
        List<CodeJson> categoryConcepts1 =
                Collections.singletonList(categoryCodeableConcepts.get(0));

        // CateogryCodeableConcept 2 - with 3 codings
        List<CodeJson> categoryConcepts2 =
                Collections.singletonList(categoryCodeableConcepts.get(1));
                                ...
                                IntStream.range(0, 10)
                                        .mapToObj(
                                                index -> {
                                                    ...
                                                    observationJson.setSubject(
                                                            String.valueOf(patientId));
                                                    if (index % 2 == 1) {
                                                        observationJson.setCategories(
                                                                categoryConcepts1);
