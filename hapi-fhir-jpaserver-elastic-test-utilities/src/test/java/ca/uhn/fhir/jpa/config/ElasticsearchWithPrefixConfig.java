 ...
 * test framework comes online. We need to do this as it is during bean creation that HS
...
public class ElasticsearchWithPrefixConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        LocalContainerEntityManagerFactoryBean retVal =
                new HapiFhirLocalContainerEntityManagerFactoryBean(
    ...
    public Properties jpaProperties() {
        ...
        extraProperties.put(
                ...
                host + ":" + httpPort);
        extraProperties.put(
                BackendSettings.backendKey(ElasticsearchBackendSettings.PROTOCOL), "http");
        extraProperties.put(
                HibernateOrmMapperSettings.SCHEMA_MANAGEMENT_STRATEGY,
                SchemaManagementStrategyName.CREATE.externalRepresentation());
        extraProperties.put(
        ...
        extraProperties.put(
                BackendSettings.backendKey(ElasticsearchIndexSettings.DYNAMIC_MAPPING), "true");
        // Only for unit tests
        extraProperties.put(
        ...
        PutIndexTemplateRequest ngramTemplate =
                new PutIndexTemplateRequest("ngram-template")
        ...
        try {
            ...
            AcknowledgedResponse acknowledgedResponse =
                    elasticsearchHighLevelRestClient
                            .indices()
            ...
            throw new ConfigurationException(
                    "Couldn't connect to the elasticsearch server to create necessary templates."
                        + " Ensure the Elasticsearch user has permissions to create templates.");
        }
