...
class TokenAutocompleteAggregationTest {
    ...
    public class AggregationQueryContents {
        ...
        public void includesSPName() {
            ...
            assertThat(
                    "nested clause includes sp",
                    myAggJson,
                    isJson(withJsonPath("nested.path", equalTo("nsp.combo-code"))));
            assertThat(
                    "terms field is sp",
                    myAggJson,
                    isJson(
                            withJsonPath(
                                    ...
                                    equalTo("nsp.combo-code.token.code-system"))));
            assertThat(
                    "fetched piece is sp",
                    myAggJson,
                    isJson(
        ...
        public void includesCount() {
            ...
            assertThat(
                    ...
                    isJson(
                            withJsonPath(
                                    "aggs.search.aggs.group_by_token.terms.size", equalTo(77))));
        }

        private void buildAggregation() {
            myAggJson =
                    new TokenAutocompleteAggregation(myCode, myCount, null, null)
                            .toJsonAggregation()
                            .toString();
        }
    }
    ...
    public class ResultExtraction {
        ...
        TokenAutocompleteAggregation myAutocompleteAggregation =
                new TokenAutocompleteAggregation("code", 22, null, null);

        @Test
        public void testResultExtraction() {

            List<TokenAutocompleteHit> hits =
                    myAutocompleteAggregation.extractResults(parsedResult);
