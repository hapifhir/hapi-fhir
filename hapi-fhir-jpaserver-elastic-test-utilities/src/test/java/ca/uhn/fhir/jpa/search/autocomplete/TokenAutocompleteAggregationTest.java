...
class TokenAutocompleteAggregationTest {
	...
	public class AggregationQueryContents {
		...
		public void includesCount() {
			...
			assertThat(
					"count for top n",
					myAggJson,
					isJson(withJsonPath("aggs.search.aggs.group_by_token.terms.size", equalTo(77))));
		}

		private void buildAggregation() {
			myAggJson = new TokenAutocompleteAggregation(myCode, myCount, null, null)
					.toJsonAggregation()
					.toString();
		}
	}
	...
	public class ResultExtraction {
		...
		String resultJson = "{ " + "  \"doc_count\": 22770, "
				+ "  \"search\": { "
				+ "    \"doc_count\": 4, "
				+ "    \"group_by_token\": { "
