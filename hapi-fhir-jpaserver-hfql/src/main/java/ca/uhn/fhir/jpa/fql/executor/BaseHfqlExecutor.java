...
/**
 * This class could be considered the main entrypoint into both HFQL executors.
 */
public abstract class BaseHfqlExecutor implements IHfqlExecutor {
	public static final int BATCH_SIZE = 1000;
	public static final String[] EMPTY_STRING_ARRAY = new String[0];
	public static final Set<GroupByKey> NULL_GROUP_BY_KEY = Set.of(new GroupByKey(List.of()));
	public static final Logger ourLog = LoggerFactory.getLogger(BaseHfqlExecutor.class);
	 ...
	 * Constructor
	 */
	protected BaseHfqlExecutor(
			FhirContext myFhirContext, IPagingProvider myPagingProvider, ISearchParamRegistry mySearchParamRegistry) {
		this.myFhirContext = myFhirContext;
		this.myPagingProvider = myPagingProvider;
		this.mySearchParamRegistry = mySearchParamRegistry;
	}
	...
	protected IHfqlExecutionResult doExecuteInitialSearch(
		...
		String fromResourceName = statement.getFromResourceName();
		IBundleProvider outcome = theBundleProviderSupplier.get(fromResourceName, map);
