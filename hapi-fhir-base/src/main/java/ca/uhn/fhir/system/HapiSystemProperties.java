...
public final class HapiSystemProperties {
    ...
    static final long DEFAULT_TEST_SYSTEM_PROP_VALIDATION_RESOURCE_CACHES_MS =
            10 * DateUtils.MILLIS_PER_SECOND;

    private HapiSystemProperties() {}

    /**
     * This property is used by unit tests - do not rely on it in production code as it may change
     * at any time. If you want to capture responses in a reliable way in your own code, just use
     * client interceptors
     */
    ...
    /**
     * This property gets used in the logback.xml file. It causes logged stack traces to skip a
     * number of packages that are just noise.
     */
    ...
    /**
     * Get the validation resource cache expireAfterWrite timeout in milliseconds. If it has not
     * been set, the default value is 10 seconds.
     */
    ...
    /**
     * This property is used to ensure unit test behaviour is deterministic. It is also used to add
    ...
    /**
     * This property prevents stack traces from getting truncated and includes the full stack trace
     * in failed search responses.
     */
    ...
    public static boolean isUnitTestCaptureStackEnabled() {
        return Boolean.parseBoolean(
                System.getProperty(HapiSystemProperties.UNIT_TEST_CAPTURE_STACK));
    }
    ...
    /**
     * This property sets {@link JpaStorageSettings#setStatusBasedReindexingDisabled(Boolean)} to
     * true when the system starts up.
     */
