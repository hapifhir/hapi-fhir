...
public class TestUtil {
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(TestUtil.class);
     ...
     *
     * <p>When we run the unit tests in cobertura, JUnit doesn't seem to clean up static fields
     * which leads to tons of memory being used by the end and the JVM crashes in Travis. Manually
     * clearing all of the static fields seems to solve this.
     */
    ...
    /**
     * Set some system properties randomly after each test.. this is kind of hackish, but it helps
     * us make sure we don't have any tests that depend on a particular environment
     */
     ...
     * <b>THIS IS FOR UNIT TESTS ONLY - DO NOT CALL THIS METHOD FROM USER CODE</b>
     *
     * <p>Wait for an atomicinteger to hit a given site and fail if it never does
     */
    public static void waitForSize(int theTarget, AtomicInteger theInteger) {
        ...
        if ((System.currentTimeMillis() - start) >= 15000) {
            throw new IllegalStateException(
                    Msg.code(1779) + "Size " + theInteger.get() + " is != target " + theTarget);
        }
    }
    ...
    public static void waitForSize(int theTarget, Callable<Integer> theSource) throws Exception {
        ...
        if ((System.currentTimeMillis() - start) >= 15000) {
            throw new IllegalStateException(
                    Msg.code(1781) + "Size " + theSource.call() + " is != target " + theTarget);
        }
    }
     ...
     * <b>THIS IS FOR UNIT TESTS ONLY - DO NOT CALL THIS METHOD FROM USER CODE</b>
     *
     * <p>Strip \r chars from a string to account for line ending platform differences
     */
