...
public class NumericParamRangeUtil {
    ...
    /**
     * Provides a Pair containing the low and high boundaries for a range based on the received
     * number characteristics. Note that the scale is used to calculate significant figures
     *
