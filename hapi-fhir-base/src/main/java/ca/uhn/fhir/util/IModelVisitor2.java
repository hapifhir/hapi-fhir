...
public interface IModelVisitor2 {
     ...
     * @param theContainingElementPath The elements in the path leading up to the actual element
     *     being accepted. The first element in this path will be the outer resource being visited,
     *     and the last element will be the saem object as the object passed as <code>theElement
     *     </code>
     */
