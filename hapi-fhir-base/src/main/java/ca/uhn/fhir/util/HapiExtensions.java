...
public class HapiExtensions {
    ...
    /**
     * This extension should be of type <code>string</code> and should be placed on the <code>
     * Subscription.channel</code> element
     */
    ...
    /**
     * This extension URL indicates whether a REST HOOK delivery should include the version ID when
     * delivering.
     *
     * <p>This extension should be of type <code>boolean</code> and should be placed on the <code>
     * Subscription.channel</code> element.
     */
    ...
    /**
     * This extension URL indicates whether a REST HOOK delivery should reload the resource and
     * deliver the latest version always. This could be useful for example if a resource which
     * triggers a subscription gets updated many times in short succession and there is no value in
     * delivering the older versions.
     *
     * <p>Note that if the resource is now deleted, this may cause the delivery to be cancelled
     * altogether.
     *
     * <p>This extension should be of type <code>boolean</code> and should be placed on the <code>
     * Subscription.channel</code> element.
    ...
    /**
     * For subscription, deliver a bundle containing a search result instead of just a single
     * resource
     */
    ...
    /**
     * Extension URL for extension on a SearchParameter indicating that text values should not be
     * indexed
     */
    ...
    /**
     * This extension represents the equivalent of the <code>Resource.meta.source</code> field
     * within R4+ resources, and is for use in DSTU3 resources. It should contain a value of type
     * <code>uri</code> and will be located on the Resource.meta
     */
    public static final String EXT_META_SOURCE =
            "http://hapifhir.io/fhir/StructureDefinition/resource-meta-source";

    public static final String EXT_SP_UNIQUE =
            "http://hapifhir.io/fhir/StructureDefinition/sp-unique";

    /**
     * URL for extension on a Phonetic String SearchParameter indicating that text values should be
     * phonetically indexed with the named encoder
     */
    ...
    /**
     * URL for extension in a Group Bulk Export which identifies the golden patient of a given
     * exported resource.
     */
    ...
    /**
     * This extension provides an example value for a parameter value for a REST operation (eg for
    ...
    /**
     * This extension provides a way for subscribers to provide a "retry-count". If provided,
     * subscriptions will be retried this many times (to a total of retry-count + 1 (for original
     * attempt)
     */
    ...
    /**
     * This extension provides a way for subscribers to indicate if DELETE messages must be sent
     * (default is ignoring them)
     */
    ...
    /**
     * This entension allows subscriptions to be marked as cross partition and with correct
     * settings, listen to incoming resources from all partitions.
     */
    ...
    /**
     * This extension is used for "uplifted refchains" on search parameters. See the HAPI FHIR
     * documentation for an explanation of how these work.
     */
