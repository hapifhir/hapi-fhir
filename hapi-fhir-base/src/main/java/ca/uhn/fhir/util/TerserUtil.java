...
public final class TerserUtil {
    ...
    public static final Collection<String> IDS_AND_META_EXCLUDES =
            Collections.unmodifiableSet(
                    Stream.of("id", "identifier", "meta").collect(Collectors.toSet()));

    /** Exclusion predicate for id, identifier, meta fields. */
    public static final Predicate<String> EXCLUDE_IDS_AND_META =
    ...
    /**
     * Exclusion predicate for id/identifier, meta and fields with empty values. This ensures that
     * source / target resources, empty source fields will not results in erasure of target fields.
     */
    public static final Predicate<Triple<BaseRuntimeChildDefinition, IBase, IBase>>
            EXCLUDE_IDS_META_AND_EMPTY =
                    new Predicate<Triple<BaseRuntimeChildDefinition, IBase, IBase>>() {
                        @Override
                        public boolean test(
                                Triple<BaseRuntimeChildDefinition, IBase, IBase> theTriple) {
    ...
    public static final Predicate<String> INCLUDE_ALL =
            new Predicate<String>() {
                @Override
                public boolean test(String s) {
                    return true;
    ...
    /**
     * Given an Child Definition of `identifier`, a R4/DSTU3 EID Identifier, and a new resource,
     * clone the EID into that resources' identifier list.
     */
    public static void cloneEidIntoResource(
        ...
        theIdentifierDefinition
                .getMutator()
                .addValue(theResourceToCloneEidInto, resourceNewIdentifier);
    }
    ...
    public static boolean hasValues(
            FhirContext theFhirContext, IBaseResource theResource, String theFieldName) {
        RuntimeResourceDefinition resourceDefinition =
                theFhirContext.getResourceDefinition(theResource);
        BaseRuntimeChildDefinition resourceIdentifier =
                resourceDefinition.getChildByName(theFieldName);
     ...
     * @param theResource Resource to check if the specified field is set
     * @param theFieldName name of the field to check
     * @return Returns all values for the specified field or null if field with the provided name
     *     doesn't exist
     */
    public static List<IBase> getValues(
            FhirContext theFhirContext, IBaseResource theResource, String theFieldName) {
        RuntimeResourceDefinition resourceDefinition =
                theFhirContext.getResourceDefinition(theResource);
        BaseRuntimeChildDefinition resourceIdentifier =
        ...
        if (resourceIdentifier == null) {
            ourLog.info(
                    "There is no field named {} in Resource {}",
                    theFieldName,
     ...
     * @param theResource Resource to check if the specified field is set
     * @param theFieldName name of the field to check
     * @return Returns the first value for the specified field or null if field with the provided
     *     name doesn't exist or has no values
     */
    public static IBase getValueFirstRep(
            FhirContext theFhirContext, IBaseResource theResource, String theFieldName) {
    ...
    /**
     * Clones specified composite field (collection). Composite field values must conform to the
        ...
        if (theMethod != null) {
            try {
                ...
                throw new RuntimeException(
                        Msg.code(1746)
                                + String.format("Unable to compare equality via %s", EQUALS_DEEP),
                        e);
            }
        }
    ...
    /**
     * Merges all fields on the provided instance. <code>theTo</code> will contain a union of all
     * values from <code>theFrom</code> instance and <code>theTo</code> instance.
     *
     * @param theFhirContext Context holding resource definition
    ...
    /**
     * Replaces all fields that have matching field names by the given inclusion strategy. <code>
     * theTo</code> will contain a copy of the values from <code>theFrom</code> instance.
     *
     * @param theFhirContext Context holding resource definition
     * @param theFrom The resource to merge the fields from
     * @param theTo The resource to merge the fields into
     * @param theFieldNameInclusion Inclusion strategy that checks if a given field should be
     *     replaced
     */
    ...
    /**
     * Replaces fields on theTo resource that test positive by the given predicate. <code>theTo
     * </code> will contain a copy of the values from <code>theFrom</code> for which predicate tests
     * positive. Please note that composite fields will be replaced fully.
     *
     * @param theFhirContext Context holding resource definition
     * @param theFrom The resource to merge the fields from
     * @param theTo The resource to merge the fields into
     ...
     * @return Returns true if resource definition has a child with the specified name and false
     *     otherwise
     */
    public static boolean fieldExists(
            FhirContext theFhirContext, String theFieldName, IBaseResource theInstance) {
    ...
    /**
     * Replaces the specified fields on <code>theTo</code> resource with the value from <code>
     * theFrom</code> resource.
     *
     * @param theFhirContext Context holding resource definition
    ...
    public static void clearField(FhirContext theFhirContext, String theFieldName, IBase theBase) {
        BaseRuntimeElementDefinition definition =
                theFhirContext.getElementDefinition(theBase.getClass());
    ...
    /**
     * Sets the provided field with the given values. This method will add to the collection of
     * existing field values in case of multiple cardinality. Use {@link #clearField(FhirContext,
     * IBaseResource, String)} to remove values before setting
     *
     * @param theFhirContext Context holding resource definition
        ...
        if (theFromFieldValues.isEmpty()) {
            for (IBase value : theValues) {
                try {
                    ...
                    ourLog.warn(
                            "Resource {} does not support multiple values, but an attempt to set {}"
                                    + " was made. Setting the first item only",
                            theResource,
                            theValues);
     ...
     */
    public static List<IBase> getFieldByFhirPath(
     ...
     */
    public static IBase getFirstFieldByFhirPath(
            FhirContext theFhirContext, String theFhirPath, IBase theResource) {
    ...
    /**
     * Merges values of all fields except for "identifier" and "meta" from <code>theFrom</code>
     * resource to <code>theTo</code> resource. Fields values are compared via the equalsDeep
    ...
    /**
     * Merges values of all field from <code>theFrom</code> resource to <code>theTo</code> resource.
     * Fields values are compared via the equalsDeep method, or via object identity if this method
     * is not available.
     *
     * @param theFhirContext Context holding resource definition
     * @param theFrom Resource to merge the specified field from
    ...
    /**
     * Merges value of the specified field from <code>theFrom</code> resource to <code>theTo</code>
     * resource. Fields values are compared via the equalsDeep method, or via object identity if
    ...
    /**
     * Creates a new element taking into consideration elements with choice that are not directly
     * retrievable by element name
     *
     * @param theFhirTerser
        ...
        if (theChildDefinition instanceof RuntimeChildChoiceDefinition) {
            runtimeElementDefinition =
                    theChildDefinition.getChildElementDefinitionByDatatype(
                            theFromFieldValue.getClass());
        } else {
            runtimeElementDefinition =
                    theChildDefinition.getChildByName(theChildDefinition.getElementName());
        }
        ...
        for (IBase theFromFieldValue : theFromFieldValues) {
            ...
            if (theFromFieldValue instanceof IPrimitiveType) {
                try {
                    ...
                    if (copyMethod != null) {
                        newFieldValue =
                                (IBase) copyMethod.invoke(theFromFieldValue, new Object[] {});
                    }
                } catch (Throwable t) {
                    ((IPrimitiveType) newFieldValue)
                            .setValueAsString(
                                    ((IPrimitiveType) theFromFieldValue).getValueAsString());
                }
            } else {
    ...
    public static <T extends IBaseResource> T clone(FhirContext theFhirContext, T theInstance) {
        RuntimeResourceDefinition definition =
                theFhirContext.getResourceDefinition(theInstance.getClass());
    ...
    public static <T extends IBase> T newElement(
            FhirContext theFhirContext, String theElementType) {
    ...
    public static <T extends IBase> T newResource(
            FhirContext theFhirContext, String theResourceName) {
