...
/**
 * Wrapper class holding context-related instances, and the resource being operated on. Sample use
 * case is
 *
 * <pre>{@code
...
public class TerserUtilHelper {
    ...
    public static TerserUtilHelper newHelper(FhirContext theFhirContext, String theResourceName) {
        return newHelper(
                theFhirContext,
                (IBaseResource) TerserUtil.newResource(theFhirContext, theResourceName));
    }
     ...
     * @return Returns a new helper instance
     */
    public static TerserUtilHelper newHelper(
     ...
     *
     * @param theField The field to get values from
     * @return Returns the first available value for the field name or null if the specified field
     *     doesn't exist or has no values
     */
