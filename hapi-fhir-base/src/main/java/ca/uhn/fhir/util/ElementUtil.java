...
public class ElementUtil {
    ...
    public static <T extends IElement> List<T> allPopulatedChildElements(
            Class<T> theType, Object... theElements) {
        ...
        for (Object next : theElements) {
            if (next == null) {
                ...
                throw new IllegalArgumentException(
                        Msg.code(1750) + "Found element of " + next.getClass());
            }
        }
        return retVal;
    }
    ...
    // @SuppressWarnings("unchecked")
    private static <T extends IElement> void addElement(
            ArrayList<T> retVal, IElement next, Class<T> theType) {
