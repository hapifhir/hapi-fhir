...
public class PrettyPrintWriterWrapper implements XMLStreamWriter {
	...
	@CoverageIgnore
	@Override
	public void writeAttribute(String theNamespaceURI, String theLocalName, String theValue)
	...
	public void writeAttribute(
				String thePrefix, String theNamespaceURI, String theLocalName, String theValue)
				throws XMLStreamException {
	...
	@Override
	public void writeCharacters(char[] theText, int theStart, int theLen)
				throws XMLStreamException {
		NonPrettyPrintWriterWrapper.writeCharacters(
					theText, theStart, theLen, myTarget, myInsidePre);
	}
	...
	@CoverageIgnore
	@Override
	public void writeEmptyElement(String theNamespaceURI, String theLocalName)
				throws XMLStreamException {
		indent();
	...
	@CoverageIgnore
	@Override
	public void writeProcessingInstruction(String theTarget, String theData)
				throws XMLStreamException {
	...
	@Override
	public void writeStartDocument(String theEncoding, String theVersion)
				throws XMLStreamException {
		myFirstIndent = true;
	...
	@Override
	public void writeStartElement(String theNamespaceURI, String theLocalName)
				throws XMLStreamException {
		indentAndAdd();
