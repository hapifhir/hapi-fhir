 ...
 *
 * <p>Note that this class is version aware. For example, a request for <code>
 * http://foo-codesystem|123</code> will only return a value if the built in resource if the version
 * matches. Unversioned URLs should generally be used, and will return whatever version is present.
 */
public class DefaultProfileValidationSupport implements IValidationSupport {
	...
	/**
	* This module just delegates all calls to a concrete implementation which will be in this
	* field. Which implementation gets used depends on the FHIR version.
	*/
	...
	*/
		...
		synchronized (ourImplementations) {
				...
				if (strategy == null) {
					if (theFhirContext
								.getVersion()
								.getVersion()
								.isEqualOrNewerThan(FhirVersionEnum.R5)) {
						/*
	...
	@Nullable
	public static String getConformanceResourceUrl(
