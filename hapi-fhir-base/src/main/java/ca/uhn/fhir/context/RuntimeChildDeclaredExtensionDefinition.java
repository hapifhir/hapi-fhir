...
public class RuntimeChildDeclaredExtensionDefinition extends RuntimeChildChoiceDefinition {
    ...
    /**
     * @param theBoundTypeBinder If the child is of a type that requires a constructor argument to
     *     instantiate, this is the argument to use
    ...
    public Object getInstanceConstructorArguments() {
        ...
        if (retVal == null && myEnumerationType != null) {
            retVal =
                    RuntimeChildPrimitiveEnumerationDatatypeDefinition.toEnumFactory(
                            myEnumerationType);
    ...
    public String getChildNameByDatatype(Class<? extends IBase> theDatatype) {
        ...
        if (retVal != null) {
            BaseRuntimeElementDefinition<?> childDef =
                    super.getChildElementDefinitionByDatatype(theDatatype);
    ...
    void sealAndInitialize(
        ...
        if (elementDef instanceof RuntimePrimitiveDatatypeDefinition
            ...
            // Per one of the examples here:
            // http://hl7.org/implement/standards/fhir/extensibility.html#extension
            //				myDatatypeChildName = "valueResource";
            //				List<Class<? extends IBaseResource>> types = new ArrayList<Class<? extends
            // IBaseResource>>();
