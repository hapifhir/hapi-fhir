 ...
 *
 * <p>Controls how bundles decide whether referenced resources should be included
 */
public enum BundleInclusionRule {

    /**
     * Decision is based on whether the resource's Include is in the IncludeSet (e.g.
     * DiagnosticReport.result). Note that the resource has to be populated to be included.
     *
    ...
    /**
     * Decision is based on whether the resource reference is set to a populated resource (in which
     * case its included) or just an id (in which case it's not included)
     *
     * <p>This is the original HAPI behavior
     */
