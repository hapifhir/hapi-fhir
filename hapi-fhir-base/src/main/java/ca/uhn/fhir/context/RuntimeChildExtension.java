...
public class RuntimeChildExtension extends RuntimeChildAny {
    ...
    //	@Override
    //	public BaseRuntimeElementDefinition<?> getChildElementDefinitionByDatatype(Class<? extends
    // IBase> theDatatype) {
    ...
    //
    //	@Override
    //	void sealAndInitialize(FhirContext theContext, Map<Class<? extends IBase>,
    // BaseRuntimeElementDefinition<?>> theClassToElementDefinitions) {
