...
public class RuntimeChildResourceDefinition extends BaseRuntimeDeclaredChildDefinition {
    ...
    void sealAndInitialize(
        ...
        //						RuntimeResourceDefinition nextDef = (RuntimeResourceDefinition)
        // nextEntry.getValue();
        ...
        //			else {
        //				RuntimeResourceDefinition nextDef = (RuntimeResourceDefinition)
        // theClassToElementDefinitions.get(next);
        //				if (nextDef == null) {
        //					throw new ConfigurationException(Msg.code(1691) + "Can't find child of type: " +
        // next.getCanonicalName() + " in " + getField().getDeclaringClass());
        //				}
        //				myValidChildNames.add(getElementName() + nextDef.getName());
        //			}
        //		}
