...
public class HapiLocalizer {
	...
	private static final org.slf4j.Logger ourLog =
				org.slf4j.LoggerFactory.getLogger(HapiLocalizer.class);
	...
	/**
	* @return Returns the raw message format string for the given key, or returns {@link
	*     #UNKNOWN_I18N_KEY_MESSAGE} if not found
	*/
	@SuppressWarnings("WeakerAccess")
		...
		if (formatString == null) {
				...
				if (ourFailOnMissingMessage) {
					throw new ConfigurationException(
								Msg.code(1908) + "Unknown localization key: " + theQualifiedKey);
				}
	...
	/**
	* This <b>global setting</b> causes the localizer to fail if any attempts are made to retrieve
	* a key that does not exist. This method is primarily for unit tests.
	*/
