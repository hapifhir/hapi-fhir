...
public class QuantityParam extends BaseParamWithPrefix<QuantityParam>
     ...
     * Constructor
     *
     * @param thePrefix The comparator, or <code>null</code> for an equals comparator
     * @param theValue A quantity value
     * @param theSystem The unit system
     * @param theUnits The unit code
     */
    public QuantityParam(
            ParamPrefixEnum thePrefix, BigDecimal theValue, String theSystem, String theUnits) {
        setPrefix(thePrefix);
        setValue(theValue);
        setSystem(theSystem);
        setUnits(theUnits);
     ...
     */
    public QuantityParam(
            ParamPrefixEnum thePrefix, double theValue, String theSystem, String theUnits) {
        setPrefix(thePrefix);
        setValue(theValue);
        setSystem(theSystem);
        setUnits(theUnits);
     ...
     */
    public QuantityParam(
            ParamPrefixEnum thePrefix, long theValue, String theSystem, String theUnits) {
        setPrefix(thePrefix);
        setValue(theValue);
        setSystem(theSystem);
        setUnits(theUnits);
     ...
     * Constructor
     *
     * @param theQuantity A quantity value (with no system or units), such as "100.0" or "gt4"
     */
     ...
     * Constructor
     *
     * @param theQuantity A quantity value (with no system or units), such as <code>100</code>
     */
     ...
     * Constructor
     *
     * @param theQuantity A quantity value (with no system or units), such as "100.0" or "&lt;=4"
     * @param theSystem The unit system
     * @param theUnits The unit code
     */
     ...
     *
     * <p>Note that prior to HAPI FHIR 1.5, this method returned a {@link UriDt}
     *
     * @since 1.5
     */
     ...
     *
     * <p>Note that prior to HAPI FHIR 1.5, this method returned a {@link DecimalDt}
     *
     * @since 1.5
     */
    ...
    public static QuantityParam toQuantityParam(IQueryParameterType theParam) {
        if (theParam instanceof BaseQuantityDt) {
            ...
            throw new IllegalArgumentException(
                    Msg.code(1948) + "Invalid quantity type: " + theParam.getClass());
        }
    }
}
