...
public enum RestSearchParameterTypeEnum {
     ...
     * Code Value: <b>date</b>
     *
     * <p>Search parameter is on a date/time. The date format is the standard XML format, though
     ...
     *
     * <p>Search parameter is a simple string, like a name part. Search is case-insensitive and
     ...
     *
     * <p>Search parameter on a coded element or identifier. May be used to search through the text,
     ...
     *
     * <p>A reference to another resource.
     */
    ...
    private static Map<String, RestSearchParameterTypeEnum> CODE_TO_ENUM =
            new HashMap<String, RestSearchParameterTypeEnum>();
    private static Map<String, Map<String, RestSearchParameterTypeEnum>> SYSTEM_TO_CODE_TO_ENUM =
            new HashMap<String, Map<String, RestSearchParameterTypeEnum>>();
        ...
        for (RestSearchParameterTypeEnum next : RestSearchParameterTypeEnum.values()) {
            ...
            if (!SYSTEM_TO_CODE_TO_ENUM.containsKey(next.getSystem())) {
                SYSTEM_TO_CODE_TO_ENUM.put(
                        next.getSystem(), new HashMap<String, RestSearchParameterTypeEnum>());
            }
    ...
    public static final IValueSetEnumBinder<RestSearchParameterTypeEnum> VALUESET_BINDER =
            new IValueSetEnumBinder<RestSearchParameterTypeEnum>() {
                ...
                @Override
                public RestSearchParameterTypeEnum fromCodeString(
                        String theCodeString, String theSystemString) {
                    Map<String, RestSearchParameterTypeEnum> map =
