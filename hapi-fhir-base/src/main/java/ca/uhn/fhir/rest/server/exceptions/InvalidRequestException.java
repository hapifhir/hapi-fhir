 ...
 * message was invalid (e.g. not a valid FHIR Resource per the specifications), as opposed to the
 * {@link UnprocessableEntityException} which indicates that data does not pass business rule
