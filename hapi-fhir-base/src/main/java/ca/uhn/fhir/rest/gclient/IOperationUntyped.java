...
public interface IOperationUntyped {
	...
	/**
	 * Use the given resource as the raw POST body of the operation, without wrapping it in a Parameters
	 * resource. This is useful for operations such as {@code $validate} that accept a resource directly
	 * as the request body.
	 *
	 * @param theResource The resource to send as the operation body. Must not be {@code null}.
	 */
	<T extends IBaseParameters> IOperationUntypedWithInputAndPartialOutput<T> withResource(IBaseResource theResource);
}
