 ...
 * rejected by the server because it "violated applicable FHIR profiles or server business rules".
 *
 * <p>This exception will generally contain an {@link IBaseOperationOutcome} instance which details
 * the failure.
 *
...
public class UnprocessableEntityException extends BaseServerResponseException {
    ...
    /**
     * Constructor which accepts an {@link IBaseOperationOutcome} resource which will be supplied in
     * the response
     *
    ...
    public UnprocessableEntityException(
        ...
        super(
                STATUS_CODE,
                OperationOutcomeUtil.getFirstIssueDetails(theCtx, theOperationOutcome),
                theOperationOutcome);
    }
    ...
    /**
     * Constructor which accepts an array of Strings describing the issue. This strings will be
     * translated into an {@link IBaseOperationOutcome} resource which will be supplied in the
     * response.
     */
    public UnprocessableEntityException(String... theMessage) {
        super(STATUS_CODE, theMessage);
