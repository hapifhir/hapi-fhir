...
public interface IGenericClient extends IRestfulClient {
    ...
    /**
     * Fluent method for the "delete" operation, which performs a logical delete on a server
     * resource
     */
    IDelete delete();
     ...
     *
     * @deprecated As of HAPI 3.0.0 this method has been deprecated, as the operation is now called
     *     "capabilities". Use {@link #capabilities()} instead
     */
    IFetchConformanceUntyped fetchConformance();

    /**
     * Force the client to fetch the server's conformance statement and validate that it is
     * appropriate for this client.
     *
     * @throws FhirClientConnectionException if the conformance statement cannot be read, or if the
     *     client
     * @throws FhirClientInappropriateForServerException If the conformance statement indicates that
     *     the server is inappropriate for this client (e.g. it implements the wrong version of
     *     FHIR)
     */
    ...
    /**
     * Fluent method for the "meta" operations, which can be used to get, add and remove tags and
     * other Meta elements from a resource or across the server.
     *
     * @since 1.1
     */
    IMeta meta();
    ...
    /**
     * Perform the "read" operation (retrieve the latest version of a resource instance by ID) using
     * an absolute URL.
     *
     * @param theType The resource type that is being retrieved
     * @param theUrl The absolute URL, e.g. "http://example.com/fhir/Patient/123"
    ...
    /**
     * Search for resources matching a given set of criteria. Searching is a very powerful feature
     * in FHIR with many features for specifying exactly what should be seaerched for and how it
     * should be returned. See the <a href="http://www.hl7.org/fhir/search.html">specification on
     * search</a> for more information.
     */
    <T extends IBaseBundle> IUntypedQuery<T> search();

    /**
     * If set to <code>true</code>, the client will log all requests and all responses. This is
     * probably not a good production setting since it will result in a lot of extra logging, but it
     * can be useful for troubleshooting.
     *
     * @param theLogRequestAndResponse Should requests and responses be logged
     * @deprecated Use LoggingInterceptor as a client interceptor registered to your client instead,
     *     as this provides much more fine-grained control over what is logged. This method will be
     *     removed at some point (deprecated in HAPI 1.6 - 2016-06-16)
     */
    @Deprecated
    ...
    /**
     * Remove an intercaptor that was previously registered using {@link
     * IRestfulClient#registerInterceptor(Object)}
     */
    @Override
     ...
     * @deprecated Use {@link #update() update() fluent method} instead (deprecated in HAPI FHIR
     *     3.0.0)
     */
    @Deprecated
     ...
     * @deprecated Use {@link #validate() validate() fluent method} instead (deprecated in HAPI FHIR
     *     3.0.0)
     */
    @Deprecated
    ...
    /**
     * Implementation of the "instance vread" method. Note that this method expects <code>theId
     * </code> to contain a resource ID as well as a version ID, and will fail if it does not.
     *
     * <p>Note that if an absolute resource ID is passed in (i.e. a URL containing a protocol and
     * host as well as the resource type and ID) the server base for the client will be ignored, and
     * the URL passed in will be queried.
     *
     * @param theType The type of resource to load
     * @param theId The ID to load, including the resource ID and the resource version ID. Valid
     *     values include "Patient/123/_history/222", or
     *     "http://example.com/fhir/Patient/123/_history/222"
     * @return The resource
     * @deprecated Use {@link #read() read() fluent method} instead (deprecated in HAPI FHIR 3.0.0)
     */
    @Deprecated
