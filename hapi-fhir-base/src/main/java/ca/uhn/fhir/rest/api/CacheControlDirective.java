...
public class CacheControlDirective {
	...
	/**
	* If the {@link #isNoStore() no-store} directive is set, this HAPI FHIR extention to the <code>
	* Cache-Control</code> header called <code>max-results=123</code> specified the maximum number
	* of results which will be fetched from the database before returning.
	*/
	...
	*/
	...
	/**
	* If <code>true<</code>, adds the <code>no-cache</code> directive to the request. This
	* directive indicates that the cache should not be used to serve this request.
	*/
