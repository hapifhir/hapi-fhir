...
/**
 * Represents an <b>HTTP 412 Precondition Failed</b> response. This exception should be thrown for
 * an {@link Update} operation if that operation requires a version to be specified in an HTTP
 * header, and none was.
 */
