...
/**
 * Represents an <b>HTTP 404 Resource Not Found</b> response, which means that the request is
 * pointing to a resource that does not exist.
 */
@CoverageIgnore
public class ResourceNotFoundException extends BaseServerResponseException {
    ...
    /**
     * @deprecated This doesn't make sense, since an identifier is not a resource ID and shouldn't
     *     generate a 404 if it isn't found - Should be removed
     */
    @Deprecated
