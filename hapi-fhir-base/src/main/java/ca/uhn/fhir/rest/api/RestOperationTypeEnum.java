...
public enum RestOperationTypeEnum {
    ...
    /** <b> Use this value with caution, this may change as the GraphQL interface matures </b> */
    ...
    private static final Map<String, RestOperationTypeEnum> CODE_TO_ENUM =
            new HashMap<String, RestOperationTypeEnum>();
    ...
    RestOperationTypeEnum(
            ...
            boolean theSystemLevel,
            boolean theTypeLevel,
            boolean theInstanceLevel) {
        myCode = theCode;
