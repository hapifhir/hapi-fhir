...
public interface IPatchExecutable extends IClientExecutable<IPatchExecutable, MethodOutcome> {
    ...
    /**
     * Add a <code>Prefer</code> header to the request, which requests that the server include or
     * suppress the resource body as a part of the result. If a resource is returned by the server
