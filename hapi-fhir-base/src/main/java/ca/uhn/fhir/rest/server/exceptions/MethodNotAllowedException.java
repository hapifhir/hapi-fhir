...
public class MethodNotAllowedException extends BaseServerResponseException {
     ...
     *     #setAllowedMethods(RequestTypeEnum...)} )
     */
    ...
    /**
     * Specifies the list of allowed HTTP methods (GET, POST, etc). This is provided in an <code>
     * Allow</code> header, as required by the HTTP specification (RFC 2616).
     */
