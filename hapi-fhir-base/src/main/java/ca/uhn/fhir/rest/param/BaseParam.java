...
public abstract class BaseParam implements IQueryParameterType {
    ...
    /**
     * Does this parameter type support chained parameters (only reference should return <code>true
     * </code> for this)
     */
    ...
    /**
     * If set to non-null value, indicates that this parameter has been populated with a
     * "[name]:missing=true" or "[name]:missing=false" value instead of a normal value
     *
