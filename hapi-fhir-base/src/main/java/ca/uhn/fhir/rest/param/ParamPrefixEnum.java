...
/**
 * Comparator/qualifier for values used in REST params, such as {@link DateParam}, {@link
 * NumberParam}, and {@link QuantityParam}
 *
 * @since 1.5
 */
public enum ParamPrefixEnum {
	...
	* Code Value: <b>eq</b>
	*
	* <p>The actual value is equal to the given value
	*/
	APPROXIMATE("ap"),
	...
	* Code Value: <b>eb</b>
	*
	* <p>The range of the search value does overlap not with the range of the target value, and the
	...
	* Code Value: <b>ne</b>
	*
	* <p>The actual value is not equal to the given value
	*/
	NOT_EQUAL("ne"),
	...
	* Code Value: <b>sa</b>
	*
	* <p>The range of the search value does not overlap with the range of the target value, and the
	...
	*/
	...
	/**
	* Returns the prefix associated with a given DSTU2+ value (e.g. <code>lt</code> or <code>eq
	* </code>)
	*
	* @param theValue e.g. <code>&lt;</code> or <code>~</code>
