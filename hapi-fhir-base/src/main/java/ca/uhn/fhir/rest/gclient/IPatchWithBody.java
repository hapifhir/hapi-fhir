...
public interface IPatchWithBody extends IPatchExecutable {
     ...
     *
     * @param theResourceType The resource type to patch (e.g. "Patient.class")
     */
     ...
     * Build a conditional URL using fluent constants on resource types
     *
     * @param theResourceType The resource type to patch (e.g. "Patient")
     */
    ...
    /**
     * The resource ID to patch (must include both a resource type and an ID, e.g. <code>Patient/123
     * </code>)
     */
