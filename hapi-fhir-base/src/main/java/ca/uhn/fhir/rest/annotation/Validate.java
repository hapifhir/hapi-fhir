 ...
 * href="http://hl7.org/implement/standards/fhir/http.html#validate">validate</a> method.
 *
 * <p>Validate is used to accept a resource, and test whether it would be acceptable for storing
 * (e.g. using an update or create method)
 *
 * <p><b>FHIR Version Note:</b> The validate operation was defined as a type operation in DSTU1
 * using a URL syntax like <code>http://example.com/Patient/_validate</code>. In DSTU2, validation
 * has been switched to being an extended operation using a URL syntax like <code>
 * http://example.com/Patient/$validate</code>, with a n
 */
