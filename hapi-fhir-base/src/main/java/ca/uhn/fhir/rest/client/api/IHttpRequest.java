...
public interface IHttpRequest {
    ...
    /**
     * @return all request headers in lower case. Note that this method returns an <b>immutable</b>
     *     Map
     */
    Map<String, List<String>> getAllHeaders();

    /**
     * Return the request body as a string. If this is not supported by the underlying technology,
     * null is returned
     *
