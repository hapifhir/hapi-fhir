...
/**
 * Represents an <b>HTTP 409 Conflict</b> response. This exception should be thrown in methods which
 * accept a version (e.g. {@link Update}, {@link Delete}) when the operation fails because of a
 * version conflict as specified in the FHIR specification.
 */
@CoverageIgnore
