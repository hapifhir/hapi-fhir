...
public class ReferenceParam extends BaseParam /*implements IQueryParameterType*/ {
	...
	*/
	...
	/**
	* Note that the parameter to this method <b>must</b> be a resource reference, e.g <code>123
	* </code> or <code>Patient/123</code> or <code>http://example.com/fhir/Patient/123</code> or
	* something like this. This is not appropriate for cases where a chain is being used and the
	* value is for a different type of parameter (e.g. a token). In that case, use one of the
	* setter constructors.
	*/
	...
	* {@link DateParam}. This is useful if you are using reference parameters and want to handle
	* chained parameters of different types in a single method.
	*
	* <p>See <a
	* href="https://hapifhir.io/hapi-fhir/docs/server_plain/rest_operations_search.html#chained-resource-references">Dynamic
	* Chains</a> in the HAPI FHIR documentation for an example of how to use this method.
	*/
	...
	/**
	* Returns a new param containing the same value as this param, but with the type copnverted to
	* {@link NumberParam}. This is useful if you are using reference parameters and want to handle
	* chained parameters of different types in a single method.
	*
	* <p>See <a
	* href="https://hapifhir.io/hapi-fhir/docs/server_plain/rest_operations_search.html#chained-resource-references">Dynamic
	...
	*/
	...
	/**
	* Returns a new param containing the same value as this param, but with the type copnverted to
	* {@link QuantityParam}. This is useful if you are using reference parameters and want to
	* handle chained parameters of different types in a single method.
	*
	* <p>See <a
	* href="https://hapifhir.io/hapi-fhir/docs/server_plain/rest_operations_search.html#chained-resource-references">Dynamic
	* Chains</a> in the HAPI FHIR documentation for an example of how to use this method.
	*/
	...
	/**
	* Returns a new param containing the same value as this param, but with the type copnverted to
	* {@link StringParam}. This is useful if you are using reference parameters and want to handle
	* chained parameters of different types in a single method.
	*
	* <p>See <a
	* href="https://hapifhir.io/hapi-fhir/docs/server_plain/rest_operations_search.html#chained-resource-references">Dynamic
	...
	*/
	...
	/**
	* Returns a new param containing the same value as this param, but with the type copnverted to
	* {@link TokenParam}. This is useful if you are using reference parameters and want to handle
	* chained parameters of different types in a single method.
	*
	* <p>See <a
	* href="https://hapifhir.io/hapi-fhir/docs/server_plain/rest_operations_search.html#chained-resource-references">Dynamic
