...
public final class QueryParameterTypeBinder extends BaseBinder<IQueryParameterType>
	...
	@Override
	public IQueryParameterType parse(FhirContext theContext, String theParamName, List<QualifiedParamList> theParams)
		...
		if (theParams.size() > 1 || theParams.get(0).size() > 1) {
			throw new InvalidRequestException(
					Msg.code(1962) + "Multiple values detected for non-repeatable parameter '" + theParamName
