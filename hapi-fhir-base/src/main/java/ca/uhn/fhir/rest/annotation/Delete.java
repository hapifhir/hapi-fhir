 ...
 * href="http://hl7.org/implement/standards/fhir/http.html#delete">delete</a> method.
 *
 * <p>Delete is used to remove an existing resource, meaning that any attempts to do a
 * non-version-specific read of that resource will fail.
 */
