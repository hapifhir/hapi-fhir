...
/**
 * This exception will be thrown by FHIR clients if the client attempts to communicate with a server
 * which is a valid FHIR server but is incompatible with this client for some reason.
 */
@CoverageIgnore
