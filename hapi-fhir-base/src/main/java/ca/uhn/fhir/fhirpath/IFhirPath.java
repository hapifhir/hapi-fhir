...
public interface IFhirPath {
	...
	*/
	...
	/**
	* Apply the given FhirPath expression against the given input and return the first match (if
	* any)
	*
	* @param theInput The input object (generally a resource or datatype)
	* @param thePath The fluent path expression
	...
	*/
	...
	/**
	* This method can be used optionally to supply an evaluation context for the FHIRPath evaluator
	* instance. The context can be used to supply data needed by specific functions, e.g. allowing
	* the <code>resolve()</code> function to fetch referenced resources.
	*
	* @since 6.4.0
	*/
