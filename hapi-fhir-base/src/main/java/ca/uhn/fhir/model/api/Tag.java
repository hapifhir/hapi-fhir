 ...
 * A single tag
 *
 * <p>Note on equality- When computing hashCode or equals values for this class, only the {@link
 * #getScheme() scheme} and
 */
public class Tag extends BaseElement implements IElement, IBaseCoding {
	...
	/**
	* @deprecated There is no reason to create a tag with a term and not a scheme, so this
