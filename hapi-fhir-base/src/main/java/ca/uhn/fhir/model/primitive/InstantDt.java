...
public class InstantDt extends BaseDateTimeDt {
    ...
    /**
     * Constructor which creates an InstantDt with <b>no timne value</b>. Note that unlike the
     * default constructor for the Java {@link Date} or {@link Calendar} objects, this constructor
     * does not initialize the object with the current time.
     *
     * @see #withCurrentTime() to create a new object that has been initialized with the current
     *     time.
     */
    public InstantDt() {
        super();
    ...
    /**
     * Create a new DateTimeDt using an existing value. <b>Use this constructor with caution</b>, as
     * it may create more precision than warranted (since for example it is possible to pass in a
     * DateTime with only a year, and this constructor will convert to an InstantDt with
    ...
    /**
     * Create a new DateTimeDt with the given date/time and {@link TemporalPrecisionEnum#MILLI}
     * precision
     */
     ...
     *
     * @param theString The string representation of the string. Must be in a valid format according
     ...
     *
     * @throws NullPointerException If the {@link #getValue() contained Date} is null
     */
    ...
    /**
     * Invokes {@link Date#before(Date)} on the contained Date against the given date
     *
     * @throws NullPointerException If the {@link #getValue() contained Date} is null
     */
    ...
    /**
     * Sets the value of this instant to the current time (from the system clock) and the
     * local/default timezone (as retrieved using {@link TimeZone#getDefault()}. This TimeZone is
     * generally obtained from the underlying OS.
     */
    ...
    /**
     * Factory method which creates a new InstantDt with millisecond precision and initializes it
     * with the current time and the system local timezone.
     */
