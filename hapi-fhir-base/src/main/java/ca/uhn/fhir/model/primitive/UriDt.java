...
public class UriDt extends BasePrimitive<String> {
	...
	/**
	* Compares the given string to the string representation of this URI. In many cases it is
	* preferable to use this instead of the standard {@link #equals(Object)} method, since that
	* method returns <code>false</code> unless it is passed an instance of {@link UriDt}
	*/
	...
	/**
	* Creates a new UriDt instance which uses the given OID as the content (and prepends "urn:oid:"
	* to the OID string in the value of the newly created UriDt, per the FHIR specification).
	*
	* @param theOid The OID to use (<code>null</code> is acceptable and will result in a UriDt
	*     instance with a <code>null</code> value)
