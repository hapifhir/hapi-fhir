...
public class TagList implements Set<Tag>, Serializable, IBase {
    ...
    /**
     * @deprecated Tags wil become immutable in a future release of HAPI, so {@link #addTag(String,
     *     String, String)} should be used instead
     */
    @Deprecated
    public Tag addTag() {
        myOrderedTags = null;
     ...
     *
     * @param theScheme The tag scheme (the system)
     * @param theTerm The tag term (the code)
     * @return Returns the newly created tag instance. Note that the tag is added to the list by
     *     this method, so you generally do not need to interact directly with the added tag.
     */
     ...
     * Add a new tag instance
     *
     * @param theScheme The tag scheme
     * @param theTerm The tag term
     * @param theLabel The tag label
     * @return Returns the newly created tag instance. Note that the tag is added to the list by
     *     this method, so you generally do not need to interact directly with the added tag.
     */
    ...
    /**
     * Returns the tag at a given index - Note that the TagList is backed by a {@link
     * LinkedHashSet}, so the order of added tags will be consistent, but duplicates will not be
     * preserved.
     */
