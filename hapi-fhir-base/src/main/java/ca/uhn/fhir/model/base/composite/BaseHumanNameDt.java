...
public abstract class BaseHumanNameDt extends BaseIdentifiableElement {
	...
	/**
	* Gets the value(s) for <b>family</b> (Family name (often called 'Surname')). creating it if it
	* does not exist. Will not return <code>null</code>.
	*
	* <p><b>Definition:</b> The part of a name that links to the genealogy. In some cultures (e.g.
	...
	*/
	...
	/**
	* Gets the value(s) for <b>prefix</b> (Parts that come before the name). creating it if it does
	* not exist. Will not return <code>null</code>.
	*
	* <p><b>Definition:</b> Part of the name that is acquired as a title due to academic, legal,
	...
	*/
	...
	/**
	* Gets the value(s) for <b>suffix</b> (Parts that come after the name). creating it if it does
	* not exist. Will not return <code>null</code>.
	*
	* <p><b>Definition:</b> Part of the name that is acquired as a title due to academic, legal,
	...
	*/
	...
	/**
	* Gets the value(s) for <b>text</b> (Text representation of the full name). creating it if it
	* does not exist. Will not return <code>null</code>.
	*
	* <p><b>Definition:</b> A full text representation of the name
	*/
	...
	*/
	...
	/**
	* Returns all of the components of the name (prefix, given, family, suffix) as a single string
	* with a single spaced string separating each part.
	*
	* <p>If none of the parts are populated, returns the {@link #getTextElement() text} element
	* value instead.
	*/
