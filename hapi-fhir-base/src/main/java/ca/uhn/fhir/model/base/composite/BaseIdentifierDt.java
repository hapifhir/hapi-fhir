...
public abstract class BaseIdentifierDt extends BaseIdentifiableElement
	...
	/**
	* Gets the value(s) for <b>system</b> (The namespace for the identifier). creating it if it
	* does not exist. Will not return <code>null</code>.
	*
	* <p><b>Definition:</b> Establishes the namespace in which set of possible id values is unique.
	*/
	public abstract UriDt getSystemElement();

	/**
	* Gets the value(s) for <b>value</b> (The value that is unique). creating it if it does not
	* exist. Will not return <code>null</code>.
	*
	* <p><b>Definition:</b> The portion of the identifier typically displayed to the user and which
	...
	*/
	...
	/**
	* Returns true if <code>this</code> identifier has the same {@link #getValueElement() value}
	* and {@link #getSystemElement() system} (as compared by simple equals comparison). Does not
	* compare other values (e.g. getUse()) or any extensions.
	*/
	...
	* <b>Not supported!</b>
	*
	* @deprecated get/setMissing is not supported in StringDt. Use {@link StringParam} instead if
