...
public enum BundleEntrySearchModeEnum {
    ...
    private static Map<String, BundleEntrySearchModeEnum> CODE_TO_ENUM =
            new HashMap<String, BundleEntrySearchModeEnum>();
    private static Map<String, Map<String, BundleEntrySearchModeEnum>> SYSTEM_TO_CODE_TO_ENUM =
            new HashMap<String, Map<String, BundleEntrySearchModeEnum>>();
        ...
        for (BundleEntrySearchModeEnum next : BundleEntrySearchModeEnum.values()) {
            ...
            if (!SYSTEM_TO_CODE_TO_ENUM.containsKey(next.getSystem())) {
                SYSTEM_TO_CODE_TO_ENUM.put(
                        next.getSystem(), new HashMap<String, BundleEntrySearchModeEnum>());
            }
    ...
    public static final IValueSetEnumBinder<BundleEntrySearchModeEnum> VALUESET_BINDER =
            new IValueSetEnumBinder<BundleEntrySearchModeEnum>() {
                ...
                @Override
                public BundleEntrySearchModeEnum fromCodeString(
                        String theCodeString, String theSystemString) {
                    Map<String, BundleEntrySearchModeEnum> map =
