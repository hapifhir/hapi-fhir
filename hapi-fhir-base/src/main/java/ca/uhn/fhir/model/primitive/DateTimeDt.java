...
public class DateTimeDt extends BaseDateTimeDt {
    ...
    /**
     * Constructor which accepts a date value, precision value, and time zone. Valid precisions
    ...
    /**
     * Returns a new instance of DateTimeDt with the current system time and SECOND precision and
