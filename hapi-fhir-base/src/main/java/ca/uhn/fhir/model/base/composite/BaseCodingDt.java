...
public abstract class BaseCodingDt extends BaseIdentifiableElement
    ...
    */
    ...
    /**
     * Returns true if <code>this</code> Coding has the same {@link #getCodeElement() Code} and
     * {@link #getSystemElement() system} (as compared by simple equals comparison). Does not
     * compare other Codes (e.g. getUseElement()) or any extensions.
     */
    ...
    /**
     * returns true if <code>this</code> Coding matches a search for the coding specified by <code>
     * theSearchParam</code>, according to the following:
     *
     * <ul>
     *   <li>[parameter]=[namespace]|[code] matches a code/value in the given system namespace
     *   <li>[parameter]=[code] matches a code/value irrespective of it's system namespace
     *   <li>[parameter]=|[code] matches a code/value that has no system namespace
     * </ul>
     *
    ...
    public boolean matchesToken(BaseCodingDt theSearchParam) {
        if (theSearchParam.isSystemPresent()) {
            if (theSearchParam.isSystemBlank()) {
                ...
                //  [parameter]=[namespace]|[code] matches a code/value in the given system
                // namespace
     ...
     * <b>Not supported!</b>
     *
     * @deprecated get/setMissing is not supported in StringDt. Use {@link TokenParam} instead if
