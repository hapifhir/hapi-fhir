...
public abstract class BaseElement implements /*IElement, */ ISupportsUndeclaredExtensions {
	...
	@Description(
				...
				formalDefinition =
						"May be used to represent additional information that is not part of the basic"
								+ " definition of the resource. In order to make the use of extensions safe"
	...
	* the resource, and that modifies the understanding of the element that contains it. Usually
	* modifier elements provide negation or qualification. In order to make the use of extensions
	* safe and manageable, there is a strict set of governance applied to the definition and use of
	...
	*/
	...
	@Description(
				...
				formalDefinition =
						"May be used to represent additional information that is not part of the basic"
								...
								+ " qualification. In order to make the use of extensions safe and"
	...
	@Override
	public ExtensionDt addUndeclaredExtension(
	...
	/**
	* Intended to be called by extending classes {@link #isEmpty()} implementations, returns <code>
	* true</code> if all content in this superclass instance is empty per the semantics of {@link
	* #isEmpty()}.
	*/
