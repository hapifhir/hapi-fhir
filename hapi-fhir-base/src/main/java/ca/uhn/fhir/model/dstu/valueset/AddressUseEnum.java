...
public enum AddressUseEnum
{
  ...
  static
  {
    for (final AddressUseEnum next : AddressUseEnum.values())
    {
   ...
   */
  public AddressUseEnum forCode(final String theCode)
  {
    final AddressUseEnum retVal = CODE_TO_ENUM.get(theCode);
    return retVal;
  }
  ...
  public static final IValueSetEnumBinder<AddressUseEnum> VALUESET_BINDER = new IValueSetEnumBinder<AddressUseEnum>()
  {
    ...
    @Override
    public String toCodeString(final AddressUseEnum theEnum)
    {
    ...
    @Override
    public String toSystemString(final AddressUseEnum theEnum)
    {
    ...
    @Override
    public AddressUseEnum fromCodeString(final String theCodeString)
    {
    ...
    @Override
    public AddressUseEnum fromCodeString(final String theCodeString, final String theSystemString)
    {
      final Map<String, AddressUseEnum> map = SYSTEM_TO_CODE_TO_ENUM.get(theSystemString);
      if (map == null)
      {
        return null;
      }
   ...
   * Constructor
   */
  AddressUseEnum(final String theCode, final String theSystem)
  {
    this.myCode = theCode;
