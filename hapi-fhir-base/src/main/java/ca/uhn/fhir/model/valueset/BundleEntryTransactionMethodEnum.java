 ...
 * ca.uhn.fhir.model.api.Bundle</code>) on a DSTU2 server. It is preferably to use the new DSTU2
 * Bundle (<code>ca.uhn.fhir.model.dstu2.resource.Bundle</code>) for this purpose.
 */
@CoverageIgnore
