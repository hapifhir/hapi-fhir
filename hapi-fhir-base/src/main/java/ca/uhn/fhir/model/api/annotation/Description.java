...
/**
 * Annotation which may be placed on a resource/datatype definition, or a field, or a search
 * parameter definition in order to provide documentation for that item.
 */
