...
public class BoundCodeDt<T extends Enum<?>> extends CodeDt {
	...
	/**
	* @deprecated This constructor is provided only for serialization support. Do not call it
	*     directly!
	*/
	@Deprecated
	public BoundCodeDt() {
	...
	public T getValueAsEnum() {
		Validate.notNull(
					myBinder,
					"This object does not have a binder. Constructor BoundCodeDt() should not be"
								+ " called!");
