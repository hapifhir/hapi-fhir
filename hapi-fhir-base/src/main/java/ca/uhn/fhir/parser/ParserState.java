...
class ParserState<T> {
    ...
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(ParserState.class);
    ...
    boolean isToplevelResourceElement() {
        return myState instanceof ParserState.ResourceStateHl7Org
                || myState instanceof ParserState.ResourceStateHapi;
    }
    ...
    /**
     * Invoked after any new XML event is individually processed, containing a copy of the XML
     * event. This is basically intended for embedded XHTML content
     */
    ...
    public ICompositeType newCompositeInstance(
        ...
        ICompositeType retVal =
                (ICompositeType)
                        theCompositeTarget.newInstance(theChild.getInstanceConstructorArguments());
    ...
    private abstract class BaseState {
         ...
         */
        public void enteringNewElement(String theNamespaceUri, String theLocalPart)
        ...
        public void enteringNewElementExtension(
                ...
                boolean theIsModifier,
                final String baseServerUrl) {
            if (myPreResourceState != null
                    && getCurrentElement() instanceof ISupportsUndeclaredExtensions) {
                ExtensionDt newExtension = new ExtensionDt(theIsModifier);
                newExtension.setUrl(theUrlAttr);
                ISupportsUndeclaredExtensions elem =
                        (ISupportsUndeclaredExtensions) getCurrentElement();
                ...
                if (theIsModifier == false) {
                    if (getCurrentElement() instanceof IBaseHasExtensions) {
                        IBaseExtension<?, ?> ext =
                                ((IBaseHasExtensions) getCurrentElement()).addExtension();
                        ext.setUrl(theUrlAttr);
                        ParserState<T>.ExtensionState newState =
                    ...
                    if (getCurrentElement() instanceof IBaseHasModifierExtensions) {
                        IBaseExtension<?, ?> ext =
                                ((IBaseHasModifierExtensions) getCurrentElement())
    ...
    private class ContainedResourcesStateHapi extends BasePreResourceState {
        ...
        public ContainedResourcesStateHapi(BasePreResourceState thePreResourcesState) {
            super(
                    thePreResourcesState,
                    thePreResourcesState.myInstance.getStructureFhirVersionEnum());
        }
        ...
        public void wereBack() {
            ...
            if (res.getId() == null || res.getId().isEmpty()) {
                // If there is no ID, we don't keep the resource because it's useless (contained
                // resources
                ...
                getPreResourceState()
                        ...
                        .put(res.getId().getValueAsString(), res);
            }
    ...
    private class DeclaredExtensionState extends BaseState {
                ...
                case COMPOSITE_DATATYPE:
                    {
                        ...
                        ICompositeType newChildInstance =
                                newCompositeInstance(
                                        getPreResourceState(), myDefinition, compositeTarget);
                        myDefinition.getMutator().addValue(myParentInstance, newChildInstance);
                        ElementCompositeState newState =
                                new ElementCompositeState(
                                        myPreResourceState,
                                        theLocalPart,
                                        compositeTarget,
                                        newChildInstance);
                ...
                case PRIMITIVE_DATATYPE:
                    {
                        ...
                        IPrimitiveType<?> newChildInstance =
                                newPrimitiveInstance(myDefinition, primitiveTarget);
                        myDefinition.getMutator().addValue(myParentInstance, newChildInstance);
                        PrimitiveState newState =
                                new PrimitiveState(
                                        getPreResourceState(),
                                        newChildInstance,
                                        theLocalPart,
        ...
        public void enteringNewElementExtension(
            ...
            if (declaredExtension != null) {
                ...
                BaseState newState =
                        new DeclaredExtensionState(
                                getPreResourceState(), declaredExtension, myChildInstance);
                push(newState);
            } else {
                super.enteringNewElementExtension(
                        theElement, theUrlAttr, theIsModifier, baseServerUrl);
            }
        }
    ...
    private class ElementCompositeState extends BaseState {
        ...
        @Override
        public void enteringNewElement(String theNamespace, String theChildName)
                throws DataFormatException {
            BaseRuntimeChildDefinition child = myDefinition.getChildByName(theChildName);
            if (child == null) {
                if (theChildName.equals("id")) {
                    if (getCurrentElement() instanceof IIdentifiableElement) {
                        push(
                                new IdentifiableElementIdState(
                                        getPreResourceState(),
                                        (IIdentifiableElement) getCurrentElement()));
                        return;
                    }
                }
            ...
            if (target == null) {
                ...
                throw new DataFormatException(
                        Msg.code(1809)
                                + "Found unexpected element '"
                                + theChildName
                                + "' in parent element '"
                                + myDefinition.getName()
                                + "'. Valid names are: "
                                + child.getValidChildNames());
            }
            ...
            switch (target.getChildType()) {
                case COMPOSITE_DATATYPE:
                    {
                        ...
                        ParserState<T>.ElementCompositeState newState =
                                new ElementCompositeState(
                                        getPreResourceState(),
                                        theChildName,
                                        compositeTarget,
                ...
                case PRIMITIVE_DATATYPE:
                    {
                        ...
                        IPrimitiveType<?> newChildInstance;
                        newChildInstance =
                                getPrimitiveInstance(child, primitiveTarget, theChildName);
                        child.getMutator().addValue(myInstance, newChildInstance);
                        PrimitiveState newState =
                                new PrimitiveState(
                                        getPreResourceState(),
                ...
                case RESOURCE_BLOCK:
                    {
                        RuntimeResourceBlockDefinition blockTarget =
                                (RuntimeResourceBlockDefinition) target;
                ...
                case CONTAINED_RESOURCES:
                    {
                        ...
                        if (values == null || values.isEmpty() || values.get(0) == null) {
                            Object newDt =
                                    newContainedDt((IResource) getPreResourceState().myInstance);
                            child.getMutator().addValue(myInstance, (IBase) newDt);
                        }
                        ContainedResourcesStateHapi state =
                                new ContainedResourcesStateHapi(getPreResourceState());
                        push(state);
                        return;
                    }
                case CONTAINED_RESOURCE_LIST:
                    {
                        ContainedResourcesStateHl7Org state =
                                new ContainedResourcesStateHl7Org(getPreResourceState());
                        push(state);
                        return;
                    }
                case RESOURCE:
            ...
            throw new DataFormatException(
                    Msg.code(1810) + "Illegal resource position: " + target.getChildType());
        }
        ...
        public void enteringNewElementExtension(
            ...
            if (declaredExtension != null) {
                BaseState newState =
                        new DeclaredExtensionState(
                                getPreResourceState(), declaredExtension, myInstance);
                push(newState);
            } else {
                super.enteringNewElementExtension(
                        theElement, theUrlAttr, theIsModifier, baseServerUrl);
    ...
    private class ExtensionState extends BaseState {
        ...
        ExtensionState(
                BasePreResourceState thePreResourceState, IBaseExtension<?, ?> theExtension) {
            super(thePreResourceState);
        ...
        public void attributeValue(String theName, String theValue) throws DataFormatException {
            if ("url".equals(theName)) {
                // The URL attribute is handles in the XML loop as a special case since it is "url"
                // instead
        ...
        public void enteringNewElement(String theNamespaceUri, String theLocalPart)
            ...
            if (theLocalPart.equals("id")) {
                if (getCurrentElement() instanceof IBaseElement) {
                    push(
                            new ElementIdState(
                                    getPreResourceState(), (IBaseElement) getCurrentElement()));
                    return;
                } else if (getCurrentElement() instanceof IIdentifiableElement) {
                    push(
                            new IdentifiableElementIdState(
                    ...
                    case COMPOSITE_DATATYPE:
                        {
                            BaseRuntimeElementCompositeDefinition<?> compositeTarget =
                                    (BaseRuntimeElementCompositeDefinition<?>) target;
                            ICompositeType newChildInstance =
                                    newCompositeTypeInstance(
                                            getPreResourceState(), compositeTarget);
    ...
    public class IdentifiableElementIdState extends BaseState {
        ...
        public IdentifiableElementIdState(
                BasePreResourceState thePreResourceState, IIdentifiableElement theElement) {
            super(thePreResourceState);
            myElement = theElement;
        }
    ...
    private class MetaElementState extends BaseState {
        ...
        public MetaElementState(
                BasePreResourceState thePreResourceState, ResourceMetadataMap theMap) {
            super(thePreResourceState);
            myMap = theMap;
        }
        ...
        public void enteringNewElement(String theNamespaceUri, String theLocalPart)
            ...
            switch (theLocalPart) {
                ...
                case "lastUpdated":
                    ...
                    push(
                            new PrimitiveState(
                                    getPreResourceState(), updated, theLocalPart, "instant"));
                    myMap.put(ResourceMetadataKeyEnum.UPDATED, updated);
                    break;
                case "security":
                    @SuppressWarnings("unchecked")
                    List<IBase> securityLabels =
                            (List<IBase>) myMap.get(ResourceMetadataKeyEnum.SECURITY_LABELS);
                    ...
                    BaseRuntimeElementCompositeDefinition<?> codinfDef =
                            (BaseRuntimeElementCompositeDefinition<?>)
                                    myContext.getElementDefinition(securityLabel.getClass());
                    push(
                            new SecurityLabelElementStateHapi(
                                    getPreResourceState(), codinfDef, securityLabel));
                ...
                case "profile":
                    ...
                    myMap.put(
                            ...
                            Collections.unmodifiableList(newProfiles));
                    break;
                case "tag":
        ...
        public void enteringNewElementExtension(
            ...
            if (metadataValue == null) {
                ...
                throw new IllegalStateException(
                        Msg.code(1812)
                                + "Expected ExtensionDt as custom resource metadata type, got: "
    ...
    private abstract class BasePreResourceState extends BaseState {
        ...
        BasePreResourceState(
                BasePreResourceState thePreResourcesState, FhirVersionEnum theParentVersion) {
        ...
        public void enteringNewElement(String theNamespaceUri, String theLocalPart)
                ...
                if ((definition == null)) {
                    throw new DataFormatException(
                            Msg.code(1813)
                                    + "Element '"
                                    + theLocalPart
                                    + "' is not a known resource type, expected a resource at this"
                                    + " position");
                }
            } else {
            ...
            if (!definition.getName().equals(theLocalPart)
                ...
                throw new DataFormatException(
                        Msg.code(1815)
                                ...
                                + theLocalPart
                                + "': Resource names are case sensitive, found similar name: '"
                                + definition.getName()
                                + "'");
            }
            ...
            if (myInstance instanceof IResource) {
                push(
                        new ResourceStateHapi(
                                getRootPreResourceState(),
                                def,
                                (IResource) myInstance,
        ...
        private void postProcess() {
            if (myContext.hasDefaultTypeForProfile()) {
                ...
                if (wantedProfileType != null && !wantedProfileType.equals(myInstance.getClass())) {
                    if (myResourceType == null
                            || myResourceType.isAssignableFrom(wantedProfileType)) {
                        ourLog.debug(
                        ...
                        myGlobalReferences.removeAll(
                                t.getAllPopulatedChildElementsOfType(
                                        myInstance, IBaseReference.class));
            ...
            if (bundle) {
                ...
                for (IBase nextEntry : entries) {
                    IPrimitiveType<?> fullUrl =
                            t.getSingleValueOrNull(nextEntry, "fullUrl", IPrimitiveType.class);
                    if (fullUrl != null && isNotBlank(fullUrl.getValueAsString())) {
                        IBaseResource resource =
                                t.getSingleValueOrNull(nextEntry, "resource", IBaseResource.class);
                        if (resource != null) {
                ...
                for (IBaseReference nextRef : myGlobalReferences) {
                    if (!nextRef.isEmpty() && nextRef.getReferenceElement() != null) {
                        ...
                        IBaseResource target =
                                idToResource.get(unqualifiedVersionless.getValueAsString());
                        // resource can already be filled with local contained resource by
                        // populateTarget()
                ...
                List<Pair<String, IBaseResource>> urlsAndResources =
                        BundleUtil.getBundleEntryUrlsAndResources(
                                myContext, (IBaseBundle) myInstance);
                    ...
                    if (StringUtils.isNotBlank(versionId)) {
                        elem.getIdElement()
                                .setValue(
                                        resourceName
                                                + "/"
                                                + elem.getIdElement().getIdPart()
                                                + "/_history/"
                                                + versionId);
                    } else {
                        elem.getIdElement()
                                .setValue(resourceName + "/" + elem.getIdElement().getIdPart());
                    }
                }
            }
        }
    ...
    private class PreTagListState extends BaseState {
        ...
        public void enteringNewElement(String theNamespaceUri, String theLocalPart)
            ...
            if (!TagList.ELEMENT_NAME_LC.equals(theLocalPart.toLowerCase())) {
                throw new DataFormatException(
                        Msg.code(1816)
                                + "resourceType does not appear to be 'TagList', found: "
                                + theLocalPart);
            }
            ...
            if ("value".equals(theName)) {
                if ("".equals(value)) {
                    ...
                    myErrorHandler.invalidValue(
                            location, value, "Attribute value must not be empty (\"\")");
                } else {
                ...
                if (myInstance instanceof IIdentifiableElement) {
                    ...
                    new IdDt(value)
                            .applyTo((org.hl7.fhir.instance.model.api.IBaseResource) myInstance);
                } else {
                    ParseLocation location = ParseLocation.fromElementName(myChildName);
    ...
    private class ResourceStateHapi extends ElementCompositeState {
        ...
        public void enteringNewElement(String theNamespace, String theChildName)
            ...
            if ("id".equals(theChildName)) {
                push(
                        new PrimitiveState(
                                getPreResourceState(), myInstance.getId(), theChildName, "id"));
    ...
    private class TagListState extends BaseState {
        ...
        public void enteringNewElement(String theNamespaceUri, String theLocalPart)
            ...
            if (TagList.ATTR_CATEGORY.equals(theLocalPart)) {
                ...
                throw new DataFormatException(
                        Msg.code(1817) + "Unexpected element: " + theLocalPart);
            }
        }
    ...
    private class TagState extends BaseState {
        ...
        public void enteringNewElement(String theNamespaceUri, String theLocalPart)
            ...
            if (Tag.ATTR_TERM.equals(theLocalPart) || "code".equals(theLocalPart)) {
                ...
                throw new DataFormatException(
                        Msg.code(1818) + "Unexpected element: " + theLocalPart);
            }
        }
    }
    ...
    private class XhtmlStateHl7Org extends XhtmlState {
        ...
        private XhtmlStateHl7Org(
                BasePreResourceState thePreResourceState, IBaseXhtml theHl7OrgDatatype) {
    ...
    static <T extends IBaseResource> ParserState<T> getPreResourceInstance(
            ...
            IParserErrorHandler theErrorHandler)
            throws DataFormatException {
        ParserState<T> retVal =
                new ParserState<T>(theParser, theContext, theJsonMode, theErrorHandler);
        if (theResourceType == null) {
    ...
    static ParserState<TagList> getPreTagListInstance(
            ...
            boolean theJsonMode,
            IParserErrorHandler theErrorHandler) {
        ParserState<TagList> retVal =
                new ParserState<TagList>(theParser, theContext, theJsonMode, theErrorHandler);
