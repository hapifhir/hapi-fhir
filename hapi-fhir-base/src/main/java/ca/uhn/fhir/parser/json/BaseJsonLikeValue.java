...
/**
 * This is the generalization of anything that is a "value" element in a JSON structure. This could
 * be a JSON object, a JSON array, a scalar value (number, string, boolean), or a null.
 */
public abstract class BaseJsonLikeValue {
	...
	public static final BaseJsonLikeValue NULL =
				new BaseJsonLikeValue() {
					@Override
	...
	public static final BaseJsonLikeValue TRUE =
				new BaseJsonLikeValue() {
					@Override
					public ValueType getJsonType() {
	...
	public static final BaseJsonLikeValue FALSE =
				new BaseJsonLikeValue() {
					@Override
					public ValueType getJsonType() {
						return ValueType.SCALAR;
