...
public class XmlParserTest
{
  ...
  public void testEncodeBinaryResource()
  {
    ...
    final String val = ourCtx.newXmlParser().encodeResourceToString(patient);
  ...
  public void testEncodeBundle() throws InterruptedException
  {
    ...
    final String bundleString = ourCtx.newXmlParser().setPrettyPrint(true).encodeBundleToString(b);
    ourLog.info(bundleString);

    final List<String> strings = new ArrayList<String>();
    strings.addAll(Arrays.asList("<published>", pub.getValueAsString(), "</published>"));
    strings
        .add("<category term=\"http://hl7.org/fhir/tag/message\" label=\"Message\" scheme=\"http://hl7.org/fhir/tag\"/>");
    strings.addAll(Arrays.asList("<entry>", "<id>1</id>", "</entry>"));
    strings.addAll(Arrays.asList("<entry>", "<id>2</id>", "<link rel=\"alternate\" href=\"http://foo/bar\"/>",
        "<link rel=\"search\" href=\"http://foo/bar/search\"/>", "</entry>"));
  ...
  public void testEncodeBundleCategory()
  {
    ...
    final String val = ourCtx.newXmlParser().setPrettyPrint(true).encodeBundleToString(b);
    ourLog.info(val);
  ...
  public void testEncodeBundleResultCount()
  {
    ...
    assertThat(val,
        StringContains
            .containsString("<os:totalResults xmlns:os=\"http://a9.com/-/spec/opensearch/1.1/\">123</os:totalResults>"));
  ...
  public void testEncodeContainedAndIncludedResources()
  {
    ...
    final IParser p = ourCtx.newXmlParser().setPrettyPrint(true);
  ...
  public void testEncodeContainedResources()
  {
    ...
    final int idx = str.indexOf("reference value=\"#") + "reference value=\"#".length();
  ...
  public void testEncodeDeclaredExtensionWithResourceContent()
  {
    ...
    assertThat(
        val,
        StringContains
            .containsString("<extension url=\"urn:foo\"><valueResource><reference value=\"Organization/123\"/></valueResource></extension>"));
  ...
  public void testEncodePrettyPrint() throws DataFormatException
  {
    ...
    final Patient patient = new Patient();
    patient.getText().getDiv()
        .setValueAsString("<div>\n  <i>  hello     <pre>\n  LINE1\n  LINE2</pre></i>\n\n\n\n</div>");
  ...
  public void testEncodeQuery()
  {
    ...
    final String val = ourCtx.newXmlParser().encodeResourceToString(q);
    ourLog.info(val);

    assertEquals(
        "<Query xmlns=\"http://hl7.org/fhir\"><parameter url=\"http://foo\"><valueString value=\"bar\"/></parameter></Query>",
        val);
  ...
  public void testEncodeResourceRef() throws DataFormatException
  {
    ...
    final ResourceReferenceDt ref = new ResourceReferenceDt();
    ...
    assertThat(
        str,
        StringContains
            .containsString("<managingOrganization><reference value=\"Organization/123\"/><display value=\"DISPLAY!\"/></managingOrganization>"));
  ...
  public void testExtensionOnComposite() throws Exception
  {
    ...
    final String output = ourCtx.newXmlParser().setPrettyPrint(true).encodeResourceToString(patient);
    ourLog.info(output);

    final String enc = ourCtx.newXmlParser().encodeResourceToString(patient);
    assertThat(
        enc,
        containsString("<name><extension url=\"http://examples.com#givenext\"><valueString value=\"Hello\"/></extension><family value=\"Shmoe\"/><given value=\"Joe\"/></name>"));

    final Patient parsed = ourCtx.newXmlParser().parseResource(Patient.class, new StringReader(enc));
  ...
  public void testExtensionOnPrimitive() throws Exception
  {
    ...
    assertThat(
        enc,
        containsString("<name><family value=\"Shmoe\"><extension url=\"http://examples.com#givenext\"><valueString value=\"Hello\"/></extension></family></name>"));
  ...
  public void testExtensions() throws DataFormatException
  {
    ...
    final MyPatient patient = new MyPatient();
    ...
    assertThat(
        str,
        StringContains
            .containsString("<extension url=\"http://example.com/dontuse#petname\"><valueString value=\"Fido\"/></extension>"));
    assertThat(
        str,
        StringContains
            .containsString("<modifierExtension url=\"http://example.com/dontuse#importantDates\"><valueDateTime value=\"2010-01-02\"/></modifierExtension>"));
    assertThat(
        str,
        StringContains
            .containsString("<modifierExtension url=\"http://example.com/dontuse#importantDates\"><valueDateTime value=\"2014-01-26T11:11:11\"/></modifierExtension>"));
  ...
  public void testLoadAndAncodeMessage() throws SAXException, IOException
  {
    ...
    final Patient patient = ourCtx.newXmlParser().parseResource(Patient.class, msg);

    assertEquals(NarrativeStatusEnum.GENERATED, patient.getText().getStatus().getValueAsEnum());
    assertEquals("<div xmlns=\"http://www.w3.org/1999/xhtml\">John Cardinal:            444333333        </div>",
        patient.getText().getDiv().getValueAsString());
    assertEquals("PRP1660", patient.getIdentifier().get(0).getValue().getValueAsString());

    final String encoded = ourCtx.newXmlParser().encodeResourceToString(patient);

    final Diff d = new Diff(new StringReader(msg), new StringReader(encoded));
  ...
  @Test
  public void testLoadAndEncodeDeclaredExtensions() throws ConfigurationException, DataFormatException, SAXException,
      IOException
  {
    final IParser p = new FhirContext(ResourceWithExtensionsA.class).newXmlParser();

    // @formatter:off
    final String msg = "<ResourceWithExtensionsA xmlns=\"http://hl7.org/fhir\">\n"
    ...
    final ResourceWithExtensionsA resource = (ResourceWithExtensionsA) p.parseResource(msg);
    ...
    final String encoded = p.encodeResourceToString(resource);
    ourLog.info(encoded);
  ...
  @Test
  public void testLoadAndEncodeUndeclaredExtensions() throws ConfigurationException, DataFormatException, SAXException,
      IOException
  {
    final IParser p = ourCtx.newXmlParser();
    ...
    final Patient resource = (Patient) p.parseResource(msg);
    assertEquals("IdentifierLabel", resource.getIdentifier().get(0).getLabel().getValue());
    ...
    assertEquals("Foo2Value1", resource.getUndeclaredModifierExtensions().get(0).getValueAsPrimitive()
        .getValueAsString());

    assertEquals("2013-01-01", resource.getUndeclaredExtensions().get(2).getUndeclaredExtensions().get(0)
        .getValueAsPrimitive().getValueAsString());
    assertEquals("2013-01-02", resource.getUndeclaredExtensions().get(2).getUndeclaredExtensions().get(1)
        .getUndeclaredExtensions().get(0).getValueAsPrimitive().getValueAsString());
  ...
  public void testLoadObservation() throws ConfigurationException, DataFormatException, IOException
  {
    ...
    final String string = IOUtils.toString(XmlParserTest.class.getResourceAsStream("/observation-example-eeg.xml"));
    final IResource resource = p.parseResource(string);

    final String result = p.encodeResourceToString(resource);
    ourLog.info(result);
  }
  ...
  public void testParseFeedWithListResource() throws ConfigurationException, DataFormatException, IOException
  {
    ...
    final IParser p = new FhirContext().newXmlParser();

    final String string = IOUtils.toString(XmlParserTest.class.getResourceAsStream("/feed-with-list.xml"));
    final Bundle bundle = p.parseBundle(string);

    final ListResource res = (ListResource) bundle.toListOfResources().get(2);
  ...
  public void testLoadQuestionnaire() throws ConfigurationException, DataFormatException, IOException
  {
    ...
    final String string = IOUtils.toString(XmlParserTest.class.getResourceAsStream("/questionnaire-example.xml"));
    final IResource resource = p.parseResource(string);
  ...
  public void testMessageWithMultipleTypes() throws SAXException, IOException
  {
    ...
    final Patient patient1 = ourCtx.newXmlParser().parseResource(Patient.class, msg);
    final String encoded1 = ourCtx.newXmlParser().encodeResourceToString(patient1);

    final ca.uhn.fhir.testmodel.Patient patient2 = ourCtx.newXmlParser().parseResource(
        ca.uhn.fhir.testmodel.Patient.class, msg);
    final String encoded2 = ourCtx.newXmlParser().encodeResourceToString(patient2);

    final Diff d = new Diff(new StringReader(encoded1), new StringReader(encoded2));
    assertTrue(d.toString(), d.identical());
  ...
  public void testMoreExtensions() throws Exception
  {
    ...
    final HumanNameDt name = patient.addName();
    name.addFamily().setValue("Shmoe");
    final StringDt given = name.addGiven();
    given.setValue("Joe");
    final ExtensionDt ext2 = new ExtensionDt(false, "http://examples.com#givenext", new StringDt("given"));
    given.addUndeclaredExtension(ext2);
    // END SNIPPET: resourceStringExtension

    // START SNIPPET: subExtension
    final ExtensionDt parent = new ExtensionDt(false, "http://example.com#parent");
    patient.addUndeclaredExtension(parent);

    final ExtensionDt child1 = new ExtensionDt(false, "http://example.com#child", new StringDt("value1"));
    parent.addUndeclaredExtension(child1);

    final ExtensionDt child2 = new ExtensionDt(false, "http://example.com#child", new StringDt("value1"));
    ...
    assertThat(
        enc,
        containsString("<Patient xmlns=\"http://hl7.org/fhir\"><extension url=\"http://example.com/extensions#someext\"><valueDateTime value=\"2011-01-02T11:13:15\"/></extension>"));
    assertThat(
        enc,
    ...
    assertThat(
        enc,
        containsString("<given value=\"Joe\"><extension url=\"http://examples.com#givenext\"><valueString value=\"given\"/></extension></given>"));
  }
  ...
  public void testNarrativeGeneration() throws DataFormatException
  {
    ...
    final FhirContext context = ourCtx;
    context.setNarrativeGenerator(gen);
    final IParser p = context.newXmlParser();
    final String str = p.encodeResourceToString(patient);
  ...
  public void testDuplicateContainedResources()
  {
    ...
    final Observation resA = new Observation();
    resA.getName().setText("A");

    final Observation resB = new Observation();
    resB.getName().setText("B");
    resB.addRelated().setTarget(new ResourceReferenceDt(resA));
    resB.addRelated().setTarget(new ResourceReferenceDt(resA));

    final String encoded = ourCtx.newXmlParser().setPrettyPrint(true).encodeResourceToString(resB);
    ourLog.info(encoded);

    assertThat(encoded,
        stringContainsInOrder(Arrays.asList("<contained>", "<Observation", "</Observation>", "</contained>")));
    assertThat(encoded, not(stringContainsInOrder(Arrays.asList("<contained>", "<Observation", "</Observation>",
        "<Obser", "</contained>"))));
  ...
  public void testNestedContainedResources()
  {
    ...
    final String str = ourCtx.newXmlParser().setPrettyPrint(true).encodeResourceToString(A);
    ourLog.info(str);
    ...
    final Observation obs = ourCtx.newXmlParser().parseResource(Observation.class, str);
  ...
  public void testParseBinaryResource()
  {
    ...
    final Binary val = ourCtx.newXmlParser().parseResource(Binary.class,
        "<Binary xmlns=\"http://hl7.org/fhir\" contentType=\"foo\">AQIDBA==</Binary>");
  ...
  public void testParseBundle()
  {
    ...
    // @formatter:off
    final String summaryText = "<div xmlns=\"http://www.w3.org/1999/xhtml\">\n"
    ...
    String msg = "<feed xmlns=\"http://www.w3.org/2005/Atom\">\n"
        ...
        + "            <code value=\"35200-5\"/>\n" + "            <code value=\"9342-7\"/>\n"
        + "          </include>\n" + "        </compose>\n" + "      </ValueSet>\n" + "    </content>\n"
        + "    <summary type=\"xhtml\">" + summaryText + "    </summary>\n" + "  </entry>" + "</feed>";
    // @formatter:on

    final IParser p = new FhirContext(ValueSet.class).newXmlParser();
    ...
    final TagList tl = (TagList) resource.getResourceMetadata().get(ResourceMetadataKeyEnum.TAG_LIST);
    ...
    assertEquals("12345",
        ((IdDt) resource.getResourceMetadata().get(ResourceMetadataKeyEnum.VERSION_ID)).getVersionIdPart());
  ...
  public void testParseBundleDeletedEntry()
  {
    ...
    final String msg = "<feed xmlns=\"http://www.w3.org/2005/Atom\">"
        ...
        + "<at:by>" + "<at:name>John Doe</at:name>" + "<at:email>jdoe@example.org</at:email>" + "</at:by>"
        + "<at:comment>Removed comment spam</at:comment>"
        + "<link rel=\"self\" href=\"http://foo/Patient/1/_history/2\"/>" + "</at:deleted-entry>" + "</feed>";
    // @formatter:on
    ...
    assertEquals("2",
        ((IdDt) entry.getResource().getResourceMetadata().get(ResourceMetadataKeyEnum.VERSION_ID)).getVersionIdPart());
    ...
    assertEquals(new InstantDt("2013-02-10T04:11:24.435+00:00"),
    ...
    final String encoded = ourCtx.newXmlParser().encodeBundleToString(bundle);
  ...
  public void testParseBundleLarge() throws IOException
  {
    ...
    final String msg = IOUtils.toString(XmlParser.class.getResourceAsStream("/atom-document-large.xml"));
    final IParser p = ourCtx.newXmlParser();
    final Bundle bundle = p.parseBundle(msg);

    assertEquals("http://spark.furore.com/fhir/_snapshot?id=327d6bb9-83b0-4929-aa91-6dd9c41e587b&start=0&_count=20",
  ...
  {
    final InputStreamReader str = new InputStreamReader(getClass().getResourceAsStream("/mixed-return-bundle.xml"));
    final Bundle b = ourCtx.newXmlParser().parseBundle(Patient.class, str);
  ...
  public void testParseContainedResources() throws IOException
  {
    ...
    final IParser p = ourCtx.newXmlParser();
    final DiagnosticReport bundle = p.parseResource(DiagnosticReport.class, msg);

    final ResourceReferenceDt result0 = bundle.getResult().get(0);
    final Observation obs = (Observation) result0.getResource();
  ...
  public void testParseEncodeNarrative()
  {
    ...
    final IResource res = ourCtx.newXmlParser().parseResource(input);
  ...
  {
    final String msg = IOUtils.toString(XmlParserTest.class.getResourceAsStream("/furore-conformance.xml"));
  ...
  public void testParseLanguage()
  {
    ...
    final Patient pt = ourCtx.newXmlParser().parseResource(Patient.class, input);
  ...
  {
    final String msg = "<Query xmlns=\"http://hl7.org/fhir\">\n" + "  <text>\n" + "    <status value=\"generated\"/>\n"
        ...
        + "  </parameter>\n" + "</Query>";
    final Query query = ourCtx.newXmlParser().parseResource(Query.class, msg);
  ...
  public void testParseWithXmlHeader() throws ConfigurationException, DataFormatException
  {
    ...
    // @formatter:off
    final String msg = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" + "<Patient xmlns=\"http://hl7.org/fhir\">\n"
        + "	<identifier>\n" + "		<label value=\"IdentifierLabel\"/>\n" + "	</identifier>\n" + "</Patient>";
    // @formatter:on
  ...
  public void testSimpleResourceEncode() throws IOException, SAXException
  {
    ...
    final String xmlString = IOUtils.toString(JsonParser.class.getResourceAsStream("/example-patient-general.json"),
        Charset.forName("UTF-8"));
    final Patient obs = ourCtx.newJsonParser().parseResource(Patient.class, xmlString);
    ...
    final IParser jsonParser = ourCtx.newXmlParser();
    final String encoded = jsonParser.encodeResourceToString(obs);
    ourLog.info(encoded);

    final String jsonString = IOUtils.toString(JsonParser.class.getResourceAsStream("/example-patient-general.xml"));

    final String expected = (jsonString);
    final String actual = (encoded.trim());

    final Diff d = new Diff(new StringReader(expected), new StringReader(actual));
    assertTrue(d.toString(), d.identical());
  ...
  public void testSimpleResourceEncodeWithCustomType() throws IOException, SAXException
  {
    ...
    final String xmlString = IOUtils.toString(JsonParser.class.getResourceAsStream("/example-patient-general.json"),
        Charset.forName("UTF-8"));
    final MyObservationWithExtensions obs = fhirCtx.newJsonParser().parseResource(MyObservationWithExtensions.class,
        xmlString);
    ...
    final IParser jsonParser = fhirCtx.newXmlParser();
    final String encoded = jsonParser.encodeResourceToString(obs);
    ourLog.info(encoded);
  ...
  public void testTagList()
  {
    ...
    // @formatter:off
    final String tagListStr = "<taglist xmlns=\"http://hl7.org/fhir\"> \n"
        + "    <category term=\"term0\" label=\"label0\" scheme=\"scheme0\" /> \n"
        + "    <category term=\"term1\" label=\"label1\" scheme=\"\" /> \n"
        + "    <category term=\"term2\" label=\"label2\" /> \n" + "</taglist>";
    // @formatter:on

    final TagList tagList = ourCtx.newXmlParser().parseTagList(tagListStr);
    ...
    // @formatter:off
    final String expected = "<taglist xmlns=\"http://hl7.org/fhir\">"
        + "<category term=\"term0\" label=\"label0\" scheme=\"scheme0\"/>"
        + "<category term=\"term1\" label=\"label1\"/>" + "<category term=\"term2\" label=\"label2\"/>" + "</taglist>";
    // @formatter:on

    final String encoded = ourCtx.newXmlParser().encodeTagListToString(tagList);
    assertEquals(expected, encoded);
  ...
  public void testTotalResultsUsingOldNamespace()
  {
    ...
    // @formatter:off
    final String bundle = "<feed xmlns=\"http://www.w3.org/2005/Atom\">\n"
    ...
    final Bundle bundleR = ourCtx.newXmlParser().parseBundle(bundle);
