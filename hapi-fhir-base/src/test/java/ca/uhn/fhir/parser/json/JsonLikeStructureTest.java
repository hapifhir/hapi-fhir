...
public class JsonLikeStructureTest {
	...
	private static final String TEST_STRUCTURELOADING_DATA = "{" + "    \"resourceType\":\"Organization\","
			+ "    \"id\":\"11111\","
			+ "    \"meta\":{"
	...
	private static final String TEST_JSONTYPES_DATA = "{" + "    \"scalar-string\":\"A scalar string\","
			+ "    \"scalar-number\":11111,"
			+ "    \"scalar-boolean\":true,"
			+ "    \"null-value\":null,"
			+ "    \"object-value\":{"
