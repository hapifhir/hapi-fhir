...
class DateRangeUtilTest {
	...
	static class NarrowCase {
		...
		public NarrowCase(
					...
					Date theNarrowStart,
					Date theNarrowEnd,
					DateParam theResultStart,
					DateParam theResultEnd) {
				message = theMessage;
				range = theRange;
		...
		static NarrowCase from(
				...
				return new NarrowCase(
						...
						theResultStart == null
									? null
									: new DateParam(GREATERTHAN_OR_EQUALS, theResultStart),
		...
		static NarrowCase from(
					...
					Date theNarrowStart,
					Date theNarrowEnd,
					ParamPrefixEnum theResultStartPrefix,
					Date theResultStart,
					ParamPrefixEnum theResultEndPrefix,
					Date theResultEnd) {
				return new NarrowCase(
						theMessage,
						theRange,
						theNarrowStart,
						theNarrowEnd,
						new DateParam(theResultStartPrefix, theResultStart),
						new DateParam(theResultEndPrefix, theResultEnd));
		}
	...
	public static List<NarrowCase> narrowCases() {

		return Arrays.asList(
					// null range cases
					new NarrowCase("nulls on null yields null", null, null, null, null, null),
					NarrowCase.from(
								"start and end narrow null", null, dateTwo, dateThree, dateTwo, dateThree),
					NarrowCase.from(
								"start on null provides open range", null, dateTwo, null, dateTwo, null),
					NarrowCase.from(
								"end on null provides open range", null, null, dateThree, null, dateThree),
					// middle range
					// default range is inclusive at top
					NarrowCase.from(
								"start and end outside leaves range unchanged",
								new DateRangeParam(dateTwo, dateFive),
								dateOne,
								dateSix,
					...
					NarrowCase.from(
								"end inside open end",
								new DateRangeParam(dateTwo, null),
								null,
								dateFour,
								dateTwo,
								dateFour),
					NarrowCase.from(
								"start inside open start",
								new DateRangeParam(null, dateFour),
								dateTwo,
								null,
								GREATERTHAN_OR_EQUALS,
								dateTwo,
					...
					NarrowCase.from(
								"gt case preserved",
								new DateRangeParam(new DateParam(GREATERTHAN, dateTwo), null),
								null,
								dateFour,
								GREATERTHAN,
								dateTwo,
								...
								dateFour),
					NarrowCase.from(
								"lt date level precision date, narrow from is inside date",
					...
					NarrowCase.from(
								"gt date level precision date, narrow to is inside date",
