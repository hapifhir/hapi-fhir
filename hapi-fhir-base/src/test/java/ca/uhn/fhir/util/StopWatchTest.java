...
public class StopWatchTest {
    ...
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(StopWatchTest.class);
    ...
    public void testFormatMillis() {
        ...
        assertEquals(
                "00:01:01",
                StopWatch.formatMillis(DateUtils.MILLIS_PER_MINUTE + DateUtils.MILLIS_PER_SECOND));
        ...
        assertEquals(
                ...
                StopWatch.formatMillis(
                                (DateUtils.MILLIS_PER_DAY * 2) + (10 * DateUtils.MILLIS_PER_HOUR))
                        .replace(',', '.'));
        assertEquals(
                "11 days",
                StopWatch.formatMillis(
                        (DateUtils.MILLIS_PER_DAY * 11) + (10 * DateUtils.MILLIS_PER_HOUR)));
    }
