...
public class PhoneticEncoderUtilTests {
	...
	public void getEncoder_withInvalidNumber_returnsNullAndLogs() {
		...
		IPhoneticEncoder encoder =
					PhoneticEncoderUtil.getEncoder(
	...
	public void getEncoder_emptyNumberValue_returnsNull() {
		...
		// test
		IPhoneticEncoder encoder =
					PhoneticEncoderUtil.getEncoder(PhoneticEncoderEnum.METAPHONE.name() + "()");
	...
	private void verifyOutcome_getEncoder_NumberParseFailure(
				IPhoneticEncoder theEncoder, String theNumberParam) {
