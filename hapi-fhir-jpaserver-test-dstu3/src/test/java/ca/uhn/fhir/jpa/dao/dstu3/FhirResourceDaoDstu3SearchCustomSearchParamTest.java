...
public class FhirResourceDaoDstu3SearchCustomSearchParamTest extends BaseJpaDstu3Test {
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(
                    FhirResourceDaoDstu3SearchCustomSearchParamTest.class);
    ...
    public void testCreateSpWithMultiplePaths2() {
        ...
        sp.setExpression(
                "Patient.telecom.where(system='phone') or Patient.telecome.where(system='email')");
    ...
    public void testCreateSpWithMultiplePaths3() {
        ...
        sp.setExpression(
                "Patient.telecom.where(system='phone' or system='email') |"
                        + " Patient.telecome.where(system='email')");
    ...
    public void testCustomReferenceParameter() throws Exception {
        ...
        Patient pat =
                myFhirContext
                        ...
                        .parseResource(
                                Patient.class,
                                ClasspathUtil.loadResource("/dstu3_custom_resource_patient.json"));
            ...
            assertThat(
                    ...
                    startsWith(
                            Msg.code(1121)
                                    ...
                                    + " \"Communication.payload[1].contentAttachment is not null\":"
                                    + " Error at 1, 4: Premature ExpressionNode termination at"
    ...
    public void testSearchOnMultivalue() throws FHIRException {
        ...
        displaySp.setExpression(
                "MedicationStatement.medication.as(CodeableConcept).coding.display");
        ...
        String id1 =
                myMedicationStatementDao.create(ms1).getId().toUnqualifiedVersionless().getValue();
    ...
    public void testProgramaticallyContainedByReferenceAreStillResolvable() {
        ...
        sp.setType(Enumerations.SearchParamType.TOKEN);
        sp.setExpression(
                "MedicationAdministration.medication.resolve().ingredient.item.as(Reference).resolve().code");
        mySearchParameterDao.create(sp);
        mySearchParamRegistry.forceRefresh();
                            ...
                            myResourceIndexedSearchParamTokenDao.findAll().stream()
                                    .filter(
                                            t ->
                                                    t.getParamName()
                                                            .equals(
                                                                    "medicationadministration-ingredient-medication"))
