...
public class FhirResourceDaoDstu3ValidateTest extends BaseJpaDstu3Test {
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(FhirResourceDaoDstu3ValidateTest.class);
    @Autowired private IValidatorModule myValidatorModule;
    @Autowired private CachingValidationSupport myValidationSupport;
    ...
    public void testValidateChangedQuestionnaire() {
        ...
        try {
            ...
            ourLog.debug(
                    myFhirContext
                            .newJsonParser()
                            .setPrettyPrint(true)
                            .encodeResourceToString(results.getOperationOutcome()));
        ...
        ProxyUtil.getSingletonTarget(
                        myPersistedResourceValidationSupport,
    ...
    public void testExpandLocalCodeSystemWithExplicitCodes() throws IOException {
        CodeSystem cs =
                loadResourceFromClasspath(
                        CodeSystem.class, "/dstu3/iar/CodeSystem-iar-citizenship-status.xml");
        myCodeSystemDao.create(cs);

        ValueSet vs =
                loadResourceFromClasspath(
                        ValueSet.class, "/dstu3/iar/ValueSet-iar-citizenship-status.xml");
        ...
        assertThat(
                ...
                containsInAnyOrder("CDN", "PR", "TR", "REF", "UNK", "ASKU"));
    }
    ...
    public void testValidateWithCanonicalReference() {
        ...
        outcome =
                myQuestionnaireResponseDao.validate(
                        qr, null, raw, EncodingEnum.JSON, ValidationModeEnum.CREATE, null, mySrd);
    ...
    public void testValidateStructureDefinition() throws Exception {
        String input =
                IOUtils.toString(
                        getClass().getResourceAsStream("/sd-david-dhtest7.json"),
    ...
    public void testValidateDocument() throws Exception {
        String input =
                IOUtils.toString(
                        getClass().getResourceAsStream("/document-bundle-dstu3.json"),
                        StandardCharsets.UTF_8);
    ...
    private OperationOutcome doTestValidateResourceContainingProfileDeclaration(
        ...
        Bundle vss =
                loadResourceFromClasspath(
                        Bundle.class, "/org/hl7/fhir/dstu3/model/valueset/valuesets.xml");
        ...
        StructureDefinition sd =
                loadResourceFromClasspath(
                        ...
                        "/org/hl7/fhir/dstu3/model/profile/devicemetricobservation.profile.xml");
        sd.setId(new IdType());
    ...
    public void testValidateNewQuestionnaireFormat() throws Exception {
        String input =
                IOUtils.toString(
                        FhirResourceDaoDstu3ValidateTest.class.getResourceAsStream(
