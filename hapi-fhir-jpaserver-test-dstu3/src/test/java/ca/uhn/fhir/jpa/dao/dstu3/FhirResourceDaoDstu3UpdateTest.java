...
public class FhirResourceDaoDstu3UpdateTest extends BaseJpaDstu3Test {
    ...
    public void testReCreateMatchResource() {
        ...
        codeSystem.setUrl("http://foo");
        IIdType id2 =
                myCodeSystemDao.update(codeSystem, "CodeSystem?url=http://foo", mySrd).getId();
    ...
    public void testUpdateRejectsInvalidTypes() {
        ...
        try {
            ...
            assertEquals(
                    Msg.code(930)
                            + "Existing resource ID[Patient/"
                            + p1id.getIdPartAsLong()
        ...
        try {
            ...
            assertEquals(
                    Msg.code(996)
                            + "Incorrect resource type (Patient) for this DAO, wanted:"
                            + " Organization",
                    e.getMessage());
        }
    }
