...
public class FhirSearchDaoDstu3Test extends BaseJpaDstu3Test {
    ...
    @Autowired private IFulltextSearchSvc mySearchDao;
    ...
    public void testContentSearch() {
        ...
        // OR
        {
            ...
            content.addAnd(
                    new StringOrListParam()
                            .addOr(new StringParam("AAAS"))
                            .addOr(new StringParam("AAAB")));
        ...
        // All Resource Types
        {
            ...
            content.addAnd(
                    new StringOrListParam()
                            .addOr(new StringParam("CCC"))
                            .addOr(new StringParam("DDD")));
