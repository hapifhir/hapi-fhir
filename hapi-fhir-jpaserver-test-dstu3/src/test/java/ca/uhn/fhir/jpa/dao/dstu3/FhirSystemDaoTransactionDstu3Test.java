...
public class FhirSystemDaoTransactionDstu3Test extends BaseJpaDstu3SystemTest {
    ...
    @AfterEach
    public void after() {
        myStorageSettings.setMaximumTransactionBundleSize(
                new JpaStorageSettings().getMaximumTransactionBundleSize());
    }
            ...
            assertThat(
                    ...
                    containsString(
                            "Transaction Bundle Too large.  Transaction bundle contains "
                                    ...
                                    + " which exceedes the maximum permitted transaction bundle"
                                    + " size of "
