...
public class FhirDaoConcurrencyDstu3Test extends BaseJpaDstu3SystemTest {
    ...
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(FhirDaoConcurrencyDstu3Test.class);

    @Autowired public BasicDataSource myBasicDataSource;
    ...
    public void testMultipleConcurrentWritesToSameResource() throws InterruptedException {
        ...
        IBundleProvider historyBundle =
                myPatientDao.history(new IdType("Patient/PID"), null, null, null, mySrd);
