...
public class ResourceProviderQuestionnaireResponseDstu3Test extends BaseResourceProviderDstu3Test {
    ...
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(ResourceProviderQuestionnaireResponseDstu3Test.class);
    ...
    public void testSaveQuestionnaire() throws Exception {
        String input =
                "<QuestionnaireResponse xmlns=\"http://hl7.org/fhir\">\n"
                    ...
                    + "            <valueCoding>\n"
                    + "                <system"
                    + " value=\"http://example.org/codesystem-breastfeeding-intention\"/>\n"
                    + "                <code value=\"true\"/>\n"
                    + "                <display value=\"Mother wants to provide formula"
                    + " exclusively\"/>\n"
                    + "            </valueCoding>\n"
                    + "        </answer>\n"
                    + "    </item>\n"
                    ...
                    + "            <valueCoding>\n"
                    + "                <system"
                    + " value=\"http://example.org/codesystem-breastfeeding-education\"/>\n"
                    + "                <code value=\"true\"/>\n"
                    + "                <display value=\"Mother not given comprehensive education"
                    + " per protocol\"/>\n"
                    + "            </valueCoding>\n"
                    + "        </answer>\n"
                    + "    </item>\n"
                    ...
                    + "            <valueCoding>\n"
                    + "                <system"
                    + " value=\"http://example.org/codesystem-breastfeeding-exclusion\"/>\n"
                    + "                <code value=\"true\"/>\n"
                    + "                <display\n"
                    + "                    value=\"Maternal use of drugs of abuse, antimetabolites,"
        ...
        post.setEntity(
                new StringEntity(
                        input,
                        ContentType.create(ca.uhn.fhir.rest.api.Constants.CT_FHIR_XML, "UTF-8")));
        ...
        try {
            ...
            String newIdString =
                    response.getFirstHeader(ca.uhn.fhir.rest.api.Constants.HEADER_LOCATION_LC)
                            .getValue();
    ...
    public void testValidateQuestionnaireResponseWithNoIdForCreate() throws Exception {
        ...
        String input =
                "{\"resourceType\":\"Parameters\",\"parameter\":[{\"name\":\"mode\",\"valueString\":\"create\"},{\"name\":\"resource\",\"resource\":{\"resourceType\":\"QuestionnaireResponse\",\"questionnaire\":{\"reference\":\"http://fhirtest.uhn.ca/baseDstu2/Questionnaire/MedsCheckEligibility\"},\"text\":{\"status\":\"generated\",\"div\":\"<div"
                    + " xmlns=\\\"http://www.w3.org/1999/xhtml\\\">!-- populated from the rendered"
                    + " HTML below"
                    + " --></div>\"},\"status\":\"completed\",\"authored\":\"2017-02-10T00:02:58.098Z\"}}]}";
        HttpPost post =
