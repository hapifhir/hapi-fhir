	...
	public void testSnapshotWithResourceParameter() throws IOException {
		StructureDefinition sd =
					loadResourceFromClasspath(
								...
								"/dstu3/profile-differential-patient-dstu3.json");
		...
		StructureDefinition response =
					myClient.operation()
								...
								.withParameter(
										...
										"url",
										new StringType(
													"http://hl7.org/fhir/StructureDefinition/MyPatient421"))
								.returnResourceType(StructureDefinition.class)
								.execute();
		assertEquals(54, response.getSnapshot().getElement().size());
	}
		...
		try {
				...
				assertEquals(
						"HTTP 400 Bad Request: "
									+ Msg.code(1770)
									+ "Must supply either an ID or a StructureDefinition or a URL (but not"
		...
		try {
				myClient.operation()
						...
						.withParameter(
									Parameters.class,
									"url",
									new StringType("http://hl7.org/fhir/StructureDefinition/FOO"))
						.returnResourceType(StructureDefinition.class)
						.execute();
				...
				assertEquals(
						"HTTP 404 Not Found: "
									+ Msg.code(1162)
									+ "No StructureDefiniton found with url ="
