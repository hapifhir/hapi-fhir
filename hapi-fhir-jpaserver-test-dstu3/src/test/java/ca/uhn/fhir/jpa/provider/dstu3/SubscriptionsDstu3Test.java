...
public class SubscriptionsDstu3Test extends BaseResourceProviderDstu3Test {
    ...
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(SubscriptionsDstu3Test.class);
    ...
    public void testCreateInvalidNoStatus() {
        ...
        try {
            ...
            assertThat(
                    e.getMessage(),
                    containsString("Subscription.status must be populated on this server"));
        }
        ...
        try {
            ...
            assertEquals(
                    "HTTP 422 Unprocessable Entity: "
                            + Msg.code(816)
                            + "Subscription.status must be 'off' or 'requested' on a newly created"
                            + " subscription",
                    e.getMessage());
        }
