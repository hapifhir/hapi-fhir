...
public class PagingMultinodeProviderDstu3Test extends BaseResourceProviderDstu3Test {
    ...
    public void testSearch() {
        ...
        found = myClient.loadPage().next(found).execute();
        assertThat(
                toUnqualifiedVersionlessIdValues(found),
                contains(
                        "Patient/A010",
    ...
    public void testSearchWithOffset() {
        ...
        assertThat(
                ...
                contains(
                        ...
                        "Patient/A009"));
        assertThat(
                found.getLink().stream()
                        .filter(l -> l.getRelation().equals("next"))
                        .map(l -> l.getUrl())
                        .findAny()
                        .orElseThrow(() -> new IllegalStateException("No next page link"))
                        .contains("_offset=10"),
                is(true));
