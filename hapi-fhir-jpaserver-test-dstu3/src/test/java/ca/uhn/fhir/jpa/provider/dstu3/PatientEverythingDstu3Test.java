...
public class PatientEverythingDstu3Test extends BaseResourceProviderDstu3Test {
    ...
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(PatientEverythingDstu3Test.class);
    ...
    public void testEverythingReturnsCorrectResources() throws Exception {
        ...
        Bundle bundle =
                fetchBundle(
                        myServerBase + "/" + myPatientId + "/$everything?_format=json&_count=100",
                        EncodingEnum.JSON);
    ...
    public void testEverythingPagesWithCorrectEncodingJson() throws Exception {
        ...
        Bundle bundle =
                fetchBundle(
                        myServerBase + "/" + myPatientId + "/$everything?_format=json&_count=1",
                        EncodingEnum.JSON);
    ...
    public void testEverythingPagesWithCorrectEncodingXml() throws Exception {
        ...
        Bundle bundle =
                fetchBundle(
                        myServerBase + "/" + myPatientId + "/$everything?_format=xml&_count=1",
                        EncodingEnum.XML);
