...
public class ResourceProviderDstu3CodeSystemTest extends BaseResourceProviderDstu3Test {
	...
	public void testLookupOperationByCodeAndSystemBuiltInCode() {
		...
		assertEquals("version", respParam.getParameter().get(1).getName());
		assertEquals(
					("2.8.2"), ((StringType) respParam.getParameter().get(1).getValue()).getValue());
		assertEquals("display", respParam.getParameter().get(2).getName());
		assertEquals(
					"Accession ID",
	...
	public void testLookupOperationForBuiltInCode() {
		...
		assertEquals("version", respParam.getParameter().get(1).getName());
		assertEquals(
					"2016-11-11", ((StringType) respParam.getParameter().get(1).getValue()).getValue());
		assertEquals("display", respParam.getParameter().get(2).getName());
		assertEquals(
					"Married", ((StringType) respParam.getParameter().get(2).getValue()).getValue());
		assertEquals("abstract", respParam.getParameter().get(3).getName());
		assertEquals(
					false, ((BooleanType) respParam.getParameter().get(3).getValue()).booleanValue());
	}
	...
	public void testValidateCodeOperation() {
		...
		assertThat(
					message,
					containsString(
								"Terminology service was unable to provide validation for https://url#1"));
	}
}
