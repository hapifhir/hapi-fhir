...
public class FhirResourceDaoDstu3StructureDefinitionTest extends BaseJpaDstu3Test {
	...
	private static final org.slf4j.Logger ourLog =
			org.slf4j.LoggerFactory.getLogger(FhirResourceDaoDstu3StructureDefinitionTest.class);
	...
	public void testGenerateSnapshot() throws IOException {
		...
		StructureDefinition output =
				myStructureDefinitionDao.generateSnapshot(sd, "http://foo", null, "THE BEST PROFILE");
