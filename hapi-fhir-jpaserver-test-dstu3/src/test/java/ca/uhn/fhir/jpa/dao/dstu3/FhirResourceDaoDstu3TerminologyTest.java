...
public class FhirResourceDaoDstu3TerminologyTest extends BaseJpaDstu3Test {
    ...
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(FhirResourceDaoDstu3TerminologyTest.class);
    @Autowired private CachingValidationSupport myCachingValidationSupport;
    @Autowired private ITermDeferredStorageSvc myTermDeferredStorageSvc;
        ...
        try {
            ...
            assertEquals(
                    Msg.code(848)
                            ...
                            + " \"http://example.com/my_code_system\", already have one with"
                            + " resource ID: CodeSystem/"
                            + id.getIdPart(),
                    e.getMessage());
        }
    }
    ...
    public void testCodeSystemWithDefinedCodes() {
        ...
        Set<TermConcept> codes =
                myTermSvc.findCodesBelow(id.getIdPartAsLong(), id.getVersionIdPartAsLong(), "A");
    ...
    public void testExpandWithCodesAndDisplayFilterBlank() {
        ...
        ValueSet result =
                myValueSetDao.expand(valueSet, new ValueSetExpansionOptions().setFilter(""));
    ...
    public void testExpandWithOpEquals() {
        ...
        ValueSet result =
                myValueSetDao.expandByIdentifier(
                        ...
                        new ValueSetExpansionOptions().setFilter(""));
        ourLog.debug(
                myFhirContext.newXmlParser().setPrettyPrint(true).encodeResourceToString(result));
    }
    ...
    public void testExpandWithCodesAndDisplayFilterPartialOnFilter() {
        ...
        ValueSet result =
                myValueSetDao.expand(valueSet, new ValueSetExpansionOptions().setFilter("lab"));
        logAndValidateValueSet(result);
    ...
    public void testExpandWithCodesAndDisplayFilterPartialOnCodes() {
        ...
        ValueSet result =
                myValueSetDao.expand(valueSet, new ValueSetExpansionOptions().setFilter("hel"));
        logAndValidateValueSet(result);
    ...
    public void testExpandWithInvalidExclude() {
        ...
        try {
            ...
            assertEquals(
                    Msg.code(890) + "ValueSet contains exclude criteria with no system defined",
                    e.getMessage());
        }
    }
    ...
    public void testExpandWithIsAInExternalValueSetReindex() {
        ...
        IValidationSupport.LookupCodeResult lookupResults =
                myCodeSystemDao.lookupCode(
                        new StringType("childAA"), new StringType(URL_MY_CODE_SYSTEM), null, mySrd);
    ...
    public void testLookupSnomed() {
        ...
        IValidationSupport.LookupCodeResult outcome =
                myCodeSystemDao.lookupCode(code, system, null, mySrd);
    ...
    public void testRefuseCostlyExpansionFhirCodesystem() {
        ...
        params.add(
                AuditEvent.SP_TYPE,
                new TokenParam(null, "http://hl7.org/fhir/ValueSet/audit-event-type")
    ...
    public void testRefuseCostlyExpansionLocalCodesystem() {
        ...
        params.add(
                Observation.SP_CODE,
                new TokenParam(URL_MY_CODE_SYSTEM, "AAA").setModifier(TokenParamModifier.ABOVE));
        try {
            ...
            assertThat(
                    ...
                    containsString(
                            Msg.code(885)
                                    + "Expansion of ValueSet produced too many codes (maximum 1) -"
                                    + " Operation aborted!"));
        }
    }
    ...
    public void testSearchCodeAboveLocalCodesystem() {
        ...
        params.add(
                ...
                new TokenParam(URL_MY_CODE_SYSTEM, "AAA").setModifier(TokenParamModifier.ABOVE));
        assertThat(
                toUnqualifiedVersionlessIdValues(myObservationDao.search(params)),
                containsInAnyOrder(idAA.getValue()));

        params = new SearchParameterMap();
        params.add(
                Observation.SP_CODE,
                new TokenParam(URL_MY_CODE_SYSTEM, "A").setModifier(TokenParamModifier.ABOVE));
    ...
    public void testSearchCodeBelowAndAboveUnknownCodeSystem() {
        ...
        params.add(
                Observation.SP_CODE,
                new TokenParam(URL_MY_CODE_SYSTEM, "childAA")
    ...
    public void testSearchCodeInUnknownCodeSystem() {
        ...
        try {
            params.add(
                    Observation.SP_CODE,
                    new TokenParam(null, URL_MY_VALUE_SET).setModifier(TokenParamModifier.IN));
            assertThat(toUnqualifiedVersionlessIdValues(myObservationDao.search(params)), empty());
        } catch (ResourceNotFoundException e) {
            //noinspection SpellCheckingInspection
            assertEquals(
                    Msg.code(2024) + "Unknown ValueSet: http%3A%2F%2Fexample.com%2Fmy_value_set",
                    e.getMessage());
        }
    }
    ...
    public void testSearchCodeBelowBuiltInCodesystem() {
        ...
        params = new SearchParameterMap();
        params.add(
                AllergyIntolerance.SP_CLINICAL_STATUS,
                new TokenParam(
                        "http://hl7.org/fhir/allergy-clinical-status",
                        AllergyIntoleranceClinicalStatus.ACTIVE.toCode()));
        assertThat(
                toUnqualifiedVersionlessIdValues(myAllergyIntoleranceDao.search(params)),
        ...
        params.add(
                ...
                new TokenParam(
                                "http://hl7.org/fhir/allergy-clinical-status",
                                AllergyIntoleranceClinicalStatus.RESOLVED.toCode())
                        .setModifier(TokenParamModifier.BELOW));
        assertThat(
                toUnqualifiedVersionlessIdValues(myAllergyIntoleranceDao.search(params)),
        ...
        params.add(
                AllergyIntolerance.SP_CLINICAL_STATUS,
                new TokenParam("http://hl7.org/fhir/allergy-clinical-status", "fooooo"));
        assertThat(
                toUnqualifiedVersionlessIdValues(myAllergyIntoleranceDao.search(params)), empty());

        // Unknown system
        params = new SearchParameterMap();
        params.add(
                AllergyIntolerance.SP_CLINICAL_STATUS,
                new TokenParam("http://hl7.org/fhir/allergy-clinical-status222222", "fooooo"));
        assertThat(
                toUnqualifiedVersionlessIdValues(myAllergyIntoleranceDao.search(params)), empty());
    }
    ...
    public void testSearchCodeBelowBuiltInCodesystemUnqualified() {
        ...
        ai1.setClinicalStatus(AllergyIntoleranceClinicalStatus.ACTIVE);
        ai1.addCategory(
                org.hl7.fhir.dstu3.model.AllergyIntolerance.AllergyIntoleranceCategory.MEDICATION);
        String id1 =
                myAllergyIntoleranceDao
                        .create(ai1, mySrd)
                        .getId()
        ...
        ai2.setClinicalStatus(AllergyIntoleranceClinicalStatus.RESOLVED);
        ai1.addCategory(
                org.hl7.fhir.dstu3.model.AllergyIntolerance.AllergyIntoleranceCategory.BIOLOGIC);
        String id2 =
                myAllergyIntoleranceDao
                        .create(ai2, mySrd)
                        .getId()
        ...
        ai3.setClinicalStatus(AllergyIntoleranceClinicalStatus.INACTIVE);
        ai1.addCategory(
                org.hl7.fhir.dstu3.model.AllergyIntolerance.AllergyIntoleranceCategory.FOOD);
        myAllergyIntoleranceDao.create(ai3, mySrd).getId().toUnqualifiedVersionless().getValue();
        ...
        params.add(
                AllergyIntolerance.SP_CLINICAL_STATUS,
                new TokenParam(null, AllergyIntoleranceClinicalStatus.ACTIVE.toCode()));
        assertThat(
                toUnqualifiedVersionlessIdValues(myAllergyIntoleranceDao.search(params)),
                containsInAnyOrder(id1));
        ...
        params = new SearchParameterMap();
        params.add(
                AllergyIntolerance.SP_CATEGORY,
                new TokenParam(null, AllergyIntoleranceCategory.MEDICATION.toCode())
                        .setModifier(TokenParamModifier.BELOW));
        assertThat(
                toUnqualifiedVersionlessIdValues(myAllergyIntoleranceDao.search(params)),
                containsInAnyOrder(id1));
        ...
        params.add(
                AllergyIntolerance.SP_CLINICAL_STATUS,
                new TokenParam(null, AllergyIntoleranceClinicalStatus.RESOLVED.toCode())
                        .setModifier(TokenParamModifier.BELOW));
        assertThat(
                toUnqualifiedVersionlessIdValues(myAllergyIntoleranceDao.search(params)),
                containsInAnyOrder(id2));
    ...
    public void testSearchCodeBelowLocalCodesystem() {
        ...
        params.add(
                Observation.SP_CODE,
                new TokenParam(URL_MY_CODE_SYSTEM, "A").setModifier(TokenParamModifier.BELOW));
        assertThat(
                toUnqualifiedVersionlessIdValues(myObservationDao.search(params)),
                containsInAnyOrder(idAA.getValue()));
        ...
        params.add(
                Observation.SP_CODE,
                new TokenParam(URL_MY_CODE_SYSTEM, "AAA").setModifier(TokenParamModifier.BELOW));
        assertThat(toUnqualifiedVersionlessIdValues(myObservationDao.search(params)), empty());
    }
    ...
    public void testSearchCodeBelowExternalCodesystemLarge() {
        ...
        params.add(
                Observation.SP_CODE,
                new TokenParam(URL_MY_CODE_SYSTEM, "codeA").setModifier(TokenParamModifier.BELOW));
        assertThat(
                toUnqualifiedVersionlessIdValues(myObservationDao.search(params)),
                containsInAnyOrder(id0.getValue(), id1.getValue(), id2.getValue()));

        params = new SearchParameterMap();
        params.add(
                Observation.SP_CODE,
                new TokenParam(URL_MY_CODE_SYSTEM, "subCodeB1")
                        .setModifier(TokenParamModifier.BELOW));
        assertThat(toUnqualifiedVersionlessIdValues(myObservationDao.search(params)), empty());
    }
    ...
    public void testSearchCodeInBuiltInValueSet() {
        ...
        params.add(
                AllergyIntolerance.SP_CLINICAL_STATUS,
                new TokenParam(null, "http://hl7.org/fhir/ValueSet/allergy-clinical-status")
                        .setModifier(TokenParamModifier.IN));
        assertThat(
                toUnqualifiedVersionlessIdValues(myAllergyIntoleranceDao.search(params)),
        ...
        params.add(
                AllergyIntolerance.SP_CLINICAL_STATUS,
                new TokenParam(null, "http://hl7.org/fhir/ValueSet/allergy-intolerance-criticality")
                        .setModifier(TokenParamModifier.IN));
        assertThat(
                toUnqualifiedVersionlessIdValues(myAllergyIntoleranceDao.search(params)), empty());
        ...
        params.add(
                AllergyIntolerance.SP_CLINICAL_STATUS,
                new TokenParam(null, "http://hl7.org/fhir/ValueSet/FOO")
                        .setModifier(TokenParamModifier.IN));
        try {
            myAllergyIntoleranceDao.search(params);
        } catch (InvalidRequestException e) {
            assertEquals(
                    "Unable to find imported value set http://hl7.org/fhir/ValueSet/FOO",
                    e.getMessage());
        }
    }
    ...
    public void testSearchCodeInExternalCodesystem() {
        ...
        assertThat(
                toUnqualifiedVersionlessIdValues(myObservationDao.search(params)),
                containsInAnyOrder(idAAA.getValue(), idAAB.getValue()));
        ...
        assertThat(
                toUnqualifiedVersionlessIdValues(myObservationDao.search(params)),
                containsInAnyOrder(idPA.getValue()));
        ...
        assertThat(
                toUnqualifiedVersionlessIdValues(myObservationDao.search(params)),
                containsInAnyOrder(idPA.getValue(), idAAA.getValue(), idAAB.getValue()));
    }
    ...
    public void testSearchCodeInFhirCodesystem() {
        ...
        params.add(
                ...
                new TokenParam(null, "http://hl7.org/fhir/ValueSet/audit-event-type")
                        .setModifier(TokenParamModifier.IN));
        assertThat(
                toUnqualifiedVersionlessIdValues(myAuditEventDao.search(params)),
                containsInAnyOrder(idIn1.getValue(), idIn2.getValue()));

        params = new SearchParameterMap();
        params.add(
                AuditEvent.SP_TYPE,
                new TokenParam(null, "http://hl7.org/fhir/ValueSet/v3-PurposeOfUse")
                        .setModifier(TokenParamModifier.IN));
    ...
    public void testSearchCodeInLocalCodesystem() {
        ...
        assertThat(
                toUnqualifiedVersionlessIdValues(myObservationDao.search(params)),
                containsInAnyOrder(idAA.getValue(), idBA.getValue()));
    }
    ...
    public void testSearchCodeInValueSetThatImportsInvalidCodeSystem() {
        ...
        try {
            ...
            assertEquals(
                    "Unable to expand imported value set: Unable to find imported value set"
                            + " http://non_existant_VS",
                    e.getMessage());
        }
        ...
        try {
            ...
            //noinspection SpellCheckingInspection
            assertEquals(
                    "Unknown ValueSet: http%3A%2F%2Fexample.com%2Fmy_value_set", e.getMessage());
        }
    }
    ...
    public void testSearchCodeNotInBuiltInValueSet() {
        ...
        params.add(
                AllergyIntolerance.SP_CLINICAL_STATUS,
                new TokenParam(null, "http://hl7.org/fhir/ValueSet/allergy-intolerance-status")
                        .setModifier(TokenParamModifier.NOT_IN));
        assertThat(
                toUnqualifiedVersionlessIdValues(myAllergyIntoleranceDao.search(params)), empty());
    ...
    private ArrayList<String> toCodesContains(
            List<ValueSetExpansionContainsComponent> theContains) {
