...
public class FhirResourceDaoDstu3PhoneticSearchNoFtTest extends BaseJpaDstu3Test {
    ...
    public void beforeDisableResultReuse() {
        ...
        createPhoneticSearchParameter(
                ADDRESS_LINE_SOUNDEX_SP, PhoneticEncoderEnum.SOUNDEX, "Patient.address.line");
        createPhoneticSearchParameter(
                PHONE_NUMBER_SP, PhoneticEncoderEnum.NUMERIC, "Patient.telecom");
        mySearchParamRegistry.forceRefresh();
        mySearchParamRegistry.setPhoneticEncoder(
                new ApacheEncoder(PhoneticEncoderEnum.SOUNDEX.name(), new Soundex()));
    }
    ...
    public void phoneticMatch() {
        ...
        List<ResourceIndexedSearchParamString> stringParams =
                myResourceIndexedSearchParamStringDao.findAll();

        assertThat(stringParams, hasSize(7));
        List<String> stringParamNames =
                stringParams.stream()
    ...
    private void createPhoneticSearchParameter(
            String theCode, PhoneticEncoderEnum theEncoder, String theFhirPath) {
