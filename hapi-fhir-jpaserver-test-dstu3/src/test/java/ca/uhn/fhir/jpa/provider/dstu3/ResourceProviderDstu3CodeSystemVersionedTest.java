...
public class ResourceProviderDstu3CodeSystemVersionedTest extends BaseResourceProviderDstu3Test {
    ...
    public void testLookupOnExternalCodeMultiVersion() {
        ...
        Parameters respParam =
                myClient.operation()
                        ...
                        .andParameter(
                                "system",
                                new UriType(FhirResourceDaoDstu3TerminologyTest.URL_MY_CODE_SYSTEM))
                        .execute();
    ...
    public void testSubsumesOnCodes_Subsumes() {
        ...
        assertEquals(
                "subsumes", ((CodeType) respParam.getParameter().get(0).getValue()).getValue());
    ...
    public void testSubsumesOnCodes_Subsumedby() {
        ...
        assertEquals("outcome", respParam.getParameter().get(0).getName());
        assertEquals(
                "subsumed-by", ((CodeType) respParam.getParameter().get(0).getValue()).getValue());
    ...
    public void testSubsumesOnCodes_Disjoint() {
        ...
        assertEquals("outcome", respParam.getParameter().get(0).getName());
        assertEquals(
                "not-subsumed", ((CodeType) respParam.getParameter().get(0).getValue()).getValue());
