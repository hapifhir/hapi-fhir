...
public class FhirResourceDaoDstu3SourceTest extends BaseJpaDstu3Test {
	...
	public void testSourceStoreAndSearch() {
		...
		assertEquals(
					"urn:source:0#a_request_id",
					pt0.getMeta().getExtensionString(HapiExtensions.EXT_META_SOURCE));
	...
	public void testSourceNotPreservedAcrossUpdate() {
		...
		assertEquals(
					"urn:source:0", pt0.getMeta().getExtensionString(HapiExtensions.EXT_META_SOURCE));
