...
public class AttachmentUtilTest {
	...
	public void testCreateAttachmentDstu3() {
		...
		assertEquals(
					"{\"resourceType\":\"Observation\",\"valueAttachment\":{\"contentType\":\"text/plain\",\"data\":\"AAECAw==\",\"url\":\"http://foo\",\"size\":123}}",
					encoded);
	}
	...
	public void testCreateAttachmentR4() {
		...
		org.hl7.fhir.r4.model.Communication communication =
					new org.hl7.fhir.r4.model.Communication();
		...
		assertEquals(
					"{\"resourceType\":\"Communication\",\"payload\":[{\"contentAttachment\":{\"contentType\":\"text/plain\",\"data\":\"AAECAw==\",\"url\":\"http://foo\",\"size\":123}}]}",
					encoded);
	}
	...
	public void testCreateAttachmentR5() {
		...
		org.hl7.fhir.r5.model.Communication communication =
					new org.hl7.fhir.r5.model.Communication();
