...
public final class HapiWorkerContext extends I18nBase implements IWorkerContext {
    ...
    public ValidationResult validateCode(
            ValidationOptions theOptions, CodeableConcept theCode, ValueSet theVs) {
    ...
    @Override
    public ValidationResult validateCode(
            ValidationOptions theOptions, Coding theCode, ValueSet theVs) {
    ...
    public ValidationResult validateCode(
        ...
        if (isNotBlank(theVs.getUrl())) {
            ...
            outcome =
                    myValidationSupport.validateCodeInValueSet(
                            new ValidationSupportContext(myValidationSupport),
                            convertConceptValidationOptions(theOptions),
                            theSystem,
                            theCode,
    ...
    public void generateSnapshot(StructureDefinition p) throws FHIRException {
        myValidationSupport.generateSnapshot(
                new ValidationSupportContext(myValidationSupport), p, "", "", "");
    }
    ...
    @Override
    public ValueSetExpander.ValueSetExpansionOutcome expandVS(
            ConceptSetComponent theInc, boolean hierarchical) throws TerminologyServiceException {
        ...
        IValidationSupport.ValueSetExpansionOutcome output =
                myValidationSupport.expandValueSet(
                        new ValidationSupportContext(myValidationSupport), options, input);
        return new ValueSetExpander.ValueSetExpansionOutcome(
                (ValueSet) output.getValueSet(), output.getError(), null);
    }
    ...
    @Override
    public <T extends org.hl7.fhir.r4b.model.Resource> T fetchResource(
        ...
        if (myValidationSupport == null || theUri == null) {
            ...
            T retVal =
                    (T)
                            myFetchedResourceCache.get(
                                    theUri,
                                    t -> myValidationSupport.fetchResource(theClass, theUri));
            return retVal;
        }
    }

    @Override
    public <T extends org.hl7.fhir.r4b.model.Resource> T fetchResourceWithException(
            Class<T> theClass, String theUri) throws FHIRException {
    ...
    @Override
    public <T extends org.hl7.fhir.r4b.model.Resource> boolean hasResource(
    ...
    @Override
    public void cacheResourceFromPackage(Resource res, PackageVersion packageDetails)
    ...
    @Override
    public ValueSetExpander.ValueSetExpansionOutcome expandVS(
            ElementDefinitionBindingComponent theBinding,
            boolean theCacheOk,
            boolean theHierarchical)
            throws FHIRException {
