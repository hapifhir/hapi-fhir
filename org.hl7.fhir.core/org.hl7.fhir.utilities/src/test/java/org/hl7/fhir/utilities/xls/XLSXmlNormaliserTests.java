...
public class XLSXmlNormaliserTests {
  ...
  public void testConvert() throws FHIRException, TransformerException, ParserConfigurationException, SAXException, IOException {
    XLSXmlNormaliser n = new XLSXmlNormaliser("../../hapi-tinder-plugin/src/main/resources/res/r4/observation-spreadsheet.xml", "target/observation-spreadsheet.out.xml", true);
    n.go();
