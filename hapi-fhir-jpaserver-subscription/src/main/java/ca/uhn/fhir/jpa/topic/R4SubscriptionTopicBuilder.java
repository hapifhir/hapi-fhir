...
public class R4SubscriptionTopicBuilder {
    ...
    public R4SubscriptionTopicBuilder() {
        ...
        code.addCoding(new Coding()
            .setSystem("http://hl7.org/fhir/fhir-types")
            .setCode("SubscriptionTopic"));
    ...
    public R4SubscriptionTopicBuilder setDescription(String theDescription) {
        addExtension(SubscriptionConstants.SUBSCRIPTION_TOPIC_R4_EXT_TOPIC_DESCRIPTION, new MarkdownType(theDescription));
        return this;
    }
    ...
    public R4SubscriptionTopicBuilder addResourceTrigger() {
        myCurrentResourceTrigger = new Extension()
            .setUrl(SubscriptionConstants.SUBSCRIPTION_TOPIC_R4_EXT_RESOURCE_TRIGGER);
    ...
    public R4SubscriptionTopicBuilder setResourceTriggerDescription(String theDescription) {
        ...
        addNestedExtension(myCurrentResourceTrigger, 
    ...
    public R4SubscriptionTopicBuilder setResourceTriggerQueryCriteriaPrevious(String thePreviousQuery) {
        ...
        queryCriteria.addExtension(new Extension().setUrl("previous").setValue(new StringType(thePreviousQuery)));
        return this;
    }
    ...
    public R4SubscriptionTopicBuilder setResourceTriggerQueryCriteriaCurrent(String theCurrentQuery) {
        checkCurrentResourceTrigger();
        Extension queryCriteria = getOrCreateQueryCriteriaExtension();
        queryCriteria.addExtension(new Extension().setUrl("current").setValue(new StringType(theCurrentQuery)));
        return this;
    }
    ...
    public R4SubscriptionTopicBuilder setResourceTriggerQueryCriteriaRequireBoth(boolean theRequireBoth) {
        checkCurrentResourceTrigger();
        Extension queryCriteria = getOrCreateQueryCriteriaExtension();
        queryCriteria.addExtension(new Extension().setUrl("requireBoth").setValue(new BooleanType(theRequireBoth)));
        return this;
    }
    ...
    public R4SubscriptionTopicBuilder addCanFilterBy() {
        myCurrentCanFilterBy = new Extension()
            .setUrl(SubscriptionConstants.SUBSCRIPTION_TOPIC_R4_EXT_CAN_FILTER_BY);
    ...
    public R4SubscriptionTopicBuilder setCanFilterByDescription(String theDescription) {
        ...
        addNestedExtension(myCurrentCanFilterBy, 
            SubscriptionConstants.SUBSCRIPTION_TOPIC_R4_EXT_DESCRIPTION, 
            new MarkdownType(theDescription));
        return this;
    }
    ...
    public R4SubscriptionTopicBuilder addNotificationShape() {
        myCurrentNotificationShape = new Extension()
            .setUrl(SubscriptionConstants.SUBSCRIPTION_TOPIC_R4_EXT_NOTIFICATION_SHAPE);
    ...
    public R4SubscriptionTopicBuilder setNotificationShapeResource(String theResourceType) {
        ...
        addNestedExtension(myCurrentNotificationShape, 
            SubscriptionConstants.SUBSCRIPTION_TOPIC_R4_EXT_RESOURCE, 
            new UriType(theResourceType));
        return this;
    }
    ...
    private void checkCurrentNotificationShape() {
        if (myCurrentNotificationShape == null) {
            throw new IllegalStateException("No current notification shape defined. Call addNotificationShape() first.");
        }
    }

    private Extension getOrCreateQueryCriteriaExtension() {
        for (Extension extension : myCurrentResourceTrigger.getExtension()) {
            if ("queryCriteria".equals(extension.getUrl())) {
                return extension;
            }
        }
        Extension queryCriteria = new Extension().setUrl("queryCriteria");
