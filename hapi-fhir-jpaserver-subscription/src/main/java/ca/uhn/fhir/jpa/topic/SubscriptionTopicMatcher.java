...
public class SubscriptionTopicMatcher {
    ...
    public SubscriptionTopicMatcher(
            SubscriptionTopicSupport theSubscriptionTopicSupport, SubscriptionTopic theTopic) {
    ...
    public InMemoryMatchResult match(ResourceModifiedMessage theMsg) {
        ...
        List<SubscriptionTopic.SubscriptionTopicResourceTriggerComponent> triggers =
                myTopic.getResourceTrigger();
