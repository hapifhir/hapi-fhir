 ...
 * Channel is created and a new MessageHandler for that subscription is subscribed to that channel.
 * These subscriptions, channels, and handlers are all caches in this registry so they can be
