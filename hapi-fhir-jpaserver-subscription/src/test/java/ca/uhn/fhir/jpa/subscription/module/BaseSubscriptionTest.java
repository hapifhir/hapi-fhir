...
public abstract class BaseSubscriptionTest {
	...
	@Autowired MockFhirClientSearchParamProvider myMockFhirClientSearchParamProvider;
	...
	public static class MyConfig {
		...
		public SubscriptionChannelFactory mySubscriptionChannelFactory(
					IChannelNamer theChannelNamer) {
				return new SubscriptionChannelFactory(
						new LinkedBlockingChannelFactory(theChannelNamer));
		}
