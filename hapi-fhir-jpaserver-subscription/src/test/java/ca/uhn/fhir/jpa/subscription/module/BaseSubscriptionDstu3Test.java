...
public abstract class BaseSubscriptionDstu3Test extends BaseSubscriptionTest {
	...
	@Autowired protected SubscriptionChannelRegistry mySubscriptionChannelRegistry;
	...
	protected Subscription makeActiveSubscription(
				String theCriteria, String thePayload, String theEndpoint) {
		return mySubscriptionTestHelper.makeActiveSubscription(
	...
	protected Subscription makeSubscriptionWithStatus(
		...
		return mySubscriptionTestHelper.makeSubscriptionWithStatus(
					theCriteria, thePayload, theEndpoint, status);
	}
	...
	protected void assertRegistrySize(
				int theSubscriptionRegistrySize, int theSubscriptionChannelRegistrySize) {
