...
public class SubscriptionCriteriaParserTest {
    ...
    public void testSearchExpression() {
        ...
        SubscriptionCriteriaParser.SubscriptionCriteria criteria =
                SubscriptionCriteriaParser.parse(expression);
        ...
        assertEquals(
                "SubscriptionCriteriaParser.SubscriptionCriteria[type=SEARCH_EXPRESSION,criteria=Patient?foo=bar,applicableResourceTypes=[Patient]]",
                criteria.toString());
    }
    ...
    public void testTypeExpression() {
        ...
        assertThat(criteria.getApplicableResourceTypes(), containsInAnyOrder("Patient"));
        assertEquals(
                "SubscriptionCriteriaParser.SubscriptionCriteria[type=SEARCH_EXPRESSION,criteria=Patient,applicableResourceTypes=[Patient]]",
                criteria.toString());
    }
    ...
    public void testStarExpression() {
        ...
        assertEquals(
                "SubscriptionCriteriaParser.SubscriptionCriteria[type=STARTYPE_EXPRESSION]",
                criteria.toString());
    }
    ...
    public void testMultitypeExpression() {
        ...
        assertThat(
                ...
                containsInAnyOrder("Patient", "Observation"));
        assertEquals(
                "SubscriptionCriteriaParser.SubscriptionCriteria[type=MULTITYPE_EXPRESSION,applicableResourceTypes=[Observation,"
                    + " Patient]]",
                criteria.toString());
    }
