...
public class ResourceModifiedTest {
    ...
    public void testCreate() {
        ...
        ResourceModifiedMessage msg =
                new ResourceModifiedMessage(
                        myFhirContext, org, ResourceModifiedMessage.OperationTypeEnum.CREATE);
    ...
    public void testUpdate() {
        ...
        ResourceModifiedMessage msg =
                new ResourceModifiedMessage(
                        myFhirContext, org, ResourceModifiedMessage.OperationTypeEnum.UPDATE);
        assertEquals(org.getIdElement(), msg.getPayloadId(myFhirContext));
    ...
    public void testDelete() {
        ...
        ResourceModifiedMessage msg =
                new ResourceModifiedMessage(
                        myFhirContext, org, ResourceModifiedMessage.OperationTypeEnum.DELETE);
