...
public class SubscriptionValidatingInterceptorTest {
    private static final Logger ourLog =
            LoggerFactory.getLogger(SubscriptionValidatingInterceptorTest.class);
    ...
    @MockBean private SubscriptionStrategyEvaluator mySubscriptionStrategyEvaluator;
    @MockBean private JpaStorageSettings myStorageSettings;
    @MockBean private IRequestPartitionHelperSvc myRequestPartitionHelperSvc;
    @Mock private IFhirResourceDao<SubscriptionTopic> mySubscriptionTopicDao;
    ...
    public void testEmptySub() {
        try {
            ...
            assertThat(
                    ...
                    is(
                            Msg.code(8)
                                    + "Can not process submitted Subscription - Subscription.status"
    ...
    public void testEmptyStatus() {
        try {
            ...
            assertThat(
                    e.getMessage(), is(Msg.code(11) + "Subscription.criteria must be populated"));
        }
    }
    ...
    public void testBadCriteria() {
        try {
            ...
            assertThat(
                    ...
                    is(
                            Msg.code(14)
                                    + "Subscription.criteria must be in the form \"{Resource"
                                    + " Type}?[params]\""));
        }
    }
    ...
    public void testBadChannel() {
        try {
            ...
            assertThat(
                    e.getMessage(),
                    is(Msg.code(20) + "Subscription.channel.type must be populated"));
        }
    }
    ...
    public void testEmptyEndpoint() {
        try {
            ...
            assertThat(
                    e.getMessage(),
                    is(Msg.code(16) + "No endpoint defined for message subscription"));
        }
    }
    ...
    public void testMalformedEndpoint() {
        ...
        try {
            ...
            assertThat(
                    e.getMessage(),
                    is(Msg.code(19) + "Invalid subscription endpoint uri channel:"));
        }
    ...
    public void testInvalidPointcut() {
        try {
            ...
            assertThat(
                    ...
                    is(
                            Msg.code(2267)
                                    + "Expected Pointcut to be either"
                                    + " STORAGE_PRESTORAGE_RESOURCE_CREATED or"
                                    + " STORAGE_PRESTORAGE_RESOURCE_UPDATED but was: "
                                    + Pointcut.TEST_RB));
        }
    }
    ...
    public void testInvalidTopic() throws URISyntaxException {
        ...
        SimpleBundleProvider emptyBundleProvider =
                new SimpleBundleProvider(Collections.emptyList());
        ...
        badSub.getMeta()
                ...
                .add(
                        new CanonicalType(
                                new URI(SubscriptionConstants.SUBSCRIPTION_TOPIC_PROFILE_URL)));
        ...
        try {
            ...
            assertThat(
                    ...
                    is(
                            Msg.code(2322)
                                    + "No SubscriptionTopic exists with topic: http://topic.url"));
        }
