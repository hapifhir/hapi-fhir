...
public abstract class BaseResourceProviderR4BTest extends BaseJpaR4BTest {
            ...
            new RestfulServerConfigurerExtension(() -> myServer)
                    .withServerBeforeAll(
                            s -> {
                                ...
                                s.getInterceptorService()
                                        .registerInterceptor(myBinaryStorageInterceptor);
                    ...
                    .withServerBeforeEach(
                            s -> {
                                ...
                                // TODO: JA-2 These don't need to be static variables, should just
                                // inline all of the uses of these
    ...
    @Autowired ResourceCountCache ourResourceCountsCache;
