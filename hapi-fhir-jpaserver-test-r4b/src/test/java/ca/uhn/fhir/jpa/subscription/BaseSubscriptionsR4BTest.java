...
public abstract class BaseSubscriptionsR4BTest extends BaseResourceProviderR4BTest {
	private static final org.slf4j.Logger ourLog =
				org.slf4j.LoggerFactory.getLogger(BaseSubscriptionsR4BTest.class);
	protected static int ourListenerPort;

	@Order(0)
	@RegisterExtension
	protected static RestfulServerExtension ourRestfulServer =
				new RestfulServerExtension(FhirContext.forR4BCached());
	...
	public void beforeReset() throws Exception {
		...
		if (myClient != null) {
				...
				for (IBaseResource next :
						BundleUtil.toListOfResources(myFhirContext, allSubscriptions)) {
	...
	protected Subscription createSubscription(
				String theCriteria, String thePayload, Extension theExtension) {
		String id = null;
	...
	protected Subscription newSubscription(String theCriteria, String thePayload) {
		return newSubscriptionWithStatus(
					theCriteria, thePayload, Enumerations.SubscriptionStatus.ACTIVE);
	}
	...
	protected Subscription newSubscriptionWithStatus(
				String theCriteria,
				String thePayload,
				Enumerations.SubscriptionStatus theSubscriptionStatus) {
	...
	protected Observation sendObservation(
				String theCode, String theSystem, String theSource, String theRequestId) {
