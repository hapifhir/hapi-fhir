...
public class ResourceProviderR4BTest extends BaseResourceProviderR4BTest {
    ...
    public void after() throws Exception {
        ...
        this.myStorageSettings.setAllowMultipleDelete(
                new JpaStorageSettings().isAllowMultipleDelete());
        this.myStorageSettings.setAllowExternalReferences(
        ...
        this.myStorageSettings.setCountSearchResultsUpTo(
                new JpaStorageSettings().getCountSearchResultsUpTo());
        this.myStorageSettings.setSearchPreFetchThresholds(
                new JpaStorageSettings().getSearchPreFetchThresholds());
        this.myStorageSettings.setAllowContainsSearches(
                new JpaStorageSettings().isAllowContainsSearches());

        myServer.getInterceptorService()
