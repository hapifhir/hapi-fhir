...
public class FqlRestClient {
	...
	public IFqlExecutionResult execute(Parameters theRequestParameters, boolean theSupportsContinuations) throws SQLException {
		return new RemoteFqlExecutionResult(theRequestParameters, myBaseUrl, myClient, myFetchSize, theSupportsContinuations);
	}
