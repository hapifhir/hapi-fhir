...
public class FqlParserTest {
	...
	private FqlParser mySvc = new FqlParser(FhirContext.forR4Cached());
	...
	public void testFromSelect() {
		...
		FqlStatement statement = mySvc.parse(input);
	...
	public void testError_InvalidStart() {
		String input = """
			blah""";
		DataFormatException ex = assertThrows(DataFormatException.class, () -> mySvc.parse(input));
