...
public class NpmTestDstu3 extends BaseJpaDstu3Test {
	...
	public void installDstu3Package() throws Exception {
		...
		PackageInstallationSpec spec = new PackageInstallationSpec().setPackageName("basisprofil.de").setPackageVersion("0.2.40").setInstallMode(PackageInstallationSpec.InstallModeEnum.STORE_ONLY);
