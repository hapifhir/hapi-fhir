...
public class NpmTestDstu3 extends BaseJpaDstu3Test {
	...
	public void installDstu3Package() throws Exception {
		...
		NpmInstallationSpec spec = new NpmInstallationSpec().setPackageId("basisprofil.de").setPackageVersion("0.2.40").setInstallMode(NpmInstallationSpec.InstallModeEnum.CACHE_ONLY);
