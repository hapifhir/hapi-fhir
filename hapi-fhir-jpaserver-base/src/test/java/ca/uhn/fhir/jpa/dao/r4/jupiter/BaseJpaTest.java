package ca.uhn.fhir.jpa.dao.r4.jupiter;
...
public abstract class BaseJpaTest extends BaseTest {
    ...
    private static final org.slf4j.Logger ourLog = org.slf4j.LoggerFactory.getLogger(ca.uhn.fhir.jpa.dao.BaseJpaTest.class);
    ...
    public void afterValidateNoTransaction() {
        ...
        if (txManager instanceof JpaTransactionManager) {
            ...
            if (currentSession != null) {
                ...
                Assertions.assertFalse(isReadOnly.get());
            }
        }
    }
    ...
    public static void waitForSize(int theTarget, List<?> theList) {
        ...
        if (sw.getMillis() >= 16000) {
            ...
            Assertions.fail("Size " + theList.size() + " is != target " + theTarget + " - Got: " + describeResults);
        }
    }
    ...
    public static void waitForSize(int theTarget, int theTimeout, Callable<Number> theCallable) throws Exception {
        ...
        if (sw.getMillis() >= theTimeout) {
            Assertions.fail("Size " + theCallable.call() + " is != target " + theTarget);
        }
        Thread.sleep(500);
    }
    ...
    public static void waitForSize(int theTarget, int theTimeout, Callable<Number> theCallable, Callable<String> theFailureMessage) throws Exception {
        ...
        if (sw.getMillis() >= theTimeout) {
            Assertions.fail("Size " + theCallable.call() + " is != target " + theTarget + " - " + theFailureMessage.call());
        }
        Thread.sleep(500);
    }
