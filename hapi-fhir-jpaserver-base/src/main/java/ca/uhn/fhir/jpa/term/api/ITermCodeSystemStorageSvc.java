...
public interface ITermCodeSystemStorageSvc {
	 ...
	 * @since 8.12.0
	 */
	default UploadStatistics uploadCodeSystemConcepts(IBaseResource theCodeSystem) {
		return uploadCodeSystemConcepts(ImportTerminologyModeEnum.SNAPSHOT, theCodeSystem);
	}
	...
	UploadStatistics uploadCodeSystemConcepts(ImportTerminologyModeEnum theMode, IBaseResource theCodeSystem);
