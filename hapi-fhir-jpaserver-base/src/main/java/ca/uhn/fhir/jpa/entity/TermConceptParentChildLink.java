...
public class TermConceptParentChildLink implements Serializable {
	...
	public int hashCode() {
		...
		result =
					prime * result + ((myRelationshipType == null) ? 0 : myRelationshipType.hashCode());
		return result;
	}
	...
	public TermConceptParentChildLink setRelationshipType(
				RelationshipTypeEnum theRelationshipType) {
