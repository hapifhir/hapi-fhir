...
import ca.uhn.fhir.jpa.bulk.export.job.BulkImportJobConfig;
import ca.uhn.fhir.jpa.bulk.export.model.BulkImportJobStatusEnum;
import ca.uhn.fhir.jpa.bulk.export.svc.BulkImportDaoSvc;
...
public class CreateBulkImportEntityStepListener implements StepExecutionListener {
	...
	public void beforeStep(StepExecution theStepExecution) {
		String jobUuid = theStepExecution.getJobExecution().getJobParameters().getString(BulkImportJobConfig.JOB_UUID_PARAMETER);
		if (jobUuid != null) {
