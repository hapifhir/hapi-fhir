...
@Table(
        ...
        indexes = {@Index(name = "IDX_CNCPT_MP_GRP_ELM_TGT_CD", columnList = "TARGET_CODE")})
public class TermConceptMapGroupElementTarget implements Serializable {
    ...
    @Id()
    @SequenceGenerator(
            name = "SEQ_CNCPT_MAP_GRP_ELM_TGT_PID",
            sequenceName = "SEQ_CNCPT_MAP_GRP_ELM_TGT_PID")
    ...
    public void setConceptMapGroupElement(
            TermConceptMapGroupElement theTermConceptMapGroupElement) {
    ...
    public String getConceptMapUrl() {
        if (myConceptMapUrl == null) {
            myConceptMapUrl =
                    getConceptMapGroupElement().getConceptMapGroup().getConceptMap().getUrl();
        }
        ...
        return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE)
                ...
                .append(
                        myConceptMapGroupElement != null
                                ? ("myConceptMapGroupElement - id="
                                        + myConceptMapGroupElement.getId())
                                : ("myConceptMapGroupElement=(null)"))
