...
public class ParsedDeleteExpungeRecord implements Serializable {
	...
	public ParsedDeleteExpungeRecord(String theTenantName, IBaseResource theRowContent, int theLineIndex) {
