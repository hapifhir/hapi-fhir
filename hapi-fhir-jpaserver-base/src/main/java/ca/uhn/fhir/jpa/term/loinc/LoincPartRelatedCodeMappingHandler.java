...
public class LoincPartRelatedCodeMappingHandler extends BaseLoincHandler
    ...
    public static final String LOINC_PART_TO_RID_PART_MAP_URI =
            "http://loinc.org/cm/loinc-parts-to-radlex";
    ...
    private static final String LOINC_RXNORM_PART_MAP_URI =
            "http://loinc.org/cm/loinc-parts-to-rxnorm";
    ...
    private static final String LOINC_PUBCHEM_PART_MAP_URI =
    ...
    public void accept(CSVRecord theRecord) {
        ...
        if (codeSystemVersionId != null) {
            loincPartMapVersion =
                    myUploadProperties.getProperty(LOINC_CONCEPTMAP_VERSION.getCode())
                            + "-"
                            + codeSystemVersionId;
        } else {
            loincPartMapVersion =
