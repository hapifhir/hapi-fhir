...
@Table(
		...
		indexes = {
			...
			// indexes for metrics
			@Index(name = "IDX_EMPI_TGT_LS_MR", columnList = "TARGET_TYPE, LINK_SOURCE, MATCH_RESULT"),
			@Index(name = "IDX_EMPI_TGT_SCORE_MR", columnList = "TARGET_TYPE, SCORE, MATCH_RESULT")
		})
@Audited
