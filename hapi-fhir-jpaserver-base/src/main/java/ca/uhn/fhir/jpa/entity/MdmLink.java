...
@Table(
		...
		indexes = {
				@Index(
						name = "IDX_EMPI_MATCH_TGT_VER",
						columnList = "MATCH_RESULT, TARGET_PID, VERSION"),
				// v---- this one
...
public class MdmLink extends AuditableBasePartitionable implements IMdmLink<JpaPid> {
	...
	*/
	...
	/**
	* Note that this method can not be called <code>getEidMatch</code> or <code>isEidMatch</code>
