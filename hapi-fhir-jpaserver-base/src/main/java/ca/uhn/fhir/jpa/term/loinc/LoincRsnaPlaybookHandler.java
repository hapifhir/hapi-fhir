...
public class LoincRsnaPlaybookHandler extends BaseLoincHandler implements IZipContentsHandlerCsv {
    ...
    public static final String RSNA_CODES_VS_URI =
    ...
    private static final String CM_COPYRIGHT =
            "The LOINC/RSNA Radiology Playbook and the LOINC Part File contain content from RadLex®"
                + " (http://rsna.org/RadLex.aspx), copyright © 2005-2017, The Radiological Society"
                + " of North America, Inc., available at no cost under the license at"
                + " http://www.rsna.org/uploadedFiles/RSNA/Content/Informatics/RadLex_License_Agreement_and_Terms_of_Use_V2_Final.pdf.";
        ...
        if (codeSystemVersionId != null) {
            partConceptMapId =
                    LoincPartRelatedCodeMappingHandler.LOINC_PART_TO_RID_PART_MAP_ID
                            ...
                            + codeSystemVersionId;
            termConceptMapId =
                    LoincPartRelatedCodeMappingHandler.LOINC_TERM_TO_RPID_PART_MAP_ID
                            + "-"
                            + codeSystemVersionId;
        } else {
