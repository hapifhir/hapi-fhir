...
public class LoincPartLinkHandler implements IZipContentsHandlerCsv {
	...
	public void accept(CSVRecord theRecord) {
		...
		Optional<TermConceptProperty> existingProprty =
					loincConcept.getProperties().stream()
		...
		if (propertyType == CodeSystem.PropertyType.STRING) {
				...
				loincConcept.addPropertyCoding(
						propertyPart, ITermLoaderSvc.LOINC_URI, partNumber, partName);
		}
	}
}
