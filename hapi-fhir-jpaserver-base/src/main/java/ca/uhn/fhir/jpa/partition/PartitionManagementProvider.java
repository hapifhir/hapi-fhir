 ...
 *
 * <ul>
 *   <li><code>partition-management-create-partition</code>
 *   <li><code>partition-management-update-partition</code>
 *   <li><code>partition-management-delete-partition</code>
 *   <li><code>partition-management-read-partition</code>
 *   <li><code>partition-management-list-partitions</code>
 * </ul>
 */
public class PartitionManagementProvider {
    ...
    public IBaseParameters addPartition(
        ...
        PartitionEntity input =
                parseInput(thePartitionId, thePartitionName, thePartitionDescription);
