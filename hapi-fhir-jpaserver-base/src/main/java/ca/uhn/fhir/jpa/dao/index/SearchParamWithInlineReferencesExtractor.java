...
public class SearchParamWithInlineReferencesExtractor
    ...
    @VisibleForTesting
    public void setSearchParamExtractorService(
            SearchParamExtractorService theSearchParamExtractorService) {
    ...
    public void storeUniqueComboParameters(
        ...
        if (myStorageSettings.isUniqueIndexesEnabled()) {
            for (ResourceIndexedComboStringUnique next :
                    DaoSearchParamSynchronizer.subtract(
            ...
            for (ResourceIndexedComboStringUnique next :
                ...
                if (myStorageSettings.isUniqueIndexesCheckedBeforeSave()) {
                    ResourceIndexedComboStringUnique existing =
                            myResourceIndexedCompositeStringUniqueDao.findByQueryString(
                                    next.getIndexString());
                    if (existing != null) {
                        ...
                        // Use ResourceVersionConflictException here because the
