...
/**
 * The purpose of this service is to define and register a job that will clean up entries created by
 * an instance of {@link ResourceSearchUrlSvc}.
 */
public class SearchUrlJobMaintenanceSvcImpl
        implements ISearchUrlJobMaintenanceSvc, IHasScheduledJobs {
     ...
     * We can shorten this if we have memory or storage pressure. MUST be longer that longest
     * transaction possible to work.
     */
    ...
    public static class SearchUrlMaintenanceJob implements HapiJob {
        ...
        @Autowired private ISearchUrlJobMaintenanceSvc mySearchUrlJobMaintenanceSvc;
