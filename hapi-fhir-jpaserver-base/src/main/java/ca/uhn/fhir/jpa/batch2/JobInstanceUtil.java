...
class JobInstanceUtil {
    ...
    public static JobInstance fromEntityToInstance(@Nonnull Batch2JobInstanceEntity theEntity) {
        ...
        retVal.setCombinedRecordsProcessedPerSecond(
                theEntity.getCombinedRecordsProcessedPerSecond());
    ...
    public static void fromInstanceToEntity(
            @Nonnull JobInstance theJobInstance,
            @Nonnull Batch2JobInstanceEntity theJobInstanceEntity) {
        ...
        theJobInstanceEntity.setCombinedRecordsProcessed(
                theJobInstance.getCombinedRecordsProcessed());
