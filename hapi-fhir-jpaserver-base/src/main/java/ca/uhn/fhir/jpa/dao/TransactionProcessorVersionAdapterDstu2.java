...
public class TransactionProcessorVersionAdapterDstu2
	...
	public void populateEntryWithOperationOutcome(
				BaseServerResponseException theCaughtEx, Bundle.Entry theEntry) {
	...
	public Bundle createBundle(String theBundleType) {
		...
		try {
				...
				throw new InternalErrorException(
						Msg.code(936) + "Unknown bundle type: " + theBundleType);
		}
		return resp;
	}
	...
	public void setResponseOutcome(
				Bundle.Entry theEntry, IBaseOperationOutcome theOperationOutcome) {
