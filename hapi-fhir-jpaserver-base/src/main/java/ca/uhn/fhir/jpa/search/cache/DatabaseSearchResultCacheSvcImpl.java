...
public class DatabaseSearchResultCacheSvcImpl implements ISearchResultCacheSvc {
    private static final Logger ourLog =
            LoggerFactory.getLogger(DatabaseSearchResultCacheSvcImpl.class);
        ...
        return myTransactionService
                ...
                .execute(
                        () -> {
                            ...
                            ourLog.debug(
                                    "fetchResultPids for range {}-{} returned {} pids",
                                    theFrom,
                                    theTo,
                                    retVal.size());
    ...
    public List<JpaPid> fetchAllResultPids(
        ...
        return myTransactionService
                ...
                .execute(
                        () -> {
                            List<Long> retVal =
                                    mySearchResultDao.findWithSearchPidOrderIndependent(
                                            theSearch.getId());
                ...
                .execute(
                        () -> {
                            ...
                            for (JpaPid nextPid : theNewResourcePids) {
                                ...
                                ourLog.trace(
                                        "Saving ORDER[{}] Resource {}",
                                        order,
                                        nextResult.getResourcePid());
