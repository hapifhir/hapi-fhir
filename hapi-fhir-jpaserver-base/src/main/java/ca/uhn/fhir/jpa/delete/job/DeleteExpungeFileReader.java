...
public class DeleteExpungeFileReader implements ItemReader<ParsedDeleteExpungeRecord> {
	...
	@Override
	public ParsedDeleteExpungeRecord read() throws Exception {

		if (myReader == null) {
			// FIXME KHS
//			DeleteExpungeJobFileJson file = myBulkDataImportSvc.fetchFile(myJobUuid, myFileIndex);
...
//			myReader = new StringReader(file.getContents());
		...
		return new ParsedDeleteExpungeRecord(myTenantName, parsed, myLineIndex);
	}
}
