...
public interface IValueSetConceptAccumulator {
    ...
    /**
     * Add or subtract from the total concept count (this is not necessarily the same thing as the
     * number of concepts in the accumulator, since the <code>offset</code> and <code>count</code>
     * parameters applied to the expansion can cause concepts to not actually be added.
     *
