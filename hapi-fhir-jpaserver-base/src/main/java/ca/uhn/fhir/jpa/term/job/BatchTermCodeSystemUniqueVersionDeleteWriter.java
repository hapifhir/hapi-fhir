...
@Component
public class BatchTermCodeSystemUniqueVersionDeleteWriter implements ItemWriter<Long> {
	private static final Logger ourLog = LoggerFactory.getLogger(BatchTermCodeSystemUniqueVersionDeleteWriter.class);
