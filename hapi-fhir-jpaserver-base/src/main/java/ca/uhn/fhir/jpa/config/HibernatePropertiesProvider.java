...
public class HibernatePropertiesProvider {
    ...
    @Autowired private LocalContainerEntityManagerFactoryBean myEntityManagerFactory;
    ...
    public String getHibernateSearchBackend() {
        ...
        if (StringUtils.isBlank(hibernateSearchBackend)) {
            ...
            Validate.notNull(
                    hibernateSearchBackend,
                    BackendSettings.backendKey(BackendSettings.TYPE) + " property is unset!");
