...
public interface IDao {
	...
	<R extends IBaseResource> R toResource(Class<R> theResourceType, IBaseResourceEntity theHistory, Collection<ResourceTag> theTagList, boolean theForHistoryOperation);
}
