...
public abstract class BaseJpaResourceProviderStructureDefinition<T extends IBaseResource>
    ...
    public IBaseResource snapshot(
            ...
            @OperationParam(name = "definition", typeName = "StructureDefinition")
                    IBaseResource theStructureDefinition,
        ...
        ValidateUtil.exactlyOneNotNullOrThrowInvalidRequestException(
                ...
                "Must supply either an ID or a StructureDefinition or a URL (but not more than one"
                        + " of these things)");
        ...
        if (theId == null && theStructureDefinition != null && theUrl == null) {
            ...
            map.add(
                    org.hl7.fhir.r4.model.StructureDefinition.SP_URL,
                    new UriParam(theUrl.getValue()));
