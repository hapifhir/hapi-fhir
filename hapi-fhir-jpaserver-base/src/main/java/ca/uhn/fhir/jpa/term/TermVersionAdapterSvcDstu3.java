...
public class TermVersionAdapterSvcDstu3 extends BaseTermVersionAdapterSvcImpl
	...
	*/
	...
	public void start(ContextRefreshedEvent theEvent) {
		myCodeSystemResourceDao =
					(IFhirResourceDao<CodeSystem>) myAppCtx.getBean("myCodeSystemDaoDstu3");
		myValueSetResourceDao = (IFhirResourceDao<ValueSet>) myAppCtx.getBean("myValueSetDaoDstu3");
		myConceptMapResourceDao =
					(IFhirResourceDao<ConceptMap>) myAppCtx.getBean("myConceptMapDaoDstu3");
	}
				...
				resourceToStore =
						(CodeSystem)
									VersionConvertorFactory_30_40.convertResource(
												theCodeSystemResource, new BaseAdvisor_30_40(false));
	...
	public void createOrUpdateConceptMap(org.hl7.fhir.r4.model.ConceptMap theConceptMap) {
		...
		try {
				resourceToStore =
						(ConceptMap)
									VersionConvertorFactory_30_40.convertResource(
												theConceptMap, new BaseAdvisor_30_40(false));
		} catch (FHIRException e) {
	...
	public void createOrUpdateValueSet(org.hl7.fhir.r4.model.ValueSet theValueSet) {
		...
		try {
				valueSetDstu3 =
						(ValueSet)
									VersionConvertorFactory_30_40.convertResource(
												theValueSet, new BaseAdvisor_30_40(false));
		} catch (FHIRException e) {
