        ...
        if (theFromVersion == null || theFromVersion.getValueAsString() == null) {
            ...
            while (--versionId > 0L && sourceResource == null) {
                ...
                try {
                    ...
                    ourLog.trace(
                            "Resource version {} can not be found, most likely it was expunged",
                            nextVersionedId);
                }
            }
            ...
            sourceResource =
                    dao.read(
                            theResourceId.withVersion(Long.toString(fromVersion)),
                            theRequestDetails);
        }
    ...
    public IBaseParameters diff(
        ...
        if (!Objects.equal(theFromVersion.getResourceType(), theToVersion.getResourceType())) {
            String msg =
                    myContext
                            .getLocalizer()
                            .getMessage(DiffProvider.class, "cantDiffDifferentTypes");
