	...
	protected void init8_12_0() {
		...
		// Add HFJ_SPIDX2_TOKEN_COMMON table
		{
			Builder.BuilderAddTableByColumns spidx2TokenCommon =
					version.addTableByColumns("20260609.10", "HFJ_SPIDX2_TOKEN_COMMON", "HASH_SYS_AND_VALUE");
			...
			spidx2TokenCommon
					.addIndex("20260609.20", "IDX_SP2_TOKEN_COMMON_SYSTEM")
					.unique(false)
					.withColumns("SYSTEM_ID", "HASH_SYS_AND_VALUE");
			spidx2TokenCommon
					.addIndex("20260609.30", "IDX_SP2_TOKEN_COMMON_VALUE")
					.unique(false)
					.withColumns("HASH_VALUE", "HASH_SYS_AND_VALUE");
			spidx2TokenCommon
					.addIndex("20260609.40", "IDX_SP2_TOKEN_COMMON_IDENTITY")
					.unique(false)
		...
		// Add HFJ_SPIDX2_TOKEN_COMMON_RES table
		{
			...
			if (getFlags().contains(FlagEnum.DB_PARTITION_MODE)) {
				...
				spidx2TokenCommonRes = version.addTableByColumns(
								"20260609.50", "HFJ_SPIDX2_TOKEN_COMMON_RES", "RES_ID", "HASH_SYS_AND_VALUE")
			...
			if (getFlags().contains(FlagEnum.DB_PARTITION_MODE)) {
				spidx2TokenCommonRes
						.addForeignKey("20260609.70", "FK_SP2_TOKEN_COMMON_RES")
