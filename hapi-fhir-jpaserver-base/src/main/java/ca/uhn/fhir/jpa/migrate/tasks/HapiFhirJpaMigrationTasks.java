...
public class HapiFhirJpaMigrationTasks extends BaseMigrationTasks<VersionEnum> {
	...
	protected void init820() {
		...
		{
			version.addIdGenerator("20250309.1", "SEQ_SPIDX_IDENTITY", 1);
			Builder.BuilderAddTableByColumns spidxIdentity =
					version.addTableByColumns("20250309.2", "HFJ_SPIDX_IDENTITY", "SP_IDENTITY_ID");
			...
			spidxIdentity
					.addIndex("20250309.3", "HFJ_SPIDX_HASH_IDENTITY")
					.unique(true)
