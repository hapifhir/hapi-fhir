...
public class ImportImgthlaJobParametersValidator
		implements ca.uhn.fhir.batch2.api.IJobParametersValidator<ImportImgthlaJobParameters> {
	private static final Pattern VERSION_PATTERN = Pattern.compile("[^ ]+");

	@Nullable
	@Override
	public List<String> validate(RequestDetails theRequestDetails, @Nonnull ImportImgthlaJobParameters theParameters) {
