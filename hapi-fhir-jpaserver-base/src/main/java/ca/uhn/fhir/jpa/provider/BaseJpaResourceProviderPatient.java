...
public abstract class BaseJpaResourceProviderPatient<T extends IBaseResource>
    ...
    public IBundleProvider patientInstanceEverything(
            ...
            @Description(
                            shortDefinition =
                                    "Filter the resources to return only resources matching the"
                                        + " given _content filter (note that this filter is applied"
                                        + " only to results which link to the given patient, not to"
                                        + " the patient itself or to supporting resources linked to"
                                        + " by the matched resources)")
                    @OperationParam(
            ...
            @Description(
                            shortDefinition =
                                    "Filter the resources to return only resources matching the"
                                        + " given _text filter (note that this filter is applied"
                                        + " only to results which link to the given patient, not to"
                                        + " the patient itself or to supporting resources linked to"
                                        + " by the matched resources)")
                    @OperationParam(
            ...
            @Description(
                            shortDefinition =
                                    "Filter the resources to return only resources matching the"
                                        + " given _filter filter (note that this filter is applied"
                                        + " only to results which link to the given patient, not to"
                                        + " the patient itself or to supporting resources linked to"
                                        + " by the matched resources)")
                    @OperationParam(
            ...
            @Description(
                            shortDefinition =
                                    "Filter the resources to return only resources matching the"
                                        + " given _type filter (note that this filter is applied"
                                        + " only to results which link to the given patient, not to"
                                        + " the patient itself or to supporting resources linked to"
                                        + " by the matched resources)")
                    @OperationParam(
        ...
        try {
            ...
            return ((IFhirResourceDaoPatient<?>) getDao())
                    .patientInstanceEverything(
                            theServletRequest, theRequestDetails, everythingParams, theId);
        } finally {
    ...
    public IBundleProvider patientTypeEverything(
            ...
            @Description(
                            shortDefinition =
                                    "Filter the resources to return based on the patient ids"
                                            + " provided.")
                    @OperationParam(
