...
@Subselect(
         ...
         */
        "SELECT CONCAT(vsc.PID, CONCAT(' ', vscd.PID)) AS PID,        vsc.PID                      "
            + "   AS CONCEPT_PID,        vsc.VALUESET_PID                AS CONCEPT_VALUESET_PID,  "
            + "      vsc.VALUESET_ORDER              AS CONCEPT_VALUESET_ORDER,       "
            + " vsc.SYSTEM_URL                  AS CONCEPT_SYSTEM_URL,        vsc.CODEVAL          "
            + "           AS CONCEPT_CODEVAL,        vsc.DISPLAY                     AS"
            + " CONCEPT_DISPLAY,        vsc.SYSTEM_VER                  AS SYSTEM_VER,       "
            + " vsc.SOURCE_PID                  AS SOURCE_PID,        vsc.SOURCE_DIRECT_PARENT_PIDS"
            + "   AS SOURCE_DIRECT_PARENT_PIDS,        vscd.PID                        AS"
