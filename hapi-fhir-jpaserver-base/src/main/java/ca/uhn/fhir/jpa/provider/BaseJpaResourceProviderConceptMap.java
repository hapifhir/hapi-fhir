...
public abstract class BaseJpaResourceProviderConceptMap<T extends IBaseResource>
    ...
    public IBaseParameters translate(
        ...
        boolean haveSourceCodeSystem =
                theSourceCodeSystem != null && theSourceCodeSystem.hasValue();
        ...
        if ((!haveSourceCode && !haveSourceCoding && !haveSourceCodeableConcept)
            ...
            throw new InvalidRequestException(
                    Msg.code(1154)
                            ...
                            + " codeableConcept) must be provided, to identify the code that is to"
                            + " be translated.");
        }
        ...
        if (haveSourceCode) {
            translationRequest
                    .getCodeableConcept()
                    .addCoding()
                    .setCode(toStringValue(theSourceCode));
        ...
        try {
            IFhirResourceDaoConceptMap<ConceptMap> dao =
                    (IFhirResourceDaoConceptMap<ConceptMap>) getDao();
