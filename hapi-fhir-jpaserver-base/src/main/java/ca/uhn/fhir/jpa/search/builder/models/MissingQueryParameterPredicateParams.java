...
public class MissingQueryParameterPredicateParams {
    ...
    /**
     * The missing boolean. True if looking for missing fields. False if looking for non-missing
     * fields.
     */
    ...
    public MissingQueryParameterPredicateParams(
            ca.uhn.fhir.jpa.search.builder.predicate.ResourceTablePredicateBuilder
                    theResourceTablePredicateBuilder,
    ...
    public ca.uhn.fhir.jpa.search.builder.predicate.ResourceTablePredicateBuilder
