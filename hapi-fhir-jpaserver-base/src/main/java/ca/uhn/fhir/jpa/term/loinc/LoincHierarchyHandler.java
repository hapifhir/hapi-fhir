    ...
    public void accept(CSVRecord theRecord) {
        ...
        if (isNotBlank(parentCode) && isNotBlank(childCode)) {
            ...
            parent.addPropertyCoding(
                    "child", ITermLoaderSvc.LOINC_URI, child.getCode(), child.getDisplay());

            child.addPropertyCoding(
                    "parent", ITermLoaderSvc.LOINC_URI, parent.getCode(), parent.getDisplay());
        }
    }
