...
public class ImportIcd10JobParametersValidator
		implements ca.uhn.fhir.batch2.api.IJobParametersValidator<ImportIcdJobParameters> {
	private static final Pattern VERSION_PATTERN = Pattern.compile("[^ ]+");

	@Nullable
	@Override
	public List<String> validate(RequestDetails theRequestDetails, @Nonnull ImportIcdJobParameters theParameters) {
