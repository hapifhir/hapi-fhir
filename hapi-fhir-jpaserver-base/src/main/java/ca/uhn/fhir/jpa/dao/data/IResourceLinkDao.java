...
public interface IResourceLinkDao extends JpaRepository<ResourceLink, Long>, IHapiFhirJpaRepository {
	...
	/**
	 * Deletes all {@code HFJ_RES_LINK} rows where {@code thePid} is the source or target.
	 * Queries raw scalar columns to avoid the {@code JpaPid} null-partition comparison issue
	 * ({@code partition_id = NULL} is always false in SQL).
	 */
	// Generated by claude-sonnet-4-6
	@Modifying
	@Query("DELETE FROM ResourceLink t WHERE t.mySourceResourcePid = :pid OR t.myTargetResourcePid = :pid")
	void deleteAllLinksByResourcePid(@Param("pid") Long thePid);
