...
public interface IResourceLinkDao extends JpaRepository<ResourceLink, Long>, IHapiFhirJpaRepository {
	...
	@Modifying
	@Query("DELETE FROM ResourceLink t WHERE t.mySourceResource.myPid = :pid OR t.myTargetResource.myPid = :pid")
	void deleteAllLinksByResourcePid(@Param("pid") JpaPid thePid);
