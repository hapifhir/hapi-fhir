...
public interface ISearchResultDao extends JpaRepository<SearchResult, Long>, IHapiFhirJpaRepository {
	...
	@Query(value = "SELECT NEW ca.uhn.fhir.jpa.model.dao.JpaPid(r.myResourcePartitionId, r.myResourcePid) FROM SearchResult r WHERE r.mySearchPid = :search ORDER BY r.myOrder ASC")
