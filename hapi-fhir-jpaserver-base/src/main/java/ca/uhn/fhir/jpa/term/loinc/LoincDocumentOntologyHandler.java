...
public class LoincDocumentOntologyHandler extends BaseLoincHandler
    ...
    private static final Logger ourLog =
            LoggerFactory.getLogger(LoincDocumentOntologyHandler.class);

    public static final String DOCUMENT_ONTOLOGY_CODES_VS_ID = "loinc-document-ontology";
    public static final String DOCUMENT_ONTOLOGY_CODES_VS_URI =
    ...
    public void accept(CSVRecord theRecord) {
        ...
        if (code != null) {
            code.addPropertyCoding(
                    loincCodePropName, ITermLoaderSvc.LOINC_URI, partNumber, partName);
            ourLog.debug(
                    "Adding coding property: {} to concept.code {}", loincCodePropName, partNumber);
        }
    }
}
