...
public class SubscriptionsRequireManualActivationInterceptorR4 extends ServerOperationInterceptorAdapter {
	...
	public void resourceCreated(RequestDetails theRequest, IBaseResource theResource) {
		if (myDao.getContext().getResourceName(theResource).equals(ResourceTypeEnum.SUBSCRIPTION.getCode())) {
	...
	public void resourceUpdated(RequestDetails theRequest, IBaseResource theOldResource, IBaseResource theNewResource) {
		if (myDao.getContext().getResourceName(theNewResource).equals(ResourceTypeEnum.SUBSCRIPTION.getCode())) {
