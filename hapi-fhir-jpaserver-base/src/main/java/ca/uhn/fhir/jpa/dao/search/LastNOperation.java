...
public class LastNOperation {
	...
	private final ExtendedHSearchSearchBuilder myExtendedHSearchSearchBuilder =
	...
	public List<Long> executeLastN(SearchParameterMap theParams, Integer theMaximumResults) {
		...
		SearchResult<ResourceTable> result =
					mySession
																...
																b -> {
																	...
																	ExtendedHSearchClauseBuilder builder =
																				new ExtendedHSearchClauseBuilder(
																						...
																						b,
																						f);
																	myExtendedHSearchSearchBuilder
								...
								.aggregation(
										observationsByCodeKey,
										f -> f.fromJson(lastNAggregation.toAggregation()))
								.fetch(0);
