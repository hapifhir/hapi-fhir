...
public class SqlObjectFactory {
    ...
    public ComboUniqueSearchParameterPredicateBuilder newComboUniqueSearchParameterPredicateBuilder(
        ...
        return myApplicationContext.getBean(
                ComboUniqueSearchParameterPredicateBuilder.class, theSearchSqlBuilder);
    }
    ...
    public ComboNonUniqueSearchParameterPredicateBuilder
            newComboNonUniqueSearchParameterPredicateBuilder(
                    SearchQueryBuilder theSearchSqlBuilder) {
        return myApplicationContext.getBean(
                ComboNonUniqueSearchParameterPredicateBuilder.class, theSearchSqlBuilder);
    }
    ...
    public QuantityNormalizedPredicateBuilder quantityNormalizedIndexTable(
            SearchQueryBuilder theSearchSqlBuilder) {
        return myApplicationContext.getBean(
                QuantityNormalizedPredicateBuilder.class, theSearchSqlBuilder);
    }
    ...
    public ResourceTablePredicateBuilder resourceTable(SearchQueryBuilder theSearchSqlBuilder) {
        return myApplicationContext.getBean(
                ResourceTablePredicateBuilder.class, theSearchSqlBuilder);
    }
    ...
    public SearchParamPresentPredicateBuilder searchParamPresentPredicateBuilder(
            SearchQueryBuilder theSearchSqlBuilder) {
        return myApplicationContext.getBean(
                SearchParamPresentPredicateBuilder.class, theSearchSqlBuilder);
    }
    ...
    public SourcePredicateBuilder newSourcePredicateBuilder(
            SearchQueryBuilder theSearchSqlBuilder) {
    ...
    public SearchQueryExecutor newSearchQueryExecutor(
        ...
        return myApplicationContext.getBean(
                SearchQueryExecutor.class, theGeneratedSql, theMaxResultsToFetch);
    }
}
