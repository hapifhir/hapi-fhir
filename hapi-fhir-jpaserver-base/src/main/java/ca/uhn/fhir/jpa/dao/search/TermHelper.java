...
public class TermHelper {
	...
	/**
	* Each input set element is: _ copied to the output set unchanged if it contains a '*'
	* character or is quoted _ trimmed, tokenized by spaces, and suffixed by ' *', and each
	* resulting string copied to the output set
	*/
	...
	*
	* @see
	*     "https://lucene.apache.org/core/8_11_2/queryparser/org/apache/lucene/queryparser/simple/SimpleQueryParser.html"
	*/
	static boolean isToLeftUntouched(String theString) {
		// remove backslashed * and - characters from string before checking, as those shouldn't be
		// considered
