...
public class DeleteExpungeSvcImpl implements IDeleteExpungeSvc<JpaPid> {
    ...
    public int deleteExpunge(
        ...
        DeleteExpungeSqlBuilder.DeleteExpungeSqlResult sqlResult =
                myDeleteExpungeSqlBuilder.convertPidsToDeleteExpungeSql(
                        theJpaPids, theCascade, theCascadeMaxRounds);
        ...
        // TODO KHS instead of logging progress, produce result chunks that get aggregated into a
        // delete expunge report
    ...
    /**
     * If we are running with HS enabled, the expunge operation will cause dangling documents
     * because Hibernate Search is not aware of custom SQL queries that delete resources. This
     * method clears the Hibernate Search index for the given resources.
     */
