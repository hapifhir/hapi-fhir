...
public class CandidateSearcher {
     ...
     * @return Optional.empty() if >= IMdmSettings.getCandidateSearchLimit() candidates are found,
     *     otherwise return the bundle provider for the search results.
     */
    ...
    public Optional<IBundleProvider> search(String theResourceType, String theResourceCriteria) {
        return this.search(
                theResourceType, theResourceCriteria, RequestPartitionId.allPartitions());
    }
