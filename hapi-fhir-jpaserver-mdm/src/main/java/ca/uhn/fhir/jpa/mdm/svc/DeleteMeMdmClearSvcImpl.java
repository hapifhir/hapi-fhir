 ...
 */
// FIXME KHS remove
public class DeleteMeMdmClearSvcImpl implements IMdmExpungeSvc {
	...
	@Autowired
	public DeleteMeMdmClearSvcImpl(MdmLinkDaoSvc theMdmLinkDaoSvc, MdmGoldenResourceDeletingSvc theMdmGoldenResourceDeletingSvcImpl, IMdmSettings theIMdmSettings) {
