...
/**
 * This class acts as a layer between MdmProviders and MDM services to support a REST API that's not
 * a FHIR Operation API.
 */
@Service
public class MdmControllerSvcImpl implements IMdmControllerSvc {
	...
	@Autowired IGoldenResourceMergerSvc myGoldenResourceMergerSvc;
	@Autowired IMdmLinkQuerySvc myMdmLinkQuerySvc;
	@Autowired IMdmLinkUpdaterSvc myIMdmLinkUpdaterSvc;
	@Autowired IMdmLinkCreateSvc myIMdmLinkCreateSvc;
	...
	public IAnyResource mergeGoldenResources(
		...
		IAnyResource fromGoldenResource =
					myMdmControllerHelper.getLatestGoldenResourceFromIdOrThrowException(
								ProviderConstants.MDM_MERGE_GR_FROM_GOLDEN_RESOURCE_ID,
								theFromGoldenResourceId);
		IAnyResource toGoldenResource =
					myMdmControllerHelper.getLatestGoldenResourceFromIdOrThrowException(
								ProviderConstants.MDM_MERGE_GR_TO_GOLDEN_RESOURCE_ID,
								theToGoldenResourceId);
		...
		return myGoldenResourceMergerSvc.mergeGoldenResources(
					fromGoldenResource,
					theManuallyMergedGoldenResource,
					toGoldenResource,
	...
	public Page<MdmLinkJson> queryLinks(
		...
		resultPage =
					queryLinksFromPartitionList(theMdmQuerySearchParameters, theMdmTransactionContext);
	...
	public Page<MdmLinkJson> getDuplicateGoldenResources(
		...
		return myMdmLinkQuerySvc.getDuplicateGoldenResources(
					theMdmTransactionContext, thePageRequest, null, null);
	}
	...
	public Page<MdmLinkJson> getDuplicateGoldenResources(
		...
		if (readPartitionId.isAllPartitions()) {
				resultPage =
						myMdmLinkQuerySvc.getDuplicateGoldenResources(
	...
	public IAnyResource updateLink(
		...
		IAnyResource source =
					myMdmControllerHelper.getLatestSourceFromIdOrThrowException(
		...
		return myIMdmLinkUpdaterSvc.updateLink(
					goldenResource, source, matchResult, theMdmTransactionContext);
	}
	...
	public IAnyResource createLink(
		...
		return myIMdmLinkCreateSvc.createLink(
					goldenResource, source, matchResult, theMdmTransactionContext);
	}
	...
	public IBaseParameters submitMdmClearJob(
		...
		ReadPartitionIdRequestDetails details =
					ReadPartitionIdRequestDetails.forOperation(
								null, null, ProviderConstants.OPERATION_MDM_CLEAR);
	...
	public IBaseParameters submitMdmSubmitJob(
		...
		Batch2JobStartResponse batch2JobStartResponse =
					myJobCoordinator.startInstance(theRequestDetails, request);
	...
	public void notDuplicateGoldenResource(
		...
		myIMdmLinkUpdaterSvc.notDuplicateGoldenResource(
					goldenResource, target, theMdmTransactionContext);
	}
