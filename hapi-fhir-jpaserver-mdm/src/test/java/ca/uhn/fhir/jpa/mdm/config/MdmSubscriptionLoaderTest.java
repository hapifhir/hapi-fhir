...
class MdmSubscriptionLoaderTest {
    @Mock IFhirResourceDao<IBaseResource> mySubscriptionDao;

    @Mock DaoRegistry myDaoRegistry;

    @Mock IMdmSettings myMdmSettings;

    @Spy FhirContext myFhirContext = FhirContext.forR4Cached();

    @Mock IChannelNamer myChannelNamer;

    @Mock SubscriptionLoader mySubscriptionLoader;

    @InjectMocks MdmSubscriptionLoader mySvc = new MdmSubscriptionLoader();
