...
class MdmBatchSvcImplIT extends BaseMdmR4Test {
    ...
    @Autowired IMdmSubmitSvc myMdmSubmitSvc;
        ...
        afterMdmLatch.runWithExpectedCount(
                ...
                () ->
                        myMdmSubmitSvc.submitAllSourceTypesToMdm(
                                null, SystemRequestDetails.forAllPartitions()));
        ...
        afterMdmLatch.runWithExpectedCount(
                ...
                () ->
                        myMdmSubmitSvc.submitSourceResourceTypeToMdm(
                                "Patient",
                                null,
                                SystemRequestDetails.newSystemRequestAllPartitions()));
    ...
    public void testMdmOnTargetTypeWithCriteria() throws InterruptedException {
        ...
        createPatient(
                buildPatientWithNameIdAndBirthday(
                        "john", "john_id", DateUtils.addDays(new Date(), -300)));
