...
public class MdmProviderMatchDstu3PlusTest extends BaseProviderDstu3PlusTest {

	private static final Logger ourLog = LoggerFactory.getLogger(MdmProviderMatchDstu3PlusTest.class);
	...
	public void testMatch() throws Exception {
		...
		Bundle result = (Bundle) myMdmProviderDstu3Plus.match(newJane);
	...
	public void testMedicationMatch() throws Exception {
		...
		Bundle result = (Bundle) myMdmProviderDstu3Plus.serverMatch(newMedication, new StringType("Medication"));
		assertEquals(1, result.getEntry().size());
	...
	public void testServerLevelMatch() throws Exception {
		...
		Bundle result = (Bundle) myMdmProviderDstu3Plus.serverMatch(newJane, new StringType("Patient"));
		assertEquals(1, result.getEntry().size());
	...
	public void testMismatch() throws Exception {
		...
		Bundle result = (Bundle) myMdmProviderDstu3Plus.match(paul);
