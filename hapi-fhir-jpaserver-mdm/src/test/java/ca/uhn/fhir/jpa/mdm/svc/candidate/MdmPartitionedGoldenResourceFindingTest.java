...
public class MdmPartitionedGoldenResourceFindingTest extends BaseMdmR4Test {
    ...
    /**
     * These test will do wacky stuff with partition, if you just want to write simple match test
     * put and would like to not deal with that headache, please see MdmGoldenResourceFindingSvcTest
     */
    @Test
    public void testNoMatchOnResourcesInDifferentPartition() {
        ...
        Patient jane =
                createPatientAndUpdateLinksOnPartition(
                        addExternalEID(buildJanePatient(), EID_1),
