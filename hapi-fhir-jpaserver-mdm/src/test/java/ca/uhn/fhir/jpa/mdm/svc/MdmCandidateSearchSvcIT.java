...
public class MdmCandidateSearchSvcIT extends BaseMdmR4Test {
    ...
    @Autowired MdmCandidateSearchSvc myMdmCandidateSearchSvc;
    @Autowired MdmSettings myMdmSettings;
    @Autowired MatchUrlService myMatchUrlService;

    @Autowired NicknameSvc myNicknameSvc;
    ...
    public void testFindCandidates() {
        ...
        Collection<IAnyResource> result =
                myMdmCandidateSearchSvc.findCandidates(
                        "Patient", newJane, RequestPartitionId.allPartitions());
    ...
    public void testNickname() {
...

        {
            ...
            Collection<IAnyResource> result =
                    myMdmCandidateSearchSvc.findCandidates(
                            "Practitioner", nick, RequestPartitionId.allPartitions());
            assertEquals(1, result.size());
        }

        {
            ...
            Collection<IAnyResource> result =
                    myMdmCandidateSearchSvc.findCandidates(
                            "Practitioner", noMatch, RequestPartitionId.allPartitions());
    ...
    public void testFindCandidatesCorrectlySearchesWithReferenceParams() {
        ...
        Collection<IAnyResource> patient =
                myMdmCandidateSearchSvc.findCandidates(
                        "Patient", incomingPatient, RequestPartitionId.allPartitions());
    ...
    public void testTooManyMatches() {
        ...
        try {
            ...
            assertEquals(
                    "HAPI-0762: More than 3 candidate matches found for"
                            + " Patient?identifier=http%3A%2F%2Fa.tv%2F%7CID.JANE.123&active=true. "
