...
public class MDMState<T, P extends IResourcePersistentId> {
     ...
     *
     * <p>Eg: P1 -> (some patient resource) PG -> (some golden patient resource)
     */
    private Map<String, T> myParameterToValue;

    /**
     * Initial state for test. Comma separated lines with: Left param value, MdmLinkSourceEnum
     * value, MdmMatchResultEnum value, Right param value
     *
     * <p>Each input line represents a link state
     *
     * <p>Eg: PG1, MANUAL, MATCH, P1 PG1, AUTO, POSSIBLE_MATCH, P2
     */
    ...
    /** Output state to verify at end of test. Same format as input */
    private String myOutputState;

    /** A list of link expressions for output state. */
    private List<MdmTestLinkExpression> myOutputLinks;

    /** The actual outcome links. Resource (typically a golden resource) -> Link */
