...
public class MdmMatchLinkSvcMultipleEidModeTest extends BaseMdmR4Test {
    ...
    @Test
    public void
            testIncomingPatientWithEIDThatMatchesGoldenResourceWithHapiEidAddsExternalEidsToGoldenResource() {
    ...
    // Test Case #5
    public void
            testWhenPatientEidUpdateWouldCauseALinkChangeThatDuplicateGoldenResourceIsCreatedInstead() {
        Patient patient1 = buildJanePatient();
        addExternalEID(patient1, "eid-1");
        addExternalEID(patient1, "eid-11");
        patient1 = createPatientAndUpdateLinks(patient1);
        ...
        // Now lets change one of the EIDs on the second patient to one that matches our original
        // patient.
        // This should create a situation in which the incoming EIDs are matched to _two_ different
        // GoldenResources. In this case, we want to
