...
class CandidateSearcherTest {
    ...
    @Mock private IMdmRuleValidator myMdmRuleValidator;
    private final MdmSettings myMdmSettings = new MdmSettings(myMdmRuleValidator);
    @Mock private MdmSearchParamSvc myMdmSearchParamSvc;
    private CandidateSearcher myCandidateSearcher;

    @BeforeEach
    public void before() {
        myCandidateSearcher =
                new CandidateSearcher(myDaoRegistry, myMdmSettings, myMdmSearchParamSvc);
    }
