...
public abstract class BaseProviderDstu3PlusTest extends BaseMdmR4Test {

	MdmProviderDstu3Plus myMdmProviderDstu3Plus;
	@Autowired
	...
	@BeforeEach
	public void before() {
		myMdmProviderDstu3Plus = new MdmProviderDstu3Plus(myFhirContext, myMdmControllerSvc, myMdmMatchFinderSvc, myMdmExpungeSvc, myMdmSubmitSvc);
