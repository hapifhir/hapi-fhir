 ...
 *
 * <p>This is now also possible directly on the Fluent Client API by calling {@link
 * ca.uhn.fhir.rest.gclient.IClientExecutable#withAdditionalHeader(String, String)}
 */
public class AdditionalRequestHeadersInterceptor {
	...
	*/
	...
	/**
	* Adds the list of header values for the given header. Note that {@code headerName} and {@code
	* headerValues} cannot be null.
	*
	* @param headerName the name of the header
