...
public class BasicAuthInterceptor implements IClientInterceptor {
    ...
    public BasicAuthInterceptor(String theCredentialString) {
        ...
        Validate.isTrue(
                theCredentialString.contains(":"),
                "theCredentialString must be in the format 'username:password'");
        String encoded =
                Base64.encodeBase64String(theCredentialString.getBytes(Constants.CHARSET_US_ASCII));
