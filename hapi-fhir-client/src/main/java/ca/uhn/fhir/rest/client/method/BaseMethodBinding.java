...
public abstract class BaseMethodBinding<T> implements IClientResponseHandler<T> {
    ...
    public BaseMethodBinding(Method theMethod, FhirContext theContext, Object theProvider) {
        ...
        myParameters =
                MethodUtil.getResourceParameters(
                        theContext, theMethod, theProvider, getRestOperationType());
    ...
    public abstract BaseHttpClientInvocation invokeClient(Object[] theArgs)
    ...
    protected BaseServerResponseException processNon2xxResponseAndReturnExceptionToThrow(
        ...
        switch (theStatusCode) {
            ...
            default:
                ex =
                        new UnclassifiedServerFailureException(
    ...
    private static void populateException(
            BaseServerResponseException theEx, InputStream theResponseInputStream) {
        try {
