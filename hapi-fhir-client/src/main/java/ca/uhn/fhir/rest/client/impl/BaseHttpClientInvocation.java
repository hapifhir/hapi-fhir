...
public abstract class BaseHttpClientInvocation {
     ...
     * @param theExtraParams Any extra request parameters the server wishes to add
     * @param theEncoding The encoding to use for any serialized content sent to the server
     */
    ...
    protected IHttpRequest createHttpRequest(
            String theUrl, EncodingEnum theEncoding, RequestTypeEnum theRequestType) {
        IHttpClient httpClient =
                getRestfulClientFactory()
                        .getHttpClient(
                                new StringBuilder(theUrl), null, null, theRequestType, myHeaders);
