...
/**
 * This is a client interceptor that captures the current request and response in a ThreadLocal
 * variable, meaning that it can work in multithreaded environments without mixing up requests.
 *
 * <p>Use this with caution, since <b>this interceptor does not automatically clean up</b> the
 * ThreadLocal after setting it. You must make sure to call {@link #clearThreadLocals()} after a
 * given request has been completed, or you will end up leaving stale request/response objects
