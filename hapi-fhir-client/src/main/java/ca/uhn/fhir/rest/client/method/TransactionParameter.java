...
public class TransactionParameter implements IParameter {
	...
	// org.slf4j.LoggerFactory.getLogger(TransactionParameter.class);
	...
	private String createParameterTypeError(Method theMethod) {
		return "Method '"
					...
					+ "' is annotated with @"
					+ TransactionParam.class.getName()
					+ " but is not of type List<"
