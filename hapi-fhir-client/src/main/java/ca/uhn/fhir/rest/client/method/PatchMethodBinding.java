...
public class PatchMethodBinding
    ...
    public BaseHttpClientInvocation invokeClient(Object[] theArgs) throws InternalErrorException {
        ...
        HttpPatchClientInvocation retVal =
                createPatchInvocation(getContext(), idDt, patchType, body);
    ...
    public static HttpPatchClientInvocation createPatchInvocation(
        ...
        HttpPatchClientInvocation retVal =
                new HttpPatchClientInvocation(
                        theContext, theId, thePatchType.getContentType(), theBody);
        return retVal;
    }
    ...
    public static HttpPatchClientInvocation createPatchInvocation(
        ...
        HttpPatchClientInvocation retVal =
                new HttpPatchClientInvocation(
                        theContext, theUrlPath, thePatchType.getContentType(), theBody);
        return retVal;
    }
    ...
    public static HttpPatchClientInvocation createPatchInvocation(
        ...
        HttpPatchClientInvocation retVal =
                new HttpPatchClientInvocation(
                        theContext, url, thePatchType.getContentType(), theBody);
        return retVal;
    }
}
