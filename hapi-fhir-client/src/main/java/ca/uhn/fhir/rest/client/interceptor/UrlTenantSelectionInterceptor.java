 ...
 * primarily intended to be used with clients that are accessing servers using <a
 * href="https://hapifhir.io/hapi-fhir/docs/server_plain/multitenancy.html#url-base-multitenancy">URL
 * Base Multitenancy</a>.
 */
public class UrlTenantSelectionInterceptor {
	...
	*/
	...
	@Hook(
				...
				order = InterceptorOrders.URL_TENANT_SELECTION_INTERCEPTOR_REQUEST)
