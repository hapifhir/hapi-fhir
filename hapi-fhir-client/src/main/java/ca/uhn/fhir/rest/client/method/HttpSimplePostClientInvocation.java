...
public class HttpSimplePostClientInvocation extends BaseHttpClientInvocation {

	private final String myUrl;
	private UrlSourceEnum myUrlSource = UrlSourceEnum.GENERATED;

	public HttpSimplePostClientInvocation(FhirContext theContext, String theUrlPath) {
		super(theContext);
		myUrl = theUrlPath;
	}
	...
	public IHttpRequest asHttpRequest(String theUrlBase, Map<String, List<String>> theExtraParams, EncodingEnum theEncoding, Boolean thePrettyPrint) {
		IHttpRequest retVal = createHttpRequest(myUrl, theEncoding, RequestTypeEnum.POST);
