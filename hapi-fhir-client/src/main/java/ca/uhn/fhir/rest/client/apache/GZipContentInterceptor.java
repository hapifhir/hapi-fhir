...
/**
 * Client interceptor which GZip compresses outgoing (POST/PUT) contents being uploaded from the
 * client to the server. This can improve performance by reducing network load time.
 */
public class GZipContentInterceptor implements IClientInterceptor {
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(GZipContentInterceptor.class);
