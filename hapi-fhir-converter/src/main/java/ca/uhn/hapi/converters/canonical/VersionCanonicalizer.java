 ...
 * The specific version that is considered canonical is arbitrary for historical reasons, generally
 * it will be R4 or R5 but this varies by resource type.
 *
 * <p>This class is an internal HAPI FHIR API and can change without notice at any time. Use with
 * caution!
 */
public class VersionCanonicalizer {
        ...
        switch (targetVersion) {
            ...
            default:
                throw new IllegalStateException(
                        Msg.code(193) + "Can't handle version: " + targetVersion);
        }
    }
    ...
    public CapabilityStatement capabilityStatementToCanonical(
            IBaseResource theCapabilityStatement) {
     ...
     * Canonical version: R5
     *
     * <p>Note that this method will look for any nonstandard resource types specified in {@literal
     * SearchParameter.base} or {@literal SearchParameter.target} and move them into extensions with
     * the URLs {@link HapiExtensions#EXTENSION_SEARCHPARAM_CUSTOM_BASE_RESOURCE} and {@link
     * HapiExtensions#EXTENSION_SEARCHPARAM_CUSTOM_TARGET_RESOURCE} respectively. If any nonstandard
     * resource types are found, all resource types in the respective list are moved into the
     * extension (including standard types) and the source list is cleared.
     */
    public <T extends IBaseResource> SearchParameter searchParameterToCanonical(
            T theSearchParameter) {
        ...
        targetExtensionValues.forEach(
                t ->
                        retVal.addExtension(
                                HapiExtensions.EXTENSION_SEARCHPARAM_CUSTOM_TARGET_RESOURCE,
                                new CodeType(t)));
        return retVal;
    }
    ...
    public IBaseResource valueSetFromValidatorCanonical(
            org.hl7.fhir.r5.model.ValueSet theResource) {
    ...
    public org.hl7.fhir.r5.model.CodeSystem codeSystemToValidatorCanonical(
    ...
    private List<String> extractNonStandardSearchParameterListAndClearSourceIfAnyArePresent(
        ...
        if (baseExtensionValues.stream()
                .allMatch(Enumerations.VersionIndependentResourceTypesAll::isValidCode)) {
    ...
    private static class Dstu2Strategy implements IStrategy {
        ...
        public ValueSet valueSetToCanonical(IBaseResource theValueSet) {
            ...
            return (ValueSet)
                    VersionConvertorFactory_10_40.convertResource(reencoded, ADVISOR_10_40);
        }
        ...
        public CodeSystem codeSystemToCanonical(IBaseResource theCodeSystem) {
            ...
            ca.uhn.fhir.model.dstu2.resource.ValueSet input =
                    (ca.uhn.fhir.model.dstu2.resource.ValueSet) theCodeSystem;
        ...
        private void translateAndAddConcept(
            ...
            for (ca.uhn.fhir.model.dstu2.resource.ValueSet.CodeSystemConceptDesignation next :
                ...
                CodeSystem.ConceptDefinitionDesignationComponent targetDesignation =
            ...
            for (ca.uhn.fhir.model.dstu2.resource.ValueSet.CodeSystemConcept nextChild :
                    theSource.getConcept()) {
        ...
        @Override
        public IBaseResource valueSetFromCanonical(ValueSet theValueSet) {
            Resource valueSetDstu2Hl7Org =
                    VersionConvertorFactory_10_40.convertResource(theValueSet, ADVISOR_10_40);
        ...
        public IBaseParameters parametersFromCanonical(Parameters theParameters) {
            Resource converted =
                    VersionConvertorFactory_10_40.convertResource(theParameters, ADVISOR_10_40);
        ...
        public IBaseResource structureDefinitionFromCanonical(StructureDefinition theResource) {
            Resource converted =
                    VersionConvertorFactory_10_50.convertResource(theResource, ADVISOR_10_50);
        ...
        @Override
        public org.hl7.fhir.r5.model.Resource resourceToValidatorCanonical(
                IBaseResource theResource) {
            org.hl7.fhir.dstu2.model.Resource reencoded = reencodeToHl7Org(theResource);
        ...
        @Override
        public org.hl7.fhir.r5.model.ValueSet valueSetToValidatorCanonical(
                IBaseResource theResource) {
            org.hl7.fhir.dstu2.model.Resource reencoded = reencodeToHl7Org(theResource);
        ...
        public IBaseResource auditEventFromCanonical(AuditEvent theResource) {
            Resource hl7Org =
                    VersionConvertorFactory_10_40.convertResource(theResource, ADVISOR_10_40);
        ...
        private Resource reencodeToHl7Org(IBaseResource theInput) {
            ...
            return (Resource)
                    myDstu2Hl7OrgContext
                            .newJsonParser()
                            .parseResource(
                                    myDstu2Context
                                            .newJsonParser()
                                            .encodeResourceToString(theInput));
        }
        ...
        private IBaseResource reencodeFromHl7Org(Resource theInput) {
            ...
            return myDstu2Context
                    .newJsonParser()
                    .parseResource(
                            myDstu2Hl7OrgContext.newJsonParser().encodeResourceToString(theInput));
        }
    }
    ...
    private static class Dstu21Strategy implements IStrategy {
        ...
        public CapabilityStatement capabilityStatementToCanonical(
                IBaseResource theCapabilityStatement) {
            return (CapabilityStatement)
                    VersionConvertorFactory_14_50.convertResource(
                            (org.hl7.fhir.dstu2016may.model.Resource) theCapabilityStatement,
                            ADVISOR_14_50);
        }
        ...
        public Coding codingToCanonical(IBaseCoding theCoding) {
            return (org.hl7.fhir.r4.model.Coding)
                    VersionConvertorFactory_14_40.convertType(
        ...
        public CodeableConcept codeableConceptToCanonical(IBaseDatatype theCodeableConcept) {
            return (org.hl7.fhir.r4.model.CodeableConcept)
                    VersionConvertorFactory_14_40.convertType(
                            (org.hl7.fhir.dstu2016may.model.CodeableConcept) theCodeableConcept,
                            ADVISOR_14_40);
        }
        ...
        public ValueSet valueSetToCanonical(IBaseResource theValueSet) {
            return (ValueSet)
                    VersionConvertorFactory_14_40.convertResource(
        ...
        public SearchParameter searchParameterToCanonical(IBaseResource theSearchParameter) {
            return (SearchParameter)
                    VersionConvertorFactory_14_50.convertResource(
                            (org.hl7.fhir.dstu2016may.model.Resource) theSearchParameter,
                            ADVISOR_14_50);
        }
        ...
        public IBaseParameters parametersFromCanonical(Parameters theParameters) {
            return (IBaseParameters)
                    VersionConvertorFactory_14_40.convertResource(theParameters, ADVISOR_14_40);
        }
        ...
        public IBaseConformance capabilityStatementFromCanonical(CapabilityStatement theResource) {
            return (IBaseConformance)
                    VersionConvertorFactory_14_50.convertResource(theResource, ADVISOR_14_50);
        }
    }
    ...
    private static class Dstu3Strategy implements IStrategy {
        ...
        public CapabilityStatement capabilityStatementToCanonical(
            ...
            return (CapabilityStatement)
                    VersionConvertorFactory_30_50.convertResource(
                            (org.hl7.fhir.dstu3.model.Resource) theCapabilityStatement,
                            ADVISOR_30_50);
        }
        ...
        public Coding codingToCanonical(IBaseCoding theCoding) {
            return (org.hl7.fhir.r4.model.Coding)
                    VersionConvertorFactory_30_40.convertType(
        ...
        public CodeableConcept codeableConceptToCanonical(IBaseDatatype theCodeableConcept) {
            return (org.hl7.fhir.r4.model.CodeableConcept)
                    VersionConvertorFactory_30_40.convertType(
                            (org.hl7.fhir.dstu3.model.CodeableConcept) theCodeableConcept,
                            ADVISOR_30_40);
        }
        ...
        public IBaseParameters parametersFromCanonical(Parameters theParameters) {
            return (IBaseParameters)
                    VersionConvertorFactory_30_40.convertResource(theParameters, ADVISOR_30_40);
        }
        ...
        public IBaseConformance capabilityStatementFromCanonical(CapabilityStatement theResource) {
            return (IBaseConformance)
                    VersionConvertorFactory_30_50.convertResource(theResource, ADVISOR_30_50);
        }
    }
    ...
    private static class R4BStrategy implements IStrategy {
        ...
        public CapabilityStatement capabilityStatementToCanonical(
            ...
            return (CapabilityStatement)
                    VersionConvertorFactory_43_50.convertResource(
                            (org.hl7.fhir.r4b.model.Resource) theCapabilityStatement,
                            ADVISOR_43_50);
        }

        @Override
        public Coding codingToCanonical(IBaseCoding theCoding) {
            org.hl7.fhir.r5.model.Coding r5coding =
                    (org.hl7.fhir.r5.model.Coding)
                            VersionConvertorFactory_43_50.convertType(
                                    (org.hl7.fhir.r4b.model.Coding) theCoding, ADVISOR_43_50);
            return (org.hl7.fhir.r4.model.Coding)
        ...
        public CodeableConcept codeableConceptToCanonical(IBaseDatatype theCodeableConcept) {
            org.hl7.fhir.r5.model.CodeableConcept r5coding =
                    (org.hl7.fhir.r5.model.CodeableConcept)
                            VersionConvertorFactory_43_50.convertType(
                                    (org.hl7.fhir.r4b.model.CodeableConcept) theCodeableConcept,
                                    ADVISOR_43_50);
            return (org.hl7.fhir.r4.model.CodeableConcept)
                    VersionConvertorFactory_40_50.convertType(r5coding, ADVISOR_40_50);
        }
        ...
        public ConceptMap conceptMapToCanonical(IBaseResource theConceptMap) {
            ...
            return (ConceptMap)
                    VersionConvertorFactory_40_50.convertResource(conceptMapR5, ADVISOR_40_50);
        }
        ...
        @Override
        public IBaseParameters parametersFromCanonical(Parameters theParameters) {
            org.hl7.fhir.r5.model.Parameters parametersR5 =
                    (org.hl7.fhir.r5.model.Parameters)
                            VersionConvertorFactory_40_50.convertResource(
                                    theParameters, ADVISOR_40_50);
            return (IBaseParameters)
                    VersionConvertorFactory_43_50.convertResource(parametersR5, ADVISOR_43_50);
        }
        ...
        @Override
        public IBaseResource auditEventFromCanonical(AuditEvent theResource) {
            org.hl7.fhir.r5.model.AuditEvent r5 =
                    (org.hl7.fhir.r5.model.AuditEvent)
                            VersionConvertorFactory_40_50.convertResource(
                                    theResource, ADVISOR_40_50);
        ...
        public IBaseConformance capabilityStatementFromCanonical(CapabilityStatement theResource) {
            return (IBaseConformance)
                    VersionConvertorFactory_43_50.convertResource(theResource, ADVISOR_43_50);
        }
    }
        ...
        public Coding codingToCanonical(IBaseCoding theCoding) {
            return (org.hl7.fhir.r4.model.Coding)
                    VersionConvertorFactory_40_50.convertType(
                            (org.hl7.fhir.r5.model.Coding) theCoding, ADVISOR_40_50);
        }
