 ...
 * times depending on the number of work chunks produced by the previous step. It will always be
 * called once in the case of the first step. It can produce 0..* work chunks that will be processed
 * in subsequent steps.
 *
