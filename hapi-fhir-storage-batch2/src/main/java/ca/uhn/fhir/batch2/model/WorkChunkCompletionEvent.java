...
public class WorkChunkCompletionEvent extends BaseWorkChunkEvent {
    ...
    public WorkChunkCompletionEvent(
            String theChunkId, int theRecordsProcessed, int theRecoveredErrorCount) {
        super(theChunkId);
    ...
    public WorkChunkCompletionEvent(
            String theChunkId,
            int theRecordsProcessed,
            int theRecoveredErrorCount,
            String theRecoveredWarningMessage) {
