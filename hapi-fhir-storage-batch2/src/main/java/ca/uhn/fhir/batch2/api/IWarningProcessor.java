...
public interface IWarningProcessor {
	...
	/**
	* Data Sink may invoke this method to indicate that an error occurred during processing in work
	* chunks but that it is non-fatal and should be saved as a warning.
	*
