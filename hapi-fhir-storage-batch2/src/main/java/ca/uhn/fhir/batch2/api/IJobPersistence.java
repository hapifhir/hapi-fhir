 ...
 * ca.uhn.hapi.fhir.batch2.test.AbstractIJobPersistenceSpecificationTest} This is a transactional
 * interface, but we have pushed the declaration of calls that have
 * {@code @Transactional(propagation = Propagation.REQUIRES_NEW)} down to the implementations since
 * we have a synchronized wrapper that was double-creating the NEW transaction.
 */
