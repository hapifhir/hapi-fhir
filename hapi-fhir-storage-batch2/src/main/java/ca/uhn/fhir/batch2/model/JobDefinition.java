...
public class JobDefinition<PT extends IModelJson> {
    ...
    private JobDefinition(
        ...
        Validate.isTrue(
                theJobDefinitionId.length() <= ID_MAX_LENGTH,
                "Maximum ID length is %d",
                ID_MAX_LENGTH);
        ...
        Validate.isTrue(
                theJobDefinitionVersion >= 1, "No job definition version supplied (must be >= 1)");
    ...
    /**
     * @return Returns a unique identifier for the version of the job definition. Higher means newer
     *     but numbers have no other meaning. Must be greater than 0.
     */
    ...
    public static class Builder<PT extends IModelJson, NIT extends IModelJson> {
        ...
        @Nullable private IJobParametersValidator<PT> myParametersValidator;
        ...
        /**
         * @param theJobDefinitionId A unique identifier for the job definition (i.e. for the "kind"
         *     of job)
         */
        ...
        /**
         * @param theJobDefinitionVersion A unique identifier for the version of the job definition.
         *     Higher means newer but numbers have no other meaning. Must be greater than 0.
         */
         ...
         *
         * @param theStepId A unique identifier for this step. This only needs to be unique within
         *     the scope of the individual job definition (i.e. diuplicates are fine for different
         *     jobs, or even different versions of the same job)
        ...
        public Builder<PT, VoidModel> addLastStep(
                String theStepId,
                String theStepDescription,
                IJobStepWorker<PT, NIT, VoidModel> theStepWorker) {
            mySteps.add(
                    new JobDefinitionStep<>(
                            theStepId,
                            theStepDescription,
        ...
        public <OT extends IModelJson> Builder<PT, OT> addFinalReducerStep(
            ...
            if (!myGatedExecution) {
                throw new ConfigurationException(
                        Msg.code(2106)
                                + String.format(
                                        "Job Definition %s has a reducer step but is not gated",
                                        myJobDefinitionId));
            }
            mySteps.add(
                    new JobDefinitionReductionStep<PT, NIT, OT>(
                            theStepId,
                            theStepDescription,
                            theStepWorker,
                            myNextInputType,
        ...
        /**
         * Sets the datatype for the parameters used by this job. This model is a {@link IModelJson}
         * JSON serializable object.
         *
         * <p><b>Validation:</b> Fields should be annotated with any appropriate <code>
         * javax.validation</code> (JSR 380) annotations (e.g. {@link
         * javax.validation.constraints.Min} or {@link javax.validation.constraints.Pattern}). In
         * addition, if there are validation rules that are too complex to express using JSR 380,
         * you can also specify a programmatic validator using {@link
         * #setParametersValidator(IJobParametersValidator)}.
         *
         * <p>Any fields that contain sensitive data (e.g. passwords) that should not be provided
         * back to the end user must be marked with {@link
         * ca.uhn.fhir.model.api.annotation.PasswordField} as well.
         *
        ...
        public <NPT extends IModelJson> Builder<NPT, NIT> setParametersType(
                @Nonnull Class<NPT> theJobParametersType) {
        ...
        /**
         * Supplies a programmatic job parameters validator. Note that as much as possible, JSR 380
         * annotations should be used for validation. This method is provided only to satisfy rules
         * that are too complex to be expressed using JSR 380.
         *
         * @param theParametersValidator The validator (must not be null. Do not call this method at
         *     all if you do not want a parameters validator).
         */
        public Builder<PT, NIT> setParametersValidator(
                @Nonnull IJobParametersValidator<PT> theParametersValidator) {
        ...
        /**
         * If this is set, the framework will wait for all work chunks to be processed for an
         * individual step before moving on to beginning processing on the next step. Otherwise,
         * processing on subsequent steps may begin as soon as any data has been produced.
         *
         * <p>This is useful in a few cases:
         *
         * <ul>
         *   <li>If there are potential constraint issues, e.g. data being written by the third step
         *       depends on all data from the second step already being written
         *   <li>If multiple steps require expensive database queries, it may reduce the chances of
         *       timeouts to ensure that they are run discretely.
         * </ul>
         *
         * <p>Setting this mode means the job may take longer, since it will rely on a polling
         * mechanism to determine that one step is complete before beginning any processing for the
         * next step.
         */
        ...
        public Builder<PT, NIT> completionHandler(IJobCompletionHandler<PT> theCompletionHandler) {
            Validate.isTrue(
                    myCompletionHandler == null, "Can not supply multiple completion handlers");
            myCompletionHandler = theCompletionHandler;
            return this;
        }
