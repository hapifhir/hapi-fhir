...
public class JobStepExecutor<PT extends IModelJson, IT extends IModelJson, OT extends IModelJson> {
	...
	JobStepExecutor(@Nonnull IJobPersistence theJobPersistence, @Nonnull BatchJobSender theBatchJobSender, JobDefinition<PT> theDefinition, JobInstance theInstance, WorkChunk theWorkChunk, JobWorkCursor<PT, IT, OT> theCursor) {
