...
public class JobInstance implements IModelJson, IJobInstance {
	...
	/**
	* Returns true if the job instance is in: {@link StatusEnum#IN_PROGRESS} {@link
	* StatusEnum#FINALIZE} and is not cancelled
	*/
		...
		switch (getStatus()) {
				...
				default:
					Logs.getBatchTroubleshootingLog()
								.debug("Status {} is considered \"not running\"", myStatus);
		}
		return false;
	}
