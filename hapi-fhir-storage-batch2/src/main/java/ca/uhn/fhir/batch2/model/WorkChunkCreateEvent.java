...
/**
 * The data required for the create transition. Payload for the work-chunk creation event including
 * all the job coordinates, the chunk data, and a sequence within the step.
 *
...
public class WorkChunkCreateEvent {
     ...
     * @param theSerializedData The data. This will be in the form of a map where the values may be
     *     strings, lists, and other maps (i.e. JSON)
     */
    ...
    public static WorkChunkCreateEvent firstChunk(
            JobDefinition<?> theJobDefinition, String theInstanceId) {
        ...
        return new WorkChunkCreateEvent(
                jobDefinitionId, jobDefinitionVersion, firstStepId, theInstanceId, 0, null);
    }
