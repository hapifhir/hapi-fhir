...
class JobQuerySvcTest extends BaseBatch2Test {
    ...
    @Mock JobDefinitionRegistry myJobDefinitionRegistry;
    JobQuerySvc mySvc;
    ...
    public void testFetchInstance_PasswordsRedacted() {
        ...
        doReturn(definition)
                .when(myJobDefinitionRegistry)
                .getJobDefinitionOrThrowException(instance);
    ...
    public void testFetchInstances() {
        ...
        JobInstance instance = createInstance();
        when(myJobPersistence.fetchInstances(eq(100), eq(0)))
                .thenReturn(Lists.newArrayList(instance));
        doReturn(createJobDefinition())
                .when(myJobDefinitionRegistry)
                .getJobDefinitionOrThrowException(instance);
