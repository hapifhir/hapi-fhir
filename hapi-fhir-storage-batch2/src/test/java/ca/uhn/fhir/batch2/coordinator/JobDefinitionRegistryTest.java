...
class JobDefinitionRegistryTest {
    ...
    @Mock private IJobStepWorker<TestJobParameters, VoidModel, TestJobStep2InputType> myFirstStep;
    @Mock private IJobStepWorker<TestJobParameters, TestJobStep2InputType, VoidModel> myLastStep;

    @BeforeEach
    void beforeEach() {
        mySvc = new JobDefinitionRegistry();

        mySvc.addJobDefinition(
    ...
    void testEnsureStepsHaveUniqueIds() {
        ...
        try {
            ...
            assertEquals(
                    "HAPI-2046: Duplicate step[S1] in definition[A] version: 3", e.getMessage());
        }
    ...
    public void getJobDefinitionOrThrowException() {
        ...
        try {
            ...
            assertEquals(
                    "HAPI-2043: Unknown job definition ID["
                            + jobDefinitionId
                            + "] version["
