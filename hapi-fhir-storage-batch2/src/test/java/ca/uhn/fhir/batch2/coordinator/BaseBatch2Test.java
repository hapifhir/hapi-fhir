...
public abstract class BaseBatch2Test {
	...
	@Mock
	protected IJobStepWorker<TestJobParameters, TestJobStep2InputType, TestJobStep3InputType>
				myStep2Worker;
	...
	@Mock
	protected IReductionStepWorker<
						TestJobParameters, TestJobStep3InputType, TestJobReductionOutputType>
	...
	protected final JobDefinition<TestJobParameters> createJobDefinition(
		...
		JobDefinition.Builder<TestJobParameters, VoidModel> builder =
					JobDefinition.newBuilder()
								...
								.addIntermediateStep(
										STEP_2, "Step 2", TestJobStep3InputType.class, myStep2Worker)
	...
	protected final JobDefinition<TestJobParameters> createJobDefinitionWithReduction(
		...
		JobDefinition.Builder<TestJobParameters, TestJobReductionOutputType> builder =
					JobDefinition.newBuilder()
								...
								.addFinalReducerStep(
										STEP_3,
										"Step 3",
										TestJobReductionOutputType.class,
										myReductionStepWorker);
