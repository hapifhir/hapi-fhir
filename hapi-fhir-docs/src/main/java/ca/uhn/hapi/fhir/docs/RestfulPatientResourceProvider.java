...
public class RestfulPatientResourceProvider implements IResourceProvider {
    ...
    /**
     * The "@Search" annotation indicates that this method supports the search operation. You may
     * have many different methods annotated with this annotation, to support many different search
     * criteria. This example searches by family name.
     *
     * @param theFamilyName This operation takes one parameter which is the search criteria. It is
     *     annotated with the "@Required" annotation. This annotation takes one argument, a string
     *     containing the name of the search criteria. The datatype here is StringParam, but there
     *     are other possible parameter types depending on the specific search criteria.
