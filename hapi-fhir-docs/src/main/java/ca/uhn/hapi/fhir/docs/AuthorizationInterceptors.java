...
public class AuthorizationInterceptors {
    ...
    public class PatientResourceProvider implements IResourceProvider {
        ...
        public MethodOutcome create(
                @ResourceParam Patient thePatient, RequestDetails theRequestDetails) {
    ...
    public void ruleFiltering() {
        ...
        consentInterceptor.registerConsentService(
                new RuleFilteringConsentService(theAuthorizationInterceptor));
        ...
        new AuthorizationInterceptor(PolicyEnum.DENY) {
            ...
            public List<IAuthRule> buildRuleList(RequestDetails theRequestDetails) {
                return new RuleBuilder()
                        ...
                        .systemExport()
                        .withResourceTypes(
                                Lists.newArrayList("Patient", "Encounter", "Observation"))
                        .build();
            }
        };
    ...
    public class MyPatientSearchNarrowingInterceptor extends SearchNarrowingInterceptor {
        ...
        /**
         * This method must be overridden to provide the list of compartments and/or resources that
         * the current user should have access to
         */
        @Override
    ...
    public void rsNarrowing() {
        ...
        SearchNarrowingInterceptor narrowingInterceptor =
                new SearchNarrowingInterceptor() {
                    @Override
                    protected AuthorizedList buildAuthorizedList(RequestDetails theRequestDetails) {
                        // Your rules go here
                        return new AuthorizedList()
    ...
    public class MyCodeSearchNarrowingInterceptor extends SearchNarrowingInterceptor {
        ...
        protected AuthorizedList buildAuthorizedList(RequestDetails theRequestDetails) {
            ...
            if ("Bearer dfw98h38r".equals(authHeader)) {
                ...
                return new AuthorizedList()
                        // When searching for Observations, narrow the search to only include
                        // Observations
                        ...
                        .addCodeInValueSet(
                                ...
                                "code",
                                "http://hl7.org/fhir/ValueSet/observation-vitalsignresult")
                        // When searching for Encounters, narrow the search to exclude Encounters
                        // where
                        // the Encounter class is in a ValueSet containing forbidden class codes
                        .addCodeNotInValueSet(
                                "Encounter", "class", "http://my-forbidden-encounter-classes");
