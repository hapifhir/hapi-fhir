...
public class ServerInterceptors {
    ...
    public static void main(String[] args) throws DataFormatException, IOException {
        ...
        given.setValue("Joe");
        ExtensionDt ext2 =
                new ExtensionDt(false, "http://examples.com#moreext", new StringDt("Hello"));
    ...
    public void foo() {
        ...
        ExtensionDt child1 =
                new ExtensionDt(false, "http://example.com#childOne", new StringDt("value1"));
        parent.addUndeclaredExtension(child1);

        ExtensionDt child2 =
                new ExtensionDt(false, "http://example.com#childTwo", new StringDt("value1"));
