...
public class CompleteExampleClient {
    ...
    /**
     * This is a simple client interface. It can have many methods for various searches but in this
     * case it has only 1.
     */
    public interface ClientInterface extends IRestfulClient {
         ...
         */
        @Search
        List<Patient> findPatientsForMrn(
                @RequiredParam(name = Patient.SP_IDENTIFIER) Identifier theIdentifier);
    }

    /**
     * The main method here will directly call an open FHIR server and retrieve a list of resources
     * matching a given criteria, then load a linked resource.
     */
