 ...
 *
 * <p>Note that we are extending DomainResource for an STU3 resource. For DSTU2 it would be
 * BaseResource.
 */
...
public class CustomResource extends DomainResource {
    ...
    /**
     * We give the resource a field with name "television". This field has no specific type, so it's
     * a choice[x] field for any type.
     */
