...
public class ValidatorExamples {
    ...
    private static void instanceValidator() throws Exception {
        ...
        // Prints:
        // Next issue ERROR - /f:Observation - Element '/f:Observation.status': minimum required =
        // 1, but only found 0
        // Next issue WARNING - /f:Observation/f:code - Unable to validate code "12345-6" in code
    ...
    private static void instanceValidatorCustom() throws Exception {
        ...
        IValidationSupport valSupport =
                new IValidationSupport() {

                    @Override
                    public List<IBaseResource> fetchAllConformanceResources() {
                        // TODO: implement (or return null if your implementation does not support
                        // this function)
                        return null;
                    }
    ...
    private static void npm() throws Exception {
        ...
        CachingValidationSupport validationSupport =
                new CachingValidationSupport(validationSupportChain);

        // Create a validator. Note that for good performance you can create as many validator
        // objects
