...
public class ValidateDirectory {
	...
	public static void main(String[] args) throws Exception {
		...
		validationSupportChain.addValidationSupport(
				(ca.uhn.fhir.context.support.IValidationSupport) new DefaultProfileValidationSupport(ctx));
		validationSupportChain.addValidationSupport((ca.uhn.fhir.context.support.IValidationSupport)
				new PrePopulatedValidationSupport(ctx, structureDefinitions, valueSets, codeSystems));
