...
public interface IRestfulClient extends IBasicClient {
     ...
     *     containing the name of the search criteria. The datatype here is StringDt, but there are
     *     other possible parameter types depending on the specific search criteria.
