...
public class FhirContextIntro {
	...
	public void encodeMsg() throws DataFormatException {
		...
		/**
			* FHIR model types in HAPI are simple POJOs. To create a new one, invoke the default
			* constructor and then start populating values.
			*/
