...
public class ClientExamples {
	...
	public void cacheControl() {
		...
		Bundle response =
					client.search()
								...
								.cacheControl(
										new CacheControlDirective().setNoCache(true)) // <-- add a directive
								.execute();
	...
	public void createSecurity() {
		...
		// register it
		IPatientClient annotationClient =
					ctx.newRestfulClient(IPatientClient.class, "http://localhost:9999/fhir");
	...
	public void createLogging() {
		{
				...
				IGenericClient genericClient =
						ctx.newRestfulGenericClient("http://localhost:9999/fhir");
		...
		/******************************/
		{
				...
				IPatientClient client =
						ctx.newRestfulClient(IPatientClient.class, "http://localhost:9999/");
