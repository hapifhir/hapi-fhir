...
public class RepositoryValidatingInterceptorExamples {
    ...
    public void createSimpleRule() {
        ...
        RepositoryValidatingRuleBuilder ruleBuilder =
                myAppCtx.getBean(RepositoryValidatingRuleBuilder.class);
        ...
        RepositoryValidatingInterceptor interceptor =
                new RepositoryValidatingInterceptor(myFhirCtx, rules);
    ...
    public void requireValidationToDeclaredProfilesTagOnFailure() {
        ...
        ruleBuilder
                ...
                .neverReject()
                .tagOnSeverity(
                        ResultSeverityEnum.ERROR, "http://example.com", "validation-failure");
