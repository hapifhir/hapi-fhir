 ...
 *
 * <p>Note the "profile" attribute below, which indicates the URL/ID of the profile implemented by
 * this resource. You are not required to supply this, but if you do it will be automatically
 * populated in the resource meta tag if the resource is returned by a server.
 */
...
public class MyPatient extends Patient {
	...
	*/
	...
	/**
	* The second example extension uses a List type to provide repeatable values. Note that a
	* [max=] value has been placed in the @Child annotation.
	*
	* <p>Note also that this extension is a modifier extension
	*/
