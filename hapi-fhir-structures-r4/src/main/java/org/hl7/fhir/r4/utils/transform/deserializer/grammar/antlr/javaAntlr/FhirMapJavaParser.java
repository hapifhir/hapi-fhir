...
public class FhirMapJavaParser extends Parser {
  ...
  public static class RuleInputContext extends ParserRuleContext {
    ...
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if ( visitor instanceof FhirMapJavaVisitor ) return ((FhirMapJavaVisitor<? extends T>)visitor).visitRuleInput(this);
      else return visitor.visitChildren(this);
    }
  }
  ...
  public static class RuleInputModeContext extends ParserRuleContext {
    ...
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if ( visitor instanceof FhirMapJavaVisitor ) return ((FhirMapJavaVisitor<? extends T>)visitor).visitRuleInputMode(this);
      else return visitor.visitChildren(this);
    }
  }
