...
public final class HapiWorkerContext extends I18nBase implements IWorkerContext {
    ...
    @Override
    public org.hl7.fhir.r4.utils.INarrativeGenerator getNarrativeGenerator(
            String thePrefix, String theBasePath) {
    ...
    @Override
    public ValueSetExpander.ValueSetExpansionOutcome expandVS(
            ConceptSetComponent theInc, boolean theHierarchical)
        ...
        IValidationSupport.ValueSetExpansionOutcome output =
                myValidationSupport.expandValueSet(
                        new ValidationSupportContext(myValidationSupport), null, input);
    ...
    public StructureDefinition fetchTypeDefinition(String theTypeName) {
        return fetchResource(
                ...
                "http://hl7.org/fhir/StructureDefinition/" + theTypeName);
    }
    ...
    @Override
    public <T extends org.hl7.fhir.r4.model.Resource> T fetchResourceWithException(
    ...
    @Override
    public <T extends org.hl7.fhir.r4.model.Resource> boolean hasResource(
