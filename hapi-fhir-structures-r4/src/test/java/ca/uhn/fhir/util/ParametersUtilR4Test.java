...
public class ParametersUtilR4Test {
	...
	public void testCreateParameters() {
		...
		ParametersUtil.addParameterToParameters(
					ourFhirContext, parameters, "someString", "string", "someStringValue");
		ParametersUtil.addParameterToParameters(
					ourFhirContext, parameters, "someDate", "date", "2019");
	...
	public void testGetValues() {
		...
		List<String> values =
					ParametersUtil.getNamedParameterValuesAsString(FhirContext.forR4(), p, "foo");
	...
	public void testGetValueAsInteger() {
		...
		Optional<Integer> value =
					ParametersUtil.getNamedParameterValueAsInteger(FhirContext.forR4(), p, "foo");
	...
	public void testGetNamedParameterPartAsString() {
		...
		for (int i = 0; i < 3; ++i) {
				IBase resultPart =
						ParametersUtil.addParameterToParameters(ourFhirContext, parameters, "link");
				ParametersUtil.addPartString(ourFhirContext, resultPart, "personId", TEST_PERSON_ID);
		}
		List<String> values =
					ParametersUtil.getNamedParameterPartAsString(
								ourFhirContext, parameters, "link", "personId");
