...
public class SearchBundleProviderWithNoSizeR4Test {
    ...
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(SearchBundleProviderWithNoSizeR4Test.class);
    ...
    public void testBundleProviderReturnsNoSize() throws Exception {
        ...
        when(ourLastBundleProvider.getResources(any(int.class), any(int.class)))
                .then(
                        new Answer<List<IBaseResource>>() {
                            @Override
