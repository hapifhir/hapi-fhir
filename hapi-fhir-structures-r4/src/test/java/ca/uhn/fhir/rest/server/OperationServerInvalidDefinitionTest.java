...
public class OperationServerInvalidDefinitionTest {
    ...
    public void testReturnTypeWrongVersion() {
        ...
        try {
            ...
            assertEquals(
                    "HAPI-0288: Failure scanning class OperationProvider: HAPI-0360: Incorrect use"
                        + " of type StringDt as return type for method when theContext is for"
                        + " version R4 in method: public org.hl7.fhir.r4.model.Parameters"
                        + " ca.uhn.fhir.rest.server.OperationServerInvalidDefinitionTest$1OperationProvider.patientMemberMatch(org.hl7.fhir.r4.model.Patient)",
                    e.getMessage());
        }
    }
}
