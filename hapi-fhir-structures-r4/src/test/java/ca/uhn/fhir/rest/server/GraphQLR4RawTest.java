...
public class GraphQLR4RawTest {
    ...
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(GraphQLR4RawTest.class);
    ...
    public void testGraphBase_Post_ListQuery() throws Exception {
        ...
        HttpPost httpPost =
                new HttpPost(
                        "http://localhost:" + myRestfulServerExtension.getPort() + "/$graphql");
        StringEntity entity =
                new StringEntity(
                        "{\"query\": \"{PatientList(date: \\\"2022\\\") {name{family,given}}}\"}");
        httpPost.setEntity(entity);
        httpPost.setHeader("Accept", "application/json");
        httpPost.setHeader("Content-type", "application/json");
    ...
    public static class MyGraphQLProvider {
        ...
        public String processPost(
                ...
                @GraphQLQueryBody String theQuery) {
            ourLastId = theId;
