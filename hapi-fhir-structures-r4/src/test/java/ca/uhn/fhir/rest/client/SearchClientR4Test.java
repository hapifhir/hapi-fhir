...
public class SearchClientR4Test {
	...
	private String createBundleWithSearchExtension() {
		return "<Bundle xmlns=\"http://hl7.org/fhir\"><id"
						+ " value=\"f61f6ddc-95e8-4ef9-a4cd-17c79bbb74f3\"></id><meta><lastUpdated"
						+ " value=\"2016-02-19T12:04:02.616-05:00\"></lastUpdated></meta><type"
						+ " value=\"searchset\"></type><link><relation value=\"self\"></relation><url"
						+ " value=\"http://localhost:8081/hapi-fhir/fhir/Location?name=Sample+Clinic&amp;_query=match\"></url></link><entry><resource><Location"
						+ " xmlns=\"http://hl7.org/fhir\"><id value=\"1\"></id><name value=\"Sample"
						+ " Clinic\"></name></Location></resource><search><extension"
						+ " url=\"http://hl7.org/fhir/StructureDefinition/algorithmic-match\"><valueCode"
						+ " value=\"probable\"></valueCode></extension><score"
						+ " value=\"0.8000000000000000444089209850062616169452667236328125\"></score>"
						+ "</search></entry></Bundle>";
	}
								...
								new Answer<InputStream>() {
									...
									public InputStream answer(InvocationOnMock theInvocation)
										...
										return new ReaderInputStream(
													new StringReader(response), Charset.forName("UTF-8"));
									}
								});

		ILocationClient client =
					ourCtx.newRestfulClient(
								ILocationClient.class, "http://localhost:8081/hapi-fhir/fhir");
	...
	public void testCapabilities() throws Exception {
		...
		IGenericClient client =
					ourCtx.newRestfulGenericClient("http://localhost:8081/hapi-fhir/fhir");

		CapabilityStatement actual =
	...
	public void testSearchWithPrimitiveTypes() throws Exception {
		...
		try {
				...
				ILocationClient client =
						ourCtx.newRestfulClient(ILocationClient.class, "http://localhost/fhir");
				...
				assertEquals(
						...
						UrlUtil.unescape(
									((HttpGet) capt.getAllValues().get(idx++)).getURI().toString()));
	...
	public void testSortForDstu3() throws Exception {
		...
		client.search(
					new SortSpec("param1", SortOrderEnum.ASC)
								.setChain(new SortSpec("param2", SortOrderEnum.DESC)));
		assertEquals(
	...
	public interface ILocationClient extends IRestfulClient {
		...
		public List<Location> getMatches(
					final @RequiredParam(name = Location.SP_NAME) StringParam name,
					final @Count Integer count);

		@Search(queryName = "match", type = Location.class)
		public Bundle getMatchesReturnBundle(
					final @RequiredParam(name = Location.SP_NAME) StringParam name,
					final @Count Integer count);
