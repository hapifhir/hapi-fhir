...
public class IncludedResourceStitchingClientTest {
    ...
    public void testWithParam() throws Exception {
        ...
        Bundle bundle = client.search().forResource("Patient").returnBundle(Bundle.class).execute();
    ...
    public void testWithDeclaredExtension() throws Exception {
        ...
        when(myHttpResponse.getEntity().getContent())
                .thenReturn(
                        new ReaderInputStream(
                                new StringReader(createLinkedBundle()), StandardCharsets.UTF_8));

        IGenericClient client = ctx.newRestfulGenericClient("http://foo");
        Bundle bundle =
                client.search()
                        .forResource(IncludeTest.ExtPatient.class)
        ...
        assertEquals(
                "o2", o1.getPartOf().getReferenceElement().toUnqualifiedVersionless().getIdPart());
    ...
    private String createLinkedBundle() {
        ...
        //				"   <link rel=\"self\"
        // href=\"http://localhost:49782/Patient?_query=declaredExtInclude&amp;_pretty=true\"/>\n" +
        //				"   <link rel=\"fhir-base\" href=\"http://localhost:49782\"/>\n" +
        //				"   <os:totalResults
        // xmlns:os=\"http://a9.com/-/spec/opensearch/1.1/\">2</os:totalResults>\n" +
        //				"   <author>\n" +
    ...
    private String createBundle() {
        ...
        //				"   <link rel=\"self\"
        // href=\"http://localhost:49627/Patient?_query=extInclude&amp;_pretty=true\"/>\n" +
