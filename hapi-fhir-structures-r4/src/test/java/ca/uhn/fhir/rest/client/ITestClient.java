...
public interface ITestClient extends IBasicClient {
	...
	Patient getPatientWithIncludes(
			@RequiredParam(name = "withIncludes") StringParam theString, @IncludeParam List<Include> theIncludes);
	...
	List<Patient> getPatientByCompartmentAndDob(
			@IdParam IdType theIdType, @RequiredParam(name = Patient.SP_BIRTHDATE) DateParam theBirthDate);
