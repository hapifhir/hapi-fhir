...
public class InteractionBlockingInterceptorTest implements ITestDataBuilder {
    ...
    private static final Logger ourLog =
            LoggerFactory.getLogger(InteractionBlockingInterceptorTest.class);
    ...
    public void testAllowInteractions() {
        // Setup
        mySvc =
                new InteractionBlockingInterceptor.Builder(ourCtx)
    ...
    private Set<String> fetchCapabilityInteractions() {
        CapabilityStatement cs =
                myServer.getFhirClient().capabilities().ofType(CapabilityStatement.class).execute();
