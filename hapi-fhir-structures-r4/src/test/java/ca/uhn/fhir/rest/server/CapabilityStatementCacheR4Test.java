...
public class CapabilityStatementCacheR4Test {
    ...
    @RegisterExtension
    protected final RestfulServerExtension myServerExtension =
            new RestfulServerExtension(myFhirContext)
                    .registerProvider(new HashMapResourceProvider<>(myFhirContext, Patient.class))
                    .withServer(
                            t ->
                                    t.setServerConformanceProvider(
                                            new MyCapabilityStatementProvider(t)));
    ...
    public void testCacheThreadShutsDownWhenServerShutsDown() throws Exception {
        CapabilityStatement response =
                myServerExtension
                        ...
                        .execute();
        sleepAtLeast(20);
        CapabilityStatement response2 =
                myServerExtension
                        .getFhirClient()
                        .capabilities()
                        .ofType(CapabilityStatement.class)
                        .execute();
        CapabilityStatement response3 =
                myServerExtension
                        .getFhirClient()
                        .capabilities()
                        .ofType(CapabilityStatement.class)
                        .execute();
        CapabilityStatement response4 =
                myServerExtension
                        .getFhirClient()
                        .capabilities()
                        .ofType(CapabilityStatement.class)
