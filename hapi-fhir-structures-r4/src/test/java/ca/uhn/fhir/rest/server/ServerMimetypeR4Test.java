...
public class ServerMimetypeR4Test {
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(ServerMimetypeR4Test.class);
    ...
    public void testConformanceMetadataUsesNewMimetypes() throws Exception {
        ...
        try {
            ...
            CapabilityStatement conf =
                    ourCtx.newXmlParser().parseResource(CapabilityStatement.class, content);
    ...
    public void testCreateWithJsonNewNoAcceptHeaderReturnsOperationOutcome() throws Exception {
        ...
        httpPost.setEntity(
                new StringEntity(
                        enc, ContentType.parse(Constants.CT_FHIR_JSON_NEW + "; charset=utf-8")));
        httpPost.addHeader(
    ...
    public void testCreateWithXmlNewNoAcceptHeader() throws Exception {
        ...
        httpPost.setEntity(
                new StringEntity(
                        enc, ContentType.parse(Constants.CT_FHIR_XML_NEW + "; charset=utf-8")));
        HttpResponse status = ourClient.execute(httpPost);
    ...
    public void testResponseContentTypesJson() throws IOException {
        ...
        assertEquals(
                ...
                readAndReturnContentType("application/fhir+json,application/json;q=0.9"));
    ...
    public void testResponseContentTypesXml() throws IOException {
        ...
        assertEquals(
                ...
                readAndReturnContentType("application/fhir+xml,application/xml;q=0.9"));
