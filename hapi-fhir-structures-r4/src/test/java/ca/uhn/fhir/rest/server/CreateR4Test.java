...
public class CreateR4Test {
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(CreateR4Test.class);
    ...
    public void testCreateFailsIfNoContentTypeProvided() throws Exception {
        ...
        try (CloseableHttpResponse status = ourClient.execute(httpPost)) {
            ...
            assertThat(
                    responseContent,
                    containsString(
                            "No Content-Type header was provided in the request. This is required"
    ...
    public void testCreatePreferDefaultRepresentation() throws Exception {
        ...
        httpPost.setEntity(
                new StringEntity(body, ContentType.parse("application/fhir+json; charset=utf-8")));
        try (CloseableHttpResponse status = ourClient.execute(httpPost)) {
    ...
    public static void beforeClass() throws Exception {
        ...
        ourServlet.setResourceProviders(
                patientProviderCreate, patientProviderRead, patientProviderSearch);
