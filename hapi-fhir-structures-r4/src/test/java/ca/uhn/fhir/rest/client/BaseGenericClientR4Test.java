...
public abstract class BaseGenericClientR4Test {
    ...
    protected byte[] extractBodyAsByteArray(ArgumentCaptor<HttpUriRequest> capt)
            throws IOException {
        byte[] body =
                IOUtils.toByteArray(
    ...
    protected ArgumentCaptor<HttpUriRequest> prepareClientForCapabilityStatement()
            throws IOException {
    ...
    protected List<Class<? extends IBaseResource>> toTypeList(
