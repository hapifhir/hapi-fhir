...
public class OperationClientR4Test {
    ...
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(OperationClientR4Test.class);
                        ...
                        new Answer<InputStream>() {
                            ...
                            public InputStream answer(InvocationOnMock theInvocation) {
                                return new ReaderInputStream(
                                        new StringReader(retVal), Charset.forName("UTF-8"));
                            }
                        });
    ...
    public void testNonRepeatingGenericUsingParameters() throws Exception {
        ourGenClient
                ...
                .execute();
        Parameters response =
                ourAnnClient.nonrepeating(new StringParam("str"), new TokenParam("sys", "val"));
        ...
        assertEquals(
                "sys2|val2", ((StringType) request.getParameter().get(1).getValue()).getValue());
    }
    ...
    public void testNonRepeatingGenericUsingUrl() {
        ...
        assertEquals(
                "http://foo/$nonrepeating?valstr=str&valtok=sys2%7Cval2",
    ...
    public void testOperationOnInstanceWithIncompleteInstanceId() {
        try {
            ...
            assertEquals(
                    "Can not invoke operation \"$nonrepeating\" on instance \"123\" - No resource"
                            + " type specified",
                    e.getMessage());
        }
    }
