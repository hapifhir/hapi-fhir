...
public class SearchMethodPriorityTest {
    ...
    public void testDateRangeSelectedWhenMultipleParametersProvided() {
        ourServerRule
                .getRestfulServer()
                .registerProviders(new DateStrengthsWithRequiredResourceProvider());
    ...
    public void testStringAndListSelectedWhenMultipleParametersProvided() {
        ourServerRule
                .getRestfulServer()
                .registerProviders(new StringStrengthsWithOptionalResourceProvider());
    ...
    public class StringStrengthsWithOptionalResourceProviderReverseOrder
