...
public class OperationGenericServer2R4Test {
    ...
    public void testDeclarativeTypedParameters() throws Exception {
        ...
        class PatientProvider implements IResourceProvider {
            ...
            public Parameters opInstance(
                    ...
                    @OperationParam(name = "PARAM1", typeName = "code")
                            IPrimitiveType<String> theParam1,
                    @OperationParam(name = "PARAM2", typeName = "Coding")
                            ICompositeType theParam2) {
        ...
        HttpPost httpPost =
                new HttpPost("http://localhost:" + myPort + "/Patient/123/$OP_INSTANCE");
        httpPost.setEntity(
    ...
    public void testDeclarativeStringTypedParameters() throws Exception {
        ...
        class PatientProvider implements IResourceProvider {
            ...
            public Parameters opInstance(
                    @ResourceParam() IBaseResource theResourceParam,
                    @IdParam IdType theId,
                    @OperationParam(name = "PARAM1", min = 1, typeName = "uri")
                            IPrimitiveType<String> theParam1,
                    @OperationParam(
                                    name = "PARAM2",
                                    min = 1,
    ...
    public void testDeclarativeTypedParametersInvalid() throws Exception {
        ...
        try {
            ...
            assertThat(
                    ce.getMessage(),
                    containsString(
                            "Failure scanning class PatientProvider: "
                                    + Msg.code(405)
                                    + "Non assignable parameter typeName=\"code\" specified on"
                                    + " method public org.hl7.fhir.r4.model.Parameters"
                                    + " ca.uhn.fhir.rest.server.OperationGenericServer2R4Test"));
        }
    }
    ...
    public void testTypeOperationWithTypeDeclaredByName() throws Exception {
        ...
        class PlainProvider {
            ...
            public Parameters opInstance(
                    @ResourceParam() IBaseResource theResourceParam, @IdParam IdType theId) {
    ...
    public void testTypeOperationWithInvalidType() throws Exception {
        ...
        try {
            ...
            assertEquals(
                    Msg.code(288)
                            + "Failure scanning class PlainProvider: "
                            + Msg.code(423)
                            + "Failed to bind method public org.hl7.fhir.r4.model.Parameters"
                            + " ca.uhn.fhir.rest.server.OperationGenericServer2R4Test$2PlainProvider.opInstance()"
                            + " - "
                            + Msg.code(1684)
                            + "Unknown resource name \"FOO\" (this name is not known in FHIR"
                            + " version \"R4\")",
                    cause.getMessage());
        }
    }
