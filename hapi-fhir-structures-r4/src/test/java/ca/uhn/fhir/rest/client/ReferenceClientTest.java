...
public class ReferenceClientTest {
    ...
    public void testWithParamAndTypeAndChain() throws Exception {
        ...
        HttpGet get = (HttpGet) capt.getValue();
        assertEquals(
                "http://foo/Patient?general-practitioner%3AOrganization.chain=123",
                get.getURI().toString());
    }
    ...
    public void testWithParamAndType() throws Exception {
        ...
        HttpGet get = (HttpGet) capt.getValue();
        assertEquals(
                "http://foo/Patient?general-practitioner=Organization%2F123",
                get.getURI().toString());
    }
    ...
    private interface IClient extends IBasicClient {
        ...
        List<Patient> search(
                @RequiredParam(name = Patient.SP_GENERAL_PRACTITIONER) ReferenceParam theString);
    }
