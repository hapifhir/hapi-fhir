...
class StandardizingInterceptorTest {
    ...
    public void init() throws Exception {
        myInterceptor =
                new StandardizingInterceptor(new ObjectMapper().readValue(CONFIG, Map.class));
    ...
    public void testBadConfig() throws Exception {
        myInterceptor =
                new StandardizingInterceptor(new ObjectMapper().readValue(BAD_CONFIG, Map.class));
    ...
    public void testTelecomStandardization() throws Exception {
        ...
        assertEquals(
                ...
                "Expected email to remain the same");
