...
class FieldValidatingInterceptorTest {
    ...
    private static final Logger ourLog =
            LoggerFactory.getLogger(FieldValidatingInterceptorTest.class);
    ...
    public void testDisablingValidationViaHeader() {
        ...
        when(request.getHeaders(eq(VALIDATION_DISABLED_HEADER)))
    ...
    public void testCustomValidation() {
        myInterceptor
                .getConfig()
                .put("telecom.where(system='phone')", EmptyValidator.class.getName());
