...
public class ServerMethodSelectionR4Test extends BaseR4ServerTest {
	...
	/**
	* Server method with no _include Client request with _include
	*
	* <p>See #1421
	*/
	@Test
	public void testRejectIncludeIfNotProvided() throws Exception {
		...
		try {
				...
				assertThat(
						e.getMessage(),
						containsString(
									"this server does not know how to handle GET operation[Patient] with"
												+ " parameters [[_include, name]]"));
		}
	}
	...
	*/
	...
	/**
	* Server method with no _revinclude Client request with _revinclude
	*
	* <p>See #1421
	*/
	@Test
