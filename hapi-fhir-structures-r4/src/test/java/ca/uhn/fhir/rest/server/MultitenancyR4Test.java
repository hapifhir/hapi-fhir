...
public class MultitenancyR4Test {
	...
	private static final org.slf4j.Logger ourLog =
				org.slf4j.LoggerFactory.getLogger(MultitenancyR4Test.class);
		...
		try {
				...
				assertThat(
						...
						containsString(
									"\"diagnostics\":\""
												+ Msg.code(307)
												+ "This is the base URL of a multitenant FHIR server. Unable to"
												+ " handle this request, as it does not contain a tenant"
												+ " ID.\""));
		} finally {
				IOUtils.closeQuietly(status.getEntity().getContent());
		}
