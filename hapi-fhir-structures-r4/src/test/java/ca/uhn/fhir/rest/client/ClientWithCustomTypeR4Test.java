...
public class ClientWithCustomTypeR4Test {
	...
	public void testSearchWithGenericReturnType() throws Exception {
		...
		List<IBaseResource> response = client.getPatientByDobWithGenericResourceReturnType(
				new DateParam(ParamPrefixEnum.GREATERTHAN_OR_EQUALS, "2011-01-02"));

		assertEquals(
				"http://foo/Patient?birthdate=ge2011-01-02",
	...
	public void testSearchWithGenericReturnType2() throws Exception {
		...
		ITestClient client = ctx.newRestfulClient(ITestClient.class, "http://foo");
		List<IAnyResource> response = client.getPatientByDobWithGenericResourceReturnType2(
				new DateParam(ParamPrefixEnum.GREATERTHAN_OR_EQUALS, "2011-01-02"));
