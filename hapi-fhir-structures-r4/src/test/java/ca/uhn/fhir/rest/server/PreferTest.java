...
public class PreferTest {
	...
	private static final org.slf4j.Logger ourLog =
				org.slf4j.LoggerFactory.getLogger(PreferTest.class);
	...
	public void testCreatePreferMinimalNoOperationOutcome() throws Exception {
		...
		// assertThat(status.getFirstHeader(Constants.HEADER_CONTENT_TYPE).getValue(),
		// not(containsString("fhir")));
	...
	public void testCreatePreferRepresentation() throws Exception {
		...
		assertEquals(
					"<Patient xmlns=\"http://hl7.org/fhir\"><id value=\"001\"/><meta><versionId"
								+ " value=\"002\"/></meta><identifier><value"
								+ " value=\"002\"/></identifier></Patient>",
					responseContent);
		assertEquals(
					"http://localhost:" + ourPort + "/Patient/001/_history/002",
					status.getFirstHeader("location").getValue());
