...
public class ElementWithExtensionR4Test {
	...
	private static final org.slf4j.Logger ourLog =
				org.slf4j.LoggerFactory.getLogger(ElementWithExtensionR4Test.class);
	...
	public void testNullFlavorPrimitiveExtensionJson() throws Exception {
		...
		assertEquals(
					1, patient.getExtensionsByUrl("/myExt").get(0).getValue().getExtension().size());
