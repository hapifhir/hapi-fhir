...
public class ExtendedPatientTest {
	...
	public void testBundleReferences() {
		...
		fhirContext.setDefaultTypeForProfile(
				"http://acme.org//StructureDefinition/patient-with-eyes", ExtendedPatient.class);
		...
		ExtendedPatient parsedHomer =
				(ExtendedPatient) parsedBundle.getEntry().get(0).getResource();
		ExtendedPatient parsedMarge =
				(ExtendedPatient) parsedBundle.getEntry().get(1).getResource();
