...
public class XmlParserR4Test extends BaseTest {
	...
	public void testEncodeAndParseBundleWithFullUrlAndResourceIdMismatch() {
		...
		assertThat(encoded, stringContainsInOrder("<fullUrl value=\"urn:uuid:0.0.0.0\"/>", "<id value=\"1.1.1.1\"/>"));
	...
	public void testEncodeToString_Resource() {
		...
		p.setActive(true);
		String expected =
				"<Patient xmlns=\"http://hl7.org/fhir\"><id value=\"123\"/><active value=\"true\"/></Patient>";
	...
	public void testEncodeToString_GeneralPurposeDataType() {
		...
		String expected =
				"<element><extension url=\"http://foo\"><valueString value=\"bar\"/></extension><family value=\"Simpson\"/><given value=\"Homer\"/><given value=\"Jay\"/></element>";
	...
	public void testEncodeToString_BackboneElement() {
		...
		String expected =
				"<element><language><text value=\"English\"/></language><preferred value=\"true\"/></element>";
