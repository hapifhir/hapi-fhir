...
public class XmlParserR4Test extends BaseTest {
    ...
    public void testEncodeAndParseBundleWithFullUrlAndResourceIdMismatch() {
        ...
        assertThat(
                ...
                stringContainsInOrder(
                        "<fullUrl value=\"urn:uuid:0.0.0.0\"/>", "<id value=\"1.1.1.1\"/>"));
    ...
    public void testNarrativeLangAttributePreserved() throws IOException {
        Observation obs =
                loadResource(ourCtx, Observation.class, "/resource-with-lang-in-narrative.xml");
    ...
    public void testEncodeContainedBundle() {
        ...
        String auditEventAsString =
                ourCtx.newXmlParser().setPrettyPrint(true).encodeResourceToString(ae);
    ...
    public void testDivXhtmlLangAttribute() {
        ...
        String parameteresAsString =
                ourCtx.newXmlParser().setPrettyPrint(true).encodeResourceToString(pa);
