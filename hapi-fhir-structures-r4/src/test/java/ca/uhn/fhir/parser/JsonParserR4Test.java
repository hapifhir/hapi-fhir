...
public class JsonParserR4Test extends BaseTest {
        ...
        try {
            ...
            assertEquals(
                    Msg.code(1844)
                            ...
                            + " ca.uhn.fhir.parser.JsonParserR4Test.MyUnknownPrimitiveType",
                    e.getMessage());
        }
    }
    ...
    public void testNamespacePrefixTrimmedFromNarrative() {
        ...
        String expected =
                "<div xmlns=\"http://www.w3.org/1999/xhtml\"><img src=\"foo\"/>@fhirabend</div>";
    ...
    public void testDontEncodeEmptyExtensionList() {
        ...
        String asString =
                ourCtx.newJsonParser().setPrettyPrint(true).encodeResourceToString(bundle);
    ...
    public void testEncodeExtensionOnBinaryData() {
        ...
        assertEquals(
                "{\"resourceType\":\"Binary\",\"meta\":{\"tag\":[{\"system\":\"http://terminology.hl7.org/CodeSystem/v3-ObservationValue\",\"code\":\"SUBSETTED\",\"display\":\"Resource"
                    + " encoded in summary mode\"}]}}",
                output);

        output =
                ourCtx.newJsonParser()
                        .setDontEncodeElements(Sets.newHashSet("*.id", "*.meta"))
                        .encodeResourceToString(b);
        assertEquals(
                "{\"resourceType\":\"Binary\",\"_data\":{\"extension\":[{\"url\":\"http://foo\",\"valueString\":\"AAA\"}]}}",
                output);
    }
    ...
    public void testDontStripVersions() {
        ...
        ctx.getParserOptions()
                .setDontStripVersionsFromReferencesAtPaths("QuestionnaireResponse.questionnaire");
    ...
    public void testContainedResourcesNotAutoContainedWhenConfiguredNotToDoSo() {
        ...
        assertEquals(
                "{\"resourceType\":\"MedicationDispense\",\"identifier\":[{\"value\":\"DISPENSE\"}],\"medicationReference\":{}}",
                encoded);

        ourCtx.getParserOptions().setAutoContainReferenceTargetsWithNoId(true);
        encoded = ourCtx.newJsonParser().setPrettyPrint(false).encodeResourceToString(md);
        assertEquals(
                "{\"resourceType\":\"MedicationDispense\",\"contained\":[{\"resourceType\":\"Medication\",\"id\":\"1\",\"code\":{\"text\":\"MED\"}}],\"identifier\":[{\"value\":\"DISPENSE\"}],\"medicationReference\":{\"reference\":\"#1\"}}",
                encoded);
    }
    ...
    public void testParseBundleWithMultipleNestedContainedResources() throws Exception {
        ...
        assertEquals(
                ...
                bundle.getEntry()
                        .get(0)
                        .getResource()
                        .getUserData(BaseParser.RESOURCE_CREATED_BY_PARSER));
        assertEquals(
                Boolean.TRUE,
                bundle.getEntry()
                        .get(1)
    ...
    private String getPatientIdValue(Bundle input, int entry) {
        final DocumentReference documentReference =
                (DocumentReference) input.getEntry().get(entry).getResource();
    ...
    /**
     * Make sure we can perform parallel parse/encodes against the same FhirContext instance when
     * deferred model scanning is enabled without running into threading issues.
     */
    @Test
    public void testEncodeAndDecodeMultithreadedWithDeferredModelScanning()
        ...
        for (int pass = 0; pass < 10; pass++) {
            ...
            for (int readIdx = 0; readIdx < 10; readIdx++) {
                bundleFutures.add(
                        executor.submit(
                                () -> parseCtx.newJsonParser().parseResource(Bundle.class, input)));
            }
                ...
                encodeFutures.add(
                        executor.submit(
                                () ->
                                        encodeCtx
                                                .newJsonParser()
                                                .encodeResourceToString(nextBundle)));
            }
    ...
    public void testEncodeAndParseBundleWithFullUrlAndResourceIdMismatch() {
        ...
        input.addEntry().setFullUrl("urn:uuid:0.0.0.0").setResource(header);
        ...
        assertThat(
                encoded,
                stringContainsInOrder("\"fullUrl\": \"urn:uuid:0.0.0.0\"", "\"id\": \"1.1.1.1\""));
    ...
    public void testParseSingleQuotes() {
        Bundle bundle =
                ourCtx.newJsonParser()
                        .parseResource(Bundle.class, "{ 'resourceType': 'Bundle', 'id': '123' }");
    ...
    public void testEncodeBinary() {
        ...
        assertEquals(
                "{\"resourceType\":\"Binary\",\"contentType\":\"application/octet-stream\",\"data\":\"AAECAwQ=\"}",
                output);
    }
    ...
    public void testEncodeWithInvalidExtensionContainingValueAndNestedExtensions() {
        ...
        try {
            ...
            assertEquals(
                    Msg.code(1827)
                            + "[element=\"Patient(res).extension\"] Extension contains both a value"
    ...
    @Test
    public void
            testEncodeWithInvalidExtensionContainingValueAndNestedExtensions_withDisableAllErrorsShouldSucceed() {
    ...
    public void testEncodeResourceWithMixedManualAndAutomaticContainedResourcesLocalLast2() {
        ...
        mr.setMedication(
                new Reference(new Medication().setStatus(Medication.MedicationStatus.ACTIVE)));
    ...
    public void testExcludeNothing() {
        ...
        assertEquals(
                "GIVEN",
                ((Patient) b.getEntry().get(0).getResource())
                        .getNameFirstRep()
    ...
    public void testParseAndEncodeExtensionWithValueWithExtension() {
        String input =
                "{\n"
                    ...
                    + "    {\n"
                    + "      \"url\":"
                    + " \"https://purl.org/elab/fhir/network/StructureDefinition/1/BirthWeight\",\n"
                    + "      \"_valueDecimal\": {\n"
                    + "        \"extension\": [\n"
                    + "          {\n"
                    + "            \"url\":"
                    + " \"http://www.hl7.org/fhir/extension-data-absent-reason.html\",\n"
                    + "            \"valueCoding\": {\n"
                    ...
                    + "    {\n"
                    + "      \"system\":"
                    + " \"https://purl.org/elab/fhir/network/StructureDefinition/1/EuroPrevallStudySubjects\",\n"
                    + "      \"value\": \"1\"\n"
                    + "    }\n"
                    + "  ],\n"
                    + "  \"gender\": \"female\"\n"
    ...
    public void testParseEmptyAttribute() {
        ...
        try {
            ...
            assertEquals(
                    Msg.code(1821)
                            + "[element=\"value\"] Invalid attribute value \"\": Attribute value"
                            + " must not be empty (\"\")",
                    e.getMessage());
        }
    }
    ...
    public void testParseExtensionWithUriValue_BuiltInStructure() {
        ...
        assertEquals(
                "ae644c07-1d4b-4ca4-bbf3-bd2023e294e5",
                parsed.getExtensionByUrl("http://myValue.url")
                        .getValueAsPrimitive()
                        .getValueAsString());
    }
    ...
    public void testParseExtensionOnPrimitive() throws IOException {
        String input =
                IOUtils.toString(
                        JsonParserR4Test.class.getResourceAsStream("/extension-on-line.txt"),
        ...
        Extension houseNumberExt =
                line0.getExtensionByUrl(
    ...
    private Composition createComposition(String sectionText) {
        ...
        Narrative compositionSectionText =
                new Narrative().setStatus(Narrative.NarrativeStatus.GENERATED);
    ...
    /**
     * 2019-09-19 - Pre #1489 18:24:48.548 [main] INFO ca.uhn.fhir.parser.JsonParserR4Test
     * [JsonParserR4Test.java:483] - Encoded 200 passes - 50ms / pass - 19.7 / second 18:24:52.472
     * [main] INFO ca.uhn.fhir.parser.JsonParserR4Test [JsonParserR4Test.java:483] - Encoded 300
     * passes - 47ms / pass - 21.3 / second 18:24:56.428 [main] INFO
     * ca.uhn.fhir.parser.JsonParserR4Test [JsonParserR4Test.java:483] - Encoded 400 passes - 45ms /
     * pass - 22.2 / second 18:25:00.463 [main] INFO ca.uhn.fhir.parser.JsonParserR4Test
     * [JsonParserR4Test.java:483] - Encoded 500 passes - 44ms / pass - 22.6 / second
     *
     * <p>2019-09-19 - Post #1489 15:20:30.134 [main] INFO ca.uhn.fhir.parser.JsonParserR4Test
     * [JsonParserR4Test.java:574] - Encoded 800 passes - 28ms / pass - 34.5 / second 15:20:32.986
     * [main] INFO ca.uhn.fhir.parser.JsonParserR4Test [JsonParserR4Test.java:574] - Encoded 900
     * passes - 28ms / pass - 34.6 / second 15:20:35.865 [main] INFO
     * ca.uhn.fhir.parser.JsonParserR4Test [JsonParserR4Test.java:574] - Encoded 1000 passes - 28ms
     * / pass - 34.6 / second 15:20:38.797 [main] INFO ca.uhn.fhir.parser.JsonParserR4Test
     * [JsonParserR4Test.java:574] - Encoded 1100 passes - 28ms / pass - 34.6 / second 15:20:41.708
     * [main] INFO ca.uhn.fhir.parser.JsonParserR4Test [JsonParserR4Test.java:574] - Encoded 1200
     * passes - 28ms / pass - 34.5 / second 15:20:44.722 [main] INFO
     * ca.uhn.fhir.parser.JsonParserR4Test [JsonParserR4Test.java:574] - Encoded 1300 passes - 29ms
     * / pass - 34.4 / second 15:20:47.716 [main] INFO ca.uhn.fhir.parser.JsonParserR4Test
     * [JsonParserR4Test.java:574] - Encoded 1400 passes - 29ms / pass - 34.4 / second
     *
     * <p>2020-02-27 - Post #1673 21:27:25.817 [main] INFO ca.uhn.fhir.parser.JsonParserR4Test
     * [JsonParserR4Test.java:609] - Encoded 1100 passes - 28ms / pass - 35.5 / second 21:27:28.598
     * [main] INFO ca.uhn.fhir.parser.JsonParserR4Test [JsonParserR4Test.java:609] - Encoded 1200
     * passes - 28ms / pass - 35.5 / second 21:27:31.436 [main] INFO
     * ca.uhn.fhir.parser.JsonParserR4Test [JsonParserR4Test.java:609] - Encoded 1300 passes - 28ms
     * / pass - 35.5 / second 21:27:34.246 [main] INFO ca.uhn.fhir.parser.JsonParserR4Test
     * [JsonParserR4Test.java:609] - Encoded 1400 passes - 28ms / pass - 35.5 / second 21:27:37.013
     * [main] INFO ca.uhn.fhir.parser.JsonParserR4Test [JsonParserR4Test.java:609] - Encoded 1500
     * passes - 28ms / pass - 35.6 / second 21:27:39.874 [main] INFO
     * ca.uhn.fhir.parser.JsonParserR4Test [JsonParserR4Test.java:609] - Encoded 1600 passes - 28ms
     * / pass - 35.5 / second
     */
    @Test
    @Disabled
    public void testTimingsOutput() throws IOException {
        ...
        for (int i = 0; ; i++) {
            ...
            if (i % 100 == 0) {
                ourLog.info(
                        "Encoded {} passes - {} / pass - {} / second",
                        i,
                        sw.formatMillisPerOperation(i),
                        sw.formatThroughput(i, TimeUnit.SECONDS));
            }
        }
    }

    /**
     * 2019-09-19 - Pre #1489 18:33:08.720 [main] INFO ca.uhn.fhir.parser.JsonParserR4Test
     * [JsonParserR4Test.java:495] - Encoded 200 passes - 47ms / pass - 21.2 / second 18:33:12.453
     * [main] INFO ca.uhn.fhir.parser.JsonParserR4Test [JsonParserR4Test.java:495] - Encoded 300
     * passes - 43ms / pass - 22.7 / second 18:33:16.195 [main] INFO
     * ca.uhn.fhir.parser.JsonParserR4Test [JsonParserR4Test.java:495] - Encoded 400 passes - 42ms /
     * pass - 23.6 / second 18:33:19.912 [main] INFO ca.uhn.fhir.parser.JsonParserR4Test
     * [JsonParserR4Test.java:495] - Encoded 500 passes - 41ms / pass - 24.2 / second
     *
     * <p>2019-09-19 - Post #1489 20:44:38.557 [main] INFO ca.uhn.fhir.parser.JsonParserR4Test
     * [JsonParserR4Test.java:500] - Encoded 200 passes - 37ms / pass - 27.0 / second 20:44:41.459
     * [main] INFO ca.uhn.fhir.parser.JsonParserR4Test [JsonParserR4Test.java:500] - Encoded 300
     * passes - 34ms / pass - 29.1 / second 20:44:44.434 [main] INFO
     * ca.uhn.fhir.parser.JsonParserR4Test [JsonParserR4Test.java:500] - Encoded 400 passes - 33ms /
     * pass - 30.1 / second 20:44:47.372 [main] INFO ca.uhn.fhir.parser.JsonParserR4Test
     * [JsonParserR4Test.java:500] - Encoded 500 passes - 32ms / pass - 30.8 / second
     */
    @Test
    @Disabled
    ...
    /**
     * 2019-09-19 15:22:30.758 [main] INFO ca.uhn.fhir.parser.JsonParserR4Test
     * [JsonParserR4Test.java:638] - Parsed 1700 passes - 12ms / pass - 79.3 / second 15:22:31.968
     * [main] INFO ca.uhn.fhir.parser.JsonParserR4Test [JsonParserR4Test.java:638] - Parsed 1800
     * passes - 12ms / pass - 79.5 / second 15:22:33.223 [main] INFO
     * ca.uhn.fhir.parser.JsonParserR4Test [JsonParserR4Test.java:638] - Parsed 1900 passes - 12ms /
     * pass - 79.5 / second 15:22:34.459 [main] INFO ca.uhn.fhir.parser.JsonParserR4Test
     * [JsonParserR4Test.java:638] - Parsed 2000 passes - 12ms / pass - 79.6 / second 15:22:35.696
     * [main] INFO ca.uhn.fhir.parser.JsonParserR4Test [JsonParserR4Test.java:638] - Parsed 2100
     * passes - 12ms / pass - 79.7 / second 15:22:36.983 [main] INFO
     * ca.uhn.fhir.parser.JsonParserR4Test [JsonParserR4Test.java:638] - Parsed 2200 passes - 12ms /
     * pass - 79.6 / second 15:22:38.203 [main] INFO ca.uhn.fhir.parser.JsonParserR4Test
     * [JsonParserR4Test.java:638] - Parsed 2300 passes - 12ms / pass - 79.7 / second 15:22:39.456
     * [main] INFO ca.uhn.fhir.parser.JsonParserR4Test [JsonParserR4Test.java:638] - Parsed 2400
     * passes - 12ms / pass - 79.7 / second 15:22:40.699 [main] INFO
     * ca.uhn.fhir.parser.JsonParserR4Test [JsonParserR4Test.java:638] - Parsed 2500 passes - 12ms /
     * pass - 79.7 / second 15:22:42.135 [main] INFO ca.uhn.fhir.parser.JsonParserR4Test
     * [JsonParserR4Test.java:638] - Parsed 2600 passes - 12ms / pass - 79.3 / second
     *
     * <p>2020-02-27 - Post #1673 21:29:38.157 [main] INFO ca.uhn.fhir.parser.JsonParserR4Test
     * [JsonParserR4Test.java:687] - Parsed 2200 passes - 11ms / pass - 83.4 / second 21:29:39.374
     * [main] INFO ca.uhn.fhir.parser.JsonParserR4Test [JsonParserR4Test.java:687] - Parsed 2300
     * passes - 12ms / pass - 83.3 / second 21:29:40.576 [main] INFO
     * ca.uhn.fhir.parser.JsonParserR4Test [JsonParserR4Test.java:687] - Parsed 2400 passes - 12ms /
     * pass - 83.3 / second 21:29:41.778 [main] INFO ca.uhn.fhir.parser.JsonParserR4Test
     * [JsonParserR4Test.java:687] - Parsed 2500 passes - 12ms / pass - 83.3 / second 21:29:42.999
     * [main] INFO ca.uhn.fhir.parser.JsonParserR4Test [JsonParserR4Test.java:687] - Parsed 2600
     * passes - 12ms / pass - 83.3 / second
     */
    @Test
    @Disabled
    ...
    /**
     * 2019-09-19 18:32:04.518 [main] INFO ca.uhn.fhir.parser.JsonParserR4Test
     * [JsonParserR4Test.java:513] - Parsed 200 passes - 37ms / pass - 26.8 / second 18:32:07.829
     * [main] INFO ca.uhn.fhir.parser.JsonParserR4Test [JsonParserR4Test.java:513] - Parsed 300
     * passes - 35ms / pass - 27.8 / second 18:32:11.087 [main] INFO
     * ca.uhn.fhir.parser.JsonParserR4Test [JsonParserR4Test.java:513] - Parsed 400 passes - 35ms /
     * pass - 28.5 / second 18:32:14.357 [main] INFO ca.uhn.fhir.parser.JsonParserR4Test
     * [JsonParserR4Test.java:513] - Parsed 500 passes - 34ms / pass - 28.9 / second
     */
    @Test
    @Disabled
    ...
    private Bundle createBigBundle() {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            obs.addIdentifier().setSystem("http://foo").setValue("blah");
            obs.setValue(
                    new Quantity()
                            .setSystem("UCUM")
                            .setCode("mg/L")
    ...
    public void testEncodeContainedBundle() {
        ...
        String auditEventAsString =
                ourCtx.newJsonParser().setPrettyPrint(true).encodeResourceToString(ae);
    ...
    @DatatypeDef(name = "UnknownPrimitiveType")
