...
public class NDJsonParserTest {
    ...
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(NDJsonParserTest.class);
    ...
    private boolean fhirResourcesEqual(IBaseResource expected, IBaseResource actual) {
        ...
        String encoded_expected =
                ourCtx.newJsonParser().setPrettyPrint(true).encodeResourceToString(expected);
        String encoded_actual =
                ourCtx.newJsonParser().setPrettyPrint(true).encodeResourceToString(actual);
