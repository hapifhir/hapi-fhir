...
public class CustomThymeleafNarrativeGeneratorR4Test {
    ...
    public void testStandardType() {
        ...
        CustomThymeleafNarrativeGenerator gen =
                new CustomThymeleafNarrativeGenerator(
                        "classpath:narrative/standardtypes_r4.properties");
        ...
        assertThat(
                actual,
                containsString(
                        "<h1>Name</h1><div class=\"nameElement\">given <b>FAM1"
                            + " </b></div><h1>Address</h1><div><span>line1 </span><br/><span>line2"
                            + " </span><br/></div></div>"));
    }
    ...
    public void testCustomType() {
        ...
        parentExtension.setSize(
                new Quantity(null, 14, "http://unitsofmeasure", "[in_i]", "Inches"));
        ...
        CustomThymeleafNarrativeGenerator gen =
                new CustomThymeleafNarrativeGenerator(
                        "classpath:narrative/customtypes_r4.properties");
        myCtx.setNarrativeGenerator(gen);
        ...
        String expected =
                "<div xmlns=\"http://www.w3.org/1999/xhtml\"><h1>CustomPatient</h1><div><div><h1>Favourite"
                    + " Pizza</h1> Toppings: <span>Mushrooms, Onions</span> Size:"
