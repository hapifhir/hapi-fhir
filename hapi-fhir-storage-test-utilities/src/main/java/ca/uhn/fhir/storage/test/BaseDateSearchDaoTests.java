...
public abstract class BaseDateSearchDaoTests {
     ...
     *
     * <p>Be careful - date searching is defined by set relations over intervals, not a simple
     * number comparison. See http://hl7.org/fhir/search.html#prefix for details.
     *
     * <p>To debug, uncomment the @CsvSource line and comment @MethodSource to run a single case
     *
    ...
    public void testDateSearchMatching(
        ...
        assertExpectedMatch(
                theResourceDate, theQuery, theExpectedMatch, matched, theFileName, theLineNumber);
    }
    ...
    protected static void assertExpectedMatch(
        ...
        String message =
                "Expected "
                        ...
                        + ":"
                        + theLineNumber
                        + ")"; // wrap this in () so tools recognize the line reference.
     ...
     *
     * <p>Use an abstract method instead of a constructor because JUnit has a such a funky
     * lifecycle.
     */
    ...
    public static class TestDataBuilderFixture<O extends IBaseResource> implements Fixture {
        ...
        public TestDataBuilderFixture(
                ITestDataBuilder theTestDataBuilder, IFhirResourceDao<O> theObservationDao) {
        ...
        public IIdType createObservationWithEffectiveDate(String theResourceDate) {
            IIdType id =
                    myTestDataBuilder.createObservation(
                            myTestDataBuilder.withEffectiveDate(theResourceDate));
            myCreatedIds.add(id);
            return id;
        }
