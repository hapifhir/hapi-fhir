...
public class BaseTransactionProcessorTest {
    ...
    void testPerformIdSubstitutionsInMatchUrl_MatchAtStart() {
        ...
        String outcome =
                BaseTransactionProcessor.performIdSubstitutionsInMatchUrl(
    ...
    void testPerformIdSubstitutionsInMatchUrl_MatchAtEnd() {
        IdSubstitutionMap idSubstitutions = new IdSubstitutionMap();
        idSubstitutions.put(
                new IdType("urn:uuid:7ea4f3a6-d2a3-4105-9f31-374d525085d4"),
                new IdType("Patient/123/_history/1"));
        String outcome =
                BaseTransactionProcessor.performIdSubstitutionsInMatchUrl(
                        idSubstitutions,
                        "Patient?name=FAMILY1&organization=urn%3Auuid%3A7ea4f3a6-d2a3-4105-9f31-374d525085d4");
    ...
    void testPerformIdSubstitutionsInMatchUrl_MatchEscapedParam() {
        ...
        String outcome =
                BaseTransactionProcessor.performIdSubstitutionsInMatchUrl(
                        idSubstitutions,
                        "Patient?foo=" + UrlUtil.escapeUrlParam("urn:uuid:1234") + "&bar=baz");
        assertEquals("Patient?foo=Patient/123&bar=baz", outcome);
    }
    ...
    void testPerformIdSubstitutionsInMatchUrl_NoParams() {
        ...
        String outcome =
                BaseTransactionProcessor.performIdSubstitutionsInMatchUrl(idSubstitutions, input);
    ...
    void testPerformIdSubstitutionsInMatchUrl_ReplaceMultiple() {
        IdSubstitutionMap idSubstitutions = new IdSubstitutionMap();
        idSubstitutions.put(
                new IdType("urn:uuid:1234"),
                new IdType("Patient/abcdefghijklmnopqrstuvwxyz0123456789"));
    ...
    void testUnqualifiedMatchUrlStart_RegexPatternMatches() {
        ...
        boolean matchResult =
                BaseTransactionProcessor.UNQUALIFIED_MATCH_URL_START.matcher(matchUrl).find();
