...
/**
 * This class is the registry for sections for the IPS document. It can be extended and customized
 * if you wish to add / remove / change sections.
 *
 * <p>By default, all standard sections in the <a href="http://hl7.org/fhir/uv/ips/">base IPS
 * specification IG</a> are included. You can customize this to remove sections, or to add new ones
 * as permitted by the IG.
 *
 * <p>To customize the sections, you may override the {@link #addSections()} method in order to add
 * new sections or remove them. You may also override individual section methods such as {@link
 * #addSectionAllergyIntolerance()} or {@link #addSectionAdvanceDirectives()}.
 */
public class SectionRegistry {
    ...
    /**
     * This method should be automatically called by the Spring context. It initializes the
     * registry.
     */
    @PostConstruct
    ...
    protected void addSectionAllergyIntolerance() {
        addSection(IpsSectionEnum.ALLERGY_INTOLERANCE)
                ...
                .withProfile(
                        "http://hl7.org/fhir/uv/ips/StructureDefinition/AllergiesAndIntolerances-uv-ips")
    ...
    protected void addSectionMedicationSummary() {
        addSection(IpsSectionEnum.MEDICATION_SUMMARY)
                ...
                .withProfile(
                        "http://hl7.org/fhir/uv/ips/StructureDefinition/MedicationSummary-uv-ips")
    ...
    protected void addSectionProcedures() {
        addSection(IpsSectionEnum.PROCEDURES)
                ...
                .withProfile(
                        "http://hl7.org/fhir/uv/ips/StructureDefinition/HistoryOfProcedures-uv-ips")
                .build();
    }
    ...
    protected void addSectionDiagnosticResults() {
        addSection(IpsSectionEnum.DIAGNOSTIC_RESULTS)
                ...
                .withResourceTypes(
                        ResourceType.DiagnosticReport.name(), ResourceType.Observation.name())
                .withProfile(
                        "http://hl7.org/fhir/uv/ips/StructureDefinition/DiagnosticResults-uv-ips")
                .build();
    }
    ...
    protected void addSectionIllnessHistory() {
        addSection(IpsSectionEnum.ILLNESS_HISTORY)
                ...
                .withResourceTypes(ResourceType.Condition.name())
                .withProfile(
                        "http://hl7.org/fhir/uv/ips/StructureDefinition/PastHistoryOfIllnesses-uv-ips")
                .build();
    }
    ...
    protected void addSectionFunctionalStatus() {
        addSection(IpsSectionEnum.FUNCTIONAL_STATUS)
                ...
                .withProfile(
                        "http://hl7.org/fhir/uv/ips/StructureDefinition/FunctionalStatus-uv-ips")
                .build();
    }
    ...
    protected void addSectionAdvanceDirectives() {
        addSection(IpsSectionEnum.ADVANCE_DIRECTIVES)
                ...
                .withProfile(
                        "http://hl7.org/fhir/uv/ips/StructureDefinition/AdvanceDirectives-uv-ips")
                .build();
    }
                ...
                .orElseThrow(
                        () ->
                                new IllegalArgumentException(
                                        "No section for type: " + theSectionEnum));
    }

    public interface INoInfoGenerator {

        /**
         * Generate an appropriate no-info resource. The resource does not need to have an ID
         * populated, although it can if it is a resource found in the repository.
         */
