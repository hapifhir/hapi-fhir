...
# Converter
cp -fvR ~/workspace/fhir/trunk/build/implementations/java/org.hl7.fhir.convertors/src/org ./hapi-fhir/hapi-fhir-converter/src/main/java/
...
cp ~/workspace/fhir/trunk/build/publish/*.sch hapi-fhir-validation-resources-r4/src/main/resources/org/hl7/fhir/instance/model/r4/schema/

cp ~/workspace/fhir/trunk/build/publish/fhir-single.xsd  hapi-fhir-validation-resources-r4/src/main/resources/org/hl7/fhir/instance/model/r4/schema/
cp ~/workspace/fhir/trunk/build/publish/fhir-xhtml.xsd   hapi-fhir-validation-resources-r4/src/main/resources/org/hl7/fhir/instance/model/r4/schema/
cp ~/workspace/fhir/trunk/build/publish/xml.xsd   hapi-fhir-validation-resources-r4/src/main/resources/org/hl7/fhir/instance/model/r4/schema/

cp ~/workspace/fhir/trunk/build/publish/profiles-*.xml hapi-fhir-validation-resources-r4/src/main/resources/org/hl7/fhir/instance/model/r4/profile/
cp ~/workspace/fhir/trunk/build/publish/v2-tables.xml  hapi-fhir-validation-resources-r4/src/main/resources/org/hl7/fhir/instance/model/r4/valueset/
cp ~/workspace/fhir/trunk/build/publish/v3-codesystems.xml   hapi-fhir-validation-resources-r4/src/main/resources/org/hl7/fhir/instance/model/r4/valueset/
cp ~/workspace/fhir/trunk/build/publish/valuesets.xml    hapi-fhir-validation-resources-r4/src/main/resources/org/hl7/fhir/instance/model/r4/valueset/
