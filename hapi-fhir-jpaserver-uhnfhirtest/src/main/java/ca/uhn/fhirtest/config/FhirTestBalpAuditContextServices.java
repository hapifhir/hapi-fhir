...
public class FhirTestBalpAuditContextServices implements IBalpAuditContextServices {
     ...
     *
     * <p>In this case we are simply returning the HTTP User Agent (ie the name of the browser or
     * HTTP client) because this server is anonymous. In a real implementation it would make more
     * sense to return the identity of the SMART on FHIR client or something similar.
     */
    @Nonnull
    @Override
     ...
     *
     * <p>In this case because this is an anoymous server we simply use a masked version of the
     * user's IP as their identity. In a real server this should have details about the user
     * account.
     */
    @Nonnull
    @Override
     ...
     *
     * <p>Because this is a public server and these audit events will be visible to the outside
     * world, we mask the latter half of the requesting IP address in order to not leak the identity
     * of our users.
     */
    @Override
