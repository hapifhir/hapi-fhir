...
public class FhirTesterConfig {
	...
	public TesterConfig testerConfig() {
		...
		retVal.addServer()
				...
				.withBaseUrl("https://hapi.fhir.org/baseR5")
				...
				.withId("home_audit")
				.withFhirVersion(FhirVersionEnum.R4)
				.withBaseUrl("https://hapi.fhir.org/baseAudit")
				.withName("HAPI Test Server (R4 Audit)")
				.addServer()
				.withId("home_r4b")
				.withFhirVersion(FhirVersionEnum.R4B)
				.withBaseUrl("https://hapi.fhir.org/baseR4B")
				...
				.withBaseUrl("https://hapi.fhir.org/baseDstu3")
				...
				.withBaseUrl("https://hapi.fhir.org/baseDstu2")
