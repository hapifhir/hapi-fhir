...
public class TestRestfulServer extends RestfulServer {
    ...
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(TestRestfulServer.class);
    ...
    protected void initialize() throws ServletException {
        ...
        WebApplicationContext parentAppCtx =
        ...
        setImplementationDescription(
                "HAPI FHIR Test/Demo Server " + fhirVersionParam + " Endpoint");
        setCopyright(
                "This server is **Open Source Software**, licensed under the terms of the [Apache"
        ...
        switch (fhirVersionParam.trim().toUpperCase()) {
            ...
            case "DSTU2":
                {
                    ...
                    beans =
                            myAppCtx.getBean(
                                    "myResourceProvidersDstu2", ResourceProviderFactory.class);
                    systemDao = myAppCtx.getBean("mySystemDaoDstu2", IFhirSystemDao.class);
                    etagSupport = ETagSupportEnum.ENABLED;
                    JpaConformanceProviderDstu2 confProvider =
                            new JpaConformanceProviderDstu2(
                                    this, systemDao, myAppCtx.getBean(JpaStorageSettings.class));
            ...
            case "R4":
                {
                    ...
                    beans =
                            myAppCtx.getBean(
                                    "myResourceProvidersR4", ResourceProviderFactory.class);
                    systemDao = myAppCtx.getBean("mySystemDaoR4", IFhirSystemDao.class);
                    etagSupport = ETagSupportEnum.ENABLED;
                    IValidationSupport validationSupport =
                            myAppCtx.getBean(IValidationSupport.class);
                    JpaCapabilityStatementProvider confProvider =
            ...
            case "R4B":
                {
                    ...
                    beans =
                            myAppCtx.getBean(
                                    "myResourceProvidersR4B", ResourceProviderFactory.class);
            ...
            case "R5":
                {
                    ...
                    beans =
                            myAppCtx.getBean(
                                    "myResourceProvidersR5", ResourceProviderFactory.class);
            ...
            default:
                throw new ServletException(
                        Msg.code(1975)
                                + "Unknown FHIR version specified in init-param[FhirVersion]: "
                                + fhirVersionParam);
        }
         ...
         */
        ResponseHighlighterInterceptor responseHighlighterInterceptor =
        ...
        if (StringUtils.isBlank(baseUrl)) {
            ...
            if (StringUtils.isBlank(baseUrl)) {
                throw new ServletException(
                        Msg.code(1976) + "Missing system property: " + baseUrlProperty);
            }
        }
        ...
        IInterceptorBroadcaster interceptorBroadcaster =
                myAppCtx.getBean(IInterceptorBroadcaster.class);
        ...
        CascadingDeleteInterceptor cascadingDeleteInterceptor =
                new CascadingDeleteInterceptor(
                        ctx, daoRegistry, interceptorBroadcaster, threadSafeResourceDeleterSvc);
        ...
        loggingInterceptor.setMessageFormat(
                "${operationType} Content-Type: ${requestHeader.content-type} - Accept:"
                        + " ${responseEncodingNoDefault} \"${requestHeader.accept}\" - Agent:"
    ...
    /**
     * The public server is deployed to <a href="https://hapi.fhir.org">hapi.fhir.org</a> and the
     * JEE webserver where this FHIR server is deployed is actually fronted by an Apache HTTPd
     * instance, so we use an address strategy to let the server know how it should address itself.
     */
