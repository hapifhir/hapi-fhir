	...
	protected void initialize() throws ServletException {
		...
		switch (fhirVersionParam.trim().toUpperCase()) {
			...
			case "DSTU2": {
				...
				JpaConformanceProviderDstu2 confProvider = new JpaConformanceProviderDstu2(this, systemDao, myAppCtx.getBean(DaoConfig.class), myAppCtx.getBean(ModelConfig.class));
			...
			case "DSTU3": {
				...
				etagSupport = ETagSupportEnum.ENABLED;
				JpaConformanceProviderDstu3 confProvider = new JpaConformanceProviderDstu3(this, systemDao, myAppCtx.getBean(DaoConfig.class), myAppCtx.getBean(ModelConfig.class), myAppCtx.getBean(ISearchParamRegistry.class));
				setServerConformanceProvider(confProvider);
			...
			case "R4": {
				...
				JpaCapabilityStatementProvider confProvider = new JpaCapabilityStatementProvider(this, systemDao, myAppCtx.getBean(DaoConfig.class), myAppCtx.getBean(ModelConfig.class), myAppCtx.getBean(ISearchParamRegistry.class), validationSupport);
				setServerConformanceProvider(confProvider);
				providers.add(myAppCtx.getBean(TerminologyUploaderProvider.class));
				providers.add(myAppCtx.getBean(GraphQLProvider.class));
				break;
