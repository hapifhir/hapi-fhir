	...
	protected void initialize() throws ServletException {
		...
		switch (fhirVersionParam.trim().toUpperCase()) {
			...
			case "R4": {
				...
				JpaCapabilityStatementProvider confProvider = new JpaCapabilityStatementProvider(this, systemDao, myAppCtx.getBean(JpaStorageSettings.class), myAppCtx.getBean(ISearchParamRegistry.class), validationSupport, myAppCtx.getBean(IPartitionLookupSvc.class));
				setServerConformanceProvider(confProvider);
				providers.add(myAppCtx.getBean(TerminologyUploaderProvider.class));
				providers.add(myAppCtx.getBean(GraphQLProvider.class));
