 ...
 * after 1 day. It uses a Timer to automatically check for old subscriptions periodically, and if it
 * finds any with a lastUpdated date more than 24 hours ago it deletes them. This is to prevent
 * people's subscription testing from hanging around and gumming up the server.
 */
