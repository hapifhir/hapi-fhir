    ...
    public void addMultipleHeaderValues() {
        ...
        final BaseRestfulResponse<?> restfulResponse =
                mock(
                        ...
                        withSettings()
                                .useConstructor((RequestDetails) null)
        ...
        assertThat(
                restfulResponse.getHeaders().get("Authorization"),
                Matchers.contains("Basic", "Bearer"));
        assertThat(
                restfulResponse.getHeaders().get("Cache-Control"),
                Matchers.contains("no-cache, no-store"));
    }
}
