...
class NameStandardizerTest {
    ...
    public void testFrenchRemains() {
        ...
        assertEquals(
                "Des Idées L'Océan", myLastNameStandardizer.standardize("Des idées\nl'océan\n\n "));
        assertEquals(
                "Ne T'Arrêtes Pas", myLastNameStandardizer.standardize("Ne\tt'arrêtes\npas\n "));
    }
    ...
    public void testNameNormalization() {
        ...
        assertEquals("Tim", myFirstNameStandardizer.standardize("tim   ☺ "));
        assertEquals(
                "Tim Berners-Lee", myLastNameStandardizer.standardize("      TiM BeRnErS-lEE\n"));
        assertEquals(
                "Sara O'Leary",
                myLastNameStandardizer.standardize("\t\nSAra     o'leARy        \n\n"));
        ...
        assertEquals(
                "Charles de Gaulle", myLastNameStandardizer.standardize("charles de gaulle\n"));
        assertEquals(
                "Charles-Gaspard de la Rive",
                myLastNameStandardizer.standardize("charles-gaspard de la rive"));
        assertEquals(
                "Niccolò Machiavelli", myLastNameStandardizer.standardize("niccolò machiavelli"));
        assertEquals(
                "O'Reilly M'Grego D'Angelo MacDonald McFry",
                myLastNameStandardizer.standardize("o'reilly m'grego d'angelo macdonald mcfry"));
        assertEquals(
                "Cornelius Vanderbilt", myLastNameStandardizer.standardize("cornelius vanderbilt"));
        assertEquals(
                "Cornelius Vanderbilt Jr.",
                myLastNameStandardizer.standardize("cornelius vanderbilt jr."));
        assertEquals(
                "William Shakespeare", myLastNameStandardizer.standardize("william shakespeare"));
        assertEquals(
                "Mr. William Shakespeare",
                myLastNameStandardizer.standardize("mr. william shakespeare"));
        assertEquals(
                "Amber-Lynn O'Brien",
                myLastNameStandardizer.standardize("AMBER-LYNN O\u0080�BRIEN\n"));
        ...
        assertEquals(
                "Sarah Ann Mary Pollock",
                myLastNameStandardizer.standardize("SARAH ANN MARY POLLOCK\n"));
        assertEquals(
                "Tarit Kumar Kanungo",
                myLastNameStandardizer.standardize("TARIT KUMAR  KANUNGO\n"));
        assertEquals(
                "Tram Anh Thi Nguyen",
                myLastNameStandardizer.standardize("TRAM ANH THI  NGUYEN\n"));
        assertEquals(
