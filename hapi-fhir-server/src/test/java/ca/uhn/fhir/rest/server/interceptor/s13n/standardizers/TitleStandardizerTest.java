...
public class TitleStandardizerTest {
    ...
    public void testSpecialCases() {
        ...
        assertEquals(
                "Agilec - Barrie/Orillia (EPS)",
                myStandardizer.standardize("Agilec - Barrie/Orillia (EPS)"));
        assertEquals(
                "Clement's/Callander Ida Pharmacies",
                myStandardizer.standardize("CLEMENT'S/CALLANDER IDA PHARMACIES"));
        assertEquals(
        ...
        assertEquals(
                "The (C/O Dr Mary Cooke)", myStandardizer.standardize("THE (C/O DR MARY COOKE)"));
        assertEquals(
                "Sarah Ann Mary Pollock", myStandardizer.standardize("SARAH ANN MARY POLLOCK"));
        assertEquals(
                "Voir...Être Vu! Opticiens",
                myStandardizer.standardize("VOIR...ÊTRE VU! OPTICIENS"));
        assertEquals(
                "Back in Sync: Wellness Centre",
                myStandardizer.standardize("BACK IN SYNC: WELLNESS CENTRE"));
        assertEquals(
