...
public class SimplePreResourceShowDetailsTest {
    ...
    @Mock private IBaseResource myResource1;
    @Mock private IBaseResource myResource2;
    ...
    public void testGetResources() {
        SimplePreResourceShowDetails details =
                new SimplePreResourceShowDetails(List.of(myResource1, myResource2));
