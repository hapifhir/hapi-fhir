 ...
 * the resource being returned with a Parameters resource containing the results of the given
 * FHIRPath expression evaluated against the resource that would otherwise have been returned.
 *
 * @see <a
 *     href="https://hapifhir.io/hapi-fhir/docs/interceptors/built_in_server_interceptors.html#response-customizing-evaluate-fhirpath">Interceptors
