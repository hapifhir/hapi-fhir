...
public class StaticCapabilityStatementInterceptor {
     ...
     *
     * @see #setCapabilityStatementResource(String) #setCapabilityStatementResource(String) is an
     *     alternate way to supply the CapabilityStatement
     */
    ...
    /**
     * Sets the classpath location of the CapabilityStatement to use. If this method is used to
     * supply the CapabiltyStatement, then the given classpath resource will be read and parsed as a
     * FHIR CapabilityStatement.
     *
     * @see #setCapabilityStatement(IBaseConformance) #setCapabilityStatement(IBaseConformance) is
     *     an alternate way to supply the CapabilityStatement
     */
    ...
    public IBaseConformance hook(RequestDetails theRequestDetails) {
        ...
        if (retVal == null) {
            ...
            Validate.notNull(
                    encoding,
                    "Could not determine FHIR encoding for resource: %s",
                    myCapabilityStatementResource);
