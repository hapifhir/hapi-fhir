...
class SinceOrAtParameter extends SearchParameter {
	...
	//						throw new InvalidRequestException(Msg.code(451) + "Invalid " + Constants.PARAM_SINCE + " value: " +
	// sinceParams[0]);
	//					}
	//				}
	//			}
	...
	//			throw new ConfigurationException(Msg.code(452) + "Method '" + theMethod.getName() + "' in type '" + "' is
	...
	//		} else {
	//			throw new ConfigurationException(Msg.code(453) + "Method '" + theMethod.getName() + "' in type '" + "' is
