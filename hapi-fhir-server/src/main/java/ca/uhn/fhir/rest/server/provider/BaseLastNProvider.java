...
/**
 * This class implements the Observation <a
 * href="http://hl7.org/fhir/observation-operation-lastn.html">$lastn</a> operation.
 *
 * <p>It is does not implement the actual storage logic for this operation, but can be subclassed to
