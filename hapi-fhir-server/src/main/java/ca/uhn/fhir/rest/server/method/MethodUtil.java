...
public class MethodUtil {
    ...
    public static void extractDescription(
            SearchParameter theParameter, Annotation[] theAnnotations) {
                ...
                if (Collection.class.isAssignableFrom(parameterType)) {
                    throw new ConfigurationException(
                            Msg.code(401)
                                    ...
                                    + "' is of an invalid generic type (can not be a collection of"
            ...
            if (ServletRequest.class.isAssignableFrom(parameterType)) {
                ...
                for (int i = 0; i < nextParameterAnnotations.length && param == null; i++) {
                    ...
                    if (nextAnnotation instanceof RequiredParam) {
                        ...
                        parameter.setCompositeTypes(
                                ((RequiredParam) nextAnnotation).compositeTypes());
                        ...
                        parameter.setCompositeTypes(
                                ((OptionalParam) nextAnnotation).compositeTypes());
                        parameter.setChainLists(
                        ...
                        if (parameterType == String.class) {
                            ...
                            throw new ConfigurationException(
                                    Msg.code(402)
                                            ...
                                            + " but has a type other than Collection<"
                                            + Include.class.getSimpleName()
                                            + ">");
                        } else {
                            instantiableCollectionType =
                                    (Class<? extends Collection<Include>>)
                        ...
                        boolean methodIsOperation =
                                theMethod.getAnnotation(Operation.class) != null;
                        ...
                        if (op == null) {
                            throw new ConfigurationException(
                                    Msg.code(404)
                                            + "@OperationParam detected on method that is not"
                        ...
                        String description =
                                ParametersUtil.extractDescription(nextParameterAnnotations);
                        List<String> examples =
                                ParametersUtil.extractExamples(nextParameterAnnotations);
                        ;
                        param =
                        ...
                        if (isNotBlank(operationParam.typeName())) {
                            ...
                            if (elementDefinition == null) {
                                elementDefinition =
                                        theContext.getResourceDefinition(operationParam.typeName());
                            }
                            ...
                            if (!declaredParameterType.isAssignableFrom(newParameterType)) {
                                throw new ConfigurationException(
                                        Msg.code(405)
                                                + "Non assignable parameter typeName=\""
                                                + operationParam.typeName()
                                                + "\" specified on method "
                                                + theMethod);
                            }
                        ...
                        if (parameterType.equals(ValidationModeEnum.class) == false) {
                            throw new ConfigurationException(
                                    Msg.code(406)
                                            ...
                                            + "."
                                            + Validate.Mode.class.getSimpleName()
                                            + " must be of type "
                                            + ValidationModeEnum.class.getName());
                        }
                        String description =
                                ParametersUtil.extractDescription(nextParameterAnnotations);
                        List<String> examples =
                        ...
                        if (parameterType.equals(String.class) == false) {
                            throw new ConfigurationException(
                                    Msg.code(407)
                                            ...
                                            + Validate.class.getSimpleName()
                                            + "."
                                            + Validate.Profile.class.getSimpleName()
                                            + " must be of type "
            ...
            if (param == null) {
                throw new ConfigurationException(
                        Msg.code(408)
                                ...
                                + "' on type '"
                                + theMethod.getDeclaringClass().getCanonicalName()
                                + "' has no recognized FHIR interface parameter"
                                + " nextParameterAnnotations. Don't know how to handle this"
                                + " parameter");
            }

            param.initializeTypes(
