...
public class ElementsParameter implements IParameter {
    ...
    public Object translateQueryParametersIntoServerArgument(
        ...
        try {
            ...
            throw new InternalErrorException(
                    Msg.code(413) + "Failed to instantiate " + myInnerCollectionType, e);
        } catch (IllegalAccessException e) {
            throw new InternalErrorException(
                    Msg.code(414) + "Failed to instantiate " + myInnerCollectionType, e);
        }
    }
    ...
    public static Set<String> getElementsValueOrNull(
            RequestDetails theRequest, boolean theExclude) {
        boolean standardMode =
                theRequest.getServer().getElementsSupport() != ElementsSupportEnum.EXTENDED;
