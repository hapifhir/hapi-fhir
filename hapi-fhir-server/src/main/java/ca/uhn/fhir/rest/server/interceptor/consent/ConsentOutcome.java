...
public class ConsentOutcome {
	...
	/**
	* Convenience constant containing <code>new ConsentOutcome(ConsentOperationStatusEnum.PROCEED)
	* </code>
	*/
	...
	/**
	* Convenience constant containing <code>new ConsentOutcome(ConsentOperationStatusEnum.REJECT)
	* </code>
	*/
	...
	/**
	* Convenience constant containing <code>
	* new ConsentOutcome(ConsentOperationStatusEnum.AUTHORIZED)</code>
	*/
	...
	public ConsentOutcome(
				ConsentOperationStatusEnum theStatus, IBaseOperationOutcome theOperationOutcome) {
