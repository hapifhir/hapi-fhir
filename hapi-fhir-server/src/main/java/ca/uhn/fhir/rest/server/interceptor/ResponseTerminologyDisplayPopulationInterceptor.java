...
public class ResponseTerminologyDisplayPopulationInterceptor
	...
	*/
	public ResponseTerminologyDisplayPopulationInterceptor(
				IValidationSupport theValidationSupport) {
		super(theValidationSupport);

		myCodingDefinitition =
		...
		myStringDefinition =
					(RuntimePrimitiveDatatypeDefinition) myContext.getElementDefinition("string");
	}

	@Hook(
				value = Pointcut.SERVER_OUTGOING_RESPONSE,
				order = RESPONSE_TERMINOLOGY_DISPLAY_POPULATION_INTERCEPTOR)
