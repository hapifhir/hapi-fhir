...
public class ValidationMessageSuppressingInterceptor {
    ...
    /**
     * Supplies one or more patterns to suppress. Any validation messages (of any severity) will be
     * suppressed if they match this pattern. Patterns are in Java Regular Expression format (as
     * defined by the {@link Pattern} class) and are treated as partial maches. They are also case
     * insensitive.
     *
     * <p>For example, a pattern of <code>loinc.*1234</code> would suppress the following message:
     * <br>
     * <code>The LOINC code 1234 is not valid</code>
     */
    public ValidationMessageSuppressingInterceptor addMessageSuppressionPatterns(
            String... thePatterns) {
