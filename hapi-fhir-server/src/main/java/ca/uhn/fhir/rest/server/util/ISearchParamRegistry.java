...
public interface ISearchParamRegistry {
    ...
    /**
     * When indexing a HumanName, if a StringEncoder is set in the context, then the "phonetic"
     * search parameter will normalize the String using this encoder.
     *
     * @since 5.1.0
     */
    ...
    /**
     * Returns a collection containing all of the valid active search parameters. This method is
     * intended for creating error messages for users as opposed to actual search processing. It
     * will include meta parameters such as <code>_id</code> and <code>_lastUpdated</code>.
     */
    ...
    /**
     * Find a search param for a resource. First, check the resource itself, then check the
     * top-level `Resource` resource.
     *
    ...
    default RuntimeSearchParam getRuntimeSearchParam(String theResourceType, String theParamName) {
        RuntimeSearchParam availableSearchParamDef =
                getActiveSearchParam(theResourceType, theParamName);
