...
public class ValidationResultEnrichingInterceptor {
    ...
    /**
     * A {@link RequestDetails#getUserData() user data} entry will be created with this key which
            ...
            if (theRequestDetails != null) {
                List<ValidationResult> validationResult =
                        (List<ValidationResult>)
                                theRequestDetails.getUserData().remove(REQUEST_VALIDATION_RESULT);
    ...
    public static void addValidationResultToRequestDetails(
            ...
            @Nonnull ValidationResult theValidationResult) {
        if (theRequestDetails != null) {
            List<ValidationResult> results =
                    (List<ValidationResult>)
                            theRequestDetails
                                    .getUserData()
                                    .computeIfAbsent(
                                            REQUEST_VALIDATION_RESULT, t -> new ArrayList<>(2));
