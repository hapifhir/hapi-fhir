...
public interface IAuthRuleBuilder {
     ...
     * Start a new rule to allow a given operation
     *
     * @param theRuleName The name of this rule. The rule name is used for logging and error
     *     messages, and could be shown to the client, but has no semantic meaning within HAPI FHIR.
     */
    IAuthRuleBuilderRule allow(String theRuleName);

    /**
     * This rule allows any invocation to proceed. It is intended to be used at the end of a chain
     * that contains {@link #deny()} rules in order to specify a blacklist chain.
     *
    ...
    /**
     * This rule allows any invocation to proceed. It is intended to be used at the end of a chain
     * that contains {@link #allow()} rules in order to specify a whitelist chain.
     *
     * <p>This call completes the rule and adds the rule to the chain.
     */
