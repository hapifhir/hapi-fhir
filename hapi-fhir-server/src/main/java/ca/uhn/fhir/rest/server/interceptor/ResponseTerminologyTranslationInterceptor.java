 ...
 * terminology from one CodeSystem to another at runtime, in resources that are being returned by
 * the server.
 *
 * <p>Mappings are applied only if they are explicitly configured in the interceptor via the {@link
 * #addMappingSpecification(String, String)} method.
 *
 * @since 5.4.0
 */
