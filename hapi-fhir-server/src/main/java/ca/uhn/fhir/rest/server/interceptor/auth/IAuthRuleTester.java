 ...
 *
 * <p>THIS IS AN EXPERIMENTAL API! Feedback is welcome, and this API may change.
 *
 * @since 3.4.0
 */
public interface IAuthRuleTester {
    ...
    class RuleTestRequest {
        ...
        /**
         * The FHIR operation being performed. Note that this is not necessarily the same as the
         * value obtained from invoking {@link RequestDetails#getRestOperationType()} on {@literal
         * requestDetails} because multiple operations can be nested within an HTTP request using
         * FHIR transaction and batch operations
         */
     ...
     * input resource.
     *
     * <p>Returning true will allow the verdict continue. Returning false will block the verdict and
     * cause the rule to abstain (i.e. return null).
     *
     * <p>THIS IS AN EXPERIMENTAL API! Feedback is welcome, and this API may change.
     *
    ...
    default boolean matches(RuleTestRequest theRequest) {
        return this.matches(
                theRequest.operation,
                theRequest.requestDetails,
                theRequest.resourceId,
                theRequest.resource);
    }
    ...
    /**
     * User supplied logic called just before the parent rule renders a verdict on an output
     * resource.
     *
     * <p>Returning true will allow the verdict continue. Returning false will block the verdict and
     * cause the rule to abstain (i.e. return null).
    ...
    default boolean matchesOutput(RuleTestRequest theRequest) {
        return this.matchesOutput(
                theRequest.operation, theRequest.requestDetails, theRequest.resource);
    }
