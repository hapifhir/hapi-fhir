...
public class ProviderConstants {
	...
	public static final String PARTITION_MANAGEMENT_CREATE_PARTITION =
				"$partition-management-create-partition";

	/** Operation name: update partition */
	public static final String PARTITION_MANAGEMENT_UPDATE_PARTITION =
				"$partition-management-update-partition";

	/** Operation name: update partition */
	public static final String PARTITION_MANAGEMENT_DELETE_PARTITION =
				"$partition-management-delete-partition";

	/** Operation name: read partition */
	public static final String PARTITION_MANAGEMENT_READ_PARTITION =
				"$partition-management-read-partition";

	/** Operation name: list partitions */
	public static final String PARTITION_MANAGEMENT_LIST_PARTITIONS =
	...
	@Deprecated
	public static final String MARK_ALL_RESOURCES_FOR_REINDEXING =
	...
	* @deprecated
	*/
	@Deprecated public static final String PERFORM_REINDEXING_PASS = "$perform-reindexing-pass";
}
