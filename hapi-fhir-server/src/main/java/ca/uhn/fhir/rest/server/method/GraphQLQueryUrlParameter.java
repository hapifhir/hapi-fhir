...
public class GraphQLQueryUrlParameter implements IParameter {
	...
	public void initializeTypes(
		...
		if (theOuterCollectionType != null) {
			throw new ConfigurationException(Msg.code(459) + "Method '" + theMethod.getName() + "' in type '"
		...
		if (!String.class.equals(theParameterType)) {
			throw new ConfigurationException(Msg.code(460) + "Method '" + theMethod.getName() + "' in type '"
					+ theMethod.getDeclaringClass().getCanonicalName() + "' is annotated with @" + Count.class.getName()
