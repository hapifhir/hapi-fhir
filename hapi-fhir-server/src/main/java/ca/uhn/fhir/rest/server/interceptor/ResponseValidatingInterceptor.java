...
public class ResponseValidatingInterceptor extends BaseValidatingInterceptor<IBaseResource> {
	...
	/**
	* Do not validate the following operations. A common use for this is to exclude {@link
	* RestOperationTypeEnum#METADATA} so that this operation will execute as quickly as possible.
	*/
