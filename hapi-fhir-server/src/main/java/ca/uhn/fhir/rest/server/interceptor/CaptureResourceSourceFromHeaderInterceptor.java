...
/**
 * This interceptor examines a header on the incoming request and places it in <code>
 * Resource.meta.source</code> (R4 and above) or in an extension on <code>Resource.meta</code> with
 * the URL <code>http://hapifhir.io/fhir/StructureDefinition/resource-meta-source</code> (DSTU3).
 *
 * <p>This interceptor does not support versions of FHIR below DSTU3.
 *
...
public class CaptureResourceSourceFromHeaderInterceptor {
    ...
    private static final Logger ourLog =
            LoggerFactory.getLogger(CaptureResourceSourceFromHeaderInterceptor.class);
    ...
    /**
     * Provides the header name to examine in incoming requests. Default is {@link
     * ca.uhn.fhir.rest.api.Constants#HEADER_REQUEST_SOURCE "X-Request-Source"}.
     */
    ...
    public void extractSource(RequestDetails theRequestDetails) {
        ...
        if (resource != null) {
            ...
            if (isNotBlank(requestSource)) {
                ourLog.trace(
                        "Setting Meta.source to \"{}\" because of header \"{}\"",
                        requestSource,
                        getHeaderName());
