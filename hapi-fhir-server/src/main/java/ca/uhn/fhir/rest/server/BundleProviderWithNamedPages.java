...
public class BundleProviderWithNamedPages extends SimpleBundleProvider {
     ...
     * Constructor
     *
     * @param theResultsInThisPage The complete list of results in the current page. Must not be
     *     null.
     * @param theSearchId The ID for the search. Note that you should also populate {@link
     *     #setNextPageId(String)} and {@link #setPreviousPageId(String)} if these are known. Must
     *     not be <code>null</code> or blank.
     * @param thePageId The ID for the current page. Note that you should also populate {@link
     *     #setNextPageId(String)} and {@link #setPreviousPageId(String)} if these are known. Must
     *     not be <code>null</code> or blank.
    ...
    public BundleProviderWithNamedPages(
            List<IBaseResource> theResultsInThisPage,
            String theSearchId,
            String thePageId,
