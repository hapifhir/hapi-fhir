...
abstract class BaseOutcomeReturningMethodBindingWithResourceParam
	...
	public BaseOutcomeReturningMethodBindingWithResourceParam(
		...
		if (myIdParamIndex != null) {
				myIdParamType =
						(Class<? extends IIdType>) theMethod.getParameterTypes()[myIdParamIndex];
		}
		...
		if (resourceParameter == null) {
				throw new ConfigurationException(
						Msg.code(456)
									...
									+ " does not have a resource parameter annotated with @"
	...
	protected void addParametersForServerRequest(RequestDetails theRequest, Object[] theParams) {
		if (myIdParamIndex != null) {
				theParams[myIdParamIndex] =
						ParameterUtil.convertIdToType(theRequest.getId(), myIdParamType);
		}
	...
	protected void populateRequestDetailsForInterceptor(
		...
		if (myResourceParameterIndex != -1) {
				...
				resource =
						ResourceParameter.parseResourceFromRequest(
									theRequestDetails, this, myResourceType);
		}
