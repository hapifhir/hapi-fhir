 ...
 * capitalizing "Mac" and "Mc" prefixes and keeping name particles in lower case.
 */
public class LastNameStandardizer extends FirstNameStandardizer {

    private Set<String> myParticles =
            new HashSet<>(Arrays.asList("van", "der", "ter", "de", "da", "la"));
    ...
    protected String handlePrefix(String theToken) {
        ...
        for (String prefix : myPrefixes) {
            ...
            String capitalizedSuffix =
                    WordUtils.capitalize(lowerCaseToken.replaceFirst(prefix, ""));
