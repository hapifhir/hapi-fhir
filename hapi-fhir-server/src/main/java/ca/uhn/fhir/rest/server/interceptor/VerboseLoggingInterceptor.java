 ...
 * payloads.
 *
 * <p>This interceptor is mainly intended for debugging since it will generate very large log
 * entries and could potentially be a security risk since it logs every header and complete payload.
 * Use with caution!
 */
