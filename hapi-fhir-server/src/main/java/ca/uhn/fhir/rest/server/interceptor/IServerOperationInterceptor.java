 ...
 * operations (create/update/delete) or within transaction and batch operations that call these
 * sub-operations.
 *
 ...
 *     interceptor methods that are declared using the {@link Hook} annotation without needing to
 *     implement any interceptor
 */
@Deprecated
