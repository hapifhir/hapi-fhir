...
public interface IPagingProvider {
     ...
     *
     * @since 4.0.0 - Note that the <code>theRequest</code> parameter was added to this method in
     *     HAPI FHIR 4.0.0. Existing implementations may choose to add this parameter and not use it
     *     if needed.
     */
    IBundleProvider retrieveResultList(
            @Nullable RequestDetails theRequestDetails, @Nonnull String theSearchId);
