...
public class SecurityEvent 
     ...
     * </p> 
	 */
	public java.util.List<ObjectElement> getObjectElement() {  
		if (myObject == null) {
			myObject = new java.util.ArrayList<ObjectElement>();
		}
		return myObject;
     ...
     * </p> 
	 */
	public java.util.List<CodeableConceptDt> getSubtypeElement() {  
		if (mySubtype == null) {
			mySubtype = new java.util.ArrayList<CodeableConceptDt>();
		}
		return mySubtype;
     ...
     * </p> 
	 */
	public java.util.List<CodeableConceptDt> getRoleElement() {  
		if (myRole == null) {
			myRole = new java.util.ArrayList<CodeableConceptDt>();
		}
		return myRole;
     ...
     * </p> 
	 */
	public java.util.List<CodingDt> getTypeElement() {  
		if (myType == null) {
			myType = new java.util.ArrayList<CodingDt>();
		}
		return myType;
     ...
     * </p> 
	 */
	public BoundCodeableConceptDt<SecurityEventObjectSensitivityEnum> getSensitivityElement() {  
		if (mySensitivity == null) {
			mySensitivity = new BoundCodeableConceptDt<SecurityEventObjectSensitivityEnum>(SecurityEventObjectSensitivityEnum.VALUESET_BINDER);
		}
		return mySensitivity;
     ...
     * </p> 
	 */
	public java.util.List<ObjectDetail> getDetailElement() {  
		if (myDetail == null) {
			myDetail = new java.util.ArrayList<ObjectDetail>();
		}
		return myDetail;
