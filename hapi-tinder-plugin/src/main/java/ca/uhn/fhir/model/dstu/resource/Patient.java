...
public class Patient 
     ...
     * </p> 
	 */
	public java.util.List<HumanNameDt> getNameElement() {  
		if (myName == null) {
			myName = new java.util.ArrayList<HumanNameDt>();
		}
		return myName;
     ...
     * </p> 
	 */
	public java.util.List<ResourceReferenceDt> getCareProviderElement() {  
		if (myCareProvider == null) {
			myCareProvider = new java.util.ArrayList<ResourceReferenceDt>();
		}
		return myCareProvider;
     ...
     * </p> 
	 */
	public java.util.List<Link> getLinkElement() {  
		if (myLink == null) {
			myLink = new java.util.ArrayList<Link>();
		}
		return myLink;
     ...
     * </p> 
	 */
	public java.util.List<CodeableConceptDt> getRelationshipElement() {  
		if (myRelationship == null) {
			myRelationship = new java.util.ArrayList<CodeableConceptDt>();
		}
		return myRelationship;
