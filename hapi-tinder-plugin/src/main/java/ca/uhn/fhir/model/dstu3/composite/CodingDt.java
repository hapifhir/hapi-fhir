 ...
 *
 * <p><b>Requirements:</b> References to codes are very common in healthcare models
 */
@DatatypeDef(name = "CodingDt")
public class CodingDt extends BaseCodingDt
		implements ICompositeDatatype, org.hl7.fhir.instance.model.api.IBaseCoding {
	...
	/**
	* Copy constructor: Creates a new Coding with the system and code copied out of the given
	* coding
	*/
	...
	public boolean isEmpty() {
		return super.isBaseEmpty()
					&& ca.uhn.fhir.util.ElementUtil.isEmpty(
								mySystem, myVersion, myCode, myDisplay, myUserSelected);
	}
	...
	*/
	...
	/**
	* Gets the value(s) for <b>version</b> (). creating it if it does not exist. Will not return
	* <code>null</code>.
	*
	...
	*/
	...
	/**
	* Gets the value(s) for <b>display</b> (). creating it if it does not exist. Will not return
	* <code>null</code>.
	*
	...
	*/
	...
	/**
	* Gets the value(s) for <b>userSelected</b> (). creating it if it does not exist. Will not
	* return <code>null</code>.
	*
	* <p><b>Definition:</b> Indicates that this coding was chosen by a user directly - i.e. off a
