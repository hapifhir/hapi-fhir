 ...
 *
 * <p><b>Definition:</b> A reference from one resource to another
 *
 * <p><b>Requirements:</b>
 */
...
public class ResourceReferenceDt extends BaseResourceReferenceDt implements ICompositeDatatype {
     ...
     *
     * <p><b> When using this in a server:</b> Generally if this is serialized, it will be
     * serialized as a contained resource, so this should not be used if the intent is not to
     * actually supply the referenced resource. This is not a hard-and-fast rule however, as the
     * server can be configured to not serialized this resource, or to load an ID and contain even
     * if this constructor is not used.
     *
    ...
    /**
     * Constructor which accepts a reference directly (this can be an ID, a partial/relative URL or
     * a complete/absolute URL)
     *
     * @param theId The reference itself
     */
     ...
     * a complete/absolute URL)
     *
     * @param theResourceId The reference itself
     */
    ...
    @Description(
            ...
            formalDefinition =
                    "A reference to a location at which the other resource is found. The reference"
                        + " may a relative reference, in which case it is relative to the service"
                        + " base URL, or an absolute URL that resolves to the location where the"
                        + " resource is found. The reference may be version specific or not. If the"
                        + " reference is not to a FHIR RESTful server, then it should be assumed to"
                        + " be version specific. Internal fragment references (start with '#')"
    ...
    public <T extends IElement> List<T> getAllPopulatedChildElementsOfType(Class<T> theType) {
        return ca.uhn.fhir.util.ElementUtil.allPopulatedChildElements(
                theType, myReference, myDisplay);
    }

    /**
     * Gets the value(s) for <b>reference</b> (Relative, internal or absolute URL reference).
     * creating it if it does not exist. Will not return <code>null</code>.
     *
     * <p><b>Definition:</b> A reference to a location at which the other resource is found. The
     * reference may a relative reference, in which case it is relative to the service base URL, or
     * an absolute URL that resolves to the location where the resource is found. The reference may
     * be version specific or not. If the reference is not to a FHIR RESTful server, then it should
    ...
    /**
     * Gets the value(s) for <b>display</b> (Text alternative for the resource). creating it if it
     * does not exist. Will not return <code>null</code>.
     *
     * <p><b>Definition:</b> Plain text narrative that identifies the resource in addition to the
     * resource reference
     */
