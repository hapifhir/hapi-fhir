...
public enum StructureDefinitionKindEnum {
     ...
     *
     * <p>A data type - either a primitive or complex structure that defines a set of data elements.
     * These can be used throughout Resource and extension definitions
     */
     ...
     *
     * <p>A resource defined by the FHIR specification
     */
     ...
     *
     * <p>A logical model - a conceptual package of data that will be mapped to resources for
     * implementation
     */
    ...
    private static Map<String, StructureDefinitionKindEnum> CODE_TO_ENUM =
            new HashMap<String, StructureDefinitionKindEnum>();
    private static Map<String, Map<String, StructureDefinitionKindEnum>> SYSTEM_TO_CODE_TO_ENUM =
            new HashMap<String, Map<String, StructureDefinitionKindEnum>>();
        ...
        for (StructureDefinitionKindEnum next : StructureDefinitionKindEnum.values()) {
            ...
            if (!SYSTEM_TO_CODE_TO_ENUM.containsKey(next.getSystem())) {
                SYSTEM_TO_CODE_TO_ENUM.put(
                        next.getSystem(), new HashMap<String, StructureDefinitionKindEnum>());
            }
    ...
    public static final IValueSetEnumBinder<StructureDefinitionKindEnum> VALUESET_BINDER =
            new IValueSetEnumBinder<StructureDefinitionKindEnum>() {
                @Override
                ...
                @Override
                public StructureDefinitionKindEnum fromCodeString(
                        String theCodeString, String theSystemString) {
                    Map<String, StructureDefinitionKindEnum> map =
