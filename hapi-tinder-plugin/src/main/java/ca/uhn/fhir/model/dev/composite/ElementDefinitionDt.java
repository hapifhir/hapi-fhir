        ...
        extends  BaseIdentifiableElement         implements ICompositeDatatype
{
	...
	@Description(
		...
		formalDefinition="A humane readable text description of how the slicing works. If there is no discriminator, this is required to be present to provide whatever information is possible about how the slices can be differentiated"
	)
