...
public class Media 
	 ...
	 * </p>
	 */
	@SearchParamDefinition(name="created", path="Media.created", description="", type="date"  )
	 ...
	 * </p>
	 */
	@SearchParamDefinition(name="patient", path="Media.subject", description="", type="reference"  )
	 ...
	 * the path value of "<b>Media.created</b>".
	 */
	public static final Include INCLUDE_CREATED = new Include("Media.created");

	/**
	 * Constant for fluent queries to be used to add include statements. Specifies
	 * the path value of "<b>Media.identifier</b>".
	 */
	public static final Include INCLUDE_IDENTIFIER = new Include("Media.identifier");
	...
	/**
	 * Constant for fluent queries to be used to add include statements. Specifies
	 * the path value of "<b>Media.subtype</b>".
	 */
	public static final Include INCLUDE_SUBTYPE = new Include("Media.subtype");

	/**
	 * Constant for fluent queries to be used to add include statements. Specifies
	 * the path value of "<b>Media.type</b>".
	 */
	public static final Include INCLUDE_TYPE = new Include("Media.type");

	/**
	 * Constant for fluent queries to be used to add include statements. Specifies
	 * the path value of "<b>Media.view</b>".
	 */
	public static final Include INCLUDE_VIEW = new Include("Media.view");


	@Child(name="type", type=CodeDt.class, order=0, min=1, max=1)	
	@Description(
		shortDefinition="MediaType",
	...
	@Description(
		shortDefinition="",
		formalDefinition="The date/time when the media was originally recorded. For video and audio, if the length of the recording is not insignificant, this is the start of the recording"
	)
	private DateTimeDt myCreated;
	
	@Child(name="subject", order=4, min=0, max=1, type={
		ca.uhn.fhir.model.dev.resource.Patient.class, 		ca.uhn.fhir.model.dev.resource.Practitioner.class, 		ca.uhn.fhir.model.dev.resource.Group.class, 		ca.uhn.fhir.model.dev.resource.Device.class, 		ca.uhn.fhir.model.dev.resource.Specimen.class	})
	@Description(
		shortDefinition="",
	...
	@Child(name="duration", type=IntegerDt.class, order=11, min=0, max=1)	
	@Description(
		shortDefinition="",
		formalDefinition="The duration of the recording in seconds - for audio and video"
	)
	private IntegerDt myDuration;
	...
	public boolean isEmpty() {
		return super.isBaseEmpty() && ca.uhn.fhir.util.ElementUtil.isEmpty(  myType,  mySubtype,  myIdentifier,  myCreated,  mySubject,  myOperator,  myView,  myDeviceName,  myHeight,  myWidth,  myFrames,  myDuration,  myContent);
	}
	
	@Override
	public <T extends IElement> List<T> getAllPopulatedChildElementsOfType(Class<T> theType) {
		return ca.uhn.fhir.util.ElementUtil.allPopulatedChildElements(theType, myType, mySubtype, myIdentifier, myCreated, mySubject, myOperator, myView, myDeviceName, myHeight, myWidth, myFrames, myDuration, myContent);
	}

	/**
	 * Gets the value(s) for <b>type</b> (MediaType).
	...
	/**
	 * Sets the value(s) for <b>type</b> (MediaType)
	 *
     * <p>
     * <b>Definition:</b>
     * Whether the media is a photo (still image), an audio recording, or a video recording
	...
	/**
	 * Gets the value(s) for <b>subtype</b> (MediaSubtype).
	 * creating it if it does
	 * not exist. Will not return <code>null</code>.
	 *
     * <p>
	...
	/**
	 * Sets the value(s) for <b>subtype</b> (MediaSubtype)
	 *
     * <p>
     * <b>Definition:</b>
     * Details of the type of the media - usually, how it was acquired (what type of device). If images sourced from a DICOM system, are wrapped in a Media resource, then this is the modality
     ...
     * </p> 
	 */
	public Media setCreated(DateTimeDt theValue) {
		myCreated = theValue;
		return this;
	}
     ...
     * </p> 
	 */
	public Media setCreated( Date theDate,  TemporalPrecisionEnum thePrecision) {
     ...
     * </p> 
	 */
	public Media setCreatedWithSecondsPrecision( Date theDate) {
	...
	/**
	 * Gets the value(s) for <b>view</b> (MediaView).
	 * creating it if it does
	 * not exist. Will not return <code>null</code>.
	 *
     * <p>
	...
	/**
	 * Sets the value(s) for <b>view</b> (MediaView)
	 *
     * <p>
     * <b>Definition:</b>
     * The name of the imaging view e.g Lateral or Antero-posterior (AP).
     ...
     * </p> 
	 */
	public IntegerDt getDurationElement() {  
		if (myDuration == null) {
			myDuration = new IntegerDt();
		}
		return myDuration;
	}
     ...
     * </p> 
	 */
	public Media setDuration(IntegerDt theValue) {
		myDuration = theValue;
		return this;
	}
	...
	public Media setDuration( int theInteger) {
		myDuration = new IntegerDt(theInteger); 
		return this; 
	}
