...
public class GVFVariant 
     ...
     * </p> 
	 */
	public java.util.List<StringDt> getVariantSeqElement() {  
		if (myVariantSeq == null) {
			myVariantSeq = new java.util.ArrayList<StringDt>();
		}
		return myVariantSeq;
     ...
     * </p> 
	 */
	public java.util.List<DecimalDt> getVariantFreqElement() {  
		if (myVariantFreq == null) {
			myVariantFreq = new java.util.ArrayList<DecimalDt>();
		}
		return myVariantFreq;
     ...
     * </p> 
	 */
	public java.util.List<VariantEffect> getVariantEffectElement() {  
		if (myVariantEffect == null) {
			myVariantEffect = new java.util.ArrayList<VariantEffect>();
		}
		return myVariantEffect;
     ...
     * </p> 
	 */
	public java.util.List<StringDt> getVariantCodonElement() {  
		if (myVariantCodon == null) {
			myVariantCodon = new java.util.ArrayList<StringDt>();
		}
		return myVariantCodon;
     ...
     * </p> 
	 */
	public java.util.List<StringDt> getVariantAAElement() {  
		if (myVariantAA == null) {
			myVariantAA = new java.util.ArrayList<StringDt>();
		}
		return myVariantAA;
     ...
     * </p> 
	 */
	public java.util.List<StringDt> getReferenceAAElement() {  
		if (myReferenceAA == null) {
			myReferenceAA = new java.util.ArrayList<StringDt>();
		}
		return myReferenceAA;
     ...
     * </p> 
	 */
	public java.util.List<StringDt> getFeatureIdElement() {  
		if (myFeatureId == null) {
			myFeatureId = new java.util.ArrayList<StringDt>();
		}
		return myFeatureId;
     ...
     * </p> 
	 */
	public java.util.List<StringDt> getPhasedElement() {  
		if (myPhased == null) {
			myPhased = new java.util.ArrayList<StringDt>();
		}
		return myPhased;
     ...
     * </p> 
	 */
	public java.util.List<StringDt> getGenotypeElement() {  
		if (myGenotype == null) {
			myGenotype = new java.util.ArrayList<StringDt>();
		}
		return myGenotype;
     ...
     * </p> 
	 */
	public java.util.List<IntegerDt> getVariantReadsElement() {  
		if (myVariantReads == null) {
			myVariantReads = new java.util.ArrayList<IntegerDt>();
		}
		return myVariantReads;
