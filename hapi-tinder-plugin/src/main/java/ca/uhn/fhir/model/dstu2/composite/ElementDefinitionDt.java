 ...
 *
 * <p><b>Definition:</b> Captures constraints on each element within the resource, profile, or
 * extension
 *
 * <p><b>Requirements:</b>
 */
...
public class ElementDefinitionDt extends BaseIdentifiableElement implements ICompositeDatatype {
	...
	@Description(
				...
				formalDefinition =
						"The path identifies the element and is expressed as a \".\"-separated list of"
									+ " ancestor elements, beginning with the name of the resource or"
									+ " extension")
	...
	@Description(
				...
				formalDefinition =
						"The name of this element definition (to refer to it from other element"
								+ " definitions using ElementDefinition.nameReference). This is a unique"
								+ " name referring to a specific set of constraints applied to this"
								+ " element. One use of this is to provide a name to different slices of"
								+ " the same element")
	...
	@Description(
				...
				formalDefinition =
						"Indicates that the element is sliced into a set of alternative definitions"
								+ " (i.e. in a structure definition, there are multiple different"
	...
	@Description(
				...
				formalDefinition =
						"Provides a complete explanation of the meaning of the data element for human"
								+ " readability.  For the case of elements derived from existing elements"
	...
	@Description(
				...
				formalDefinition =
						"This element is for traceability of why the element was created and why the"
								+ " constraints exist as they do. This may be used to point to source"
	...
	@Description(
				...
				formalDefinition =
						"Information about the base definition of the element, provided to make it"
								+ " unncessary for tools to trace the derviation of the element through the"
								+ " derived and related profiles. This information is only provided where"
								+ " the element definition represents a constraint on another element"
								+ " definition, and must be present if there is a base element definition")
	private Base myBase;
	...
	@Description(
				...
				formalDefinition =
						"Specifies a value that SHALL be exactly the value  for this element in the"
									+ " instance. For purposes of comparison, non-signficant whitespace is"
	...
	@Description(
				...
				formalDefinition =
						"Specifies a value that the value in the instance SHALL follow - that is, any"
								+ " value in the pattern must be found in the instance. Other additional"
								+ " values may be found too. This is effectively constraint by example. "
								+ " The values of elements present in the pattern must match exactly"
								+ " (case-senstive, accent-sensitive, etc.)")
	...
	@Description(
				...
				formalDefinition =
						"The minimum allowed value for the element. The value is inclusive. This is"
								+ " allowed for the types date, dateTime, instant, time, decimal, integer,"
								+ " and Quantity")
	...
	@Description(
				...
				formalDefinition =
						"Indicates the maximum length in characters that is permitted to be present in"
									+ " conformant instances and which is expected to be supported by"
	...
	@Description(
				...
				formalDefinition =
						"If true, implementations that produce or consume resources SHALL provide"
									+ " \"support\" for the element in some meaningful way.  If false, the"
									+ " element may be ignored and not supported")
	...
	@Description(
				...
				formalDefinition =
						"If true, the value of this element affects the interpretation of the element"
								...
								+ " systems: they SHALL either recognize the element and process it, and/or"
								+ " a pre-determination has been made that it is not relevant to their"
								+ " particular system.")
	...
	/**
	* Gets the value(s) for <b>path</b> (). creating it if it does not exist. Will not return
	* <code>null</code>.
	*
	* <p><b>Definition:</b> The path identifies the element and is expressed as a
	* \&quot;.\&quot;-separated list of ancestor elements, beginning with the name of the resource
	* or extension
	*/
	...
	*/
	...
	/**
	* Gets the value(s) for <b>representation</b> (). creating it if it does not exist. Will not
	* return <code>null</code>.
	*
	* <p><b>Definition:</b> Codes that define how this element is represented in instances, when
	...
	* the deviation varies from the normal case
	*/
	public ElementDefinitionDt setRepresentation(
				java.util.List<BoundCodeDt<PropertyRepresentationEnum>> theValue) {
		myRepresentation = theValue;
		return this;
	}

	/**
	* Add a value for <b>representation</b> () using an enumerated type. This is intended as a
	* convenience method for situations where the FHIR defined ValueSets are mandatory or contain
	* the desirable codes. If you wish to use codes other than those which are built-in, you may
	* also use the {@link #addRepresentation()} method.
	*
	* <p><b>Definition:</b> Codes that define how this element is represented in instances, when
	* the deviation varies from the normal case
	*/
	public BoundCodeDt<PropertyRepresentationEnum> addRepresentation(
				PropertyRepresentationEnum theValue) {
		BoundCodeDt<PropertyRepresentationEnum> retVal =
					new BoundCodeDt<PropertyRepresentationEnum>(
	...
	/**
	* Gets the first repetition for <b>representation</b> (), creating it if it does not already
	* exist.
	*
	* <p><b>Definition:</b> Codes that define how this element is represented in instances, when
	* the deviation varies from the normal case
	...
	*/
	public BoundCodeDt<PropertyRepresentationEnum> addRepresentation() {
		BoundCodeDt<PropertyRepresentationEnum> retVal =
					new BoundCodeDt<PropertyRepresentationEnum>(
								PropertyRepresentationEnum.VALUESET_BINDER);
		getRepresentation().add(retVal);
		return retVal;
	}
	...
	*/
	...
	/**
	* Gets the value(s) for <b>name</b> (). creating it if it does not exist. Will not return
	* <code>null</code>.
	*
	* <p><b>Definition:</b> The name of this element definition (to refer to it from other element
	* definitions using ElementDefinition.nameReference). This is a unique name referring to a
	* specific set of constraints applied to this element. One use of this is to provide a name to
	...
	*/
	...
	/**
	* Gets the value(s) for <b>label</b> (). creating it if it does not exist. Will not return
	* <code>null</code>.
	*
	* <p><b>Definition:</b> The text to display beside the element indicating its meaning or to use
	* to prompt for the element in a user display or form.
	*/
	...
	* <code>null</code>.
	*
	* <p><b>Definition:</b> A code that provides the meaning for the element according to a
	...
	*/
	...
	/**
	* Gets the first repetition for <b>code</b> (), creating it if it does not already exist.
	*
	* <p><b>Definition:</b> A code that provides the meaning for the element according to a
	* particular terminology.
	*/
	...
	/**
	* Gets the value(s) for <b>slicing</b> (). creating it if it does not exist. Will not return
	* <code>null</code>.
	*
	* <p><b>Definition:</b> Indicates that the element is sliced into a set of alternative
	* definitions (i.e. in a structure definition, there are multiple different constraints on a
	* single element in the base resource). Slicing can be used in any resource that has
	* cardinality ..* on the base resource, or any resource with a choice of types. The set of
	* slices is any elements that come after this in the element sequence that have the same path,
	* until a shorter path occurs (the shorter path terminates the set)
	*/
	...
	*/
	...
	/**
	* Gets the value(s) for <b>short</b> (). creating it if it does not exist. Will not return
	* <code>null</code>.
	*
	* <p><b>Definition:</b> A concise description of what this element means (e.g. for use in
	* auto-generated summaries)
	*/
	...
	*/
	...
	/**
	* Gets the value(s) for <b>definition</b> (). creating it if it does not exist. Will not return
	* <code>null</code>.
	*
	* <p><b>Definition:</b> Provides a complete explanation of the meaning of the data element for
	...
	*/
	...
	/**
	* Gets the value(s) for <b>comments</b> (). creating it if it does not exist. Will not return
	* <code>null</code>.
	*
	* <p><b>Definition:</b> Explanatory notes and implementation guidance about the data element,
	* including notes about how to use the data properly, exceptions to proper use, etc.
	*/
	...
	*/
	...
	/**
	* Gets the value(s) for <b>requirements</b> (). creating it if it does not exist. Will not
	* return <code>null</code>.
	*
	* <p><b>Definition:</b> This element is for traceability of why the element was created and why
	...
	*/
	...
	/**
	* Gets the value(s) for <b>alias</b> (). creating it if it does not exist. Will not return
	* <code>null</code>.
	*
	* <p><b>Definition:</b> Identifies additional names by which this element might also be known
	*/
	...
	*/
	...
	/**
	* Gets the first repetition for <b>alias</b> (), creating it if it does not already exist.
	*
	* <p><b>Definition:</b> Identifies additional names by which this element might also be known
	*/
	...
	*/
	...
	/**
	* Gets the value(s) for <b>min</b> (). creating it if it does not exist. Will not return <code>
	* null</code>.
	*
	* <p><b>Definition:</b> The minimum number of times this element SHALL appear in the instance
	*/
	...
	*/
	...
	/**
	* Gets the value(s) for <b>max</b> (). creating it if it does not exist. Will not return <code>
	* null</code>.
	*
	* <p><b>Definition:</b> The maximum number of times this element is permitted to appear in the
	* instance
	*/
	...
	*/
	...
	/**
	* Gets the value(s) for <b>base</b> (). creating it if it does not exist. Will not return
	* <code>null</code>.
	*
	* <p><b>Definition:</b> Information about the base definition of the element, provided to make
	* it unncessary for tools to trace the derviation of the element through the derived and
	* related profiles. This information is only provided where the element definition represents a
	* constraint on another element definition, and must be present if there is a base element
	* definition
	*/
	public Base getBase() {
		if (myBase == null) {
	...
	*/
	...
	/**
	* Gets the value(s) for <b>type</b> (). creating it if it does not exist. Will not return
	* <code>null</code>.
	*
	* <p><b>Definition:</b> The data type or resource that the value of this element is permitted
	* to be
	*/
	...
	*/
	...
	/**
	* Gets the first repetition for <b>type</b> (), creating it if it does not already exist.
	*
	* <p><b>Definition:</b> The data type or resource that the value of this element is permitted
	* to be
	*/
	...
	/**
	* Gets the value(s) for <b>nameReference</b> (). creating it if it does not exist. Will not
	* return <code>null</code>.
	*
	* <p><b>Definition:</b> Identifies the name of a slice defined elsewhere in the profile whose
	* constraints should be applied to the current element
	*/
	...
	*/
	...
	/**
	* Gets the value(s) for <b>defaultValue[x]</b> (). creating it if it does not exist. Will not
	* return <code>null</code>.
	*
	* <p><b>Definition:</b> The value that should be used if there is no value stated in the
	...
	*/
	...
	/**
	* Gets the value(s) for <b>meaningWhenMissing</b> (). creating it if it does not exist. Will
	* not return <code>null</code>.
	*
	* <p><b>Definition:</b> The Implicit meaning that is to be understood when this element is
	...
	*/
	...
	/**
	* Gets the value(s) for <b>fixed[x]</b> (). creating it if it does not exist. Will not return
	* <code>null</code>.
	*
	* <p><b>Definition:</b> Specifies a value that SHALL be exactly the value for this element in
	* the instance. For purposes of comparison, non-signficant whitespace is ignored, and all
	* values must be an exact match (case and accent sensitive). Missing elements/attributes must
	* also be missing
	*/
	...
	*/
	...
	/**
	* Gets the value(s) for <b>pattern[x]</b> (). creating it if it does not exist. Will not return
	* <code>null</code>.
	*
	* <p><b>Definition:</b> Specifies a value that the value in the instance SHALL follow - that
	* is, any value in the pattern must be found in the instance. Other additional values may be
	* found too. This is effectively constraint by example. The values of elements present in the
	* pattern must match exactly (case-senstive, accent-sensitive, etc.)
	*/
	...
	*/
	...
	/**
	* Gets the value(s) for <b>example[x]</b> (). creating it if it does not exist. Will not return
	* <code>null</code>.
	*
	* <p><b>Definition:</b> A sample value for this element demonstrating the type of information
	* that would typically be captured.
	*/
	...
	*/
	...
	/**
	* Gets the value(s) for <b>minValue[x]</b> (). creating it if it does not exist. Will not
	* return <code>null</code>.
	*
	* <p><b>Definition:</b> The minimum allowed value for the element. The value is inclusive. This
	* is allowed for the types date, dateTime, instant, time, decimal, integer, and Quantity
	*/
	...
	*/
	...
	/**
	* Gets the value(s) for <b>maxValue[x]</b> (). creating it if it does not exist. Will not
	* return <code>null</code>.
	*
	* <p><b>Definition:</b> The maximum allowed value for the element. The value is inclusive. This
	* is allowed for the types date, dateTime, instant, time, decimal, integer, and Quantity
	*/
	...
	*/
	...
	/**
	* Gets the value(s) for <b>maxLength</b> (). creating it if it does not exist. Will not return
	* <code>null</code>.
	*
	* <p><b>Definition:</b> Indicates the maximum length in characters that is permitted to be
	* present in conformant instances and which is expected to be supported by conformant consumers
	...
	*/
	...
	/**
	* Gets the value(s) for <b>condition</b> (). creating it if it does not exist. Will not return
	* <code>null</code>.
	*
	* <p><b>Definition:</b> A reference to an invariant that may make additional statements about
	...
	*/
	...
	/**
	* Gets the first repetition for <b>condition</b> (), creating it if it does not already exist.
	*
	* <p><b>Definition:</b> A reference to an invariant that may make additional statements about
	* the cardinality or value in the instance
	*/
	...
	*/
	...
	/**
	* Gets the value(s) for <b>constraint</b> (). creating it if it does not exist. Will not return
	* <code>null</code>.
	*
	* <p><b>Definition:</b> Formal constraints such as co-occurrence and other constraints that can
	...
	*/
	...
	/**
	* Gets the first repetition for <b>constraint</b> (), creating it if it does not already exist.
	*
	* <p><b>Definition:</b> Formal constraints such as co-occurrence and other constraints that can
	* be computationally evaluated within the context of the instance
	*/
	...
	/**
	* Gets the value(s) for <b>mustSupport</b> (). creating it if it does not exist. Will not
	* return <code>null</code>.
	*
	* <p><b>Definition:</b> If true, implementations that produce or consume resources SHALL
	* provide \&quot;support\&quot; for the element in some meaningful way. If false, the element
	...
	*/
	...
	/**
	* Gets the value(s) for <b>isModifier</b> (). creating it if it does not exist. Will not return
	* <code>null</code>.
	*
	* <p><b>Definition:</b> If true, the value of this element affects the interpretation of the
	...
	*/
	...
	/**
	* Gets the value(s) for <b>isSummary</b> (). creating it if it does not exist. Will not return
	* <code>null</code>.
	*
	* <p><b>Definition:</b> Whether the element should be included if a client requests a search
	...
	*/
	...
	/**
	* Gets the value(s) for <b>binding</b> (). creating it if it does not exist. Will not return
	* <code>null</code>.
	*
	* <p><b>Definition:</b> Binds to a value set if this element is coded (code, Coding,
	* CodeableConcept)
	*/
	...
	*/
	...
	/**
	* Gets the value(s) for <b>mapping</b> (). creating it if it does not exist. Will not return
	* <code>null</code>.
	*
	* <p><b>Definition:</b> Identifies a concept from an external specification that roughly
	...
	*/
	...
	/**
	* Gets the first repetition for <b>mapping</b> (), creating it if it does not already exist.
	*
	* <p><b>Definition:</b> Identifies a concept from an external specification that roughly
	* corresponds to this element
	*/
	...
	*/
	...
	public static class Slicing extends BaseIdentifiableElement implements IResourceBlock {
		...
		@Description(
					...
					formalDefinition =
								"Designates which child elements are used to discriminate between the"
									...
									+ " SHALL completely distinguish which slice the element in the"
									+ " resource matches based on the allowed values for those elements in"
									+ " each of the slices")
		...
		@Description(
					...
					formalDefinition =
								"Whether additional slices are allowed or not. When the slices are ordered,"
										+ " profile authors can also say that additional slices are only"
										+ " allowed at the end")
		...
		public boolean isEmpty() {
				return super.isBaseEmpty()
						&& ca.uhn.fhir.util.ElementUtil.isEmpty(
									myDiscriminator, myDescription, myOrdered, myRules);
		}
		...
		/**
			* Gets the value(s) for <b>discriminator</b> (). creating it if it does not exist. Will not
			* return <code>null</code>.
			*
			* <p><b>Definition:</b> Designates which child elements are used to discriminate between
			* the slices when processing an instance. If one or more discriminators are provided, the
			* value of the child elements in the instance data SHALL completely distinguish which slice
			* the element in the resource matches based on the allowed values for those elements in
			* each of the slices
			*/
		...
		/**
			* Gets the first repetition for <b>discriminator</b> (), creating it if it does not already
			* exist.
			*
			* <p><b>Definition:</b> Designates which child elements are used to discriminate between
			* the slices when processing an instance. If one or more discriminators are provided, the
		...
		/**
			* Gets the value(s) for <b>description</b> (). creating it if it does not exist. Will not
			* return <code>null</code>.
			*
			* <p><b>Definition:</b> A human-readable text description of how the slicing works. If
			* there is no discriminator, this is required to be present to provide whatever information
		...
		/**
			* Gets the value(s) for <b>ordered</b> (). creating it if it does not exist. Will not
			* return <code>null</code>.
			*
			* <p><b>Definition:</b> If the matching elements have to occur in the same order as defined
			* in the profile
			*/
		...
		/**
			* Gets the value(s) for <b>rules</b> (). creating it if it does not exist. Will not return
			* <code>null</code>.
			*
			* <p><b>Definition:</b> Whether additional slices are allowed or not. When the slices are
			* ordered, profile authors can also say that additional slices are only allowed at the end
			*/
	...
	*/
	...
	public static class Base extends BaseIdentifiableElement implements IResourceBlock {
		...
		public boolean isEmpty() {
				return super.isBaseEmpty()
						&& ca.uhn.fhir.util.ElementUtil.isEmpty(myPath, myMin, myMax);
		}

		@Override
		public <T extends IElement> List<T> getAllPopulatedChildElementsOfType(Class<T> theType) {
				return ca.uhn.fhir.util.ElementUtil.allPopulatedChildElements(
						theType, myPath, myMin, myMax);
		}
		...
		/**
			...
			* <code>null</code>.
			*
			* <p><b>Definition:</b> The Path that identifies the base element - this matches the
			* ElementDefinition.path for that element. Across FHIR, there is only one base definition
			* of any element - that is, an element definition on a [[[StructureDefinition]]] without a
		...
		/**
			* Gets the value(s) for <b>min</b> (). creating it if it does not exist. Will not return
			* <code>null</code>.
			*
			* <p><b>Definition:</b> Minimum cardinality of the base element identified by the path
			*/
		public IntegerDt getMinElement() {
				if (myMin == null) {
					myMin = new IntegerDt();
		...
		/**
			* Gets the value(s) for <b>max</b> (). creating it if it does not exist. Will not return
			* <code>null</code>.
			*
			* <p><b>Definition:</b> Maximum cardinality of the base element identified by the path
			*/
		public StringDt getMaxElement() {
				if (myMax == null) {
					myMax = new StringDt();
	...
	*/
	...
	public static class Type extends BaseIdentifiableElement implements IResourceBlock {
		...
		@Description(
					shortDefinition = "",
					formalDefinition =
								"Name of Data type or Resource that is a(or the) type used for this"
										+ " element")
		...
		@Description(
					...
					formalDefinition =
								"Identifies a profile structure or implementation Guide that SHALL hold for"
									+ " resources or datatypes referenced as the type of this element. Can"
									+ " be a local reference - to another structure in this profile, or a"
									+ " reference to a structure in another profile. When more than one"
									+ " profile is specified, the content must conform to all of them. When"
									+ " an implementation guide is specified, the resource SHALL conform to"
		...
		@Description(
					...
					formalDefinition =
								"If the type is a reference to another resource, how the resource is or can"
									+ " be aggreated - is it a contained resource, or a reference, and if"
		...
		public boolean isEmpty() {
				return super.isBaseEmpty()
						&& ca.uhn.fhir.util.ElementUtil.isEmpty(myCode, myProfile, myAggregation);
		}

		@Override
		public <T extends IElement> List<T> getAllPopulatedChildElementsOfType(Class<T> theType) {
				return ca.uhn.fhir.util.ElementUtil.allPopulatedChildElements(
						theType, myCode, myProfile, myAggregation);
		}
		...
		/**
			...
			* <code>null</code>.
			*
			* <p><b>Definition:</b> Name of Data type or Resource that is a(or the) type used for this
			* element
			*/
		...
		/**
			* Gets the value(s) for <b>profile</b> (). creating it if it does not exist. Will not
			* return <code>null</code>.
			*
			* <p><b>Definition:</b> Identifies a profile structure or implementation Guide that SHALL
			* hold for resources or datatypes referenced as the type of this element. Can be a local
			* reference - to another structure in this profile, or a reference to a structure in
			* another profile. When more than one profile is specified, the content must conform to all
			* of them. When an implementation guide is specified, the resource SHALL conform to at
		...
		/**
			* Gets the first repetition for <b>profile</b> (), creating it if it does not already
			* exist.
			*
			* <p><b>Definition:</b> Identifies a profile structure or implementation Guide that SHALL
			* hold for resources or datatypes referenced as the type of this element. Can be a local
		...
		/**
			* Gets the value(s) for <b>aggregation</b> (). creating it if it does not exist. Will not
			* return <code>null</code>.
			*
			* <p><b>Definition:</b> If the type is a reference to another resource, how the resource is
			* or can be aggreated - is it a contained resource, or a reference, and if the context is a
		...
		/**
			* Add a value for <b>aggregation</b> () using an enumerated type. This is intended as a
			* convenience method for situations where the FHIR defined ValueSets are mandatory or
			* contain the desirable codes. If you wish to use codes other than those which are
			* built-in, you may also use the {@link #addAggregation()} method.
			*
			* <p><b>Definition:</b> If the type is a reference to another resource, how the resource is
			* or can be aggreated - is it a contained resource, or a reference, and if the context is a
			* bundle, is it included in the bundle
		...
		public BoundCodeDt<AggregationModeEnum> addAggregation(AggregationModeEnum theValue) {
				BoundCodeDt<AggregationModeEnum> retVal =
						new BoundCodeDt<AggregationModeEnum>(
									AggregationModeEnum.VALUESET_BINDER, theValue);
				getAggregation().add(retVal);
				return retVal;
		}

		/**
			* Gets the first repetition for <b>aggregation</b> (), creating it if it does not already
			* exist.
			*
			* <p><b>Definition:</b> If the type is a reference to another resource, how the resource is
			* or can be aggreated - is it a contained resource, or a reference, and if the context is a
	...
	*/
	...
	public static class Constraint extends BaseIdentifiableElement implements IResourceBlock {
		...
		@Description(
					...
					formalDefinition =
								"Allows identification of which elements have their cardinalities impacted"
									+ " by the constraint.  Will not be referenced for constraints that do"
		...
		public boolean isEmpty() {
				return super.isBaseEmpty()
						&& ca.uhn.fhir.util.ElementUtil.isEmpty(
									myKey, myRequirements, mySeverity, myHuman, myXpath);
		}
		...
		/**
			* Gets the value(s) for <b>key</b> (). creating it if it does not exist. Will not return
			* <code>null</code>.
			*
			* <p><b>Definition:</b> Allows identification of which elements have their cardinalities
			* impacted by the constraint. Will not be referenced for constraints that do not affect
			* cardinality
			*/
		...
		/**
			...
			* return <code>null</code>.
			*
			* <p><b>Definition:</b> Description of why this constraint is necessary or appropriate
			*/
		...
		/**
			* Gets the value(s) for <b>severity</b> (). creating it if it does not exist. Will not
			* return <code>null</code>.
			*
			* <p><b>Definition:</b> Identifies the impact constraint violation has on the conformance
			* of the instance
			*/
				...
				if (mySeverity == null) {
					mySeverity =
								new BoundCodeDt<ConstraintSeverityEnum>(
										ConstraintSeverityEnum.VALUESET_BINDER);
				}
				return mySeverity;
		}
		...
		/**
			* Gets the value(s) for <b>human</b> (). creating it if it does not exist. Will not return
			* <code>null</code>.
			*
			* <p><b>Definition:</b> Text that can be used to describe the constraint in messages
		...
		/**
			* Gets the value(s) for <b>xpath</b> (). creating it if it does not exist. Will not return
			* <code>null</code>.
			*
			* <p><b>Definition:</b> An XPath expression of constraint that can be executed to see if
	...
	*/
	...
	public static class Binding extends BaseIdentifiableElement implements IResourceBlock {
		...
		@Description(
					...
					formalDefinition =
								"Indicates the degree of conformance expectations associated with this"
									+ " binding - that is, the degree to which the provided value set must"
									+ " be adhered to in the instances")
		...
		public boolean isEmpty() {
				return super.isBaseEmpty()
						&& ca.uhn.fhir.util.ElementUtil.isEmpty(myStrength, myDescription, myValueSet);
		}
		...
		/**
			* Gets the value(s) for <b>strength</b> (). creating it if it does not exist. Will not
			* return <code>null</code>.
			*
			* <p><b>Definition:</b> Indicates the degree of conformance expectations associated with
			* this binding - that is, the degree to which the provided value set must be adhered to in
			* the instances
			*/
		public BoundCodeDt<BindingStrengthEnum> getStrengthElement() {
				if (myStrength == null) {
					myStrength =
								new BoundCodeDt<BindingStrengthEnum>(BindingStrengthEnum.VALUESET_BINDER);
				}
				return myStrength;
		}
		...
		/**
			...
			* return <code>null</code>.
			*
			* <p><b>Definition:</b> Describes the intended use of this particular set of codes
			*/
		public StringDt getDescriptionElement() {
				if (myDescription == null) {
					myDescription = new StringDt();
		...
		/**
			* Gets the value(s) for <b>valueSet[x]</b> (). creating it if it does not exist. Will not
			* return <code>null</code>.
			*
			* <p><b>Definition:</b> Points to the value set or external definition (e.g. implicit value
	...
	*/
	...
	public static class Mapping extends BaseIdentifiableElement implements IResourceBlock {
		...
		public boolean isEmpty() {
				return super.isBaseEmpty()
						&& ca.uhn.fhir.util.ElementUtil.isEmpty(myIdentity, myLanguage, myMap);
		}

		@Override
		public <T extends IElement> List<T> getAllPopulatedChildElementsOfType(Class<T> theType) {
				return ca.uhn.fhir.util.ElementUtil.allPopulatedChildElements(
						theType, myIdentity, myLanguage, myMap);
		}

		/**
			* Gets the value(s) for <b>identity</b> (). creating it if it does not exist. Will not
			* return <code>null</code>.
			*
			* <p><b>Definition:</b> An internal reference to the definition of a mapping
			*/
		...
		/**
			* Gets the value(s) for <b>language</b> (). creating it if it does not exist. Will not
			* return <code>null</code>.
			*
			* <p><b>Definition:</b> Identifies the computable language in which mapping.map is
			* expressed.
			*/
		...
		/**
			* Gets the value(s) for <b>map</b> (). creating it if it does not exist. Will not return
			* <code>null</code>.
			*
			* <p><b>Definition:</b> Expresses what part of the target specification corresponds to this
			* element
			*/
