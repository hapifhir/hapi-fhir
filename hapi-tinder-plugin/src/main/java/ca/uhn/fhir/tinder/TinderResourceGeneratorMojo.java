...
public class TinderResourceGeneratorMojo extends AbstractGeneratorMojo {
    ...
    @Parameter(
            required = true,
            defaultValue = "${project.build.directory}/generated-resources/tinder")
    ...
    protected void doExecute(Configuration configuration)
        ...
        ResourceGeneratorUsingModel gen =
                new ResourceGeneratorUsingModel(
                        configuration.getVersion(), configuration.getBaseDir());
        ...
        try {
            ...
            InputStream templateIs =
                    ResourceGeneratorUsingSpreadsheet.class.getResourceAsStream(templateName);
