...
public class Configuration {
    ...
    public Configuration(
        ...
        this.packageDirectoryBase =
                new File(targetDirectory, packageBase.replace(".", File.separatorChar + ""));
        ...
        switch (version) {
            ...
            default:
                throw new IllegalArgumentException(
                        Msg.code(92) + "Unknown version configured: " + version);
        }
        ...
        if (baseResourceNames == null || baseResourceNames.isEmpty()) {
            ...
            try {
                ...
                throw new IllegalArgumentException(
                        Msg.code(93) + "Failed to load version property file", e);
            }
