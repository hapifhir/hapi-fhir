...
public class ExamineTestTrace {
    ...
    public static void main(String[] aaa) {
        String input =
                "[INFO] Running ca.uhn.fhir.rest.client.RestfulClientFactoryDstu2Test\n"
                    + "[INFO] Tests run: 9, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 2.982"
                    + " s - in ca.uhn.fhir.validation.ResourceValidatorDstu2Test";
