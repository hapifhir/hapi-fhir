...
@Mojo(name = "generate-providers", defaultPhase = LifecyclePhase.GENERATE_SOURCES)
public class TinderProvidersMojo extends AbstractMojo {

	private static final org.slf4j.Logger ourLog = org.slf4j.LoggerFactory.getLogger(TinderProvidersMojo.class);
	...
	@Parameter(required = true, defaultValue = "hapi-providers-springbeans.xml")
	...
	public void execute() throws MojoExecutionException, MojoFailureException {
		...
		try {
			...
			gen.setTemplate("/vm/resource_provider.vm");
		...
		try {
			 ...
			 * Spring XML
			 */
			InputStream templateIs = ResourceGeneratorUsingSpreadsheet.class.getResourceAsStream("/vm/provider_spring_beans.vm");
			 ...
			 * Spring Java
			 */
			templateIs = ResourceGeneratorUsingSpreadsheet.class.getResourceAsStream("/vm/provider_spring_beans_java.vm");
	...
	public static void main(String[] args) throws ParseException, IOException, MojoFailureException, MojoExecutionException {
		...
		TinderProvidersMojo mojo = new TinderProvidersMojo();
