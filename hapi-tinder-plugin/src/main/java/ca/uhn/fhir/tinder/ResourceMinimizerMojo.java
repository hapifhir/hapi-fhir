...
public class ResourceMinimizerMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        for (File nextFile : files) {
            ...
            try {
                inputString =
                        IOUtils.toString(new FileInputStream(nextFile), StandardCharsets.UTF_8);
            } catch (IOException e) {
                throw new MojoFailureException(
                        Msg.code(118) + "Failed to read file: " + nextFile, e);
            }
            ...
            if (!inputString.equals(outputString)) {
                ...
                try {
                    ...
                    throw new MojoFailureException(
                            Msg.code(119) + "Failed to write " + nextFile, e);
                }
            }
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        // File("./hapi-fhir-validation-resources-dstu2/src/main/resources/org/hl7/fhir/instance/model/valueset");
        //		m.fhirVersion = "DSTU2";
        //		m.execute();
        //		byteCount += m.getByteCount();
        //		fileCount += m.getFileCount();
        ...
        //		m.myCtx = ctxDstu2;
        //		m.targetDirectory = new
        // File("./hapi-fhir-validation-resources-dstu2/src/main/resources/org/hl7/fhir/instance/model/profile");
        //		m.fhirVersion = "DSTU2";
        //		m.execute();
        //		byteCount += m.getByteCount();
        //		fileCount += m.getFileCount();
        ...
        //		m.myCtx = ctxDstu3;
        //		m.targetDirectory = new
        // File("./hapi-fhir-validation-resources-dstu3/src/main/resources/org/hl7/fhir/dstu3/model/valueset");
        //		m.fhirVersion = "DSTU3";
        //		m.execute();
        //		byteCount += m.getByteCount();
        ...
        //		m.myCtx = ctxR4;
        //		m.targetDirectory = new
        // File("./hapi-fhir-validation-resources-r4/src/main/resources/org/hl7/fhir/r4/model/profile");
        //		m.fhirVersion = "R4";
        //		m.execute();
        //		byteCount += m.getByteCount();
        //		fileCount += m.getFileCount();
        ...
        //		m.myCtx = ctxR4;
        //		m.targetDirectory = new
        // File("./hapi-fhir-validation-resources-r4/src/main/resources/org/hl7/fhir/r4/model/valueset");
        //		m.fhirVersion = "R4";
        //		m.execute();
        //		byteCount += m.getByteCount();
        //		fileCount += m.getFileCount();
        ...
        //		m.myCtx = ctxR4;
        //		m.targetDirectory = new
        // File("./hapi-fhir-validation-resources-r4/src/main/resources/org/hl7/fhir/r4/model/sp");
        //		m.fhirVersion = "R4";
        //		m.execute();
        //		byteCount += m.getByteCount();
        //		fileCount += m.getFileCount();
        ...
        m.targetDirectory =
                new File(
                        "./hapi-fhir-validation-resources-r4b/src/main/resources/org/hl7/fhir/r4b/model/profile");
        m.fhirVersion = "R4B";
        m.execute();
        byteCount += m.getByteCount();
        fileCount += m.getFileCount();
        ...
        m.targetDirectory =
                new File(
                        "./hapi-fhir-validation-resources-r4b/src/main/resources/org/hl7/fhir/r4b/model/valueset");
        m.fhirVersion = "R4B";
        m.execute();
        byteCount += m.getByteCount();
        fileCount += m.getFileCount();
        ...
        m.targetDirectory =
                new File(
                        "./hapi-fhir-validation-resources-r4b/src/main/resources/org/hl7/fhir/r4b/model/extension");
        m.fhirVersion = "R4B";
        m.execute();
        byteCount += m.getByteCount();
        fileCount += m.getFileCount();
        ...
        m.targetDirectory =
                new File(
                        "./hapi-fhir-validation-resources-r4b/src/main/resources/org/hl7/fhir/r4b/model/sp");
        m.fhirVersion = "R4B";
        m.execute();
        byteCount += m.getByteCount();
        fileCount += m.getFileCount();
        ...
        m.targetDirectory =
                new File(
                        "./hapi-fhir-validation-resources-r5/src/main/resources/org/hl7/fhir/r5/model/profile");
        m.fhirVersion = "R5";
        m.execute();
        byteCount += m.getByteCount();
        fileCount += m.getFileCount();
        ...
        m.targetDirectory =
                new File(
                        "./hapi-fhir-validation-resources-r5/src/main/resources/org/hl7/fhir/r5/model/valueset");
        m.fhirVersion = "R5";
        m.execute();
        byteCount += m.getByteCount();
        fileCount += m.getFileCount();
        ...
        m.targetDirectory =
                new File(
                        "./hapi-fhir-validation-resources-r5/src/main/resources/org/hl7/fhir/r5/model/extension");
        m.fhirVersion = "R5";
        m.execute();
        byteCount += m.getByteCount();
        fileCount += m.getFileCount();
        ...
        m.targetDirectory =
                new File(
                        "./hapi-fhir-validation-resources-r5/src/main/resources/org/hl7/fhir/r5/model/sp");
        m.fhirVersion = "R5";
        m.execute();
        byteCount += m.getByteCount();
        fileCount += m.getFileCount();
