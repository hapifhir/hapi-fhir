...
public class TinderJpaRestServerMojo extends AbstractMojo {
    ...
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(TinderJpaRestServerMojo.class);

    @Parameter(
            required = true,
            defaultValue = "${project.build.directory}/generated-sources/tinder")
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        if ("dstu2".equals(version)) {
            ...
            throw new MojoFailureException(
                    Msg.code(113) + "Unknown version configured: " + version);
        }
        ...
        if (baseResourceNames == null || baseResourceNames.isEmpty()) {
            ...
            try {
                ...
                throw new MojoFailureException(
                        Msg.code(114) + "Failed to load version property file", e);
            }
        ...
        try {
            ...
            Reader templateReader =
                    ClasspathUtil.loadResourceAsReader("/vm/jpa_spring_beans_java.vm");
            File f =
                    new File(
                            configPackageDirectoryBase,
                            "GeneratedDaoAndResourceProviderConfig" + capitalize + ".java");
