...
public class TinderStructuresMojo extends AbstractMojo {
    ...
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(TinderStructuresMojo.class);
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        File resDirectoryBase =
                new File(
                        new File(targetResourceDirectory),
        ...
        DatatypeGeneratorUsingSpreadsheet dtp =
                new DatatypeGeneratorUsingSpreadsheet(version, baseDir);
        if (buildDatatypes) {
            try {
                dtp.parse();
        ...
        ResourceGeneratorUsingSpreadsheet rp =
                new ResourceGeneratorUsingSpreadsheet(version, baseDir);
        if (baseResourceNames != null && baseResourceNames.size() > 0) {
            ...
            ourLog.info(
                    "Writing Resources to directory: {}", resSubDirectoryBase.getAbsolutePath());
