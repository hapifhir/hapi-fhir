...
public class VersionPropertyFileGeneratorMojo extends AbstractMojo {
	...
	public void execute() throws MojoFailureException {
		...
		ourLog.info(
					"Found {} resources and {} datatypes", resourceTypes.size(), datatypeTypes.size());
	...
	public static void main(String[] theArgs) throws MojoFailureException {
		...
		m.targetFile =
					new File(
								"hapi-fhir-structures-r5/src/main/resources/org/hl7/fhir/r5/model/fhirversion.properties");
		m.execute();
