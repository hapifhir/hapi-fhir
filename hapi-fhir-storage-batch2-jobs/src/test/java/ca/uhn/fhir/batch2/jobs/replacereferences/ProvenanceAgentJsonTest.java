...
class ProvenanceAgentJsonTest {
	...
	@Test
	void testFromAndAsIProvenanceAgent_RoundTrip() {
		...
		IProvenanceAgent result = ProvenanceAgentJson.asIProvenanceAgent(json, fhirContext);
	...
	@Test
	void testAsIProvenanceAgent_NullInput() {
		assertThat(ProvenanceAgentJson.asIProvenanceAgent(null, fhirContext)).isNull();
	}
	...
	@Test
	void testFromAndAsIProvenanceAgent_RoundTrip_PartialFields_NullOnBehalfOf() {
		ProvenanceAgent agent = new ProvenanceAgent();
		IBaseReference who = new Reference();
	...
	@Test
	void testFromAndAsIProvenanceAgent_RoundTrip_PartialFields_NullWho() {
		ProvenanceAgent agent = new ProvenanceAgent();
		IBaseReference onBehalfOf = new Reference();
		onBehalfOf.setReference("Organization/456");
		agent.setOnBehalfOf(onBehalfOf);
	...
	@Test
	void testFromAndAsIProvenanceAgent_RoundTrip_PartialFields_IdentifierInWhoReference() {
		ProvenanceAgent agent = new ProvenanceAgent();
		...
		assertThat(who.getIdentifier()).isNotNull();
	...
	@Test
	void testFromAndAsIProvenanceAgent_RoundTrip_PartialFields_IdentifierInOnBehalfOfReference() {
		ProvenanceAgent agent = new ProvenanceAgent();
