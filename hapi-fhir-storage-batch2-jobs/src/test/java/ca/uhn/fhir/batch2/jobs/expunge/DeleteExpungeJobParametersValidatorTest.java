...
public class DeleteExpungeJobParametersValidatorTest {
	...
	@Mock private IDeleteExpungeSvc<?> myDeleteExpungeSvc;
	@Mock private IUrlListValidator myUrlListValidator;
	@Mock private IRequestPartitionHelperSvc myRequestPartitionHelperSvc;
	@InjectMocks private DeleteExpungeJobParametersValidator mySvc;
	...
	public void testRejectCascadeIfNotSupported() {
		...
		assertThat(
					outcome.toString(),
					outcome,
					contains("Cascading delete is not supported on this server"));
	}
