...
public class ProvenanceAgentJson {
	...
	public static IProvenanceAgent asIProvenanceAgent(@Nullable ProvenanceAgentJson theProvenanceAgentJson, FhirContext theFhirContext) {
		...
		if (theProvenanceAgentJson.myWho != null) {
			...
			theFhirContext.newJsonParser().parseInto(theProvenanceAgentJson.myWho, who);
		...
		if (theProvenanceAgentJson.myOnBehalfOf != null) {
			...
			theFhirContext.newJsonParser().parseInto(theProvenanceAgentJson.myOnBehalfOf, onBehalfOf);
