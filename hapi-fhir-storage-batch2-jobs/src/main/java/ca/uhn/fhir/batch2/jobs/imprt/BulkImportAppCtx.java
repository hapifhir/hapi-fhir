...
public class BulkImportAppCtx {
	...
	public static final int PARAM_MAXIMUM_BATCH_SIZE_DEFAULT =
				800; // Avoid the 1000 SQL param limit
	...
	@Bean
	public IJobStepWorker<BulkImportJobParameters, VoidModel, NdJsonFileJson>
				bulkImport2FetchFiles() {
		return new FetchFilesStep();
	}

	@Bean
	public IJobStepWorker<BulkImportJobParameters, NdJsonFileJson, VoidModel>
