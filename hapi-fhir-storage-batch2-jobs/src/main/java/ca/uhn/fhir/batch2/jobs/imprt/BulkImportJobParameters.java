...
/** This class is the parameters model object for starting a bulk import job. */
public class BulkImportJobParameters implements IModelJson {
	...
	private List<@Pattern(regexp = "^http[s]?://.*", message = "Must be a valid URL") String>
				myNdJsonUrls;

	@JsonProperty(
				value = "httpBasicCredentials",
	...
	public BulkImportJobParameters setMaxBatchResourceCount(
				@Nullable Integer theMaxBatchResourceCount) {
