...
/**
 * The V2 bulk export expand-and-write step.
 * <p>
 * This is a frozen copy of the V2 behaviour. It was previously implemented by subclassing
 * the V3 step, which meant changes to V3 silently changed the V2 job. V2 is a legacy job
 * and its behaviour must not change, so it now stands alone. Do not refactor this class
 * to share code with the V3 step.
 */
// Created by Claude Opus 5
public class ExpandResourceAndWriteBinaryV2Step
		implements IJobStepWorker<BulkExportJobParameters, ResourceIdList, BulkExportBinaryFileId> {
	private static final Logger ourLog = getLogger(ExpandResourceAndWriteBinaryV2Step.class);
	 ...
	 * Constructor
	 */
	public ExpandResourceAndWriteBinaryV2Step() {
		super();
	}
	...
	/**
	 * V2 scopes the Binary write to the partition resolved for security at request time.
	 */
