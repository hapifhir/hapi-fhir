...
class CdsPrefetchSvcTest {
	...
	protected static Stream<Arguments> provideArgumentsForAllFailureModes() {
		return Stream.of(
	...
	protected static Stream<Arguments> provideArgumentsForNonFailingPrefetchModeTest() {
		return Stream.of(
			Arguments.of(CdsPrefetchFailureMode.OPERATION_OUTCOME, CdsResolutionStrategyEnum.FHIR_CLIENT),
			Arguments.of(CdsPrefetchFailureMode.OMIT, CdsResolutionStrategyEnum.FHIR_CLIENT),
			Arguments.of(CdsPrefetchFailureMode.OPERATION_OUTCOME, CdsResolutionStrategyEnum.DAO),
	...
	@ParameterizedTest
	@MethodSource("provideArgumentsForNonFailingPrefetchModeTest")
	void testAugmentRequest_WhenPrefetchFailureModeIsNonFailing_ClientSendsOperationOutcome_DoesNotFail(CdsPrefetchFailureMode theFailureMode,
	...
	@ParameterizedTest
	@MethodSource("provideArgumentsForNonFailingPrefetchModeTest")
	void testAugmentRequest_WhenPrefetchFailureModeIsNonFailing_DoesNotFailIfPrefetchFails(CdsPrefetchFailureMode theFailureMode,
																					  CdsResolutionStrategyEnum theResolutionStrategy) {
	...
	@Test
	void testAugmentRequest_WhenPrefetchFailureModeIsOperationOutcome_And_ExceptionContainsOperationOutcome_DoesNotFailAndPrefetchHasTheOperationOutcome() {
	...
	void testAugmentRequest_WhenPrefetchFailureModeIsFail_ClientSendsOperationOutcome_ThrowsException(CdsResolutionStrategyEnum theResolutionStrategy) {
		...
		assertThat(exceptionThrown.getMessage()).isEqualTo("HAPI-2635: The CDS service 'test_failure_mode_service_id' received an OperationOutcome resource for prefetch key 'patient' but the service isn't configured to handle OperationOutcomes");
	}

	@ParameterizedTest
	@MethodSource("provideArgumentsForAllFailureModes")
	...
	@ParameterizedTest
	@MethodSource("provideArgumentsForAutoFetchingResolutionStrategies")
	void testAugmentRequest_WhenPrefetchFailureModeIsFail_ThrowsException(CdsResolutionStrategyEnum theResolutionStrategy) {
	...
	@ParameterizedTest
	@MethodSource("provideArgumentsForAutoFetchingResolutionStrategies")
	void testAugmentRequest_MultiplePrefetchKeysWithDifferentNonFailingModes_MissingPrefetches_Succeeds(CdsResolutionStrategyEnum theResolutionStrategy) {
		CdsServiceJson spec = new CdsServiceJson();
