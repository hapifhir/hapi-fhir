...
public class DiscoveryResolutionStu3 implements IDaoRegistryUser {
	...
	public CdsServiceJson resolveService(PlanDefinition planDefinition) {
		return new DiscoveryElementStu3(planDefinition, getPrefetchUrlList(planDefinition)).getCdsServiceJson();
	}
