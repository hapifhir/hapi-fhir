...
public interface ICdsConfigService {
	...
	private static <T extends IIdType> T newId(FhirVersionEnum fhirVersionEnum, String id) {
		checkNotNull(fhirVersionEnum);
		checkNotNull(id);

		switch (fhirVersionEnum) {
			case DSTU2:
				return (T) new ca.uhn.fhir.model.primitive.IdDt(id);
			case DSTU2_1:
				return (T) new org.hl7.fhir.dstu2016may.model.IdType(id);
			case DSTU2_HL7ORG:
				return (T) new org.hl7.fhir.dstu2.model.IdType(id);
			case DSTU3:
				return (T) new org.hl7.fhir.dstu3.model.IdType(id);
			case R4:
				return (T) new org.hl7.fhir.r4.model.IdType(id);
			case R4B:
				return (T) new org.hl7.fhir.r4b.model.IdType(id);
			case R5:
				return (T) new org.hl7.fhir.r5.model.IdType(id);
			default:
