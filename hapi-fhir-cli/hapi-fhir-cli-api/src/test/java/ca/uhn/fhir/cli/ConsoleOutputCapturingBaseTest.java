...
/**
 * This class splits output stream to both STDOUT, and a capturing byte array output stream, which
...
public class ConsoleOutputCapturingBaseTest {
    ...
    protected final TeeOutputStream myTeeOutputStream =
            new TeeOutputStream(System.out, outputStreamCaptor);
