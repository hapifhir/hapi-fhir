...
public class ValidationSupportChainCreator {
    ...
    public static ValidationSupportChain getValidationSupportChainR4(
            FhirContext ctx, CommandLine commandLine) {
    ...
    public static ValidationSupportChain getValidationSupportChainDstu2(
            FhirContext ctx, CommandLine commandLine) {
        ValidationSupportChain chain =
                new ValidationSupportChain(
                        new DefaultProfileValidationSupport(ctx),
