...
public class ValidationDataUploader extends BaseCommand {
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(ValidationDataUploader.class);
    ...
    private void filterBundle(ca.uhn.fhir.model.dstu2.resource.Bundle theBundle) {
        for (Iterator<Entry> iter = theBundle.getEntry().iterator(); iter.hasNext(); ) {
            ...
            for (IIdType nextExclude : myExcludes) {
                if (nextExclude.hasResourceType()
                        && nextExclude
    ...
    private void filterBundle(org.hl7.fhir.dstu3.model.Bundle theBundle) {
        for (Iterator<BundleEntryComponent> iter = theBundle.getEntry().iterator();
                iter.hasNext(); ) {
            IBaseResource next = iter.next().getResource();
            for (IIdType nextExclude : myExcludes) {
                if (nextExclude.hasResourceType()
    ...
    private void filterBundle(org.hl7.fhir.r4.model.Bundle theBundle) {
        for (Iterator<org.hl7.fhir.r4.model.Bundle.BundleEntryComponent> iter =
                        theBundle.getEntry().iterator();
                iter.hasNext(); ) {
            IBaseResource next = iter.next().getResource();
            for (IIdType nextExclude : myExcludes) {
                if (nextExclude.hasResourceType()
    ...
    public String getCommandDescription() {
        return "Uploads the conformance resources (StructureDefinition and ValueSet) from the"
    ...
    public Options getOptions() {
        ...
        opt =
                new Option(
                        ...
                        "exclude",
                        true,
                        "Exclude uploading the given resources, e.g. \"-e dicom-dcim,foo\"");
    ...
    public void run(CommandLine theCommandLine) throws ParseException {
        ...
        if (isBlank(targetServer)) {
            ...
            throw new ParseException(
                    Msg.code(1590) + "Invalid target server specified, must begin with 'http'");
        }
    ...
    private void uploadDefinitionsDstu2(CommandLine theCommandLine, FhirContext ctx)
            throws CommandFailureException, ParseException {
        ...
        try {
            ...
            vsContents =
                    IOUtils.toString(
                            ValidationDataUploader.class.getResourceAsStream(
                                    "/org/hl7/fhir/instance/model/valueset/" + "valuesets.xml"),
                            "UTF-8");
        } catch (IOException e) {
        ...
        for (Entry i : bundle.getEntry()) {
            ...
            ourLog.info(
                    "Uploading ValueSet {}/{} : {}",
                    new Object[] {count, total, next.getIdElement().getValue()});
        ...
        try {
            vsContents =
                    IOUtils.toString(
                            ValidationDataUploader.class.getResourceAsStream(
                                    "/org/hl7/fhir/instance/model/valueset/"
                                            + "v3-codesystems.xml"),
                            "UTF-8");
        } catch (IOException e) {
        ...
        for (Entry i : bundle.getEntry()) {
            ...
            ourLog.info(
                    "Uploading v3-codesystems ValueSet {}/{} : {}",
                    new Object[] {count, total, next.getIdElement().getValue()});
            client.update().resource(next).execute();
        ...
        try {
            vsContents =
                    IOUtils.toString(
                            ValidationDataUploader.class.getResourceAsStream(
                                    "/org/hl7/fhir/instance/model/valueset/" + "v2-tables.xml"),
                            "UTF-8");
        } catch (IOException e) {
        ...
        try {
            mappingLocations =
                    patternResolver.getResources(
                            "classpath*:org/hl7/fhir/instance/model/profile/" + "*.profile.xml");
        } catch (IOException e) {
        ...
        for (Resource i : mappingLocations) {
                ...
                next =
                        ctx.newXmlParser()
                                .parseResource(
                                        ...
                                        IOUtils.toString(i.getInputStream(), "UTF-8"));
            } catch (Exception e) {
            ...
            ourLog.info(
                    "Uploading StructureDefinition {}/{} : {}",
                    new Object[] {count, total, next.getIdElement().getValue()});
            try {
                client.update().resource(next).execute();
            } catch (Exception e) {
                ourLog.warn(
                        "Failed to upload {} - {}", next.getIdElement().getValue(), e.getMessage());
            }
            count++;
        }
    ...
    private void uploadDefinitionsDstu3(CommandLine theCommandLine, FhirContext theCtx)
            throws CommandFailureException, ParseException {
        IGenericClient client = newClient(theCommandLine);
        ourLog.info("Uploading definitions to server");
        ...
        try {
            ...
            vsContents =
                    IOUtils.toString(
                            ValidationDataUploader.class.getResourceAsStream(
                                    "/org/hl7/fhir/dstu3/model/valueset/" + "valuesets.xml"),
                            "UTF-8");
        } catch (IOException e) {
        ...
        for (BundleEntryComponent i : bundle.getEntry()) {
            ...
            ourLog.info(
                    "Uploading ValueSet {}/{} : {} ({} bytes}",
                    new Object[] {count, total, next.getIdElement().getValue(), bytes});
            try {
        ...
        try {
            vsContents =
                    IOUtils.toString(
                            ValidationDataUploader.class.getResourceAsStream(
                                    "/org/hl7/fhir/dstu3/model/valueset/" + "v3-codesystems.xml"),
                            "UTF-8");
        } catch (IOException e) {
        ...
        try {
            vsContents =
                    IOUtils.toString(
                            ValidationDataUploader.class.getResourceAsStream(
                                    "/org/hl7/fhir/dstu3/model/valueset/" + "v2-tables.xml"),
                            "UTF-8");
        } catch (IOException e) {
    ...
    private void uploadDefinitionsR4(CommandLine theCommandLine, FhirContext theCtx)
            throws CommandFailureException, ParseException {
        IGenericClient client = newClient(theCommandLine);
        ourLog.info("Uploading definitions to server");
        ...
        bundle =
                theCtx.newXmlParser().parseResource(org.hl7.fhir.r4.model.Bundle.class, vsContents);
        filterBundle(bundle);
        ...
        try {
            vsContents =
                    IOUtils.toString(
                            ValidationDataUploader.class.getResourceAsStream(
                                    "/org/hl7/fhir/r4/model/valueset/" + "v3-codesystems.xml"),
                            "UTF-8");
        } catch (IOException e) {
        ...
        try {
            vsContents =
                    IOUtils.toString(
                            ValidationDataUploader.class.getResourceAsStream(
                                    "/org/hl7/fhir/r4/model/valueset/" + "v2-tables.xml"),
                            "UTF-8");
        } catch (IOException e) {
        ...
        for (org.hl7.fhir.r4.model.Bundle.BundleEntryComponent i : bundle.getEntry()) {
            ...
            if (next.getIdElement().isIdPartValidLong()) {
                next.setIdElement(
                        new org.hl7.fhir.r4.model.IdType("v2-" + next.getIdElement().getIdPart()));
            }
            next.setId(next.getIdElement().toUnqualifiedVersionless());
    ...
    private void uploadDstu3Profiles(FhirContext ctx, IGenericClient client, String theName)
        ...
        try {
            vsContents =
                    IOUtils.toString(
                            ValidationDataUploader.class.getResourceAsStream(
                                    "/org/hl7/fhir/dstu3/model/" + theName + ".xml"),
                            "UTF-8");
        } catch (IOException e) {
        ...
        bundle =
                ctx.newXmlParser().parseResource(org.hl7.fhir.dstu3.model.Bundle.class, vsContents);
        filterBundle(bundle);
        total = bundle.getEntry().size();
        count = 1;
        ...
        Collections.sort(
                bundle.getEntry(),
                new Comparator<BundleEntryComponent>() {
                    @Override
                    public int compare(BundleEntryComponent theO1, BundleEntryComponent theO2) {
                        ...
                        return theO2.getResource()
                                .getClass()
                                .getName()
                                .compareTo(theO1.getResource().getClass().getName());
                    }
                });
        ...
        for (BundleEntryComponent i : bundle.getEntry()) {
            ...
            ourLog.info(
                    "Uploading {} StructureDefinition {}/{} : {}",
                    new Object[] {theName, count, total, next.getIdElement().getValue()});
            client.update().resource(next).execute();
    ...
    private void uploadR4Profiles(FhirContext theContext, IGenericClient theClient, String theName)
            throws CommandFailureException {
        int total;
        int count;
        org.hl7.fhir.r4.model.Bundle bundle;
        ...
        try {
            vsContents =
                    IOUtils.toString(
                            ValidationDataUploader.class.getResourceAsStream(
                                    "/org/hl7/fhir/r4/model/" + theName + ".xml"),
                            "UTF-8");
        } catch (IOException e) {
        ...
        bundle =
                theContext
                        .newXmlParser()
                        .parseResource(org.hl7.fhir.r4.model.Bundle.class, vsContents);
        filterBundle(bundle);
        total = bundle.getEntry().size();
        count = 1;
        ...
        Collections.sort(
                bundle.getEntry(),
                new Comparator<org.hl7.fhir.r4.model.Bundle.BundleEntryComponent>() {
                    @Override
                    public int compare(
                            org.hl7.fhir.r4.model.Bundle.BundleEntryComponent theO1,
                            org.hl7.fhir.r4.model.Bundle.BundleEntryComponent theO2) {
                        if (theO1.getResource() == null && theO2.getResource() == null) {
                            return 0;
                        }
                        if (theO1.getResource() == null) {
