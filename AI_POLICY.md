...
any code that is merged and released.
...
If you are opening an issue, you are expected to describe the
...
closed, perhaps without notice.

If you wish to include context from an interaction with AI in your comments,
it must be in a quote block (e.g., using `>`) and disclosed as such. It must
be accompanied by human commentary explaining the relevance and implications
of the context. Do not share long snippets.

AI can be a useful aid when communicating as a non-native English speaker. If
you are using AI to edit your comments for this purpose, please take the time
to ensure the result reflects your own voice and ideas. If you are using AI
