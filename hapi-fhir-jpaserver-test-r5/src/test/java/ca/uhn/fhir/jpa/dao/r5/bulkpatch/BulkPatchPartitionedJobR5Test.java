...
public class BulkPatchPartitionedJobR5Test extends BaseBulkPatchR5Test {
	...
	public void before() throws Exception {
		...
		registerInterceptor(new PatientIdPartitionInterceptor(getFhirContext(), mySearchParamExtractor, myPartitionSettings, myDaoRegistry, myTransactionBundleNormalizer));
