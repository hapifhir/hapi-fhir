...
public class SubscriptionTopicR5Test extends BaseSubscriptionsR5Test {
    ...
    public void testFilteredTopicSubscription() throws Exception {
        ...
        // execute
        Encounter badSentEncounter =
                sendEncounterWithStatus(Enumerations.EncounterStatus.COMPLETED, false);
        Encounter goodSentEncounter =
                sendEncounterWithStatusAndParticipationType(
                        Enumerations.EncounterStatus.COMPLETED, "PRPF", true);
    ...
    private Subscription createTopicSubscription(String... theFilters) throws InterruptedException {
        Subscription subscription =
                newTopicSubscription(
                        BaseSubscriptionsR5Test.SUBSCRIPTION_TOPIC_TEST_URL,
    ...
    private Encounter sendEncounterWithStatus(
            Enumerations.EncounterStatus theStatus, boolean theExpectDelivery)
            throws InterruptedException {
    ...
    private Encounter sendEncounterWithStatusAndParticipationType(
            Enumerations.EncounterStatus theStatus,
            String theParticipantType,
            boolean theExpectDelivery)
            throws InterruptedException {
        Encounter encounter = new Encounter();
        encounter.setStatus(theStatus);
