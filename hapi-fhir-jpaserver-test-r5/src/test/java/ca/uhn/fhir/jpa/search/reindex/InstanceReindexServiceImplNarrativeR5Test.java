...
public class InstanceReindexServiceImplNarrativeR5Test {
    private static final Logger ourLog =
            LoggerFactory.getLogger(InstanceReindexServiceImplNarrativeR5Test.class);
    ...
    public void testIndexComboNonUnique() throws IOException {
        ...
        newParams.myComboTokenNonUnique.add(
                new ResourceIndexedComboTokenNonUnique(
                        myPartitionSettings, myEntity, "Patient?identifier=123"));

        // Test
        Parameters outcome =
                mySvc.buildIndexResponse(newParams(), newParams, true, Collections.emptyList());
        ourLog.info(
                "Output:\n{}",
    ...
    public void testIndexComboUnique() throws IOException {
        ...
        newParams.myComboStringUniques.add(
                new ResourceIndexedComboStringUnique(
                        myEntity, "Patient?identifier=123", new IdType("Parameter/foo")));
    ...
    public void testIndexMissing() throws IOException {
        ...
        newParams.myTokenParams.add(
                new ResourceIndexedSearchParamToken(
                        myPartitionSettings, "Observation", "identifier", true));
    ...
    public void testIndexNumber() throws IOException {
        ...
        newParams.myNumberParams.add(
                new ResourceIndexedSearchParamNumber(
                        myPartitionSettings, "Immunization", "dose", BigDecimal.ONE));
    ...
    public void testIndexResourceLinkAbsolute() throws IOException {
        ...
        newParams.myLinks.add(
                ResourceLink.forAbsoluteReference(
                        "Observation.subject",
                        myEntity,
                        new IdType("http://foo/base/Patient/123"),
                        new Date()));
    ...
    public void testIndexQuantity() throws IOException {
        // Setup
        ResourceIndexedSearchParams newParams = newParams();
        newParams.myQuantityParams.add(
    ...
    public void testIndexQuantityNormalized() throws IOException {
        // Setup
        ResourceIndexedSearchParams newParams = newParams();
        newParams.myQuantityNormalizedParams.add(
    ...
    public void testIndexUrl() throws IOException {
        ...
        newParams.myUriParams.add(
                new ResourceIndexedSearchParamUri(
                        myPartitionSettings, "CodeSystem", "uri", "http://some-codesystem"));
