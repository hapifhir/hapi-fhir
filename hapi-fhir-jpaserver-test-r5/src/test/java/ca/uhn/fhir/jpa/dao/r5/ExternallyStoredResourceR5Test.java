...
public class ExternallyStoredResourceR5Test extends BaseJpaR5Test {
    ...
    @Autowired private ExternallyStoredResourceServiceRegistry myProviderRegistry;

    @Mock private IExternallyStoredResourceService myProvider;
    ...
    private IIdType storePatientWithExternalAddress() {
        ...
        ExternallyStoredResourceAddress address =
                new ExternallyStoredResourceAddress(MY_PROVIDER_ID, ADDRESS_123);
