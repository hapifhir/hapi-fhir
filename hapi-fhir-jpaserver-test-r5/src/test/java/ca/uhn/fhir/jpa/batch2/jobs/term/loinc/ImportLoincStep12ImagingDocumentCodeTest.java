...
class ImportLoincStep12ImagingDocumentCodeTest extends BaseImportLoincStepTest{

	@InjectMocks
	private ImportLoincStep12ImagingDocumentCode mySvc;
	...
	void testProcess() {
		...
		assertThat(renderEmittedChunks()).containsExactly(
			"finalize-import -> ResourcesToActivate[ValueSet/loinc-imaging-document-codes-1.234]",
