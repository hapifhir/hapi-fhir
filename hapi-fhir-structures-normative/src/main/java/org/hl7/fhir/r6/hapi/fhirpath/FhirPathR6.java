package org.hl7.fhir.r6.hapi.fhirpath;
...
import org.hl7.fhir.r6.hapi.ctx.HapiWorkerContext;
import org.hl7.fhir.services.fhirpath.ExpressionNode;
import org.hl7.fhir.services.fhirpath.FHIRPathEngine;
import org.hl7.fhir.services.fhirpath.FHIRPathUtilityClasses;
...
public class FhirPathR6 implements IFhirPath {

	private final FHIRPathEngine myEngine;

	public FhirPathR6(FhirContext theCtx) {
	...
	public void setEvaluationContext(@Nonnull IFhirPathEvaluationContext theEvaluationContext) {
		myEngine.setHostServices(new IHostApplicationServices() {
			...
			public List<Base> resolveConstant(
				...
				return theEvaluationContext
					.resolveConstant(appContext, name, hapiConstantEvaluationMode)
					.stream()
					.map(Base.class::cast)
					.toList();
			}
