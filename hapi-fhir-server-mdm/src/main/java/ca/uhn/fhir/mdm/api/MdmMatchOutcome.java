...
public final class MdmMatchOutcome {
	...
	public static final MdmMatchOutcome NEW_GOLDEN_RESOURCE_MATCH =
				new MdmMatchOutcome(null, 1.0)
						.setMatchResultEnum(MdmMatchResultEnum.MATCH)
						.setCreatedNewResource(true);
	public static final MdmMatchOutcome EID_MATCH =
				new MdmMatchOutcome(null, 1.0)
						.setMatchResultEnum(MdmMatchResultEnum.MATCH)
						.setEidMatch(true);
	...
	/**
	* The sum of all scores for all rules evaluated. Similarity rules add the similarity score
	* (between 0.0 and 1.0) whereas matcher rules add either a 0.0 or 1.0.
	*/
	...
	*
	* @param theMdmRuleCount Number of MDM rules that were checked for this match outcome
	...
	*
	* @return Returns the number of rules
	*/
	...
	*
	* @return Returns the normalized score
	*/
