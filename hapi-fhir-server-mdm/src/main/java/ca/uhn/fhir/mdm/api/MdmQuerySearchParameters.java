...
public class MdmQuerySearchParameters {
    ...
    public static final Set<String> ourValidSortParameters =
            Set.of(
    ...
    public MdmQuerySearchParameters setGoldenResourceId(String theGoldenResourceId) {
        myGoldenResourceId =
                MdmControllerUtil.extractGoldenResourceIdDtOrNull(
    ...
    public MdmQuerySearchParameters setSourceId(String theSourceId) {
        mySourceId =
                MdmControllerUtil.extractSourceIdDtOrNull(
                        ProviderConstants.MDM_QUERY_LINKS_RESOURCE_ID, theSourceId);
        return this;
    }
        ...
        for (String param : theSortString.split(",")) {
            ...
            if (!MdmQuerySearchParameters.ourValidSortParameters.contains(p)) {
                throw new InvalidRequestException(
                        Msg.code(2233)
                                + "Unrecognized sort parameter: "
                                + p
                                + ". Valid parameters are: "
                                + String.join(
                                        ", ", MdmQuerySearchParameters.ourValidSortParameters));
            }
