 ...
 *
 * <p>1. A {@link MatchTypeEnum} which determines the actual similarity values. 2. A given resource
 * type (e.g. Patient) 3. A given FHIRPath expression for finding the particular primitive to be
