...
public class MdmLinkExpandSvc implements IMdmLinkExpandSvc {
    ...
    /**
     * Given a source resource, perform MDM expansion and return all the resource IDs of all
     * resources that are MDM-Matched to this resource.
     *
    ...
    /**
     * Given a resource ID of a source resource, perform MDM expansion and return all the resource
    ...
    public Set<String> expandMdmBySourceResourceId(IIdType theId) {
        ...
        return expandMdmBySourceResourcePid(
                myIdHelperService.getPidOrThrowException(
                        RequestPartitionId.allPartitions(), theId));
    }

    /**
     * Given a PID of a source resource, perform MDM expansion and return all the resource IDs of
     * all resources that are MDM-Matched to this resource.
     *
    ...
    public Set<String> expandMdmBySourceResourcePid(IResourcePersistentId theSourceResourcePid) {
        ...
        List<MdmPidTuple> goldenPidSourcePidTuples =
                myMdmLinkDao.expandPidsBySourcePidAndMatchResult(
                        theSourceResourcePid, MdmMatchResultEnum.MATCH);
        return flattenPidTuplesToSet(theSourceResourcePid, goldenPidSourcePidTuples);
    }

    /**
     * Given a PID of a golden resource, perform MDM expansion and return all the resource IDs of
     * all resources that are MDM-Matched to this golden resource.
     *
    ...
    public Set<String> expandMdmByGoldenResourceId(IResourcePersistentId theGoldenResourcePid) {
        ...
        List<MdmPidTuple> goldenPidSourcePidTuples =
                myMdmLinkDao.expandPidsByGoldenResourcePidAndMatchResult(
                        theGoldenResourcePid, MdmMatchResultEnum.MATCH);
        return flattenPidTuplesToSet(theGoldenResourcePid, goldenPidSourcePidTuples);
    }

    /**
     * Given a resource ID of a golden resource, perform MDM expansion and return all the resource
     * IDs of all resources that are MDM-Matched to this golden resource.
     *
    ...
    public Set<String> flattenPidTuplesToSet(
        ...
        goldenPidSourcePidTuples.forEach(
                tuple -> {
