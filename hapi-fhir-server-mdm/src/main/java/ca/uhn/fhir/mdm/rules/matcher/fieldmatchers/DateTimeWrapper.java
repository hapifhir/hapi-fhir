...
public class DateTimeWrapper {
	...
	public DateTimeWrapper(FhirContext theFhirContext, IBase theDate) {
		if (theDate instanceof org.hl7.fhir.dstu3.model.BaseDateTimeType) {
				org.hl7.fhir.dstu3.model.BaseDateTimeType dstu3Date =
						(org.hl7.fhir.dstu3.model.BaseDateTimeType) theDate;
				...
				org.hl7.fhir.r4.model.BaseDateTimeType r4Date =
						(org.hl7.fhir.r4.model.BaseDateTimeType) theDate;
	...
	public String getValueAsStringWithPrecision(TemporalPrecisionEnum thePrecision) {
		// we are using an R4 DateTypes because all datetime strings are the same for all fhir
		// versions
