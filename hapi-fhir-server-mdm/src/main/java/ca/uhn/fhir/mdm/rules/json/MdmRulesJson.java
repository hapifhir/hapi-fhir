...
public class MdmRulesJson implements IModelJson {
    ...
    /**
     * Use {@link this#setEnterpriseEIDSystems(Map)} (String)} or {@link
     * this#addEnterpriseEIDSystem(String, String)} instead.
     */
    @Deprecated
    ...
    public String getSummary() {
        return myCandidateSearchParams.size()
                + " Candidate Search Params, "
                + myCandidateFilterSearchParams.size()
                + " Filter Search Params, "
                + myMatchFieldJsonList.size()
                + " Match Fields, "
                + myMatchResultMap.size()
