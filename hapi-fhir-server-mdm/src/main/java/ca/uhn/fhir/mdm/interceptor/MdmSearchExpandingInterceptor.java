...
/**
 * This interceptor replaces the auto-generated CapabilityStatement that is generated by the HAPI
 * FHIR Server with a static hard-coded resource.
 */
@Interceptor
public class MdmSearchExpandingInterceptor {
    ...
    @Autowired private IMdmLinkExpandSvc myMdmLinkExpandSvc;
    ...
    /**
     * If a Parameter is a reference parameter, and it has been set to expand MDM, perform the
     * expansion.
     */
            ...
            if (iQueryParameterType instanceof ReferenceParam) {
                ...
                if (refParam.isMdmExpand()) {
                    ...
                    Set<String> expandedResourceIds =
                            myMdmLinkExpandSvc.expandMdmBySourceResourceId(
                                    new IdDt(refParam.getValue()));

                    // If we failed, attempt to expand as a golden resource
                    if (expandedResourceIds.isEmpty()) {
                        expandedResourceIds =
                                myMdmLinkExpandSvc.expandMdmByGoldenResourceId(
                                        new IdDt(refParam.getValue()));
                    }
    ...
    /**
     * Expands out the provided _id parameter into all the various ids of linked resources.
     *
    ...
    private void expandIdParameter(
        ...
        if (id == null) {
            ...
            ourLog.warn(
                    "_id parameter of incorrect type. Expected StringParam or TokenParam, but got"
            ...
            if (!expandedResourceIds.isEmpty()) {
                ourLog.debug(
                        "_id parameter has been expanded to: {}",
                        String.join(", ", expandedResourceIds));
