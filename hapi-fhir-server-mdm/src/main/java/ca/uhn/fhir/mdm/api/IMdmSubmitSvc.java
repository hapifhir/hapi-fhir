...
public interface IMdmSubmitSvc {
     ...
     *
     * @param theCriteria The FHIR search critieria for filtering the resources to be submitted for
     *     MDM processing. NOTE: When using this function, the criteria supplied must be valid for
     *     all MDM types. e.g. , if you run this with the criteria birthDate=1990-06-28, it will
     *     fail, as Practitioners do not have a birthday. Use with caution.
     * @return
     */
     ...
     *
     * @param theSourceResourceType the resource type that you wish to execute a search over for
     *     submission to MDM.
     * @param theCriteria The FHIR search critieria for filtering the resources to be submitted for
     *     MDM processing..
    ...
    /**
     * Convenience method that calls {@link #submitSourceResourceTypeToMdm(String, String)} with the
     * type pre-populated.
     *
     * @param theCriteria The FHIR search critieria for filtering the resources to be submitted for
     *     MDM processing.
    ...
    /**
     * Given an ID and a source resource type valid for MDM, manually submit the given ID for MDM
     * processing.
     *
     * @param theId the ID of the resource to process for MDM.
     * @return the constant `1`, as if this function returns successfully, it will have processed
     *     one resource for MDM.
     */
