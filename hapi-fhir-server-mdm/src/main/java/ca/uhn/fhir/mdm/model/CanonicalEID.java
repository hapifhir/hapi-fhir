...
public class CanonicalEID {
    ...
    private CanonicalEID(IFhirPath theFhirPath, IBase theIBase) {
        ...
        List<IPrimitiveType> system =
                theFhirPath.evaluate(theIBase, "system", IPrimitiveType.class);
    ...
    /**
     * Get the appropriate FHIRPath expression to extract the EID identifier value, regardless of
     * resource type. e.g. if theBaseResource is a patient, and the MDM EID system is test-system,
     * this will return
     *
     * <p>Patient.identifier.where(system='test-system').value
     */
     ...
     *
     * @param theFhirContext the {@link FhirContext} of the application, used to generate a FHIRPath
     *     parser.
     ...
     * @return an optional {@link CanonicalEID} object, representing a resource identifier that
     *     matched the given eidSystem.
     */
