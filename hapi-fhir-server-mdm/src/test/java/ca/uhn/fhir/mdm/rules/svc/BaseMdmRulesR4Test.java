...
public abstract class BaseMdmRulesR4Test extends BaseR4Test {
	...
	public static final String PRACTITIONER_EID_FOR_TEST =
				"http://hello.com/naming/practitioner-eid";
	...
	protected MdmRulesJson buildActiveBirthdateIdRules() {
		MdmFilterSearchParamJson activePatientsBlockingFilter =
					new MdmFilterSearchParamJson()
								.setResourceType("Patient")
								.setSearchParam(Patient.SP_ACTIVE)
								.setFixedValue("true");

		MdmResourceSearchParamJson patientBirthdayBlocking =
					new MdmResourceSearchParamJson()
								.setResourceType("Patient")
