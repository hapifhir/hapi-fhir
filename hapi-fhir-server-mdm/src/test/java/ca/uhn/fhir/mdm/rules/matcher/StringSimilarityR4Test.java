...
public class StringSimilarityR4Test extends BaseMatcherR4Test {
    ...
    private static final HapiStringSimilarity JARO_WINKLER =
            new HapiStringSimilarity(new JaroWinkler());
    ...
    private static final HapiStringSimilarity LEVENSCHTEIN =
            new HapiStringSimilarity(new NormalizedLevenshtein());
    private static final HapiStringSimilarity SORENSEN_DICE =
            new HapiStringSimilarity(new SorensenDice());
    ...
    private double similarity(IMdmFieldSimilarity theSimilarity, String theLeft, String theRight) {
        return theSimilarity.similarity(
                ourFhirContext, new StringType(theLeft), new StringType(theRight), false);
    }
}
