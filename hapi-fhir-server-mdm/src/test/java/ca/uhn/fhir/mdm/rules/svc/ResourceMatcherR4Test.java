...
public class ResourceMatcherR4Test extends BaseMdmRulesR4Test {
	...
	private static final String MATCH_FIELDS =
				PATIENT_GIVEN + "," + PATIENT_FAMILY + "," + PATIENT_PHONE;
	...
	public void testMetaphoneMatchResult() {
		MdmResourceMatcherSvc matcherSvc =
					buildMatcher(buildNamePhoneRules(MatchTypeEnum.METAPHONE));
	...
	protected MdmRulesJson buildNamePhoneRules(MatchTypeEnum theMatcherEnum) {
		MdmFieldMatchJson lastNameMatchField =
		...
		MdmFieldMatchJson firstNameMatchField =
					new MdmFieldMatchJson()
