...
public class MdmRuleValidatorTest extends BaseR4Test {
    ...
    public void testValidate() throws IOException {
        try {
            ...
            assertThat(
                    ...
                    is(
                            Msg.code(1519)
                                    + "Enterprise Identifier System (eidSystem) must be a valid"
                                    + " URI"));
        }
    }
    ...
    public void testSimilarityHasThreshold() throws IOException {
        try {
            ...
            assertThat(
                    ...
                    is(
                            Msg.code(1514)
                                    + "MatchField given-name similarity COSINE requires a"
                                    + " matchThreshold"));
        }
    }
    ...
    public void testMatcherBadPath() throws IOException {
        try {
            ...
            assertThat(
                    ...
                    startsWith(
                            Msg.code(1517)
                                    + "MatchField given-name resourceType Patient has invalid path"
                                    + " 'name.first'.  "
                                    + Msg.code(1700)
                                    + "Unknown child name 'first' in element HumanName"));
        }
    }
    ...
    public void testMatcherBadFhirPath() throws IOException {
        try {
            ...
            assertThat(
                    ...
                    startsWith(
                            Msg.code(1518)
                                    + "MatchField [given-name] resourceType [Patient] has failed"
                                    + " FHIRPath evaluation.  Error in ?? at 1, 1: The name blurst"
    ...
    public void testBadRulesMissingBothPaths() throws IOException {
        try {
            ...
            assertThat(
                    ...
                    startsWith(
                            Msg.code(1516)
                                    + "MatchField [given-name] resourceType [Patient] has defined"
                                    + " neither a resourcePath or a fhirPath. You must define one"
                                    + " of the two."));
        }
    }
        ...
        try {
            ...
            assertThat(
                    ...
                    startsWith(
                            Msg.code(1515)
                                    + "MatchField [given-name] resourceType [Patient] has defined"
                                    + " both a resourcePath and a fhirPath. You must define one of"
                                    + " the two."));
        }
    }
    ...
    public void testMatcherBadSearchParam() throws IOException {
        try {
            ...
            assertThat(
                    ...
                    startsWith(
                            Msg.code(1511)
                                    + "Error in candidateSearchParams: Patient does not have a"
                                    + " search parameter called 'foo'"));
        }
    }
    ...
    public void testMatcherBadFilter() throws IOException {
        try {
            ...
            assertThat(
                    ...
                    startsWith(
                            Msg.code(1511)
                                    + "Error in candidateFilterSearchParams: Patient does not have"
                                    + " a search parameter called 'foo'"));
        }
    }
    ...
    public void testMatcherduplicateName() throws IOException {
        try {
            ...
            assertThat(
                    e.getMessage(),
                    startsWith(Msg.code(1512) + "Two MatchFields have the same name 'foo'"));
        }
    }
    ...
    public void testInvalidPath() throws IOException {
        try {
            ...
            assertThat(
                    ...
                    startsWith(
                            Msg.code(1517)
                                    + "MatchField name-prefix resourceType Organization has invalid"
                                    + " path"));
        }
    }
        ...
        try {
            ...
            assertThat(
                    ...
                    is(
                            equalTo(
                                    Msg.code(1508)
                                            + "not-a-resource is not a valid resource type, but is"
                                            + " set in the eidSystems field.")));
        }
    }
        ...
        try {
            ...
            assertThat(
                    ...
                    is(
                            equalTo(
                                    Msg.code(1507)
                                            + "There is an eidSystem set for [Patient] but that is"
                                            + " not one of the mdmTypes. Valid options are"
                                            + " [Organization, *].")));
        }
    }
    ...
    private void setMdmRuleJson(String theTheS) throws IOException {
        MdmRuleValidator mdmRuleValidator =
                new MdmRuleValidator(ourFhirContext, mySearchParamRetriever);
