...
public final class HapiWorkerContext extends I18nBase implements IWorkerContext {
    ...
    public ValidationResult validateCode(
        ...
        return new ValidationResult(
                severity, result.getMessage(), theSystem, theVersion, definition, null, null);
    }
    ...
    @Override
    public ValueSetExpansionOutcome expandVS(
            ConceptSetComponent theInc, boolean theHierarchical, boolean theNoInactive)
    ...
    public <T extends Resource> T fetchResourceWithException(
            Class<T> theClass, String uri, Resource sourceOfReference) throws FHIRException {
    ...
    @Override
    public <T extends org.hl7.fhir.r5.model.Resource> boolean hasResource(
    ...
    public <T extends Resource> List<T> fetchResourcesByType(Class<T> theClass) {
        ...
        throw new UnsupportedOperationException(
                Msg.code(2113) + "Can't fetch all resources of type: " + theClass);
    }
