...
public class OperationServerWithSearchParamTypesDstu2Test {
	...
	public void testGenerateConformance() throws Exception {
		...
		// @formatter:off
		assertThat(
				conf, stringContainsInOrder("<type value=\"Patient\"/>", "<operation>", "<name value=\"andlist\"/>"));
		assertThat(
				conf,
		...
		OperationDefinition andListDef =
				sc.readOperationDefinition(new IdDt("OperationDefinition/Patient-t-andlist"), createRequestDetails(rs));
