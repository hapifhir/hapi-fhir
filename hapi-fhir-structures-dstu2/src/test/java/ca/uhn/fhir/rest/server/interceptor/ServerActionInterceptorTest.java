...
public class ServerActionInterceptorTest {
    ...
    public void testRead() throws Exception {
        ...
        verify(ourInterceptor)
                .incomingRequestPreHandled(eq(RestOperationTypeEnum.READ), detailsCapt.capture());
    ...
    public void testVRead() throws Exception {
        ...
        ArgumentCaptor<RequestDetails> detailsCapt = ArgumentCaptor.forClass(RequestDetails.class);
        verify(ourInterceptor)
                .incomingRequestPreHandled(eq(RestOperationTypeEnum.VREAD), detailsCapt.capture());
    ...
    public void testCreate() throws Exception {
        ...
        ArgumentCaptor<RequestDetails> detailsCapt = ArgumentCaptor.forClass(RequestDetails.class);
        verify(ourInterceptor)
                .incomingRequestPreHandled(eq(RestOperationTypeEnum.CREATE), detailsCapt.capture());
        ...
        assertEquals(
                "FAMILY",
                ((Patient) details.getResource()).getName().get(0).getFamily().get(0).getValue());
    }
    ...
    public void testUpdate() throws Exception {
        ...
        ArgumentCaptor<RequestDetails> detailsCapt = ArgumentCaptor.forClass(RequestDetails.class);
        verify(ourInterceptor)
                .incomingRequestPreHandled(eq(RestOperationTypeEnum.UPDATE), detailsCapt.capture());
    ...
    public void testHistorySystem() throws Exception {
        ...
        verify(ourInterceptor)
                .incomingRequestPreHandled(
                        eq(RestOperationTypeEnum.HISTORY_SYSTEM), detailsCapt.capture());
    }
    ...
    public void testHistoryType() throws Exception {
        ...
        verify(ourInterceptor)
                .incomingRequestPreHandled(
                        eq(RestOperationTypeEnum.HISTORY_TYPE), detailsCapt.capture());
    ...
    public void before() {
        ...
        when(ourInterceptor.incomingRequestPreProcessed(
    ...
    public static void beforeClass() throws Exception {
        ...
        servlet.setResourceProviders(
                new DummyPatientResourceProvider(), new DummyObservationResourceProvider());
