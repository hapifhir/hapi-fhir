...
public class ReadDstu2Test {
    ...
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(ReadDstu2Test.class);
    ...
    public void testAddProfile() throws Exception {
        ...
        assertEquals(
                "<Patient xmlns=\"http://hl7.org/fhir\"><id value=\"p1ReadId\"/><meta><lastUpdated"
                        + " value=\"2012-01-01T12:12:12Z\"/><profile"
    ...
    public void testAddProfileToExistingList() throws Exception {
        ...
        assertEquals(
                "<Patient xmlns=\"http://hl7.org/fhir\"><id value=\"p1ReadId\"/><meta><lastUpdated"
                        + " value=\"2012-01-01T12:12:12Z\"/><profile value=\"http://foo\"/><profile"
                        + " value=\"http://foo_profile\"/></meta><identifier><value"
                        + " value=\"p1ReadValue\"/></identifier></Patient>",
                responseContent);
    }
