...
public class OperationServerDstu2Test {
    ...
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(OperationServerDstu2Test.class);
    ...
    public void testConformance() throws Exception {
        ...
        assertThat(
                ops.get(0).getDefinition().getReference().getValue(),
                startsWith("OperationDefinition/"));

        OperationDefinition def =
                myFhirClient
                        .read()
                        .resource(OperationDefinition.class)
                        .withId(ops.get(0).getDefinition().getReference())
                        .execute();
        ...
        assertEquals(
                "OperationDefinition/Patient-t-OP_TYPE",
                ops.get(opNames.indexOf("OP_TYPE")).getDefinition().getReference().getValue());
    }
    ...
    public void testOperationWrongParameterType() throws Exception {
        ...
        try {
            ...
            assertThat(
                    response,
                    containsString(
                            "Request has parameter PARAM1 of type IntegerDt but method expects type"
                                    + " StringDt"));
    ...
    public static class PatientProvider implements IResourceProvider {
        ...
        public Bundle opProfileDt(@OperationParam(name = "PARAM1") MoneyDt theParam1) {
            // @formatter:on
        ...
        public Bundle opProfileDt(@OperationParam(name = "PARAM1") UnsignedIntDt theParam1) {
            // @formatter:on
        ...
        public Parameters opTypeOnlyString(@OperationParam(name = "PARAM1") StringDt theParam1) {
            // @formatter:on
