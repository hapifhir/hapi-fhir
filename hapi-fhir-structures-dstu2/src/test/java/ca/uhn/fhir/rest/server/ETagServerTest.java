...
public class ETagServerTest {
	...
	public void testAutomaticNotModified() throws Exception {
		...
		try {
				assertEquals(
						Constants.STATUS_HTTP_304_NOT_MODIFIED, status.getStatusLine().getStatusCode());
		} finally {
	...
	public void testUpdateWithIfMatch() throws Exception {
		...
		http.setEntity(
					new StringEntity(resBody, ContentType.create(Constants.CT_FHIR_XML, "UTF-8")));
	...
	public static class PatientProvider implements IResourceProvider {
		...
		public MethodOutcome updatePatient(
					@IdParam IdDt theId, @ResourceParam Patient theResource) {
				ourLastId = theId;
