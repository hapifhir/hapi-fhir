...
public class OperationClientDstu2Test {
	...
	private static final org.slf4j.Logger ourLog =
				org.slf4j.LoggerFactory.getLogger(OperationClientDstu2Test.class);
	...
	public void testOpInstanceWithBundleReturn() throws Exception {
		...
		Bundle response =
					client.opInstanceWithBundleReturn(
								new IdDt("222"), new StringDt("PARAM1str"), new Patient().setActive(true));
	...
	public void testOpServer() throws Exception {
		...
		Parameters response =
					client.opServer(new StringDt("PARAM1str"), new Patient().setActive(true));
		assertEquals("FOO", response.getParameter().get(0).getName());
		HttpPost value = (HttpPost) capt.getAllValues().get(idx);
		String requestBody = IOUtils.toString(((HttpPost) value).getEntity().getContent());
		IOUtils.closeQuietly(((HttpPost) value).getEntity().getContent());
	...
	public void testOpWithListParam() throws Exception {
		...
		Parameters response =
					client.opServerListParam(
								...
								Arrays.asList(new StringDt("PARAM3str1"), new StringDt("PARAM3str2")));
		assertEquals("FOO", response.getParameter().get(0).getName());
		HttpPost value = (HttpPost) capt.getAllValues().get(idx);
		String requestBody = IOUtils.toString(((HttpPost) value).getEntity().getContent());
		IOUtils.closeQuietly(((HttpPost) value).getEntity().getContent());
		...
		assertEquals(
					"PARAM3str1", ((StringDt) request.getParameter().get(1).getValue()).getValue());
		assertEquals("PARAM3", request.getParameter().get(2).getName());
		assertEquals(
					"PARAM3str2", ((StringDt) request.getParameter().get(2).getValue()).getValue());
		idx++;
		...
		assertEquals(
					"PARAM3str1", ((StringDt) request.getParameter().get(0).getValue()).getValue());
		assertEquals("PARAM3", request.getParameter().get(1).getName());
		assertEquals(
					"PARAM3str2", ((StringDt) request.getParameter().get(1).getValue()).getValue());
		idx++;
	...
	public void testOpType() throws Exception {
		...
		Parameters response =
					client.opType(new StringDt("PARAM1str"), new Patient().setActive(true));
		assertEquals("FOO", response.getParameter().get(0).getName());
		HttpPost value = (HttpPost) capt.getAllValues().get(idx);
		String requestBody = IOUtils.toString(((HttpPost) value).getEntity().getContent());
		IOUtils.closeQuietly(((HttpPost) value).getEntity().getContent());
