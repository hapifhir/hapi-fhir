...
public class BundleTypeDstu2Test {
	...
	private static final org.slf4j.Logger ourLog =
				org.slf4j.LoggerFactory.getLogger(BundleTypeDstu2Test.class);
	...
	public void testTransaction() throws Exception {
		...
		when(ourHttpResponse.getEntity().getContent())
					.thenReturn(
								new ReaderInputStream(new StringReader(retVal), Charset.forName("UTF-8")));
		...
		assertThat(
					body,
					Matchers.containsString("<type value=\"" + BundleTypeEnum.TRANSACTION.getCode()));
	}
	...
	public static void main(String[] args) {
		...
		IGenericClient client =
					ctx.newRestfulGenericClient("http://54.165.58.158:8081/FHIRServer/fhir");
