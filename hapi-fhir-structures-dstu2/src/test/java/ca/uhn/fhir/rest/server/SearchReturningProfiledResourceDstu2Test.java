...
public class SearchReturningProfiledResourceDstu2Test {
    ...
    public void testClientUntypedRequestWithHint() throws Exception {
        ...
        ourCtx.setDefaultTypeForProfile(
                "http://ahr.copa.inso.tuwien.ac.at/StructureDefinition/Patient",
    ...
    public void testProfilesGetAdded() throws Exception {
        ...
        assertThat(
                ...
                containsString(
                        "<profile"
                            + " value=\"http://ahr.copa.inso.tuwien.ac.at/StructureDefinition/Patient\"/>"));
    }
    ...
    public void testProfilesGetAddedHtml() throws Exception {
        ...
        assertThat(
                responseContent,
                containsString("http://ahr.copa.inso.tuwien.ac.at/StructureDefinition/Patient"));
    }
    ...
    public static class DummyPatientResourceProvider implements IResourceProvider {
        ...
        /**
         * Basic search, available for every resource. Allows search per id (use of read is better,
         * though), fulltext content and lastUpdated timestamp.
         *
         * @param id
         * @param content
         * @param lastUpdated
        ...
        public List<Patient> search(
                @Description(shortDefinition = "The resource id") @OptionalParam(name = "_id")
                        StringParam id,
                @Description(
                                shortDefinition =
                                        "Search the contents of the resource's data using a"
                                                + " fulltext search")
                        @OptionalParam(name = Constants.PARAM_CONTENT)
                        StringParam content,
                @Description(
                                shortDefinition =
                                        "Search for resources considering the time of their last"
                                                + " update")
            ...
            ResourceMetadataKeyEnum.PROFILES.put(
                    pp, Collections.singletonList(new IdDt("http://foo")));
