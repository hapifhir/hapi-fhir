                        ...
                        new Answer<InputStream>() {
                            ...
                            public InputStream answer(InvocationOnMock theInvocation)
                                ...
                                return new ReaderInputStream(
                                        new StringReader(input), StandardCharsets.UTF_8);
                            }
                        });
        return capt;
    }
    ...
    public void testErrors() {
        ...
        try {
            ...
            assertEquals(
                    Msg.code(1906)
                            ...
                            + " type]/[resource ID]) - Reference is: 123",
                    e.getMessage());
        }
        ...
        try {
            ...
            assertEquals(
                    Msg.code(1906)
                            + "Reference is not complete (must be in the form [baseUrl]/[resource"
                            + " type]/[resource ID]) - Reference is: Patient/123",
                    e.getMessage());
        }
        ...
        try {
            ...
            assertEquals(
                    Msg.code(1684)
                            + "Unknown resource name \"123123\" (this name is not known in FHIR"
                            + " version \"DSTU2\")",
                    e.getMessage());
        }
        ...
        try {
            ...
            assertEquals(
                    Msg.code(1684)
                            + "Unknown resource name \"Sometype\" (this name is not known in FHIR"
                            + " version \"DSTU2\")",
                    e.getMessage());
        }
    }
