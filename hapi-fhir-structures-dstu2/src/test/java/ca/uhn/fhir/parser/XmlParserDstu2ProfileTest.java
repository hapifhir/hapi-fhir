...
public class XmlParserDstu2ProfileTest {

	private static FhirContext ourCtx = FhirContext.forDstu2();
	private static final org.slf4j.Logger ourLog = org.slf4j.LoggerFactory.getLogger(XmlParserDstu2ProfileTest.class);

	
	@Test
	public void testParseWithPreference() {
		MyPatientA pt = new MyPatientA();
		pt.addName().addFamily("FAM");
		
		String str = ourCtx.newXmlParser().setPrettyPrint(true).encodeResourceToString(pt);
		ourLog.info(str);
	}
	
	@ResourceDef(name="Patient", profile="http://example.com/StructureDefinition/mypatient_a")
	public class MyPatientA extends Patient {
	...
	@ResourceDef(name="Patient", profile="http://example.com/StructureDefinition/mypatient_a_b")
	public class MyPatientAB extends MyPatientA {
		private static final long serialVersionUID = 1L;
	}

	@ResourceDef(name="Patient", profile="http://example.com/StructureDefinition/mypatient_b")
	public class MyPatientB extends Patient {
		private static final long serialVersionUID = 1L;
	}
