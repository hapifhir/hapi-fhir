...
public class CustomTypeDstu2Test {
    ...
    public void testCustomTypeWithCustomDatatype() {
        ...
        resource.setBaseValues(
                new CustomResource364CustomDate().setDate(new DateTimeDt("2016-05-13")));
        ...
        CustomResource364Dstu2 parsedResource =
                parser.parseResource(CustomResource364Dstu2.class, xml);
        assertEquals(
                "2016-05-13",
    ...
    public void testParseResourceWithContainedResourcesWithProfile() {
        // @formatter:off
        String input =
                "<MedicationOrder xmlns=\"http://hl7.org/fhir\"><id"
        ...
        assertEquals(
                MyMedication.class, mo.getContained().getContainedResources().get(0).getClass());
    }
