...
public class ServerConformanceProvider extends BaseServerCapabilityStatementProvider
    ...
    /**
     * No-arg constructor and setter so that the ServerConfirmanceProvider can be Spring-wired with
    ...
    private void checkBindingForSystemOps(
            Rest rest,
            Set<SystemRestfulInteractionEnum> systemOps,
    ...
    public Conformance getServerConformance(
        ...
        retVal.setAcceptUnknown(
                UnknownContentCodeEnum
                        .UNKNOWN_EXTENSIONS); // TODO: make this configurable - this is a fairly big
        ...
        for (Entry<String, List<BaseMethodBinding>> nextEntry : resourceToMethods.entrySet()) {
            ...
            if (nextEntry.getKey().isEmpty() == false) {
                ...
                // Map<String, Conformance.RestResourceSearchParam> nameToSearchParam = new
                // HashMap<String,
                ...
                for (BaseMethodBinding nextMethodBinding : nextEntry.getValue()) {
                    if (nextMethodBinding.getRestOperationType() != null) {
                        ...
                        if (resOpCode != null) {
                            TypeRestfulInteractionEnum resOp =
                                    TypeRestfulInteractionEnum.VALUESET_BINDER.fromCodeString(
                                            resOpCode);
                            if (resOp != null) {
                                            ...
                                            if (nextMethodBinding.isSupportsConditionalMultiple()) {
                                                resource.setConditionalDelete(
                                                        ConditionalDeleteStatusEnum
                                                                .MULTIPLE_DELETES_SUPPORTED);
                                            } else {
                                                resource.setConditionalDelete(
                                                        ConditionalDeleteStatusEnum
                                                                .SINGLE_DELETES_SUPPORTED);
                                            }
                                            break;
                                        case UPDATE:
                    ...
                    Collections.sort(
                            ...
                            new Comparator<RestResourceInteraction>() {
                                @Override
                                public int compare(
                                        RestResourceInteraction theO1,
                                        RestResourceInteraction theO2) {
                                    TypeRestfulInteractionEnum o1 =
                                            theO1.getCodeElement().getValueAsEnum();
                                    TypeRestfulInteractionEnum o2 =
                                            theO2.getCodeElement().getValueAsEnum();
                                    if (o1 == null && o2 == null) {
                                        return 0;
                                    }
                                    if (o1 == null) {
            ...
            for (SearchParameter nextParameter : searchParameters) {
                ...
                if (StringUtils.isNotBlank(chain)) {
                    ...
                    if (nextParameter.getParamType() == RestSearchParameterTypeEnum.REFERENCE) {
                        for (String nextWhitelist :
                                new TreeSet<>(nextParameter.getQualifierWhitelist())) {
                ...
                for (Class<? extends IBaseResource> nextTarget : nextParameter.getDeclaredTypes()) {
                    ...
                    if (targetDef != null) {
                        ResourceTypeEnum code =
                                ResourceTypeEnum.VALUESET_BINDER.fromCodeString(
                                        targetDef.getName());
                        if (code != null) {
    ...
    public OperationDefinition readOperationDefinition(
            @IdParam IdDt theId, RequestDetails theRequestDetails) {
