 ...
 *
 * <p><b>Definition:</b> A human-readable formatted text, including images
 *
 * <p><b>Requirements:</b>
 */
...
public class NarrativeDt extends BaseNarrativeDt {
	...
	/**
	* Gets the value(s) for <b>status</b> (generated | extensions | additional). creating it if it
	* does not exist. Will not return <code>null</code>.
	*
	* <p><b>Definition:</b> The status of the narrative - whether it's entirely generated (from
