        ...
        return new IBaseMetaType() {
            ...
            public IBaseMetaType addProfile(String theProfile) {
                ...
                List<IdDt> existingTagList =
                        ResourceMetadataKeyEnum.PROFILES.get(BaseResource.this);
            ...
            public IBaseCoding addSecurity() {
                List<BaseCodingDt> tagList =
                        ResourceMetadataKeyEnum.SECURITY_LABELS.get(BaseResource.this);
                if (tagList == null) {
            ...
            public IBaseMetaType setLastUpdated(Date theHeaderDateValue) {
                if (theHeaderDateValue == null) {
                    ...
                    ResourceMetadataKeyEnum.UPDATED.put(
                            BaseResource.this, new InstantDt(theHeaderDateValue));
                }
                return this;
            }
