...
public final class ThreadPoolUtil {
	...
	public static ThreadPoolTaskExecutor newThreadPool(
		...
		return newThreadPool(
					theCorePoolSize, theMaxPoolSize, theThreadNamePrefix, theQueueCapacity, null);
	}
	...
	public static ThreadPoolTaskExecutor newThreadPool(
		...
		Validate.isTrue(
					...
					"If the queue capacity is greater than 0, core pool size needs to match max pool"
								+ " size or the system won't grow the queue");
		Validate.isTrue(
					theThreadNamePrefix.endsWith("-"),
					"Thread pool prefix name must end with a hyphen");
