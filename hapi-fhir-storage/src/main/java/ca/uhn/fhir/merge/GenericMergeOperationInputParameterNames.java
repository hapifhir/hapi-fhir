...
public class GenericMergeOperationInputParameterNames extends AbstractMergeOperationInputParameterNames {
	...
	public String getSourceResourceParameterName() {
		return OPERATION_MERGE_PARAM_SOURCE_RESOURCE;
	}

	@Override
	public String getTargetResourceParameterName() {
		return OPERATION_MERGE_PARAM_TARGET_RESOURCE;
	}

	@Override
	public String getSourceIdentifiersParameterName() {
		return OPERATION_MERGE_PARAM_SOURCE_RESOURCE_IDENTIFIER;
	}

	@Override
	public String getTargetIdentifiersParameterName() {
		return OPERATION_MERGE_PARAM_TARGET_RESOURCE_IDENTIFIER;
	}
