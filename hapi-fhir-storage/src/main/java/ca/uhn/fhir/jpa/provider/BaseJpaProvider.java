...
public abstract class BaseJpaProvider {
    ...
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(BaseJpaProvider.class);
    ...
    protected IBaseParameters createExpungeResponse(ExpungeOutcome theOutcome) {
        ...
        ParametersUtil.addParameterToParameters(
                getContext(),
                parameters,
                JpaConstants.OPERATION_EXPUNGE_OUT_PARAM_EXPUNGE_COUNT,
                "integer",
                value);
        return parameters;
    }
    ...
    protected DateRangeParam processSinceOrAt(Date theSince, DateRangeParam theAt) {
        boolean haveAt =
                theAt != null
                        && (theAt.getLowerBoundAsInstant() != null
                                || theAt.getUpperBoundAsInstant() != null);
        if (haveAt && theSince != null) {
            String msg =
                    getContext()
                            .getLocalizer()
                            .getMessage(BaseJpaProvider.class, "cantCombintAtAndSince");
    ...
    public static void startRequest(HttpServletRequest theRequest) {
        ...
        if (ourLog.isDebugEnabled()) {
            ...
            for (Enumeration<String> enums = theRequest.getHeaderNames();
