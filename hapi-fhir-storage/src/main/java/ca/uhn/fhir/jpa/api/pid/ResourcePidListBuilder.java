...
public class ResourcePidListBuilder {
    ...
    public static IResourcePidList fromChunksAndDate(
        ...
        if (containsMixed || resourceTypes.size() > 1) {
            ...
            return new HomogeneousResourcePidList(
                    onlyResourceType, ids, endDate, requestPartitionId);
        }
    }

    private static Date getLatestDate(
            IResourcePidList theChunk, Date theCurrentEndDate, Date thePassedInEndDate) {
