...
public interface ITermCodeSystemDeleteJobSvc {
    ...
    /**
     * Deletes all metadata associated with a code system version Specific metadata deleted: *
     * concept links * concept properties * concept designations * concepts
     *
     ...
     */
    CodeSystemConceptsDeleteResult deleteCodeSystemConceptsByCodeSystemVersionPid(
            long theVersionPid);

    /**
     * Deletes a Code System Version NB: it is expected that any concepts related to the Code System
     * Version are deleted first.
     *
