...
public class DaoMethodOutcome extends MethodOutcome {
	...
	private IBaseResource myWrittenResource;
	...
	/**
	 * The resource as it was written to the database, captured before any consent interceptor
	 * may null {@link #getResource()} via {@code STORAGE_PREACCESS_RESOURCES}. Used by the
	 * transaction processor to complete write operations (history entry creation, reference
	 * resolution, search parameter indexing) even when consent hides the resource from
	 * the response.
	 */
	public IBaseResource getWrittenResource() {
		return myWrittenResource;
	}

	// Generated by claude-sonnet-4-6
	/**
	 * @see #getWrittenResource()
	 */
	public DaoMethodOutcome setWrittenResource(IBaseResource theWrittenResource) {
		myWrittenResource = theWrittenResource;
		return this;
	}
