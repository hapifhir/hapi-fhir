...
/**
 * Denotes a search that should be performed in the background periodically in order to keep a fresh
 * copy in the query cache. This improves performance for searches by keeping a copy loaded in the
 * background.
 */
