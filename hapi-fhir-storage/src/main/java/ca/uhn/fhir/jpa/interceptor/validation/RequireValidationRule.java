...
class RequireValidationRule extends BaseTypedRule {
    ...
    public void tagOnSeverity(
            ResultSeverityEnum theSeverity, String theTagSystem, String theTagCode) {
    ...
    private static class TagOnSeverity {
        ...
        @Override
        public String toString() {
            return ResultSeverityEnum.values()[mySeverity].name()
                    + "/"
                    + myTagSystem
                    + "/"
                    + myTagCode;
