...
/**
 * This interface is used to translate between {@link IResourcePersistentId} and actual resource
 * IDs.
 */
public interface IIdHelperService<T extends IResourcePersistentId> {
    ...
    /**
     * Given a forced ID, convert it to it's Long value. Since you are allowed to use string IDs for
