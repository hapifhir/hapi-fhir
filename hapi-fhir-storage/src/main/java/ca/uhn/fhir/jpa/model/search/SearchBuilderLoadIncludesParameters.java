...
public class SearchBuilderLoadIncludesParameters<T extends IResourcePersistentId> {
    ...
    /**
     * A collection of fhirpaths to include in the search. Used to search for resources recursively.
     */
    ...
    /**
     * List of resource types of interest. If specified, only these resource types are returned.
     *
     * <p>This may have performance issues as TARGET_RESOURCE_TYPE is not an indexed field.
     *
     * <p>Use sparingly
     */
