...
public interface IRepositoryValidatingRule {
    ...
    class RuleEvaluation {
        ...
        static RuleEvaluation forFailure(
                IRepositoryValidatingRule theRule, String theFailureDescription) {
            Validate.notNull(theRule);
        ...
        static RuleEvaluation forFailure(
                IRepositoryValidatingRule theRule, IBaseOperationOutcome theOperationOutcome) {
            Validate.notNull(theRule);
