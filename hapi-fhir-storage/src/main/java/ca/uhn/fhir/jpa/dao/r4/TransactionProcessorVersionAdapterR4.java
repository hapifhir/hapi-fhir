...
public class TransactionProcessorVersionAdapterR4 implements ITransactionProcessorVersionAdapter<Bundle, Bundle.BundleEntryComponent> {
	@Override
	...
	public Bundle createBundle(String theBundleType) {
		...
		try {
			...
			throw new InternalErrorException(Msg.code(552) + "Unknown bundle type: " + theBundleType);
		}
		return resp;
	}
