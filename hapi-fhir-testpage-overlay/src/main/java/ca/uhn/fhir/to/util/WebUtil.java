...
public class WebUtil {
    ...
    public static void addStaticResourceWebJar(
            ResourceHandlerRegistry theRegistry, String pkg, String name) {
        ...
        try {
            ...
            if (resourceAsStream == null) {
                throw new ConfigurationException(
                        Msg.code(196) + "Failed to load resource: " + resourceName);
            }
            props.load(resourceAsStream);
        } catch (IOException e) {
            throw new ConfigurationException(
                    Msg.code(197) + "Failed to load resource: " + resourceName);
        }
    ...
    public static ResourceHandlerRegistration addWebjarWithVersion(
        ...
        return theRegistry
                ...
                .addResourceLocations(
                        "classpath:/META-INF/resources/webjars/" + name + "/" + version + "/");
    }

    public static void webJarAddAwesomeCheckbox(ResourceHandlerRegistry theRegistry) {
        WebUtil.addStaticResourceWebJar(
                theRegistry, "org.webjars.bower", "awesome-bootstrap-checkbox");
    }
    ...
    public static void webJarAddEonasdanBootstrapDatetimepicker(
            ResourceHandlerRegistry theRegistry) {
        WebUtil.addStaticResourceWebJar(
                theRegistry, "org.webjars", "Eonasdan-bootstrap-datetimepicker");
    }
