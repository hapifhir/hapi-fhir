...
public class OverlayTestApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //		restServerDstu2.setFhirContext(ourAppCtx.getBean("myFhirContextDstu2",
        // FhirContext.class));
        //		List<IResourceRetriever> rpsDev = (List<IResourceRetriever>)
        // ourAppCtx.getBean("myResourceProvidersDstu2", List.class);
        //		restServerDstu2.setResourceProviders(rpsDev);
        //
        //		JpaSystemProviderDstu2 systemProvDev = (JpaSystemProviderDstu2)
        // ourAppCtx.getBean("mySystemProviderDstu2", JpaSystemProviderDstu2.class);
        ...
        //		restServerDstu1.setFhirContext(ourAppCtx.getBean("myFhirContextDstu1",
        // FhirContext.class));
        //		List<IResourceRetriever> rpsDstu1 = (List<IResourceRetriever>)
        // ourAppCtx.getBean("myResourceProvidersDstu1", List.class);
        //		restServerDstu1.setResourceProviders(rpsDstu1);
        //
        //		JpaSystemProviderDstu1 systemProvDstu1 = (JpaSystemProviderDstu1)
        // ourAppCtx.getBean("mySystemProviderDstu1", JpaSystemProviderDstu1.class);
