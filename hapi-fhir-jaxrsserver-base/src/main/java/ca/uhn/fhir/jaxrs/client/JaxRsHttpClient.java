...
public class JaxRsHttpClient implements IHttpClient {
    ...
    public IHttpRequest createByteRequest(
        ...
        Entity<String> entity =
                Entity.entity(theContents, theContentType + Constants.HEADER_SUFFIX_CT_UTF_8);
    ...
    public IHttpRequest createBinaryRequest(FhirContext theContext, IBaseBinary theBinary) {
        Entity<String> entity =
                Entity.entity(theBinary.getContentAsBase64(), theBinary.getContentType());
        JaxRsHttpRequest retVal = createHttpRequest(entity);
    ...
    public void addHeadersToRequest(
            JaxRsHttpRequest theHttpRequest, EncodingEnum theEncoding, FhirContext theContext) {
        if (myHeaders != null) {
        ...
        theHttpRequest.addHeader(
                "User-Agent", HttpClientUtil.createUserAgentString(theContext, "jax-rs"));
