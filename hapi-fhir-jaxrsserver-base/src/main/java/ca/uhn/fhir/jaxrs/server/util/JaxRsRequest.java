		...
		public JaxRsRequest build() {
         ...
         if (StringUtils.isNotBlank(myVersion)) {
             switch (fhirContextVersion) {
                 case R4:
                     result.setId(new org.hl7.fhir.r4.model.IdType(myResourceName, UrlUtil.unescape(myId), UrlUtil.unescape(myVersion)));
                     break;
                 case DSTU3:
                     result.setId(new org.hl7.fhir.dstu3.model.IdType(myResourceName, UrlUtil.unescape(myId), UrlUtil.unescape(myVersion)));
                     break;
                 case DSTU2_1:
                     result.setId(new org.hl7.fhir.dstu2016may.model.IdType(myResourceName, UrlUtil.unescape(myId), UrlUtil.unescape(myVersion)));
                     break;
                 case DSTU2_HL7ORG:
                     result.setId(new org.hl7.fhir.instance.model.IdType(myResourceName, UrlUtil.unescape(myId), UrlUtil.unescape(myVersion)));
                     break;
                 case DSTU2:
                     result.setId(new ca.uhn.fhir.model.primitive.IdDt(myResourceName, UrlUtil.unescape(myId), UrlUtil.unescape(myVersion)));
                     break;
                 default:
             ...
             switch (fhirContextVersion) {
                 ...
                 case DSTU2_1:
                     ...
                     break;
                 case DSTU2_HL7ORG:
                     result.setId(new org.hl7.fhir.instance.model.IdType(myResourceName, UrlUtil.unescape(myId)));
                     break;
                 case DSTU2:
