...
public class JaxRsExceptionInterceptor {
    ...
    public JaxRsResponseException convertException(
        ...
        final BaseServerResponseException convertedException =
                preprocessException(theException, requestDetails);
    ...
    public Response convertExceptionIntoResponse(
            final JaxRsRequest theRequest, final JaxRsResponseException theException)
            throws IOException {
    ...
    private BaseServerResponseException preprocessException(
        ...
        try {
            ...
            return exceptionHandler.preProcessOutgoingException(
                    requestDetails, theExceptionToConvert, null);
    ...
    private Response handleExceptionWithoutServletError(
            final JaxRsRequest theRequest, final BaseServerResponseException theException)
            throws IOException {
        try {
