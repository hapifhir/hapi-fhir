...
/**
 * This server is the abstract superclass for all resource providers. It exposes a large amount of
 * the fhir api functionality using JAXRS
 *
...
public abstract class AbstractJaxRsResourceProvider<R extends IBaseResource>
        extends AbstractJaxRsProvider implements IRestfulServer<JaxRsRequest>, IResourceProvider {
    ...
    /**
     * The base for request for a resource provider has the following form:</br> {@link
     * AbstractJaxRsResourceProvider#getBaseForServer() getBaseForServer()} + "/" + {@link
     * AbstractJaxRsResourceProvider#getResourceType() getResourceType()} .{@link
     * java.lang.Class#getSimpleName() getSimpleName()}
     */
    @Override
    public String getBaseForRequest() {
        try {
            return new URL(getUriInfo().getBaseUri().toURL(), getResourceType().getSimpleName())
                    .toExternalForm();
     ...
     *
     * @param resource the body of the post method containing resource being created in a xml/json
     *     form
     * @return the response
    ...
    public Response create(final String resource) throws IOException {
        return execute(
                getResourceRequest(RequestTypeEnum.POST, RestOperationTypeEnum.CREATE)
                        .resource(resource));
    }
     ...
     * @return the response
     * @see <a
     *     href="https://www.hl7.org/fhir/http.html#update">https://www.hl7.org/fhir/http.html#update</a>
     */
    @PUT
    public Response conditionalUpdate(final String resource) throws IOException {
        return execute(
                getResourceRequest(RequestTypeEnum.PUT, RestOperationTypeEnum.UPDATE)
                        .resource(resource));
    }
     ...
     * @return the response
     * @see <a
     *     href="https://www.hl7.org/fhir/http.html#delete">https://www.hl7.org/fhir/http.html#delete</a>
     */
    @DELETE
    ...
    public Response delete(@PathParam("id") final String id) throws IOException {
        return execute(
                getResourceRequest(RequestTypeEnum.DELETE, RestOperationTypeEnum.DELETE).id(id));
    }
     ...
     * @return the response
     * @see <a
     *     href="https://www.hl7.org/fhir/http.html#read">https://www.hl7.org/fhir/http.html#read</a>
     */
    @GET
    @Path("/{id : ((?!_history).)*}")
     ...
     * @return the response
     * @see <a
     *     href="https://www.hl7.org/fhir/operations.html">https://www.hl7.org/fhir/operations.html</a>
     */
    protected Response customOperation(
        ...
        final Builder request =
                getResourceRequest(requestType, operationType).resource(resource).id(id);
     ...
     * @return the response
     * @see <a
     *     href="https://www.hl7.org/fhir/http.html#history">https://www.hl7.org/fhir/http.html#history</a>
     */
    @GET
    @Path("/{id}/_history/{version}")
    public Response findVersion(
            @PathParam("id") final String id, @PathParam("version") final String version)
            throws IOException {
        final Builder theRequest =
                getResourceRequest(RequestTypeEnum.GET, RestOperationTypeEnum.VREAD)
                        .id(id)
                        .version(version);
    ...
    public Response historyForInstance(@PathParam("id") final String id) throws IOException {
        final Builder theRequest =
                getResourceRequest(RequestTypeEnum.GET, RestOperationTypeEnum.HISTORY_INSTANCE)
                        .id(id);
        return execute(theRequest);
    }
    ...
    public Response historyForType() throws IOException {
        final Builder theRequest =
                getResourceRequest(RequestTypeEnum.GET, RestOperationTypeEnum.HISTORY_TYPE);
        return execute(theRequest);
    }
     ...
     *     href="https://www.hl7.org/fhir/http.html#search">https://www.hl7.org/fhir/http.html#search</a>
     * @see <a
     *     href="https://www.hl7.org/fhir/compartments.html#compartment">https://www.hl7.org/fhir/compartments.html#compartment</a>
     */
    @GET
    @Path("/{id}/{compartment : ((?!_history).)*}")
    public Response findCompartment(
            @PathParam("id") final String id, @PathParam("compartment") final String compartment)
            throws IOException {
        final Builder theRequest =
                getResourceRequest(RequestTypeEnum.GET, RestOperationTypeEnum.SEARCH_TYPE)
                        .id(id)
     ...
     */
    private Builder getResourceRequest(
