...
public class AbstractJaxRsConformanceProviderDstu2Hl7OrgTest {
	...
	public void testConformance() throws Exception {
		...
		providers.put(
					TestJaxRsDummyPatientProviderDstu2Hl7Org.class,
					new TestJaxRsDummyPatientProviderDstu2Hl7Org());
	...
	public void testConformanceWithMethods() throws Exception {
		providers.put(AbstractJaxRsConformanceProvider.class, provider);
		providers.put(
					TestJaxRsMockPatientRestProviderDstu2Hl7Org.class,
					new TestJaxRsMockPatientRestProviderDstu2Hl7Org());
		Response response = createConformanceProvider(providers).conformance();
	...
	private AbstractJaxRsConformanceProvider createConformanceProvider(
		...
		AbstractJaxRsConformanceProvider result =
					new AbstractJaxRsConformanceProvider(
								FhirContext.forDstu2Hl7Org(), null, null, null) {
						@Override
