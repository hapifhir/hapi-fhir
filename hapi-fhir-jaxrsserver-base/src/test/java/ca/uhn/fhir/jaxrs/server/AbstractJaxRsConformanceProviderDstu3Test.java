...
public class AbstractJaxRsConformanceProviderDstu3Test {
    ...
    public void testConformance() throws Exception {
        ...
        providers.put(
                TestJaxRsDummyPatientProviderDstu3.class, new TestJaxRsDummyPatientProviderDstu3());
    ...
    public void testConformanceWithMethods() throws Exception {
        providers.put(AbstractJaxRsConformanceProvider.class, provider);
        providers.put(
                TestJaxRsMockPatientRestProviderDstu3.class,
                new TestJaxRsMockPatientRestProviderDstu3());
        Response response = createConformanceProvider(providers).conformance();
    ...
    private AbstractJaxRsConformanceProvider createConformanceProvider(
        ...
        AbstractJaxRsConformanceProvider result =
                new AbstractJaxRsConformanceProvider(FhirContext.forDstu3(), null, null, null) {
                    @Override
