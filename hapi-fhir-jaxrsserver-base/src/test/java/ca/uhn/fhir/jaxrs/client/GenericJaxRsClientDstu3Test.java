...
public class GenericJaxRsClientDstu3Test {
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(GenericJaxRsClientDstu3Test.class);
    ...
    public void testProviderWhereWeForgotToSetTheContext() {
        ...
        try {
            ...
            assertEquals(
                    Msg.code(1355)
                            + "JaxRsRestfulClientFactory does not have FhirContext defined. This"
                            + " must be set via"
                            + " JaxRsRestfulClientFactory#setFhirContext(FhirContext)",
                    e.getMessage());
        }
    }
    ...
    public void testMetaGet() {
        ...
        // @formatter:off
        Meta resp = client.meta().get(Meta.class).fromServer().execute();
        // @formatter:on
        ...
        // @formatter:off
        resp = client.meta().get(Meta.class).fromType("Patient").execute();
        // @formatter:on
        ...
        // @formatter:off
        resp = client.meta().get(Meta.class).fromResource(new IdType("Patient/123")).execute();
        // @formatter:on
    ...
    public void testOperationWithBundleResponseJson() {
        ...
        Parameters outParams =
                client.operation()
                        .onInstance(new IdType("Patient", "18066"))
                        .named("$everything")
                        .withParameters(inParams)
                        .execute();
         ...
         */
        org.hl7.fhir.dstu3.model.Bundle responseBundle =
                (org.hl7.fhir.dstu3.model.Bundle) outParams.getParameter().get(0).getResource();
        ...
        resp =
                client.operation()
                        ...
                        .withParameter(
                                Parameters.class,
                                "name1",
                                new Identifier().setSystem("system1").setValue("value1"))
                        .andParameter("name2", new StringType("value1"))
                        .encodedXml()
                        .execute();
        // @formatter:on
    ...
    public void testPageNext() {
        ...
        // @formatter:off
        org.hl7.fhir.dstu3.model.Bundle resp = client.loadPage().next(sourceBundle).execute();
        // @formatter:on
    ...
    public void testPagePrev() {
        ...
        // @formatter:off
        org.hl7.fhir.dstu3.model.Bundle resp = client.loadPage().previous(sourceBundle).execute();
        // @formatter:on
    ...
    public void testReadFluentByUri() {
        ...
        response =
                client.read()
                        ...
                        .withUrl(new IdType("http://localhost:" + ourPort + "/AAA/Patient/123"))
                        .execute();
    ...
    public void testSearchReturningDstu2Bundle() throws Exception {
        String msg =
                IOUtils.toString(
                        GenericJaxRsClientDstu3Test.class.getResourceAsStream("/bundle_orion.xml"));
    ...
    public void testTransactionWithListOfResources() {
        ...
        org.hl7.fhir.dstu3.model.Bundle requestBundle =
    ...
    public void testTransactionWithString() {
        ...
        observation.setValue(
                new Quantity(null, 190, "http://unitsofmeaure.org", "{lb_av}", "{lb_av}"));
        req.addEntry()
        ...
        assertEquals(
                ...
                ourRequestFirstHeaders.get("Content-Type").getValue());
