...
public class JaxRsExceptionInterceptorTest {
	...
	public void testInterceptWithBaseServerError() throws Throwable {
		NotImplementedOperationException thrownException =
					new NotImplementedOperationException("not implemented");
	...
	public void testInterceptorWithServletError() throws Throwable {
		...
		when(exceptionHandler.preProcessOutgoingException(
								any(RequestDetails.class), any(Throwable.class), isNull()))
					.thenThrow(new ServletException("someMessage"));
	...
	public void testHandleExceptionWithServletError() throws Throwable {
		JaxRsRequest request =
					((AbstractJaxRsProvider) context.getTarget()).getRequest(null, null).build();
		...
		JaxRsResponseException thrownException =
					new JaxRsResponseException(new NotImplementedOperationException("not implemented"));
		doThrow(new javax.servlet.ServletException("someMessage"))
					.when(exceptionHandler)
					.handleException(request, thrownException);
