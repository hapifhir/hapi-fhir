...
public class TestJaxRsMockPatientRestProvider extends AbstractJaxRsResourceProvider<Patient> {
    ...
    public static final TestJaxRsMockPatientRestProvider mock =
            Mockito.mock(TestJaxRsMockPatientRestProvider.class);
    ...
    public MethodOutcome delete(
            @IdParam final IdDt theId, @ConditionalUrlParam final String theConditional) {
    ...
    public Parameters someCustomOperation(
            @IdParam IdDt myId, @OperationParam(name = "dummy") StringDt dummyInput) {
