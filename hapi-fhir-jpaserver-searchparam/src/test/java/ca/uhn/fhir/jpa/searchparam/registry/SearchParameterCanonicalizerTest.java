...
public class SearchParameterCanonicalizerTest {
    private static final Logger ourLog =
            LoggerFactory.getLogger(SearchParameterCanonicalizerTest.class);

    ca.uhn.fhir.model.dstu2.resource.SearchParameter initSearchParamDstu2() {
        ca.uhn.fhir.model.dstu2.resource.SearchParameter sp =
                new ca.uhn.fhir.model.dstu2.resource.SearchParameter();
        ...
        sp.addUndeclaredExtension(
                new ExtensionDt(
                        false, EXTENSION_SEARCHPARAM_CUSTOM_BASE_RESOURCE, new StringDt("Meal")));
        sp.addUndeclaredExtension(
                new ExtensionDt(
                        false, EXTENSION_SEARCHPARAM_CUSTOM_TARGET_RESOURCE, new StringDt("Chef")));
        return sp;
    }

    org.hl7.fhir.dstu3.model.SearchParameter initSearchParamDstu3() {
        org.hl7.fhir.dstu3.model.SearchParameter sp =
        ...
        sp.addExtension(
                ...
                new org.hl7.fhir.dstu3.model.StringType("Meal"));
        sp.addExtension(
                EXTENSION_SEARCHPARAM_CUSTOM_TARGET_RESOURCE,
                new org.hl7.fhir.dstu3.model.StringType("Chef"));
        return sp;
    }
    ...
    IBaseResource initSearchParamR4B() {
        ...
        sp.addExtension(
                EXTENSION_SEARCHPARAM_CUSTOM_BASE_RESOURCE,
                new org.hl7.fhir.r4b.model.StringType("Meal"));
        sp.addExtension(
                EXTENSION_SEARCHPARAM_CUSTOM_TARGET_RESOURCE,
                new org.hl7.fhir.r4b.model.StringType("Chef"));
        return sp;
    }
    ...
    IBaseResource initSearchParamR5() {
        ...
        sp.setExpression("Meal.chef | Observation.subject");
        sp.addTarget(
                org.hl7.fhir.r5.model.Enumerations.VersionIndependentResourceTypesAll.RESOURCE);
        sp.addTarget(
                org.hl7.fhir.r5.model.Enumerations.VersionIndependentResourceTypesAll.OBSERVATION);
        sp.addExtension(
                EXTENSION_SEARCHPARAM_CUSTOM_BASE_RESOURCE,
                new org.hl7.fhir.r5.model.StringType("Meal"));
        sp.addExtension(
                EXTENSION_SEARCHPARAM_CUSTOM_TARGET_RESOURCE,
                new org.hl7.fhir.r5.model.StringType("Chef"));
        return sp;
    }
    ...
    public void testCanonicalizeSearchParameterWithCustomType(boolean theConvertToR5) {
        ...
        if (theConvertToR5) {
            VersionCanonicalizer versionCanonicalizer =
                    new VersionCanonicalizer(FhirContext.forR4Cached());
