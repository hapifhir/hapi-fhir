...
class SearchParameterMapTest {
    ...
    public void testRemoveByModifier() {
        ...
        TokenOrListParam qualifiedTokenParam =
    ...
    public void testRemoveByNullModifier() {
        ...
        TokenOrListParam unqualifiedTokenParam =
                new TokenOrListParam()
        ...
        map.add("code", unqualifiedTokenParam);
        map.add("code", qualifiedTokenParam);
        List<List<IQueryParameterType>> andList =
                map.removeByNameAndModifier("code", (String) null);
        assertThat(andList, hasSize(1));
        List<IQueryParameterType> orList = andList.get(0);
        assertThat(orList, hasSize(2));
    ...
    public void clone_searchParams_copiesAllFields() {
        ...
        Assertions.assertEquals(
                orig.toNormalizedQueryString(null), copy.toNormalizedQueryString(null));
    ...
    public void testCompareParameters() {
        ...
        assertEquals(
                ...
                compare(
                        ourFhirContext,
                        new StringParam().setMissing(true),
                        new StringParam().setMissing(true)));
        assertEquals(
                -1,
                compare(ourFhirContext, new StringParam("A"), new StringParam().setMissing(true)));
        assertEquals(
                1,
                compare(ourFhirContext, new StringParam().setMissing(true), new StringParam("A")));
        ...
        assertEquals(
                ...
                compare(
                        ourFhirContext,
                        new StringParam("B").setContains(true),
                        new StringParam("A")));
        assertEquals(
                1,
                compare(
