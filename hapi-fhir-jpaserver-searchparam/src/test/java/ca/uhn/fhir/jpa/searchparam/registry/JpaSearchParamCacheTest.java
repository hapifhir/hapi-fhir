...
public class JpaSearchParamCacheTest {
	...
	public void testGetAllActiveComboParams() {
		...
		setActiveComboSearchParams(
					RESOURCE_TYPE, List.of(unique1, unique2, nonUnique1, nonUnique2));

		List<RuntimeSearchParam> result =
					myJpaSearchParamCache.getActiveComboSearchParams(RESOURCE_TYPE);
	...
	public void testGetUniqueActiveComboParams() {
		...
		List<RuntimeSearchParam> result =
					myJpaSearchParamCache.getActiveComboSearchParams(
								RESOURCE_TYPE, ComboSearchParamType.UNIQUE);
	...
	public void testGetNonUniqueActiveComboParams() {
		...
		List<RuntimeSearchParam> result =
					myJpaSearchParamCache.getActiveComboSearchParams(
								RESOURCE_TYPE, ComboSearchParamType.NON_UNIQUE);
		assertEquals(2, result.size());
	...
	public void testGetActiveComboParamByIdPresent() {
		...
		Optional<RuntimeSearchParam> found =
					myJpaSearchParamCache.getActiveComboSearchParamById(RESOURCE_TYPE, id1);
	...
	public void testGetActiveComboParamByIdAbsent() {
		...
		Optional<RuntimeSearchParam> found =
					myJpaSearchParamCache.getActiveComboSearchParamById(RESOURCE_TYPE, id2);
	...
	private void setActiveComboSearchParams(
				String theResourceType, List<RuntimeSearchParam> theRuntimeSearchParams) {
	...
	private class TestableJpaSearchParamCache extends JpaSearchParamCache {
		public void setActiveComboSearchParams(
					Map<String, List<RuntimeSearchParam>> theActiveComboSearchParams) {
