...
public class ResourceChangeEvent implements IResourceChangeEvent {
    ...
    public static ResourceChangeEvent fromCreatedUpdatedDeletedResourceIds(
        ...
        return new ResourceChangeEvent(
                theCreatedResourceIds, theUpdatedResourceIds, theDeletedResourceIds);
    }
    ...
    public boolean isEmpty() {
        return myCreatedResourceIds.isEmpty()
                && myUpdatedResourceIds.isEmpty()
                && myDeletedResourceIds.isEmpty();
    }
