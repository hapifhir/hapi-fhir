...
public class FullTextExtractionResponse {
     ...
     * Constructor
     */
    private FullTextExtractionResponse(boolean theDoNotIndex, String thePayload) {
    ...
    public static FullTextExtractionResponse doNotIndex() {
        return new FullTextExtractionResponse(true, null);
    }
    ...
    public static FullTextExtractionResponse indexPayload(@Nullable String thePayload) {
        return new FullTextExtractionResponse(false, thePayload);
    }
