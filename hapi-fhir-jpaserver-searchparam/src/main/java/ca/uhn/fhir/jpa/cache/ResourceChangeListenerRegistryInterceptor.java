 ...
 * IResourceChangeListenerCache} entries. If the resource matches the resource type and search
 * parameter map of that entry, then the corresponding cache will be expired so it is refreshed and
 * listeners are notified of that change within {@link
