...
/**
 * An immutable object containing the count of resource creates, updates and deletes detected by a
 * cache refresh operation. Used internally for testing.
 */
public class ResourceChangeResult {
    ...
    public ResourceChangeResult plus(ResourceChangeResult theResult) {
        return new ResourceChangeResult(
                created + theResult.created,
                updated + theResult.updated,
                deleted + theResult.deleted);
    }
