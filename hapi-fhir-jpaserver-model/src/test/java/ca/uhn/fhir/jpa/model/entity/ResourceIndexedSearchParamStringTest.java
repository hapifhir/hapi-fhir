...
public class ResourceIndexedSearchParamStringTest {
    ...
    public void testHashFunctions() {
        ResourceIndexedSearchParamString token =
                new ResourceIndexedSearchParamString(
    ...
    public void testHashFunctionsPrefixOnly_John_JN_vs_JAN() {
        ...
        final ResourceIndexedSearchParamString token2 =
                new ResourceIndexedSearchParamString(
                        new PartitionSettings(),
                        new StorageSettings(),
                        "Patient",
        ...
        assertAll(
                ...
                () ->
                        assertEquals(
                                token1.getHashNormalizedPrefix(), token2.getHashNormalizedPrefix()),
