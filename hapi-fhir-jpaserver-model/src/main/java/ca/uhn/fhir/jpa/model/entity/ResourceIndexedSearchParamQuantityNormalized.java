...
public class ResourceIndexedSearchParamQuantityNormalized
    ...
    // Changed to double here for storing the value after converted to the CanonicalForm due to
    // BigDecimal maps NUMBER(19,2)
    ...
    public <T extends BaseResourceIndex> void copyMutableValuesFrom(T theSource) {
        ...
        ResourceIndexedSearchParamQuantityNormalized source =
                (ResourceIndexedSearchParamQuantityNormalized) theSource;
    ...
    public boolean equals(Object theObj) {
        ...
        ResourceIndexedSearchParamQuantityNormalized obj =
                (ResourceIndexedSearchParamQuantityNormalized) theObj;
    ...
    public boolean matches(IQueryParameterType theParam) {
        ...
        // -- convert the value/unit to the canonical form if any, otherwise store the original
        // value/units pair
        Pair canonicalForm =
                UcumServiceUtil.getCanonicalForm(quantitySystem, quantityValue, quantityUnits);
