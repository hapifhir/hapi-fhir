...
public class UcumServiceUtil {
    ...
    /**
     * Get the canonical form of a code, it's define at <link>http://unitsofmeasure.org</link>
     *
     * <p>e.g. 12cm -> 0.12m where m is the canonical form of the length.
     *
    ...
    public static Pair getCanonicalForm(String theSystem, BigDecimal theValue, String theCode) {
        ...
        try {
            ...
            // For some reason code [degF], degree Fahrenheit, can't be converted. it returns value
            // null.
    ...
    /**
     * Returns the received Fahrenheit value converted to Kelvin units and code Formula is K = (x°F
     * − 32) × 5/9 + 273.15
     */
    private static Pair canonicalizeFahrenheit(BigDecimal theValue) throws UcumException {
        BigDecimal converted =
                theValue.subtract(BigDecimal.valueOf(32))
    ...
    public static QuantityParam toCanonicalQuantityOrNull(QuantityParam theQuantityParam) {
        Pair canonicalForm =
                getCanonicalForm(
                        theQuantityParam.getSystem(),
                        theQuantityParam.getValue(),
                        theQuantityParam.getUnits());
    ...
    public static double convert(
            double theDistanceKm, String theSourceUnits, String theTargetUnits) {
        init();
        try {
