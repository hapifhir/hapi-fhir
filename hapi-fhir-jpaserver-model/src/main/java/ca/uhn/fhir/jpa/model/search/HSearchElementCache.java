 ...
 *
 * <p>The Hibernate Search DocumentElement api only supports create - it does not support fetching
 * an existing element. This class demand-creates object elements for a given path.
 */
