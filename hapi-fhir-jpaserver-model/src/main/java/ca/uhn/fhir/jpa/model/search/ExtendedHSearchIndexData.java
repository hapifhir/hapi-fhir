...
public class ExtendedHSearchIndexData {
    ...
    final SetMultimap<String, QuantitySearchIndexData> mySearchParamQuantities =
            HashMultimap.create();
    final SetMultimap<String, CompositeSearchIndexData> mySearchParamComposites =
            HashMultimap.create();
     ...
     *
     * <p>Called by Hibernate Search after the ResourceTable entity has been flushed/committed. Keep
     * this in sync with the schema defined in {@link SearchParamTextPropertyBinder}
     *
    ...
    public void writeIndexElements(DocumentElement theDocument) {
        ...
        Multimaps.asMap(mySearchParamNumbers)
                .forEach(ifNotContained(indexWriter::writeNumberIndex));
    ...
    public void addTokenIndexDataIfNotPresent(String theSpName, String theSystem, String theValue) {
        boolean isPresent =
                mySearchParamTokens.get(theSpName).stream()
                        .anyMatch(
                                c ->
                                        Objects.equals(c.getSystem(), theSystem)
                                                && Objects.equals(c.getCode(), theValue));
        if (!isPresent) {
    ...
    public void addDateIndexData(
        ...
        addDateIndexData(
                theSpName,
                new DateSearchIndexData(
                        theLowerBound, theLowerBoundOrdinal, theUpperBound, theUpperBoundOrdinal));
    }
    ...
    public void addCompositeIndexData(
            String theSearchParamName, CompositeSearchIndexData theBuildCompositeIndexData) {
