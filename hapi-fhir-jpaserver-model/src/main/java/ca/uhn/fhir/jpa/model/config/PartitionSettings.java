...
public class PartitionSettings {
    ...
    private CrossPartitionReferenceMode myAllowReferencesAcrossPartitions =
    ...
    public void setAlwaysOpenNewTransactionForDifferentPartition(
        ...
        myAlwaysOpenNewTransactionForDifferentPartition =
                theAlwaysOpenNewTransactionForDifferentPartition;
    }

    /**
     * If set to <code>true</code> (default is <code>false</code>) the <code>PARTITION_ID</code>
     * value will be factored into the hash values used in the <code>HFJ_SPIDX_xxx</code> tables,
     * removing the need to explicitly add a selector on this column in queries. If set to <code>
     * false</code>, an additional selector is used instead, which may perform better when using
     * native database partitioning features.
     *
     * <p>This setting has no effect if partitioning is not enabled via {@link
    ...
    /**
     * Should resources references be permitted to cross partition boundaries. Default is {@link
     * CrossPartitionReferenceMode#NOT_ALLOWED}.
     *
     * @since 5.0.0
     */
     ...
     * @since 5.0.0
     */
    public void setAllowReferencesAcrossPartitions(
    ...
    /**
     * If set to <code>true</code> (default is <code>false</code>), partitions will be unnamed and
     * all IDs from {@link Integer#MIN_VALUE} through {@link Integer#MAX_VALUE} will be allowed
     * without needing to be created ahead of time.
     *
     * @since 5.5.0
     */
    ...
    /**
     * If set, the given ID will be used for the default partition. The default is <code>null</code>
     * which will result in the use of a null value for default partition items.
     *
     * @since 5.5.0
     */
    ...
    public enum CrossPartitionReferenceMode {
        ...
        /**
         * References can cross partition boundaries, with an assumption that boundaries will be
