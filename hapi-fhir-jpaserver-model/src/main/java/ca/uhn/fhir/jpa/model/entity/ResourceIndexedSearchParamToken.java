...
@Table(
        ...
        indexes = {
            ...
            @Index(
                    name = "IDX_SP_TOKEN_HASH_V2",
                    columnList = "HASH_IDENTITY,SP_SYSTEM,SP_VALUE,RES_ID,PARTITION_ID"),
            @Index(name = "IDX_SP_TOKEN_HASH_S_V2", columnList = "HASH_SYS,RES_ID,PARTITION_ID"),
            @Index(
                    name = "IDX_SP_TOKEN_HASH_SV_V2",
                    columnList = "HASH_SYS_AND_VALUE,RES_ID,PARTITION_ID"),
            @Index(name = "IDX_SP_TOKEN_HASH_V_V2", columnList = "HASH_VALUE,RES_ID,PARTITION_ID"),
            @Index(
                    name = "IDX_SP_TOKEN_RESID_V2",
                    columnList =
                            "RES_ID,HASH_SYS_AND_VALUE,HASH_VALUE,HASH_SYS,HASH_IDENTITY,PARTITION_ID")
        })
public class ResourceIndexedSearchParamToken extends BaseResourceIndexedSearchParam {
    ...
    public void calculateHashes() {
        ...
        // Searches using the :of-type modifier can never be partial (system-only or value-only) so
        // don't
        // bother saving these
        boolean calculatePartialHashes =
                !StringUtils.endsWith(paramName, Constants.PARAMQUALIFIER_TOKEN_OF_TYPE);
    ...
    public static long calculateHashSystem(
        ...
        return calculateHashSystem(
                thePartitionSettings, requestPartitionId, theResourceType, theParamName, theSystem);
    }
    ...
    public static long calculateHashValue(
        ...
        return calculateHashValue(
                thePartitionSettings, requestPartitionId, theResourceType, theParamName, theValue);
    }
    ...
    public static long calculateHashValue(
        ...
        return hash(
                thePartitionSettings, theRequestPartitionId, theResourceType, theParamName, value);
    }
