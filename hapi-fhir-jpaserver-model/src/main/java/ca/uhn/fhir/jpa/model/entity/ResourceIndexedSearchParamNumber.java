...
@Table(
        ...
        indexes = {
            ...
            @Index(
                    name = "IDX_SP_NUMBER_HASH_VAL_V2",
                    columnList = "HASH_IDENTITY,SP_VALUE,RES_ID,PARTITION_ID"),
            @Index(
                    name = "IDX_SP_NUMBER_RESID_V2",
                    columnList = "RES_ID, HASH_IDENTITY, SP_VALUE, PARTITION_ID")
        })
public class ResourceIndexedSearchParamNumber extends BaseResourceIndexedSearchParam {
    ...
    public boolean equals(Object theObj) {
        ...
        b.append(
                normalizeForEqualityComparison(getValue()),
                normalizeForEqualityComparison(obj.getValue()));
    ...
    public String toString() {
        ...
        b.append(
                "resourceId",
                getResource().getId()); // TODO: add a field so we don't need to resolve this
