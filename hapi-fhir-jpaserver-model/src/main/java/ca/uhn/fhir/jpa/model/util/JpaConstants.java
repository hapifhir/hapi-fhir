...
public class JpaConstants {
    ...
    public static final String OPERATION_APPLY_CODESYSTEM_DELTA_REMOVE =
     ...
     */
    @Deprecated public static final String OPERATION_EXPUNGE = ProviderConstants.OPERATION_EXPUNGE;
     ...
     */
    @Deprecated
    public static final String OPERATION_EXPUNGE_PARAM_LIMIT =
            ProviderConstants.OPERATION_EXPUNGE_PARAM_LIMIT;
    ...
    /**
     * Header name for the "X-Meta-Snapshot-Mode" header, which specifies that properties in meta
     * (tags, profiles, security labels) should be treated as a snapshot, meaning that these things
     * will be removed if they are nt explicitly included in updates
     */
    ...
    // NB don't delete this, it's used in Smile as well, even though hapi-fhir-server uses the
    // version from Constants.java
    ...
    public static final String OPERATION_UPLOAD_EXTERNAL_CODE_SYSTEM =
    ...
    /**
     * Whether mdm should be performed on group export items to expand the group items to linked
     * items before performing the export
     */
    ...
    public static final String EXT_SEARCHPARAM_PHONETIC_ENCODER =
            HapiExtensions.EXT_SEARCHPARAM_PHONETIC_ENCODER;
    ...
    public static final String SUMMARY_OPERATION_URL =
    ...
    public static final String BULK_META_EXTENSION_JOB_ID =
            "https://hapifhir.org/NamingSystem/bulk-export-job-id";
