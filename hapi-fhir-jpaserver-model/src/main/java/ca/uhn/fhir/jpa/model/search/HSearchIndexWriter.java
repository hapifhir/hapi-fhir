...
public class HSearchIndexWriter {
	...
	public static HSearchIndexWriter forRoot(
				StorageSettings theStorageSettings, DocumentElement theDocument) {
	...
	public void writeStringIndex(String theSearchParam, String theValue) {
		DocumentElement stringIndexNode =
					getSearchParamIndexNode(theSearchParam, INDEX_TYPE_STRING);
	...
	public void writeTokenFields(DocumentElement theDocumentElement, IBaseCoding theValue) {
		...
		addDocumentValue(
					theDocumentElement,
					TOKEN_SYSTEM_CODE,
					theValue.getSystem() + "|" + theValue.getCode());
	}

	private void addDocumentValue(
				DocumentElement theDocumentElement, String theKey, Object theValue) {
		if (theValue != null) {
	...
	public void writeQuantityFields(
				DocumentElement nestedQtyNode, QuantitySearchIndexData theValue) {
		...
		Pair canonicalForm =
					UcumServiceUtil.getCanonicalForm(
								theValue.getSystem(),
								BigDecimal.valueOf(theValue.getValue()),
								theValue.getCode());
	...
	public void writeNumberIndex(
				String theParamName, Collection<BigDecimal> theNumberValueCollection) {
		DocumentElement numberNode =
					myNodeCache.getObjectElement(SEARCH_PARAM_ROOT).addObject(theParamName);
		for (BigDecimal numberSearchIndexValue : theNumberValueCollection) {
				ourLog.trace(
						"Adding Search Param Number: {} -- {}", theParamName, numberSearchIndexValue);
