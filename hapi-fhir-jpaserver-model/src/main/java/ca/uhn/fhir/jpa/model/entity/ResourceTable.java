...
public class ResourceTable extends BaseHasResource<JpaPid> implements Serializable, IBasePersistedResource<JpaPid> {
	 ...
	 */
	public static final class FhirIdGenerator implements BeforeExecutionGenerator {
		@Override
		public Object generate(
			...
			ResourceTable that = (ResourceTable) theOwner;
	...
	/**
	 * Marks {@link #myFhirId} as generated by {@link FhirIdGenerator} on insert. This replaces the
	 * {@literal @GeneratorType(when = GenerationTime.INSERT, type = FhirIdGenerator.class)} annotation, which
	 * Hibernate 7 removed in favour of {@link ValueGenerationType}.
	 */
	@ValueGenerationType(generatedBy = FhirIdGenerator.class)
	@Retention(RetentionPolicy.RUNTIME)
	@Target({ElementType.FIELD, ElementType.METHOD})
	public @interface GeneratedFhirId {}
}
