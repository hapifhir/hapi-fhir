...
public class HapiFhirRepositoryR4Test extends BaseCrR4Test {
    ...
    void crudTest() {
        ...
        var result =
                repository.create(
                        new Patient().addName(new HumanName().setFamily("Test").addGiven("Name1")));
        ...
        var ex =
                assertThrows(
                        ...
                        () ->
                                repository.read(
                                        Patient.class,
                                        new IdType(patient.getIdElement().getIdPart())));
    ...
    void canSearchMoreThan50Patients() {
        ...
        var repository =
                new HapiFhirRepository(myDaoRegistry, setupRequestDetails(), ourRestServer);
