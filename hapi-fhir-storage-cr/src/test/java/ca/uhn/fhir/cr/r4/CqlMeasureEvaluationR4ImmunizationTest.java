...
public class CqlMeasureEvaluationR4ImmunizationTest extends BaseCrR4Test {
	...
	public void test_Immunization_Ontario_Schedule() throws IOException {
		...
		MeasureReport reportByPractitioner = evaluateMeasureByMeasure(
				"ImmunizationStatusRoutine", "Practitioner/ImmunizationStatus-practitioner-3", null);
		MeasureReport reportIndividualImmunized =
				evaluateMeasureByMeasure("ImmunizationStatusRoutine", null, "ImmunizationStatus-1-year-patient-1");
		MeasureReport reportIndividualNotImmunized =
				evaluateMeasureByMeasure("ImmunizationStatusRoutine", null, "ImmunizationStatus-1-year-patient-2");
