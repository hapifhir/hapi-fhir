...
public class PlanDefinitionOperationsProviderTest extends BaseCrR4Test {
	...
	void testCdsHooksMultiAction() {
		...
		var carePlan = readResource(
				CarePlan.class, "ca/uhn/fhir/cr/r4/cds-hooks-multi-action/cds_hooks_multiple_actions_careplan.json");
		assertEquals(ourParser.encodeResourceToString(carePlan), ourParser.encodeResourceToString(result));

		var resultR5 = this.planDefinitionOperationsProvider.applyR5(
				planDefinitionID,
				null,
				null,
				patientID,
		...
		var bundle = readResource(
				Bundle.class, "ca/uhn/fhir/cr/r4/cds-hooks-multi-action/cds_hooks_multiple_actions_bundle.json");
	...
	void testGenerateQuestionnaire() {
		...
		var result = (CarePlan) this.planDefinitionOperationsProvider.apply(
				planDefinitionID,
				null,
				null,
				patientID,
		...
		var resultR5 = (Bundle) this.planDefinitionOperationsProvider.applyR5(
				planDefinitionID,
				null,
				null,
				patientID,
