...
public class CrProviderDstu3Test extends BaseCrDstu3Test {
    ...
    protected final RequestDetails myRequestDetails =
            RequestDetailsHelper.newServletRequestDetails();

    @Autowired @RegisterExtension protected PartitionHelper myPartitionHelper;
    ...
    public void before() throws IOException {
        ...
        var modelDef =
                readResource(
                        Library.class,
                        "ca/uhn/fhir/cr/dstu3/hedis-ig/library/library-fhir-model-definition.json");
        var fhirHelpers =
                readResource(
                        Library.class,
                        "ca/uhn/fhir/cr/dstu3/hedis-ig/library/library-fhir-helpers.json");
    ...
    */
    ...
    public void testHedisIGEvaluatePatientMeasure() throws IOException {
        loadResource(
                Library.class,
                "ca/uhn/fhir/cr/dstu3/hedis-ig/library/library-asf-logic.json",
                myRequestDetails);
        // Load the measure for ASF: Unhealthy Alcohol Use Screening and Follow-up (ASF)
        loadResource(
                Measure.class, "ca/uhn/fhir/cr/dstu3/hedis-ig/measure-asf.json", myRequestDetails);
        ...
        ourLog.debug(
                myFhirContext.newJsonParser().setPrettyPrint(true).encodeResourceToString(report));
        ...
        ourLog.info(
                "Called evaluateMeasure() {} times: average time per call: {}",
                runCount,
                sw.formatMillisPerOperation(runCount));
