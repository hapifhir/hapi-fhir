...
public class QuestionnaireOperationsProviderTest extends BaseCrR4Test {
    @Autowired QuestionnaireOperationsProvider questionnaireOperationsProvider;
    ...
    void testPopulate() {
        ...
        var result =
                this.questionnaireOperationsProvider.populate(
    ...
    void testPrePopulate() {
        ...
        var parameters =
                new Parameters()
                        ...
                        .addParameter("Service Request Id", "SleepStudy2");
        var result =
                this.questionnaireOperationsProvider.prepopulate(
                        new IdType("Questionnaire", "ASLPA1"),
                        null,
                        null,
                        theSubject,
    ...
    void testQuestionnairePackage() {
        ...
        var requestDetails = setupRequestDetails();
        var result =
                this.questionnaireOperationsProvider.packageQuestionnaire(
                        null,
