...
public abstract class BaseCrR4Test extends BaseResourceProviderR4Test implements IResourceLoader {
            ...
            HoverflyRule.inSimulationMode(
                    dsl(
                            service(TEST_ADDRESS)
                                    ...
                                    .willReturn(
                                            success(
                                                    getCapabilityStatement().toString(),
                                                    "application/json"))));
    ...
    public StubServiceBuilder mockFhirRead(
            String thePath, Resource theResource, int theStatusCode) {
    ...
    public StubServiceBuilder mockFhirSearch(
        ...
        return service(TEST_ADDRESS)
                ...
                .willReturn(
                        success(
                                ourParser.encodeResourceToString(makeBundle(theResources)),
                                "application/json"));
    }
    ...
    public List<StubServiceBuilder> mockValueSet(String theId, String theUrl) {
        ...
        return Arrays.asList(
                mockFhirSearch(
                        "/fhir/ValueSet", "url", String.format("%s/%s", theUrl, theId), valueSet),
