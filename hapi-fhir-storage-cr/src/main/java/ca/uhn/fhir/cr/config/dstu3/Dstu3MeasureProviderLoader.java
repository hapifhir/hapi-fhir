 ...
 **/
@Service
public class Dstu3MeasureProviderLoader {
	private static final Logger myLogger = LoggerFactory.getLogger(Dstu3MeasureProviderLoader.class);
	private final FhirContext myFhirContext;
	private final ResourceProviderFactory myResourceProviderFactory;
	private final Dstu3MeasureProviderFactory myDstu3MeasureProviderFactory;

	public Dstu3MeasureProviderLoader(
		...
		myDstu3MeasureProviderFactory = theDstu3MeasureProviderFactory;
	}
	...
	public void loadProvider() {
		switch (myFhirContext.getVersion().getVersion()) {
			case DSTU3:
				...
				myResourceProviderFactory.addSupplier(() -> myDstu3MeasureProviderFactory.getMeasureOperationsProvider());
				break;
			default:
