...
public class ActivityDefinitionOperationsProvider {
	...
	@Autowired IActivityDefinitionProcessorFactory myDstu3ActivityDefinitionServiceFactory;

	/**
	* Implements the <a href=
	* "http://www.hl7.org/fhir/activitydefinition-operation-apply.html">$apply</a> operation found
	* in the <a href="http://www.hl7.org/fhir/clinicalreasoning-module.html">FHIR Clinical
	* Reasoning Module</a>. This implementation aims to be compatible with the CPG IG.
	*
	* @param theId The id of the ActivityDefinition to apply
	* @param theCanonical The canonical identifier for the ActivityDefinition to apply (optionally
	*     version-specific)
	* @param theActivityDefinition The ActivityDefinition to be applied
	* @param theSubject The subject(s) that is/are the target of the activity definition to be
	*     applied.
	...
	*     libraries referenced by the ActivityDefinition.
	...
	*     codesystems, and membership testing) referenced by the ActivityDefinition.
