...
public class QuestionnaireOperationsProvider {
	...
	@Autowired IQuestionnaireProcessorFactory myR4QuestionnaireProcessorFactory;
	...
	* @param theCanonical The canonical identifier for the questionnaire (optionally
	*     version-specific). @Param theIsPut A boolean value to determine if the Bundle returned
	*     uses PUT or POST request methods. Defaults to false.
	* @param theRequestDetails The details (such as tenant) of this request. Usually autopopulated
	*     by HAPI.
