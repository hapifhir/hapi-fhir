...
/**
 * This class provides an implementation of the cql-engine's RetrieveProvider interface which is
 * used for loading data during CQL evaluation.
 */
public class HapiFhirRetrieveProvider extends SearchParamFhirRetrieveProvider
		implements IDaoRegistryUser {
	...
	/**
	* The queryIterable class provides an Iterable to cycle through a series of search queries and
	* results of those queries, implementation of this avoided loading all resources into a list.
	*/
	...
	protected Iterable<IBaseResource> executeQuery(String dataType, SearchParameterMap map) {
		ca.uhn.fhir.jpa.searchparam.SearchParameterMap hapiMap =
