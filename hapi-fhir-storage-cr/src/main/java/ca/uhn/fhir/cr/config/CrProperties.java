...
public class CrProperties {
	...
	public static class MeasureProperties {
		...
		public static class MeasureReportConfiguration {
				 ...
				 * "https://www.hl7.org/fhir/measurereport.html">MeasureReport</a> FHIR Resource. This
				 * is required by the <a href=
				 * "http://hl7.org/fhir/us/davinci-deqm/StructureDefinition/indv-measurereport-deqm">DEQMIndividualMeasureReportProfile</a>
				 * profile found in the <a
				 * href="http://build.fhir.org/ig/HL7/davinci-deqm/index.html">Da Vinci DEQM FHIR
				 ...
				 * "http://www.hl7.org/fhir/composition.html">Composition</a> FHIR Resource. This is
				...
				public void setCareGapsCompositionSectionAuthor(
						String theCareGapsCompositionSectionAuthor) {
