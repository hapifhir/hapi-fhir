...
public class CpgProviderLoader {
	...
	public CpgProviderLoader(FhirContext theFhirContext, ResourceProviderFactory theResourceProviderFactory, CpgProviderFactory theCpgProviderFactory) {
		myFhirContext = theFhirContext;
		myResourceProviderFactory = theResourceProviderFactory;
		myCpgProviderFactory = theCpgProviderFactory;
	...
	private void loadProvider() {
		switch (myFhirContext.getVersion().getVersion()) {
			case DSTU3:
			case R4:
				myLogger.info("Registering CPG Provider");
				myResourceProviderFactory.addSupplier(() -> myCpgProviderFactory.getActivityDefinitionOperationsProvider());
