...
public class SdcProviderLoader {
	...
	public SdcProviderLoader(FhirContext theFhirContext, ResourceProviderFactory theResourceProviderFactory, SdcProviderFactory theSdcProviderFactory) {
		myFhirContext = theFhirContext;
		myResourceProviderFactory = theResourceProviderFactory;
		mySdcProviderFactory = theSdcProviderFactory;
	...
	private void loadProvider() {
		switch (myFhirContext.getVersion().getVersion()) {
			...
			case R4:
				...
				myResourceProviderFactory.addSupplier(() -> mySdcProviderFactory.getQuestionnaireOperationsProvider());
