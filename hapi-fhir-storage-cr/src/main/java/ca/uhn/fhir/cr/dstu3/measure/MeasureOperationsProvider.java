...
public class MeasureOperationsProvider {
    @Autowired Function<RequestDetails, MeasureService> myDstu3MeasureServiceFactory;
     ...
     * @param thePatient the patient to use as the subject to use for the evaluation
     ...
     */
    @Operation(
            name = ProviderConstants.CQL_EVALUATE_MEASURE,
            idempotent = true,
            type = Measure.class)
