...
public class Searches {
	...
	*/
	public static <C extends IPrimitiveType<String>> SearchParameterMap byCanonical(
				C theCanonicalType) {
	...
	/**
	* Method to return a SearchParameterMap which has parameters of canonical search string and
	* version
	*
	* @param theCanonical a string representing the canonical
	...
	*/
	...
	public static <C extends IPrimitiveType<String>> SearchParameterMap byCanonicals(
				List<C> theCanonicalTypes) {
		checkNotNull(theCanonicalTypes);

		List<String> urls = new ArrayList<>();
		theCanonicalTypes.forEach(
					canonicalType -> {
