...
public class QuestionnaireOperationsProvider {
    ...
    @Autowired IQuestionnaireProcessorFactory myDstu3QuestionnaireServiceFactory;
     ...
     * Capture (SDC) IG</a>. This implementation will return a Questionnaire resource with the
     * initialValues set rather than a QuestionnaireResponse with the answers filled out.
     *
     * @param theId The id of the Questionnaire to populate.
     * @param theCanonical The canonical identifier for the questionnaire (optionally
     *     version-specific).
     * @param theQuestionnaire The Questionnaire to populate. Used when the operation is invoked at
     *     the 'type' level.
     ...
     *     libraries referenced by the Questionnaire.
     ...
     *     codesystems, and membership testing) referenced by the Questionnaire.
     ...
     */
    @Operation(
            name = ProviderConstants.CR_OPERATION_PREPOPULATE,
            idempotent = true,
    ...
    public QuestionnaireResponse populate(
        ...
        return (QuestionnaireResponse)
                this.myDstu3QuestionnaireServiceFactory
                        .create(myRepositoryFactory.create(theRequestDetails))
                        .populate(
                                theId,
                                new StringType(theCanonical),
     ...
     * @param theRequestDetails The details (such as tenant) of this request. Usually autopopulated
     *     by HAPI.
     * @return A Bundle containing the Questionnaire and all related Library, CodeSystem and
     *     ValueSet resources
     */
    @Operation(
