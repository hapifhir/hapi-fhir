 ...
 * used for Terminology operations in CQL
 */
public class HapiTerminologyProvider implements TerminologyProvider {
    ...
    public Iterable<Code> expand(ValueSetInfo theValueSet) throws ResourceNotFoundException {
        ...
        VersionedIdentifier vsId =
                new VersionedIdentifier()
                        .withId(theValueSet.getId())
                        .withVersion(theValueSet.getVersion());
        ...
        IValidationSupport.ValueSetExpansionOutcome vs =
                myValidationSupport.expandValueSet(
    ...
    @Override
    public Code lookup(Code theCode, CodeSystemInfo theCodeSystem)
        ...
        switch (version) {
            ...
            default:
                throw new IllegalArgumentException(
                        Msg.code(2225)
                                + String.format(
                                        "FHIR version %s is unsupported.",
                                        version.getFhirVersionString()));
        }
    }
