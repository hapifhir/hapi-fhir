...
/**
 * This class pulls existing methods from the BaseResourceReturningMethodBinding class used for
 * taking the results of a BundleProvider and turning it into a Bundle. It is intended to be used
 * only by the HapiFhirRepository.
 */
