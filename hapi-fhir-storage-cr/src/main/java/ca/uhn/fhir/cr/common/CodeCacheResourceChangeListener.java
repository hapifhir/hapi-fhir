...
/**
 * This class listens for changes to ValueSet resources and invalidates the CodeCache. The CodeCache
 * is used in CQL evaluation to speed up terminology operations. If ValueSet changes, it's possible
 * that the constituent codes change and therefore the cache needs to be updated.
 */
public class CodeCacheResourceChangeListener implements IResourceChangeListener {
    ...
    private void invalidateCacheById(IIdType theId) {
        ...
        // name and version.
            ...
            ourLog.debug(
                    "Failed to locate resource {} to look up url and version. Clearing all codes"
                            + " from cache.",
