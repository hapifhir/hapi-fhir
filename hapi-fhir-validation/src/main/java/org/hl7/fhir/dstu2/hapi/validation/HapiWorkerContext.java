...
import org.hl7.fhir.dstu2.hapi.validation.IValidationSupport.CodeValidationResult;
...
public final class HapiWorkerContext implements IWorkerContext, ValueSetExpanderFactory, ValueSetExpander {
	...
	@Override
	public StructureDefinition fetchTypeDefinition(String theType) {
		return fetchResource(StructureDefinition.class, "http://hl7.org/fhir/StructureDefinition/" + theType);
	}

	@Override
	public ValueSetExpansionOutcome expand(ValueSet theSource) throws ETooCostly, IOException {
