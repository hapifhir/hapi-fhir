...
class ValidatorWrapper {
    ...
    public ValidatorWrapper setBestPracticeWarningLevel(
            BestPracticeWarningLevel theBestPracticeWarningLevel) {
    ...
    public ValidatorWrapper setValidationPolicyAdvisor(
            IValidationPolicyAdvisor validationPolicyAdvisor) {
        this.myValidationPolicyAdvisor = validationPolicyAdvisor;
        return this;
    }

    public ValidatorWrapper setValidatorResourceFetcher(
            IValidatorResourceFetcher validatorResourceFetcher) {
    ...
    public List<ValidationMessage> validate(
        ...
        if (encoding == EncodingEnum.XML) {
            ...
            try {
                ...
                m.setMessage(
                        "Failed to parse input, it does not appear to be valid XML:"
                                + e2.getMessage());
                messages.add(m);
                return messages;
            }
            ...
            InputStream inputStream =
                    new ReaderInputStream(
                            new StringReader(resourceAsString), StandardCharsets.UTF_8);
    ...
    private void fetchAndAddProfile(
        ...
        try {
            StructureDefinition structureDefinition =
                    theWorkerContext.fetchResource(StructureDefinition.class, theUrl);
