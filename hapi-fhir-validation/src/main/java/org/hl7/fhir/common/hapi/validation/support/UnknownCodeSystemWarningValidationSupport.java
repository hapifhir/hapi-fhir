...
/**
 * This validation support module may be placed at the end of a {@link ValidationSupportChain} in
 * order to configure the validator to generate a warning if a resource being validated contains an
 * unknown code system.
 *
 * <p>Note that this module must also be activated by calling {@link
 * #setAllowNonExistentCodeSystem(boolean)} in order to specify that unknown code systems should be
 * allowed.
 */
public class UnknownCodeSystemWarningValidationSupport extends BaseValidationSupport {
	private static final Logger ourLog =
				LoggerFactory.getLogger(UnknownCodeSystemWarningValidationSupport.class);
	...
	/**
	* Returns true if non existent code systems will still validate. False if they will throw
	* errors.
	*
	* @return
	*/
