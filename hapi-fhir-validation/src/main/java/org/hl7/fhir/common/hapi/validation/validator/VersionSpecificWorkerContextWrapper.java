...
public class VersionSpecificWorkerContextWrapper extends I18nBase implements IWorkerContext {
    private static final Logger ourLog =
            LoggerFactory.getLogger(VersionSpecificWorkerContextWrapper.class);
        ...
        myFetchResourceCache =
                CacheFactory.build(
                        ...
                        key -> {
                            ...
                            Resource canonical =
                                    myVersionCanonicalizer.resourceToValidatorCanonical(fetched);
                            ...
                            if (canonical instanceof StructureDefinition) {
                                ...
                                if (canonicalSd.getSnapshot().isEmpty()) {
                                    ourLog.info(
                                            "Generating snapshot for StructureDefinition: {}",
                                            canonicalSd.getUrl());
                                    fetched =
                                            myValidationSupportContext
                                                    .getRootValidationSupport()
                                    ...
                                    Validate.isTrue(
                                            fetched != null,
                                            "StructureDefinition %s has no snapshot, and no"
                                                    + " snapshot generator is configured",
                                            key.getUri());
                                    canonical =
                                            myVersionCanonicalizer.resourceToValidatorCanonical(
                                                    fetched);
                                }
                            }
            ...
            for (IBaseResource next :
                ...
                try {
                    StructureDefinition converted =
                            myVersionCanonicalizer.structureDefinitionToCanonical(next);
    ...
    @Override
    public void cacheResourceFromPackage(Resource res, PackageInformation packageDetails)
            throws FHIRException {}
    ...
    private ValidationResult convertValidationResult(
        ...
        if (retVal == null) {
            retVal =
                    new ValidationResult(
                            ValidationMessage.IssueSeverity.ERROR, "Validation failed", null);
        }
    ...
    public ValueSetExpansionOutcome expandVS(
        ...
        if (expanded.getValueSet() != null) {
            try {
                convertedResult =
                        myVersionCanonicalizer.valueSetToValidatorCanonical(expanded.getValueSet());
            } catch (FHIRException e) {
    ...
    @Override
    public ValueSetExpansionOutcome expandVS(
            ValueSet.ConceptSetComponent inc, boolean hierarchical, boolean noInactive)
    ...
    public org.hl7.fhir.r5.model.CodeSystem fetchCodeSystem(String system) {
        ...
        try {
            return (org.hl7.fhir.r5.model.CodeSystem)
                    myVersionCanonicalizer.codeSystemToValidatorCanonical(fetched);
        } catch (FHIRException e) {
    ...
    @Override
    public <T extends Resource> T fetchResourceWithException(Class<T> class_, String uri)
            throws FHIRException {
        T retVal = fetchResource(class_, uri);
        if (retVal == null) {
            throw new FHIRException(
                    Msg.code(667)
                            + "Can not find resource of type "
    ...
    public <T extends Resource> T fetchResource(
            Class<T> class_, String uri, Resource canonicalForSource) {
        return fetchResource(class_, uri);
    }

    @Override
    public <T extends Resource> T fetchResourceWithException(
            Class<T> class_, String uri, Resource sourceOfReference) throws FHIRException {
    ...
    public StructureDefinition fetchTypeDefinition(String typeName) {
        return fetchResource(
                StructureDefinition.class, "http://hl7.org/fhir/StructureDefinition/" + typeName);
    }
    ...
    public <T extends Resource> List<T> fetchResourcesByType(Class<T> theClass) {
        ...
        throw new UnsupportedOperationException(
                Msg.code(650) + "Unable to fetch resources of type: " + theClass);
    }
    ...
    private static class ResourceKey {
        ...
        private ResourceKey(String theResourceName, String theUri) {
            ...
            myUri = theUri;
            myHashCode =
                    new HashCodeBuilder(17, 37).append(myResourceName).append(myUri).toHashCode();
        }
    ...
    public static ConceptValidationOptions convertConceptValidationOptions(
            ValidationOptions theOptions) {
