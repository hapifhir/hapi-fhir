...
public class PrePopulatedValidationSupport extends BaseStaticResourceValidationSupport
     ...
     * Constructor
     *
     * @param theStructureDefinitions The StructureDefinitions to be returned by this module. Keys
     *     are the logical URL for the resource, and values are the resource itself.
     * @param theValueSets The ValueSets to be returned by this module. Keys are the logical URL for
     *     the resource, and values are the resource itself.
     * @param theCodeSystems The CodeSystems to be returned by this module. Keys are the logical URL
     ...
     * @param theCodeSystems The CodeSystems to be returned by this module. Keys are the logical URL
     *     for the resource, and values are the resource itself.
     * @param theBinaries The binary files to be returned by this module. Keys are the unique
     *     filename for the binary, and values are the contents of the file as a byte array.
     */
    public PrePopulatedValidationSupport(
            FhirContext theFhirContext,
            Map<String, IBaseResource> theStructureDefinitions,
    ...
    private Set<String> processResourceAndReturnUrls(
        ...
        String version =
                versionValue.map(t -> (((IPrimitiveType<?>) t).getValueAsString())).orElse(null);
    ...
    public void addStructureDefinition(IBaseResource theStructureDefinition) {
        validateNotLocked();
        Set<String> url =
                processResourceAndReturnUrls(theStructureDefinition, "StructureDefinition");
    ...
    private <T extends IBaseResource> void addToMap(
            T theResource, Map<String, T> theMap, Collection<String> theUrls) {
