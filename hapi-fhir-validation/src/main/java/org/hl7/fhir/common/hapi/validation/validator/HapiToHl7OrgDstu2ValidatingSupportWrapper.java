...
public class HapiToHl7OrgDstu2ValidatingSupportWrapper extends BaseValidationSupportWrapper
    ...
    public HapiToHl7OrgDstu2ValidatingSupportWrapper(IValidationSupport theWrap) {
        ...
        Validate.isTrue(
                theWrap.getFhirContext().getVersion().getVersion() == FhirVersionEnum.DSTU2);
    ...
    private Class<? extends IBaseResource> translateTypeToHapi(
            Class<? extends IBaseResource> theCodeSystemType) {
