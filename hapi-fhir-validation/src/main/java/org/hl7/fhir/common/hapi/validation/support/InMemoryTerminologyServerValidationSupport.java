...
/**
 * This class is a basic in-memory terminology service, designed to expand ValueSets and validate
 * codes completely in-memory. It is suitable for runtime validation purposes where no dedicated
 * terminology service exists (either an internal one such as the HAPI FHIR JPA terminology service,
 * or an external term service API)
 */
...
public class InMemoryTerminologyServerValidationSupport implements IValidationSupport {
	...
	private ValueSetExpansionOutcome expandValueSet(
		...
		switch (myCtx.getVersion().getVersion()) {
				case DSTU2:
					{
						org.hl7.fhir.r4.model.ValueSet expansionR4 =
									(org.hl7.fhir.r4.model.ValueSet)
												VersionConvertorFactory_40_50.convertResource(
														expansionR5, new BaseAdvisor_40_50(false));
				...
				case DSTU2_HL7ORG:
					{
						expansion =
									VersionConvertorFactory_10_50.convertResource(
												expansionR5, new BaseAdvisor_10_50(false));
						break;
					}
				case DSTU3:
					{
						expansion =
									VersionConvertorFactory_30_50.convertResource(
												expansionR5, new BaseAdvisor_30_50(false));
						break;
					}
				case R4:
					{
				...
				case R4B:
					{
						expansion =
									VersionConvertorFactory_43_50.convertResource(
												expansionR5, new BaseAdvisor_43_50(false));
						break;
					}
				case R5:
					{
	...
	private org.hl7.fhir.r5.model.ValueSet expandValueSetToCanonical(
				ValidationSupportContext theValidationSupportContext,
				IBaseResource theValueSetToExpand,
		...
		try {
				...
				String msg =
						"Failed to expand ValueSet '"
									+ vsUrl
									+ "' (in-memory). Could not validate code "
									+ theCodeSystemUrlAndVersion
									+ "#"
									+ theCode;
	...
	public CodeValidationResult validateCode(
		...
		if (isNotBlank(theValueSetUrl)) {
				...
				switch (myCtx.getVersion().getVersion()) {
					...
					case DSTU2_HL7ORG:
						vs =
									new org.hl7.fhir.dstu2.model.ValueSet()
												.setCompose(
														new org.hl7.fhir.dstu2.model.ValueSet
					...
					case R4B:
						if (codeSystemVersion != null) {
								vs =
										new org.hl7.fhir.r4b.model.ValueSet()
													.setCompose(
																new org.hl7.fhir.r4b.model.ValueSet
																					.ValueSetComposeComponent()
																		.addInclude(
	...
	private CodeValidationResult validateCodeInExpandedValueSet(
		...
		switch (getFhirVersionEnum(
				...
				case DSTU3:
					{
						org.hl7.fhir.dstu3.model.ValueSet expansionVs =
									(org.hl7.fhir.dstu3.model.ValueSet) theExpansion;
						List<org.hl7.fhir.dstu3.model.ValueSet.ValueSetExpansionContainsComponent>
									contains = expansionVs.getExpansion().getContains();
						flattenAndConvertCodesDstu3(contains, codes);
						break;
					}
				case R4:
					{
						org.hl7.fhir.r4.model.ValueSet expansionVs =
									(org.hl7.fhir.r4.model.ValueSet) theExpansion;
				...
				case R4B:
					{
						org.hl7.fhir.r4b.model.ValueSet expansionVs =
									(org.hl7.fhir.r4b.model.ValueSet) theExpansion;
				...
				case R5:
					{
						org.hl7.fhir.r5.model.ValueSet expansionVs =
									(org.hl7.fhir.r5.model.ValueSet) theExpansion;
						List<org.hl7.fhir.r5.model.ValueSet.ValueSetExpansionContainsComponent>
									contains = expansionVs.getExpansion().getContains();
					...
					case R4:
						{
								...
								codeSystemResourceContentMode =
										systemR4.getContentElement().getValueAsString();
								break;
						}
					case R4B:
						{
					...
					case R5:
						{
								...
								codeSystemResourceContentMode =
										systemR5.getContentElement().getValueAsString();
								break;
						}
					case DSTU2_1:
					default:
		...
		if (theCodeSystemUrlAndVersionToValidate != null) {
				...
				if (versionIndex > -1) {
					codeSystemUrlToValidate =
								theCodeSystemUrlAndVersionToValidate.substring(0, versionIndex);
					codeSystemVersionToValidate =
								theCodeSystemUrlAndVersionToValidate.substring(versionIndex + 1);
				} else {
	...
	@Nullable
	private org.hl7.fhir.r5.model.ValueSet expandValueSetDstu2Hl7Org(
				ValidationSupportContext theValidationSupportContext,
				ValueSet theInput,
				@Nullable String theWantSystemUrlAndVersion,
				@Nullable String theWantCode)
				throws ExpansionCouldNotBeCompletedInternallyException {
		org.hl7.fhir.r5.model.ValueSet input =
					(org.hl7.fhir.r5.model.ValueSet)
								VersionConvertorFactory_10_50.convertResource(
										theInput, new BaseAdvisor_10_50(false));
		return (expandValueSetR5(
					theValidationSupportContext, input, theWantSystemUrlAndVersion, theWantCode));
	}

	@Nullable
	private org.hl7.fhir.r5.model.ValueSet expandValueSetDstu2(
				ValidationSupportContext theValidationSupportContext,
		...
		org.hl7.fhir.dstu2.model.ValueSet valueSetRi =
					parserRi.parseResource(
								org.hl7.fhir.dstu2.model.ValueSet.class,
								parserHapi.encodeResourceToString(theInput));
		org.hl7.fhir.r5.model.ValueSet input =
					(org.hl7.fhir.r5.model.ValueSet)
								VersionConvertorFactory_10_50.convertResource(
	...
	public boolean isCodeSystemSupported(
		...
		if (cs != null) {
				IPrimitiveType<?> content =
						getFhirContext()
									.newTerser()
									.getSingleValueOrNull(cs, "content", IPrimitiveType.class);
	...
	private void addCodesDstu2Hl7Org(
		...
		for (ValueSet.ConceptDefinitionComponent nextSource : theSourceList) {
				CodeSystem.ConceptDefinitionComponent targetConcept =
	...
	private void addCodesDstu2(
				...
				List<CodeSystem.ConceptDefinitionComponent> theTargetList) {
		for (ca.uhn.fhir.model.dstu2.resource.ValueSet.CodeSystemConcept nextSource :
					theSourceList) {
				CodeSystem.ConceptDefinitionComponent targetConcept =
						new CodeSystem.ConceptDefinitionComponent()
									.setCode(nextSource.getCode())
	...
	@Nullable
	private org.hl7.fhir.r5.model.ValueSet expandValueSetDstu3(
				ValidationSupportContext theValidationSupportContext,
		...
		org.hl7.fhir.r5.model.ValueSet input =
					(org.hl7.fhir.r5.model.ValueSet)
								VersionConvertorFactory_30_50.convertResource(
										theInput, new BaseAdvisor_30_50(false));
		return (expandValueSetR5(
					theValidationSupportContext, input, theWantSystemUrlAndVersion, theWantCode));
	}

	@Nullable
	private org.hl7.fhir.r5.model.ValueSet expandValueSetR4(
				ValidationSupportContext theValidationSupportContext,
		...
		org.hl7.fhir.r5.model.ValueSet input =
					(org.hl7.fhir.r5.model.ValueSet)
								VersionConvertorFactory_40_50.convertResource(
										theInput, new BaseAdvisor_40_50(false));
		return expandValueSetR5(
					theValidationSupportContext, input, theWantSystemUrlAndVersion, theWantCode);
	}

	@Nullable
	private org.hl7.fhir.r5.model.ValueSet expandValueSetR4B(
				ValidationSupportContext theValidationSupportContext,
		...
		org.hl7.fhir.r5.model.ValueSet input =
					(org.hl7.fhir.r5.model.ValueSet)
								VersionConvertorFactory_43_50.convertResource(
										theInput, new BaseAdvisor_43_50(false));
		return expandValueSetR5(
					theValidationSupportContext, input, theWantSystemUrlAndVersion, theWantCode);
	}
	...
	private org.hl7.fhir.r5.model.ValueSet expandValueSetR5(
		...
		for (FhirVersionIndependentConcept next : concepts) {
				org.hl7.fhir.r5.model.ValueSet.ValueSetExpansionContainsComponent contains =
						retVal.getExpansion().addContains();
	...
	*/
	public void expandValueSetIncludeOrExclude(
		...
		expandValueSetR5IncludeOrExclude(
					theValidationSupportContext, theConsumer, null, null, theIncludeOrExclude);
	}
	...
	private boolean expandValueSetR5IncludeOrExclude(
		...
		Function<String, CodeSystem> codeSystemLoader =
					newCodeSystemLoader(theValidationSupportContext);
		...
		if (isNotBlank(includeOrExcludeConceptSystemUrl)) {
				...
				includeOrExcludeConceptSystemUrl =
						substringBefore(includeOrExcludeConceptSystemUrl, OUR_PIPE_CHARACTER);

				if (wantSystemUrl != null && !wantSystemUrl.equals(includeOrExcludeConceptSystemUrl)) {
					return false;
				}

				if (wantSystemVersion != null
						&& !wantSystemVersion.equals(includeOrExcludeConceptSystemVersion)) {
					return false;
				}
				...
				if (includeOrExcludeSystemResource == null
						|| includeOrExcludeSystemResource.getContent()
									== Enumerations.CodeSystemContentMode.NOTPRESENT) {
						...
						if (theValidationSupportContext
								...
								if (Objects.equals(theInclude.getSystem(), theWantSystemUrlAndVersion)) {
									...
									if (!theInclude.getConcept().isEmpty()) {
										...
										failureMessage =
													getFailureMessageForMissingOrUnusableCodeSystem(
				...
				if (!ableToHandleCode) {
					...
					throw new ExpansionCouldNotBeCompletedInternallyException(
								Msg.code(702) + failureMessage, failureType);
				}
		...
		for (CanonicalType nextValueSetInclude : theInclude.getValueSet()) {
				org.hl7.fhir.r5.model.ValueSet vs =
						valueSetLoader.apply(nextValueSetInclude.getValueAsString());
				if (vs != null) {
					...
					if (subExpansion == null) {
						throw new ExpansionCouldNotBeCompletedInternallyException(
									Msg.code(703)
												+ "Failed to expand ValueSet: "
												+ nextValueSetInclude.getValueAsString(),
									FailureType.OTHER);
					}
				...
				case DSTU2_HL7ORG:
					return t -> {
						...
						if (vs instanceof ca.uhn.fhir.model.dstu2.resource.ValueSet) {
								IParser parserRi =
										FhirContext.forCached(FhirVersionEnum.DSTU2_HL7ORG).newJsonParser();
								IParser parserHapi = FhirContext.forDstu2Cached().newJsonParser();
								...
								org.hl7.fhir.dstu2.model.ValueSet valueSetRi =
										parserRi.parseResource(
													org.hl7.fhir.dstu2.model.ValueSet.class,
													parserHapi.encodeResourceToString(valueSet));
								...
								return (org.hl7.fhir.r5.model.ValueSet)
										VersionConvertorFactory_10_50.convertResource(
													valueSet, new BaseAdvisor_10_50(false));
						}
					};
				case DSTU3:
					return t -> {
						...
						return (org.hl7.fhir.r5.model.ValueSet)
									VersionConvertorFactory_30_50.convertResource(
												valueSet, new BaseAdvisor_30_50(false));
					};
				case R4:
					return t -> {
						...
						return (org.hl7.fhir.r5.model.ValueSet)
									VersionConvertorFactory_40_50.convertResource(
												valueSet, new BaseAdvisor_40_50(false));
					};
				case R4B:
					return t -> {
						...
						return (org.hl7.fhir.r5.model.ValueSet)
									VersionConvertorFactory_43_50.convertResource(
												valueSet, new BaseAdvisor_43_50(false));
					};
				default:
				case DSTU2_1:
				case R5:
	...
	private Function<String, CodeSystem> newCodeSystemLoader(
				ValidationSupportContext theValidationSupportContext) {
		switch (myCtx.getVersion().getVersion()) {
				case DSTU2:
				case DSTU2_HL7ORG:
					return t -> {
						...
						if (codeSystem != null) {
								...
								if (codeSystem instanceof ca.uhn.fhir.model.dstu2.resource.ValueSet) {
									...
									addCodesDstu2(
												codeSystemCasted.getCodeSystem().getConcept(),
												retVal.getConcept());
								} else {
				...
				case DSTU3:
					return t -> {
						...
						return (CodeSystem)
									VersionConvertorFactory_30_50.convertResource(
												codeSystem, new BaseAdvisor_30_50(false));
					};
				case R4:
					return t -> {
						...
						return (CodeSystem)
									VersionConvertorFactory_40_50.convertResource(
												codeSystem, new BaseAdvisor_40_50(false));
					};
				case R4B:
					return t -> {
						org.hl7.fhir.r4b.model.CodeSystem codeSystem =
									(org.hl7.fhir.r4b.model.CodeSystem)
												theValidationSupportContext
														.getRootValidationSupport()
														.fetchCodeSystem(t);
						return (CodeSystem)
									VersionConvertorFactory_43_50.convertResource(
												codeSystem, new BaseAdvisor_43_50(false));
					};
				case DSTU2_1:
				case R5:
				default:
	...
	private String getFailureMessageForMissingOrUnusableCodeSystem(
		...
		if (includeOrExcludeSystemResource == null) {
				failureMessage =
						"Unable to expand ValueSet because CodeSystem could not be found: "
									+ loadedCodeSystemUrl;
		} else {
				assert includeOrExcludeSystemResource.getContent()
						== Enumerations.CodeSystemContentMode.NOTPRESENT;
				failureMessage =
						"Unable to expand ValueSet because CodeSystem has"
									+ " CodeSystem.content=not-present but contents were not found: "
									+ loadedCodeSystemUrl;
		}
	...
	public static class ExpansionCouldNotBeCompletedInternallyException extends Exception {
		...
		public ExpansionCouldNotBeCompletedInternallyException(
					String theMessage, FailureType theFailureType) {
				super(theMessage);
	...
	private static void flattenAndConvertCodesDstu2(
		...
		for (ca.uhn.fhir.model.dstu2.resource.ValueSet.ExpansionContains next : theInput) {
				theFhirVersionIndependentConcepts.add(
						new FhirVersionIndependentConcept(
									next.getSystem(), next.getCode(), next.getDisplay()));
	...
	private static void flattenAndConvertCodesDstu2Hl7Org(
		...
		for (org.hl7.fhir.dstu2.model.ValueSet.ValueSetExpansionContainsComponent next : theInput) {
				theFhirVersionIndependentConcepts.add(
						new FhirVersionIndependentConcept(
									next.getSystem(), next.getCode(), next.getDisplay()));
				flattenAndConvertCodesDstu2Hl7Org(
						next.getContains(), theFhirVersionIndependentConcepts);
		}
	}
