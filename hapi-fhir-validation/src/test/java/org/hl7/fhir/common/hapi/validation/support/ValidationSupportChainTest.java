...
public class ValidationSupportChainTest {
    ...
    public void testVersionCheck() {
        ...
        DefaultProfileValidationSupport ctx3 =
                new DefaultProfileValidationSupport(FhirContext.forDstu3());
        DefaultProfileValidationSupport ctx4 =
                new DefaultProfileValidationSupport(FhirContext.forR4());
        ...
        try {
            ...
            assertEquals(
                    Msg.code(709)
                            + "Trying to add validation support of version R4 to chain with 1"
                            + " entries of version DSTU3",
                    e.getMessage());
        }
    }
    ...
    public void testMissingContext() {
        ...
        try {
            ...
            assertEquals(
                    Msg.code(708) + "Can not add validation support: getFhirContext() returns null",
                    e.getMessage());
        }
    }
    ...
    public void fetchBinary_normally_returnsExpectedBinaries() {
        ...
        IValidationSupport validationSupport1 =
                createMockValidationSupportWithSingleBinary(
                        EXPECTED_BINARY_KEY_1, EXPECTED_BINARY_CONTENT_1);
        ...
        final byte[] actualBinaryContent1 =
                validationSupportChain.fetchBinary(EXPECTED_BINARY_KEY_1);
        final byte[] actualBinaryContent2 =
                validationSupportChain.fetchBinary(EXPECTED_BINARY_KEY_2);
    ...
    private static IValidationSupport createMockValidationSupportWithSingleBinary(
        ...
        when(validationSupport1.fetchBinary(expected_binary_key))
                .thenReturn(expected_binary_content);
