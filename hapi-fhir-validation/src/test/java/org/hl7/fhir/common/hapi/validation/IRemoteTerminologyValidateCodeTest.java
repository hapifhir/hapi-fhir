...
public interface IRemoteTerminologyValidateCodeTest extends IValidateCodeTest {
	...
	@Test
	default void createCodeValidationIssues_withCodeSystemOutcome_returnsAsExpected() {
	...
	@Test
	default void createCodeValidationIssues_withValueSetOutcome_returnsAsExpected() {
