...
public class ValidationSupportUtilsTest {
	...
	@Test
	public void extractCodeSystemForCodeR4_nullValueSet_returnsNull() {
		String result = ValidationSupportUtils.extractCodeSystemForCodeR4(null, CODE);

		assertNull(result);
	}

	@Test
	public void extractCodeSystemForCodeR5_nullValueSet_returnsNull() {
		String result = ValidationSupportUtils.extractCodeSystemForCodeR5(null, CODE);
	...
	public void extractCodeSystemForCodeR4_withDifferentValueSetIncludes_returnsCorrectResult(List<ValueSet.ConceptSetComponent> theValueSetComponents,
		...
		// execute
		String result = ValidationSupportUtils.extractCodeSystemForCodeR4(valueSet, CODE);
	...
	public void extractCodeSystemForCodeR5_withDifferentValueSetIncludes_returnsCorrectResult(List<org.hl7.fhir.r5.model.ValueSet.ConceptSetComponent> theValueSetComponents,
		...
		// execute
		String result = ValidationSupportUtils.extractCodeSystemForCodeR5(valueSet, CODE);
