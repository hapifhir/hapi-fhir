...
public class QuestionnaireValidatorDstu3Test {
    private static final Logger ourLog =
            LoggerFactory.getLogger(QuestionnaireValidatorDstu3Test.class);
    ...
    public void testQuestionnaireWithPredefinedExtensionDomainsForCodeableConcept() {
        ...
        for (String extensionDomainToTest : extensionDomainsToTest) {
            ...
            assertThat(
                    ...
                    containsString(
                            "and a coding should come from this value set unless it has no suitable"
                                + " code (note that the validator cannot judge what is suitable)"
                                + " (codes = null#text-box)"));
        }
    }
    ...
    public void testQuestionnaireWithCustomExtensionDomain() {
        ...
        assertThat(
                errors.getMessages().get(0).getMessage(),
                Matchers.startsWith("Unknown extension " + extensionUrl));
