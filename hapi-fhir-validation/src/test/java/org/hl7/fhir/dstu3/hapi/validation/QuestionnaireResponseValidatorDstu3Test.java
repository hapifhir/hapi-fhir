...
public class QuestionnaireResponseValidatorDstu3Test {
    ...
    public void testCodedAnswer() {
        ...
        assertThat(
                errors.toString(),
                containsString(
                        "Unknown code: http://codesystems.com/system / code1 for"
                                + " 'http://codesystems.com/system#code1'"));
        ...
        assertThat(
                errors.toString(),
                containsString("Unknown code 'http://codesystems.com/system2#code3'"));
        assertThat(errors.toString(), containsString("QuestionnaireResponse.item[0].answer[0]"));
    }
    ...
    public void testRequiredQuestionQuantityWithEnableWhenEnablesQuestionValue() {
        ...
        assertThat(
                errors.toString(),
                containsString(" No response answer found for required item 'link1'"));
    }
    ...
    public void testRequiredQuestionCodingWithEnableWhenEnablesQuestionValue() {
        ...
        assertThat(
                errors.toString(),
                containsString(
                        "Item has answer, even though it is not enabled (item id = 'link1')"));
    ...
    public void testRequiredQuestionWithEnableWheHidesRequiredQuestionnHasAnswerFalse() {
        ...
        // link1 should be disabled, because the enableWhen enables it when link0 doesn't haven an
        // answer
        qa.addItem().setLinkId("link0").addAnswer().setValue(new StringType("FOO"));
    ...
    public void testGivenQuestionIsNotEnabledWithEnableWhenButHasItemsWithoutAnswersAreOk2() {
        ...
        assertThat(
                errors.toString(),
                containsString("No response answer found for required item 'link2'"));
    ...
    public void testValidateQuestionnaireResponseWithValueSetChoiceAnswer() {
        ...
        QuestionnaireResponse.QuestionnaireResponseItemComponent basicGroup =
    ...
    public void testOpenchoiceAnswer() {
        ...
        assertThat(
                ...
                containsString(
                        "A code with no system has no defined meaning. A system should be"
                                + " provided"));
        assertThat(
        ...
        assertThat(
                ...
                containsString(
                        "The code provided code1 in the system null) is not in the options value"
                                + " set (ValueSet[http://somevalueset]) in the questionnaire:"
                                + " Validation failed"));
        assertThat(
