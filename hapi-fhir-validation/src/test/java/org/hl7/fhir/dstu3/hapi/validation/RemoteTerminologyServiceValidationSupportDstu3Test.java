...
public class RemoteTerminologyServiceValidationSupportDstu3Test {
    ...
    public void testLookupOperation_CodeSystem_Success() {
        createNextCodeSystemLookupReturnParameters(
                true, CODE_SYSTEM_VERSION, CODE_SYSTEM_VERSION_AS_TEXT, DISPLAY);
    ...
    public void testLookupOperationWithAllParams_CodeSystem_Success() {
        ...
        IValidationSupport.LookupCodeResult outcome =
                mySvc.lookupCode(null, CODE_SYSTEM, CODE, LANGUAGE);
        assertNotNull(outcome, "Call to lookupCode() should return a non-NULL result!");
        assertEquals(DISPLAY, outcome.getCodeDisplay());
        assertEquals(CODE_SYSTEM_VERSION, outcome.getCodeSystemVersion());
        ...
        for (Parameters.ParametersParameterComponent param :
            ...
            if (paramName.equals("result")) {
                ...
                for (org.hl7.fhir.dstu3.model.Parameters.ParametersParameterComponent
                        propertyComponent : param.getPart()) {
                    switch (propertyComponent.getName()) {
                        ...
                        case "value":
                            assertEquals(
                                    "1930-01-01",
                                    ((DateType) propertyComponent.getValue()).asStringValue());
                            break;
                    }
                }
            } else if (paramName.equals("designation")) {
                for (org.hl7.fhir.dstu3.model.Parameters.ParametersParameterComponent
                        designationComponent : param.getPart()) {
    ...
    private void createNextCodeSystemLookupReturnParameters(
        ...
        createNextCodeSystemLookupReturnParameters(
                theResult, theVersion, theVersionAsText, theDisplay, null);
    }
    ...
    private void createNextCodeSystemLookupReturnParameters(
        ...
        myCodeSystemProvider
                ...
                .addParameter()
                .setName("result")
                .setValue(new BooleanType(theResult));
        myCodeSystemProvider
                .myNextReturnParams
                .addParameter()
                .setName("version")
