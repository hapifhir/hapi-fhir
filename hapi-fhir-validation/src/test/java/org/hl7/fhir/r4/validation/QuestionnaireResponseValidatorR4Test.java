...
public class QuestionnaireResponseValidatorR4Test {
    public static final String ID_ICC_QUESTIONNAIRE_SETUP =
            "http://example.com/Questionnaire/profile";
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(QuestionnaireResponseValidatorR4Test.class);
    private static final String CODE_ICC_SCHOOLTYPE_PT = "PT";
    private static final String ID_VS_SCHOOLTYPE = "ValueSet/schooltype";
    private static final String SYSTEMURI_ICC_SCHOOLTYPE =
            "http://ehealthinnovation/icc/ns/schooltype";
    ...
    public void testAnswerWithCorrectType() {
        ...
        when(myValSupport.fetchCodeSystem(eq("http://codesystems.com/system")))
        ...
        options.getCompose()
                ...
                .addConcept()
                .setCode("code0");
        when(myValSupport.fetchResource(eq(ValueSet.class), eq("http://somevalueset")))
                .thenReturn(options);
        ...
        for (int i = 0; i < itemCnt; i++) {
            ...
            QuestionnaireItemComponent questionnaireItemComponent =
                    q.addItem()
                            .setLinkId(linkId)
                            .setRequired(true)
                            .setType(questionnaireItemTypes[i]);
            if (i == 10 || i == 11) {
            ...
            when(myValSupport.fetchResource(eq(Questionnaire.class), eq(qa.getQuestionnaire())))
                    .thenReturn(q);
            when(myValSupport.validateCode(
                            any(), any(), any(), any(), any(), nullable(String.class)))
                    .thenReturn(
                            new IValidationSupport.CodeValidationResult()
                                    .setSeverity(IValidationSupport.IssueSeverity.ERROR)
                                    .setMessage("Unknown code"));
            when(myValSupport.validateCodeInValueSet(
                            any(), any(), any(), any(), any(), nullable(ValueSet.class)))
    ...
    public void testAnswerWithWrongType() {
        ...
        when(myValSupport.fetchResource(
                        eq(Questionnaire.class), eq(qa.getQuestionnaireElement().getValue())))
                .thenReturn(q);
    ...
    public void testCodedAnswer() {
        ...
        q.addItem()
                ...
                .setAnswerValueSet("http://somevalueset");
        when(myValSupport.fetchResource(
                        eq(Questionnaire.class), eq("http://example.com/Questionnaire/q1")))
                .thenReturn(q);

        when(myValSupport.isCodeSystemSupported(any(), eq("http://codesystems.com/system")))
                .thenReturn(true);
        when(myValSupport.isCodeSystemSupported(any(), eq("http://codesystems.com/system2")))
                .thenReturn(true);
        when(myValSupport.validateCode(
                        any(),
                        any(),
                        eq("http://codesystems.com/system"),
                        eq("code0"),
                        any(),
        ...
        when(myValSupport.fetchCodeSystem(eq("http://codesystems.com/system2")))
                .thenReturn(codeSystem2);
        ...
        options.getCompose()
                .addInclude()
                .setSystem("http://codesystems.com/system2")
                .addConcept()
                .setCode("code2");
        when(myValSupport.fetchResource(eq(ValueSet.class), eq("http://somevalueset")))
                .thenReturn(options);
        ...
        qa.addItem()
                .setLinkId("link0")
                .addAnswer()
                .setValue(new Coding().setSystem("http://codesystems.com/system").setCode("code0"));
        ...
        qa.addItem()
                .setLinkId("link0")
                .addAnswer()
                .setValue(new Coding().setSystem("http://codesystems.com/system").setCode("code1"));
        errors = myVal.validateWithResult(qa);
        errors = stripBindingHasNoSourceMessage(errors);
        ourLog.info(errors.toString());
        assertThat(
                errors.toString(),
                containsString("Unknown code for 'http://codesystems.com/system#code1'"));
        ...
        qa.addItem()
                ...
                .addAnswer()
                .setValue(
                        new Coding().setSystem("http://codesystems.com/system2").setCode("code3"));
        errors = myVal.validateWithResult(qa);
        errors = stripBindingHasNoSourceMessage(errors);
        ourLog.info(errors.toString());
        assertThat(
                errors.toString(),
                containsString(
                        "Unknown code 'http://codesystems.com/system2#code3' for"
                                + " 'http://codesystems.com/system2#code3'"));
        assertThat(errors.toString(), containsString("QuestionnaireResponse.item[0].answer[0]"));
    }
    ...
    public void testGroupWithNoLinkIdInQuestionnaireResponse() {
        ...
        assertThat(
                errors.toString(),
                containsString(
                        "QuestionnaireResponse.item.linkId: minimum required = 1, but only found"
                                + " 0"));
    }
    ...
    public void testItemWithNoType() {
        ...
        assertThat(
                errors.toString(),
                containsString("Definition for item link0 does not contain a type"));
    ...
    public void testMissingRequiredQuestion() {
        ...
        assertThat(
                errors.toString(),
                containsString("No response answer found for required item 'link0'"));
    }
    ...
    public void testEmbeddedItemInChoice() {
        ...
        item1.addItem().setLinkId("link11").setType(QuestionnaireItemType.TEXT);
        ...
        when(myValSupport.fetchResource(eq(ValueSet.class), eq(valueSetRef))).thenReturn(options);
        when(myValSupport.validateCode(
                        any(),
                        any(),
                        eq(codeSystemUrl),
        ...
        qa.addItem().setLinkId("link1").addAnswer().addItem().setLinkId("link11");
    ...
    public void testEmbeddedItemInString() {
        ...
        // create the questionnaire
        QuestionnaireItemComponent item1 = new QuestionnaireItemComponent();
        item1.setLinkId("link1").setType(QuestionnaireItemType.TEXT);
    ...
    public void testMissingRequiredAnswer() {
        Questionnaire q = new Questionnaire();
        q.addItem().setLinkId("link0").setType(QuestionnaireItemType.STRING).setRequired(true);
    ...
    public void testOpenchoiceAnswer() {
        ...
        //
        //		qa = new QuestionnaireResponse();
        //		qa.getText().setDiv(new
        // XhtmlNode().setValue("<div>AA</div>")).setStatus(Narrative.NarrativeStatus.GENERATED);
        //		qa.setStatus(QuestionnaireResponseStatus.COMPLETED);
        //		qa.getQuestionnaireElement().setValue(questionnaireRef);
        //		qa.addItem().setLinkId("link0").addAnswer().setValue(new
        // Coding().setSystem("http://codesystems.com/system").setCode("code0"));
        //		errors = myVal.validateWithResult(qa);
        //		errors = stripBindingHasNoSourceMessage(errors);
        ...
        //		qa.getQuestionnaireElement().setValue(questionnaireRef);
        //		qa.addItem().setLinkId("link0").addAnswer().setValue(new
        // Coding().setSystem("http://codesystems.com/system").setCode("code1"));
        //		errors = myVal.validateWithResult(qa);
        //		errors = stripBindingHasNoSourceMessage(errors);
        //		ourLog.info(errors.toString());
        //		assertThat(errors.toString(), containsString("The value provided
        // (http://codesystems.com/system::code1) is not in the options value set in the
        // questionnaire"));
        //		assertThat(errors.toString(),
        // containsString("QuestionnaireResponse.item[0].answer[0]"));
        //
        //		// Partial code
        //
        //		qa = new QuestionnaireResponse();
        ...
        //		qa.getQuestionnaireElement().setValue(questionnaireRef);
        //		qa.addItem().setLinkId("link0").addAnswer().setValue(new
        // Coding().setSystem(null).setCode("code1"));
        //		errors = myVal.validateWithResult(qa);
        //		errors = stripBindingHasNoSourceMessage(errors);
        //		ourLog.info(errors.toString());
        //		assertThat(errors.toString(), containsString("The value provided (null::code1) is not in
        // the options value set in the questionnaire"));
        //		assertThat(errors.toString(),
        // containsString("QuestionnaireResponse.item[0].answer[0]"));
        //
        //		qa = new QuestionnaireResponse();
        ...
        //		qa.getQuestionnaireElement().setValue(questionnaireRef);
        //		qa.addItem().setLinkId("link0").addAnswer().setValue(new
        // Coding().setSystem("").setCode("code1"));
        //		errors = myVal.validateWithResult(qa);
        //		errors = stripBindingHasNoSourceMessage(errors);
        //		ourLog.info(errors.toString());
        //		assertThat(errors.toString(), containsString("The value provided (null::code1) is not in
        ...
        //		qa.getQuestionnaireElement().setValue(questionnaireRef);
        //		qa.addItem().setLinkId("link0").addAnswer().setValue(new
        // Coding().setSystem("http://codesystems.com/system").setCode(null));
        //		errors = myVal.validateWithResult(qa);
        //		ourLog.info(errors.toString());
        //		assertThat(errors.toString(), containsString("The value provided
        // (http://codesystems.com/system::null) is not in the options value set in the
        // questionnaire"));
        //		assertThat(errors.toString(),
        // containsString("QuestionnaireResponse.item[0].answer[0]"));
        ...
        qa.addItem()
                .setLinkId("link0")
                .addAnswer()
                .setValue(new Coding().setSystem("http://system").setCode(null));
        errors = myVal.validateWithResult(qa);
        ourLog.info(errors.toString());
        ...
        assertThat(
                errors.toString(),
                containsString(
                        "ValidationResult{messageCount=1, isSuccessful=false, description='"));
        assertThat(errors.toString(), containsString("QuestionnaireResponse.item[0].answer[0]"));
        ...
        assertThat(
                errors.toString(),
                containsString(
                        "Cannot validate integer answer option because no option list is"
                                + " provided"));
        assertThat(errors.toString(), containsString("QuestionnaireResponse.item[0].answer[0]"));
        ...
        errors = myVal.validateWithResult(qa);
        List<SingleValidationMessage> warningsAndErrors =
                errors.getMessages().stream()
                        .filter(
                                t ->
                                        t.getSeverity().ordinal()
                                                > ResultSeverityEnum.INFORMATION.ordinal())
    ...
    public void testOpenchoiceAnswerWithOptions() {
        ...
        options.add(
                new Questionnaire.QuestionnaireItemAnswerOptionComponent()
                        .setValue(new Coding("http://foo", "foo", "FOOOO")));
        options.add(
                new Questionnaire.QuestionnaireItemAnswerOptionComponent()
                        .setValue(new Coding("http://bar", "bar", "FOOOO")));
        options.add(
                new Questionnaire.QuestionnaireItemAnswerOptionComponent()
                        .setValue(new StringType("Hello")));
        ...
        qa.addItem()
                .setLinkId("link0")
                .addAnswer()
                .setValue(new Coding().setSystem("http://foo").setCode("foo"));
        errors = myVal.validateWithResult(qa);
        ourLog.info(errors.toString());
        ...
        qa.addItem()
                .setLinkId("link0")
                .addAnswer()
                .setValue(new Coding().setSystem("http://foo").setCode("hello"));
        errors = myVal.validateWithResult(qa);
        ourLog.info(errors.toString());
        // This is set in InstanceValidator#validateAnswerCode
    ...
    public void testValidateQuestionnaireResponseWithValueSetChoiceAnswer() {
        ...
        QuestionnaireResponse.QuestionnaireResponseItemComponent basicGroup = qa.addItem();
        basicGroup.setLinkId("basic");
        basicGroup
                .addItem()
                .setLinkId("schoolType")
        ...
        when(myValSupport.fetchResource(eq(ValueSet.class), eq(ID_VS_SCHOOLTYPE)))
                .thenReturn(iccSchoolTypeVs);
        when(myValSupport.validateCodeInValueSet(
                        any(), any(), any(), any(), any(), any(ValueSet.class)))
                .thenReturn(
                        new IValidationSupport.CodeValidationResult()
                                .setCode(CODE_ICC_SCHOOLTYPE_PT));
