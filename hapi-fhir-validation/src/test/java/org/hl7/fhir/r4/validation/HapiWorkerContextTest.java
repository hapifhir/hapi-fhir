...
public class HapiWorkerContextTest extends BaseTest {
	...
	public void testCodeInPrePopulatedValidationSupport() throws IOException {
		...
		getResources("/r4/carin/carin/codesystem/")
					.forEach(t -> prePopulatedValidationSupport.addCodeSystem(t));
		getResources("/r4/carin/uscore/codesystem/")
					.forEach(t -> prePopulatedValidationSupport.addCodeSystem(t));
		getResources("/r4/carin/carin/valueset/")
