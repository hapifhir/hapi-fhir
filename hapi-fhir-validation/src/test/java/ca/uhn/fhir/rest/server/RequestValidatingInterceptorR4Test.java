...
public class RequestValidatingInterceptorR4Test {
	...
	@RegisterExtension static HttpClientExtension ourClient = new HttpClientExtension();
	...
	public void testGraphQlRequestResponse_POST() throws IOException {
		...
		request.setEntity(
					new StringEntity("{\"query\": \"{name}\"}", ContentType.APPLICATION_JSON));
	...
	public void testCreateXmlInvalidNoValidatorsSpecifiedOutcomeHeader() throws Exception {
		...
		assertThat(
					status.toString(),
					containsString("X-FHIR-Request-Validation: {\"resourceType\":\"OperationOutcome"));
	}
