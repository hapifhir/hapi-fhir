...
public class HapiFhirCodeSystemGeneratorTest {
    ...
    public static final String HAPI_FHIR_STORAGE_RESPONSE_CODE_JSON =
            "HapiFhirStorageResponseCode.json";
    public static final FhirContext ourCtx = FhirContext.forR5Cached();
    private static final Logger ourLog =
            LoggerFactory.getLogger(HapiFhirCodeSystemGeneratorTest.class);
