	...
	public class QuantitySearch {
		...
		public class SimpleQueries {
				...
				public void noQuantityThrows() {
					...
					DataFormatException thrown =
								assertThrows(
										DataFormatException.class,
										() ->
													myTestDaoSearch.searchForIds(
																"/Observation?value-quantity=" + invalidQtyParam));
				...
				public void invalidPrefixThrows() {
					DataFormatException thrown =
								assertThrows(
										...
										() ->
													myTestDaoSearch.searchForIds(
																"/Observation?value-quantity=st5.35"));
				...
				public void eq() {
					...
					assertNotFind(
								"when wrong system", "/Observation?value-quantity=0.6|http://another.org");
		...
		public class CombinedQueries {
				...
				void gtAndLt() {
					...
					assertFind(
								"when gt0.5 and lt0.7",
								"/Observation?value-quantity=gt0.5&value-quantity=lt0.7");
					assertNotFind(
								"when gt0.5 and lt0.6",
								"/Observation?value-quantity=gt0.5&value-quantity=lt0.6");
					assertNotFind(
								"when gt6.5 and lt0.7",
								"/Observation?value-quantity=gt6.5&value-quantity=lt0.7");
					assertNotFind(
								"impossible matching",
								"/Observation?value-quantity=gt0.7&value-quantity=lt0.5");
				}
				...
				public class QualifiedOrClauses {
					...
					void gtOrLt() {
						...
						assertNotFind(
									"when gt0.7 or lt0.55", "/Observation?value-quantity=gt0.7,lt0.55");
					}
					...
					void gtOrLe() {
						...
						assertNotFind(
									"when gt0.7 or le0.55", "/Observation?value-quantity=gt0.7,le0.55");
					}
					...
					void geOrGe() {
						...
						assertNotFind(
									"when ge0.65 or ge0.7", "/Observation?value-quantity=ge0.65,ge0.7");
					}
					...
					void ltOrLt() {
						...
						assertNotFind(
									"when lt0.55 or lt0.3", "/Observation?value-quantity=lt0.55,lt0.3");
					}
					...
					void leOrLe() {
						...
						assertNotFind(
									"when le0.5 or le0.59", "/Observation?value-quantity=le0.5,le0.59");
					}
				}
				...
				void testMultipleComponentsHandlesAndOr() {
					...
					{
						String theUrl =
									"/Observation?component-value-quantity=107&component-value-quantity=60";
					...
					{
						String theUrl =
									"/Observation?component-value-quantity=107&component-value-quantity=260";
						List<String> resourceIds = myTestDaoSearch.searchForIds(theUrl);
					...
					{
						String theUrl =
									"/Observation?component-value-quantity=107&component-value-quantity=gt50,lt70";
						List<String> resourceIds = myTestDaoSearch.searchForIds(theUrl);
						assertThat(
					...
					{
						String theUrl =
									"/Observation?component-value-quantity=50,70&component-value-quantity=260";
						List<String> resourceIds = myTestDaoSearch.searchForIds(theUrl);
					...
					{
						String theUrl =
									"/Observation?component-value-quantity=50,60&component-value-quantity=105,107";
						List<String> resourceIds = myTestDaoSearch.searchForIds(theUrl);
						assertThat(
					...
					{
						String theUrl =
									"/Observation?component-value-quantity=50,60&component-value-quantity=250,260";
						List<String> resourceIds = myTestDaoSearch.searchForIds(theUrl);
						assertThat(
									"when same component with qtys 50,60 and 250,260",
									resourceIds,
									empty());
					}
				}
		...
		public class Sorting {
				...
				public void sortByNumeric() {
					...
					List<String> allIds =
								myTestDaoSearch.searchForIds("/Observation?_sort=value-quantity");
		...
		public class CorrelatedQueries {
				...
				public void unitsMustMatch() {
					...
					assertFind(
								"correct units matches value",
								"/Observation?component-value-quantity=42||cats");
					assertNotFind(
		...
		public class SpecTestCases {
				...
				void specCase2() {
					...
					assertFindIds(
								"when le", Set.of(id2, id3, id4), "/Observation?value-quantity=5.40e-3");
				}
	...
	public class QuantityNormalizedSearch {
		...
		public class SimpleQueries {
				...
				public void ne() {
					...
					assertFind(
								"when lt UCUM",
								"/Observation?value-quantity=ne70|" + UCUM_CODESYSTEM_URL + "|10*3/L");
					assertFind(
								"when gt UCUM",
								"/Observation?value-quantity=ne50|" + UCUM_CODESYSTEM_URL + "|10*3/L");
					assertNotFind(
								"when eq UCUM",
								"/Observation?value-quantity=ne60|" + UCUM_CODESYSTEM_URL + "|10*3/L");
				}
				...
				public void eq() {
					...
					assertFind(
								"when eq UCUM 10*3/L ",
								"/Observation?value-quantity=60|" + UCUM_CODESYSTEM_URL + "|10*3/L");
					assertFind(
								"when eq UCUM 10*9/L",
					...
					assertNotFind(
								"when ne UCUM 10*3/L",
								"/Observation?value-quantity=80|" + UCUM_CODESYSTEM_URL + "|10*3/L");
					assertNotFind(
								"when gt UCUM 10*3/L",
								"/Observation?value-quantity=50|" + UCUM_CODESYSTEM_URL + "|10*3/L");
					assertNotFind(
								"when lt UCUM 10*3/L",
								"/Observation?value-quantity=70|" + UCUM_CODESYSTEM_URL + "|10*3/L");

					assertFind(
								"Units required to match and do",
								"/Observation?value-quantity=60000|" + UCUM_CODESYSTEM_URL + "|/L");
					// request generates a quantity which value matches the "value-norm", but not the
					// "code-norm"
					assertNotFind(
				...
				public void ap() {
					...
					assertNotFind(
								"when gt UCUM",
								"/Observation?value-quantity=ap50|" + UCUM_CODESYSTEM_URL + "|10*3/L");
					assertFind(
								"when little gt UCUM",
								"/Observation?value-quantity=ap58|" + UCUM_CODESYSTEM_URL + "|10*3/L");
					assertFind(
								"when eq UCUM",
								"/Observation?value-quantity=ap60|" + UCUM_CODESYSTEM_URL + "|10*3/L");
					assertFind(
								"when a little lt UCUM",
								"/Observation?value-quantity=ap63|" + UCUM_CODESYSTEM_URL + "|10*3/L");
					assertNotFind(
								"when lt UCUM",
								"/Observation?value-quantity=ap71|" + UCUM_CODESYSTEM_URL + "|10*3/L");
				}
				...
				public void gt() {
					...
					assertFind(
								"when gt UCUM",
								"/Observation?value-quantity=gt50|" + UCUM_CODESYSTEM_URL + "|10*3/L");
					assertNotFind(
								"when eq UCUM",
								"/Observation?value-quantity=gt60|" + UCUM_CODESYSTEM_URL + "|10*3/L");
					assertNotFind(
								"when lt UCUM",
								"/Observation?value-quantity=gt71|" + UCUM_CODESYSTEM_URL + "|10*3/L");
				}
				...
				public void ge() {
					...
					assertFind(
								"when gt UCUM",
								"/Observation?value-quantity=ge50|" + UCUM_CODESYSTEM_URL + "|10*3/L");
					assertFind(
								"when eq UCUM",
								"/Observation?value-quantity=ge60|" + UCUM_CODESYSTEM_URL + "|10*3/L");
					assertNotFind(
								"when lt UCUM",
								"/Observation?value-quantity=ge62|" + UCUM_CODESYSTEM_URL + "|10*3/L");
				}
				...
				public void lt() {
					...
					assertNotFind(
								"when gt",
								"/Observation?value-quantity=lt50|" + UCUM_CODESYSTEM_URL + "|10*3/L");
					assertNotFind(
								"when eq",
								"/Observation?value-quantity=lt60|" + UCUM_CODESYSTEM_URL + "|10*3/L");
					assertFind(
								"when lt",
								"/Observation?value-quantity=lt70|" + UCUM_CODESYSTEM_URL + "|10*3/L");
				}
				...
				public void le() {
					...
					assertNotFind(
								"when gt",
								"/Observation?value-quantity=le50|" + UCUM_CODESYSTEM_URL + "|10*3/L");
					assertFind(
								"when eq",
								"/Observation?value-quantity=le60|" + UCUM_CODESYSTEM_URL + "|10*3/L");
					assertFind(
								"when lt",
								"/Observation?value-quantity=le70|" + UCUM_CODESYSTEM_URL + "|10*3/L");
				}

				/**
				 * "value-quantity" data is stored in a nested object, so if not queried properly it
				 * could return false positives. For instance: two Observations for following
				 * combinations of code and value: Obs 1 code AAA1 value: 123 Obs 2 code BBB2 value: 456
				 * A search for code: AAA1 and value: 456 would bring both observations instead of the
				 * expected empty reply, unless both predicates are enclosed in a "nested"
				 */
				@Test
		...
		public class CombinedQueries {
				...
				public void multipleSearchParamsAreSeparate() {
					// for debugging
					//	myLogbackLevelOverrideExtension.setLogLevel(DaoTestDataBuilder.class,
					// Level.DEBUG);

					// this configuration must generate a combo-value-quantity entry with both quantity
					// objects
					myResourceId =
								createObservation(
										List.of(
					...
					assertFind(
								"by value",
								"Observation?value-quantity=0.02|" + UCUM_CODESYSTEM_URL + "|10*6/L");
					assertFind(
								"by component value",
								"Observation?component-value-quantity=0.06|"
										+ UCUM_CODESYSTEM_URL
										+ "|10*6/L");

					assertNotFind(
								"by value",
								"Observation?value-quantity=0.06|" + UCUM_CODESYSTEM_URL + "|10*6/L");
					assertNotFind(
								"by component value",
								"Observation?component-value-quantity=0.02|"
										+ UCUM_CODESYSTEM_URL
										+ "|10*6/L");
				}
		}
				...
				public void sortByNumeric() {
					String idAlpha1 =
								withObservationWithQuantity(0.06, UCUM_CODESYSTEM_URL, "10*6/L")
										.getIdPart(); // 60,000
					String idAlpha2 =
								withObservationWithQuantity(50, UCUM_CODESYSTEM_URL, "10*3/L")
										.getIdPart(); // 50,000
					String idAlpha3 =
								withObservationWithQuantity(0.000070, UCUM_CODESYSTEM_URL, "10*9/L")
										.getIdPart(); // 70_000
