...
public class HapiEmbeddedDatabasesExtension implements AfterAllCallback {
    ...
    private static final Logger ourLog =
            LoggerFactory.getLogger(HapiEmbeddedDatabasesExtension.class);
    ...
    public HapiEmbeddedDatabasesExtension() {
        ...
        if (canUseOracle()) {
            ...
            String message =
                    "Cannot add OracleEmbeddedDatabase. If you are using a Mac you must configure"
                        + " the TestContainers API to run using Colima"
    ...
    public void initializePersistenceSchema(DriverTypeEnum theDriverType) {
        ...
        String fileName =
                String.format(
                        ...
                        FIRST_TESTED_VERSION, embeddedDatabase.getDriverType());
