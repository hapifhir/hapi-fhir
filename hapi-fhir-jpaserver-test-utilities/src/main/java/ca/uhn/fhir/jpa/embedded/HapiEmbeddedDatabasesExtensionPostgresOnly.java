...
public class HapiEmbeddedDatabasesExtensionPostgresOnly implements AfterAllCallback {

	public static final VersionEnum FIRST_TESTED_VERSION = VersionEnum.V5_1_0;

	private static final Logger ourLog = LoggerFactory.getLogger(HapiEmbeddedDatabasesExtensionPostgresOnly.class);
	...
	public HapiEmbeddedDatabasesExtensionPostgresOnly() {
