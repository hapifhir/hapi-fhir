 ...
 * <br>
 * Embedded database that uses a {@link ca.uhn.fhir.jpa.migrate.DriverTypeEnum#H2_EMBEDDED} driver
 * and a .h2 file in the target directory.
 */
        ...
        if (directory.exists()) {
            try {
                ...
                throw new RuntimeException(
                        "Could not delete database directory: " + DATABASE_DIRECTORY);
            }
        }
    }
