...
public class SocketImplementation {
	...
	private static final Logger ourLog =
				org.slf4j.LoggerFactory.getLogger(SocketImplementation.class);
	...
	/**
	* This method is executed when the client is connecting to the server. In this case, we are
	* sending a message to create the subscription dynamically
	*
	* @param session
	*/
	@OnWebSocketConnect
