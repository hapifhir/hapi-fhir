...
public class ZipCollectionBuilder {
	...
	public void addFilePlain(String theClasspathPrefix, String theClasspathFileName)
				throws IOException {
	...
	public void addFileZip(String theClasspathPrefix, String theClasspathFileName)
				throws IOException {
		addFileZip(theClasspathPrefix, theClasspathFileName, theClasspathFileName);
	}

	public void addFileZip(
				String theClasspathPrefix, String theClasspathFileName, String theOutputFilename)
				throws IOException {
	...
	public void addPropertiesZip(Properties properties, String theOutputFilename)
				throws IOException {
