...
public class TestJPAConfig {
	...
	@Bean
	public TerminologyTestHelper terminologyTestHelper(IJobPersistence theJobPersistence, IJobCoordinator theJobCoordinator, Batch2JobHelper theBatch2JobHelper, MemoryCacheService theMemoryCacheSvc, IValidationSupport theValidationSupport, ITermDeferredStorageSvc theTermDeferredStorageSvc) {
		return new TerminologyTestHelper(theJobPersistence, theJobCoordinator, theBatch2JobHelper, theMemoryCacheSvc, theValidationSupport, theTermDeferredStorageSvc);
	}
