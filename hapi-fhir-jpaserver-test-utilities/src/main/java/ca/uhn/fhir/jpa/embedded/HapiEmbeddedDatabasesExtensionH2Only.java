...
public class HapiEmbeddedDatabasesExtensionH2Only implements AfterAllCallback {

	public static final VersionEnum FIRST_TESTED_VERSION = VersionEnum.V5_1_0;

	private static final Logger ourLog = LoggerFactory.getLogger(HapiEmbeddedDatabasesExtensionH2Only.class);
	...
	public HapiEmbeddedDatabasesExtensionH2Only() {
