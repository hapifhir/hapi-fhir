...
public abstract class BaseSearchQueryBuilderDialectTest {
    ...
    private static final Logger ourLog =
            LoggerFactory.getLogger(BaseSearchQueryBuilderDialectTest.class);
    protected final FhirContext myFhirContext = FhirContext.forR4Cached();
    @Mock protected SqlObjectFactory mySqlObjectFactory;
    @Mock protected HibernatePropertiesProvider myHibernatePropertiesProvider;
    ...
    protected GeneratedSql buildSqlWithNumericSort(
        ...
        Condition hashIdentityPredicate =
                sortPredicateBuilder.createHashIdentityPredicate(
        ...
        if (theNullOrder == null) {
            searchQueryBuilder.addSortNumeric(
                    sortPredicateBuilder.getColumnValueLow(), theAscending);
        } else {
            searchQueryBuilder.addSortNumeric(
