...
public class ReindexStepTest extends BaseJpaR4Test {
	...
	public void testReindex_NoActionNeeded() {
		...
		data.getIds().add(new ResourceIdListWorkChunk.Id().setResourceType("Patient").setId(id0.toString()));
		data.getIds().add(new ResourceIdListWorkChunk.Id().setResourceType("Patient").setId(id1.toString()));
	...
	public void testReindex_OneResourceReindexFailedButOthersSucceeded() {
		...
		data.getIds().add(new ResourceIdListWorkChunk.Id().setResourceType("Patient").setId(id0.toString()));
		data.getIds().add(new ResourceIdListWorkChunk.Id().setResourceType("Patient").setId(id1.toString()));
		data.getIds().add(new ResourceIdListWorkChunk.Id().setResourceType("Patient").setId(idPatientToInvalidate.toString()));
		data.getIds().add(new ResourceIdListWorkChunk.Id().setResourceType("Observation").setId(idObservation.toString()));
