...
class Batch2JobHelperTest {
    ...
    @Mock IJobMaintenanceService myJobMaintenanceService;
    @Mock IJobCoordinator myJobCoordinator;

    @InjectMocks Batch2JobHelper myBatch2JobHelper;
