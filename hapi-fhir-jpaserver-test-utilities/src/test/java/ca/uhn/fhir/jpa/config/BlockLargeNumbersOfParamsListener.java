 ...
 *
 * <p>Oracle chokes on queries that have more than 1000 parameters. We have stress tests that do
 * giant queries, so this is here to cause a failure if these result in lots of bound parameters
 * that would cause a failure in oracle. By default these don't cause issues in Derby which is why
