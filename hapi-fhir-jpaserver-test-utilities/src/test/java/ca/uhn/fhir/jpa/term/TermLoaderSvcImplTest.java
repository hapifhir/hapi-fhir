...
class TermLoaderSvcImplTest {
	...
	@Mock
	private ITermDeferredStorageSvc theDeferredStorageSvc;

	@Mock
	private ITermCodeSystemStorageSvc theCodeSystemStorageSvc;

	@Mock
	private LoadedFileDescriptors theDescriptors;

	@Mock
	private RequestDetails theRequestDetails;

	@Mock
	private Properties theUploadProperties;

	@Mock
	private LoincXmlFileZipContentsHandler myZipContentsHandler;
	...
	public static final String versionedLoinXmlsString =
			"<CodeSystem xmlns=\"http://hl7.org/fhir\">" + "	<id value=\"loinc\"/>"
	...
	void loadLoincWithoutLoincXmlFileThrows() {
		InvalidRequestException thrown = assertThrows(
				...
				() -> testedClass.processLoincFiles(theDescriptors, theRequestDetails, theUploadProperties, true));
