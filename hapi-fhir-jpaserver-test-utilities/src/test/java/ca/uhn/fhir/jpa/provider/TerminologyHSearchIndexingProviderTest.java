...
public class TerminologyHSearchIndexingProviderTest {
	...
	public void testNoSearchEnabled() throws InterruptedException {
		...
		Optional<String> successValueOpt =
				ParametersUtil.getNamedParameterValueAsString(myContext, retVal, RESP_PARAM_SUCCESS);
	...
	void testServiceThrows() throws InterruptedException {
		...
		InternalErrorException thrown =
				assertThrows(InternalErrorException.class, () -> testedProvider.reindexTerminology(myRequestDetails));

		assertTrue(thrown.getMessage()
				.startsWith(Msg.code(2072) + "Re-creating terminology freetext indexes " + "failed with exception: "
						+ exceptionMsg));
	}
}
