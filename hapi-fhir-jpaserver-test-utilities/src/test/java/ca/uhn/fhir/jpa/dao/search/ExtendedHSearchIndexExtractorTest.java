...
class ExtendedHSearchIndexExtractorTest implements ITestDataBuilder.WithSupport {
    ...
    FhirContextSearchParamRegistry mySearchParamRegistry =
            new FhirContextSearchParamRegistry(myFhirContext);
    SearchParamExtractorR4 mySearchParamExtractor =
            new SearchParamExtractorR4(
                    myJpaStorageSettings,
    ...
    void testExtract_composite_producesValues() {
        ...
        ResourceIndexedSearchParamComposite composite =
                new ResourceIndexedSearchParamComposite(
        ...
        composite.addComponentIndexedSearchParams(
                "component-code", RestSearchParameterTypeEnum.TOKEN, codeParams);
        ...
        ResourceSearchParams activeSearchParams =
                mySearchParamRegistry.getActiveSearchParams("Observation");
        ExtendedHSearchIndexExtractor extractor =
                new ExtendedHSearchIndexExtractor(
                        myJpaStorageSettings,
                        myFhirContext,
                        activeSearchParams,
    ...
    void testExtract_withParamMarkedAsMissing_willBeIgnored() {
        ...
        ResourceIndexedSearchParamDate searchParamDate =
                new ResourceIndexedSearchParamDate(
                        new PartitionSettings(),
                        "SearchParameter",
                        "Date",
                        null,
        ...
        ResourceIndexedSearchParamQuantity searchParamQuantity =
                new ResourceIndexedSearchParamQuantity(
        ...
        // run: now translate to HSearch
        ResourceSearchParams activeSearchParams =
                mySearchParamRegistry.getActiveSearchParams("Patient");
        ExtendedHSearchIndexExtractor extractor =
                new ExtendedHSearchIndexExtractor(
                        myJpaStorageSettings,
                        myFhirContext,
