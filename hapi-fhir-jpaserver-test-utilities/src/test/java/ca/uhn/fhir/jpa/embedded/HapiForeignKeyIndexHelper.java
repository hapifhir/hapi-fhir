...
public class HapiForeignKeyIndexHelper {
	...
	public void ensureAllForeignKeysAreIndexed(PostgresEmbeddedDatabase theDatabase) throws SQLException {
		List<Map<String, Object>> results = theDatabase.query(FK_QUERY);
