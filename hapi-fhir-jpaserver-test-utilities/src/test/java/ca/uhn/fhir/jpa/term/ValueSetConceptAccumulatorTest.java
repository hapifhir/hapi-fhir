...
public class ValueSetConceptAccumulatorTest {
	...
	@Mock private ITermValueSetDao myValueSetDao;
	@Mock private ITermValueSetConceptDesignationDao myValueSetDesignationDao;
	@Mock private ITermValueSetConceptDao myValueSetConceptDao;
	...
	public void testExcludeConceptWithDesignations() {
		for (int i = 0; i < 1000; i++) {
				...
				when(myValueSetConceptDao.findByTermValueSetIdSystemAndCode(
									any(), eq("sys"), eq("code" + i)))
