...
public class PackageInstallationSpecTest {
	...
	void jsonSerializationWithVersionPolicy(PackageInstallationSpec.VersionPolicyEnum theVersionPolicy) throws Exception {
	...
	void jsonDeserializationWithVersionPolicy(
