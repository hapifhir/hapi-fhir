...
public class ResourceLinkPredicateBuilderTest {
    ...
    @Mock private SearchQueryBuilder mySearchQueryBuilder;
    ...
    public void init() {
        ...
        myResourceLinkPredicateBuilder =
                new ResourceLinkPredicateBuilder(null, mySearchQueryBuilder, false);
    }
    ...
    public void createEverythingPredicate_withListOfPids_returnsInPredicate() {
        ...
        Condition condition =
                myResourceLinkPredicateBuilder.createEverythingPredicate(
                        "Patient", new ArrayList<>(), 1l, 2l);
    ...
    public void createEverythingPredicate_withNoPids_returnsBinaryCondition() {
        Condition condition =
                myResourceLinkPredicateBuilder.createEverythingPredicate(
                        "Patient", new ArrayList<>(), new Long[0]);
        assertEquals(BinaryCondition.class, condition.getClass());
    }
}
