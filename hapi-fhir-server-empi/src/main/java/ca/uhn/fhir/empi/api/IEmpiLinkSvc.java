...
public interface IEmpiLinkSvc {
	 ...
	 */
	void updateLink(IAnyResource thePerson, IAnyResource theTargetResource, EmpiMatchResult theMatchResult, EmpiLinkSourceEnum theLinkSource, EmpiTransactionContext theEmpiTransactionContext);
