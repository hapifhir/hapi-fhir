...
class HapiErrorCodeCheckTest {
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(HapiErrorCodeCheckTest.class);
    ...
    public void testExpectedErrors() throws CheckstyleException {
        ...
        assertThat(
                errorLines[0],
                endsWith(
                        "BadClass.java:7: Exception thrown that does not call Msg.code()"
                                + " [HapiErrorCode]"));
        assertThat(errorLines[1], startsWith("[ERROR] "));
        assertThat(
                errorLines[1],
                containsString("Two different exception messages call Msg.code(2258)."));
        assertThat(
                errorLines[2],
                containsString(
    ...
    private Checker buildChecker() throws CheckstyleException {
        ...
        DefaultConfiguration childConf =
                new DefaultConfiguration("ca.uhn.fhir.checks.HapiErrorCodeCheck");
