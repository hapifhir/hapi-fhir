...
public class BaseDstu21Config extends BaseConfig {
	...
	public SystemProviderDstu21 systemProviderDstu21() {
		SystemProviderDstu21 retVal = new SystemProviderDstu21();
		retVal.setSystemDaoFactory(fhirDaoFactory());
		return retVal;
	}
	
	// DAO Factory gets wired from DAO implementation bundle
	@Resource(name="myDaoFactoryDstu21")
	private IDaoFactory myDaoFactoryDstu21;
