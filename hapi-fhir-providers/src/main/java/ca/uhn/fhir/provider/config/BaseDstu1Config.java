...
public class BaseDstu1Config extends BaseConfig {
	...
	public SystemProviderDstu1 systemProviderDstu1() {
		SystemProviderDstu1 retVal = new SystemProviderDstu1();
		retVal.setSystemDaoFactory(fhirDaoFactory());
		return retVal;
	}
	
	// DAO Factory gets wired from DAO implementation bundle
	@Resource(name="myDaoFactoryDstu1")
	private IDaoFactory myDaoFactoryDstu1;
