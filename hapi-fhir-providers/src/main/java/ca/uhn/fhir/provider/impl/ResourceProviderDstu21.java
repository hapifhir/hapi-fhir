...
public class ResourceProviderDstu21<T extends IResource> extends BaseResourceProvider<T> {
	...
	public ResourceProviderDstu21() {
		// nothing
	}

	@CoverageIgnore
	public ResourceProviderDstu21(IDaoFactory theDaoFactory) {
		super(theDaoFactory);
	}
