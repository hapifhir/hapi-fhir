...
public class BinaryHl7OrgDstu2Test {
    ...
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(BinaryHl7OrgDstu2Test.class);
    ...
    public void testReadWithExplicitTypeXml() throws Exception {
        ...
        assertThat(
                status.getFirstHeader("content-type").getValue(),
    ...
    public void testSearchJson() throws Exception {
        ...
        org.hl7.fhir.dstu2.model.Bundle bundle =
                ourCtx.newJsonParser()
                        .parseResource(org.hl7.fhir.dstu2.model.Bundle.class, responseContent);
