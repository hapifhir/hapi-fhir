...
public class TransactionWithBundleResourceParamHl7OrgDstu2Test {
    ...
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(
                    TransactionWithBundleResourceParamHl7OrgDstu2Test.class);
    ...
    public void testConformance() {
        ...
        Conformance rest =
                client.fetchConformance().ofType(Conformance.class).prettyPrint().execute();
    ...
    public void testTransactionWithXmlRequest() throws Exception {
        ...
        httpPost.setEntity(
                new StringEntity(bundleString, ContentType.create(Constants.CT_FHIR_XML, "UTF-8")));
    ...
    public void testTransactionWithJsonRequest() throws Exception {
        ...
        httpPost.setEntity(
                new StringEntity(
                        bundleString, ContentType.create(Constants.CT_FHIR_JSON, "UTF-8")));
        HttpResponse status = ourClient.execute(httpPost);
        String responseContent = IOUtils.toString(status.getEntity().getContent());
        IOUtils.closeQuietly(status.getEntity().getContent());
    ...
    public static class DummyProvider {
        ...
        public Bundle transaction(@TransactionParam Bundle theResources) {
            ...
            for (BundleEntryComponent nextEntry : theResources.getEntry()) {
                ...
                String newIdDt =
                        new IdType("Patient", newId, "9" + Integer.toString(index)).getValue();
