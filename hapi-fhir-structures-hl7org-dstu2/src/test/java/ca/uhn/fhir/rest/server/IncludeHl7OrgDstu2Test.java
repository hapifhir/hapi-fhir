...
public class IncludeHl7OrgDstu2Test {
	...
	public void testIIncludedResourcesNonContained() throws Exception {
		...
		assertEquals(
				new IdType("Patient/p1"),
				bundle.getEntry().get(0).getResource().getIdElement().toUnqualifiedVersionless());
		assertEquals(
				new IdType("Patient/p2"),
				bundle.getEntry().get(1).getResource().getIdElement().toUnqualifiedVersionless());
		assertEquals(
				new IdType("Organization/o1"),
				bundle.getEntry().get(2).getResource().getIdElement().toUnqualifiedVersionless());
		assertEquals(
				SearchEntryMode.INCLUDE, bundle.getEntry().get(2).getSearch().getMode());
	...
	public void testIIncludedResourcesNonContainedInDeclaredExtension() throws Exception {
		...
		assertEquals(
				...
				bundle.getEntry().get(2).getResource().getIdElement().toUnqualifiedVersionless());
		assertEquals(
				new IdType("Organization/o2"),
				bundle.getEntry().get(3).getResource().getIdElement().toUnqualifiedVersionless());
		assertEquals(
				SearchEntryMode.INCLUDE, bundle.getEntry().get(2).getSearch().getMode());
		assertEquals(
				SearchEntryMode.INCLUDE, bundle.getEntry().get(3).getSearch().getMode());
