...
public class ETagClientTest {
    ...
    private String getResourceResult() {
        return "<Patient xmlns=\"http://hl7.org/fhir\"><id value=\"123\"/><meta><versionId"
                + " value=\"4444\"/></meta><text><status value=\"generated\" /><div"
    ...
    public void testReadWithETag() throws Exception {
        ...
        Patient response =
                client.read().resource(Patient.class).withId(new IdDt("Patient/1234")).execute();
        assertThat(
                response.getName().get(0).getFamily().get(0).getValue(),
