...
public class GenericClientDstu2Hl7OrgTest {
    ...
    public void testReadUpdatedHeaderDoesntOverwriteResourceValue() throws Exception {
        ...
        assertEquals(
                ...
                response.getMeta().getLastUpdatedElement().getValueAsString());
    }
    ...
    public void testTransactionWithListOfResources() throws Exception {
        ...
        List<IBaseResource> response =
                client.transaction().withResources(input).encodedJson().execute();
        // @formatter:on
        ...
        org.hl7.fhir.dstu2.model.Bundle requestBundle =
                ourCtx.newJsonParser()
                        .parseResource(org.hl7.fhir.dstu2.model.Bundle.class, requestString);
    ...
    public void testDeleteConditional() throws Exception {
        ...
        client.delete()
                ...
                .where(new StringClientParam("name").matches().value("foo"))
                .execute();
        assertEquals("DELETE", capt.getAllValues().get(idx).getMethod());
        assertEquals(
                "http://example.com/fhir/Patient?name=foo",
    ...
    public void testUpdateConditional() throws Exception {
        ...
        client.update()
                ...
                .conditional()
                .where(new StringClientParam("name").matches().value("foo"))
                .and(new StringClientParam("address").matches().value("AAA|BBB"))
                .encodedXml()
                .execute();
        assertEquals(
                1, capt.getAllValues().get(idx).getHeaders(Constants.HEADER_CONTENT_TYPE).length);
