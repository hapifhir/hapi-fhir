...
public class MyObservationWithExtensions extends Patient {
    ...
    /**
     * Block class for child element: <b>Observation.referenceRange</b> (Provides guide for
     * interpretation)
     *
     * <p><b>Definition:</b> Guidance on how to interpret the value by comparison to a normal or
     * recommended range
     */
