...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="//f:StructureDefinition">
      ...
      <sch:assert test="not(exists(constrainedType)) or f:url/@value=concat('http://hl7.org/fhir/StructureDefinition/', f:name/@value)">sdf-7: If the type is Resource or Type, the url has to start with &quot;http://hl7.org/fhir/StructureDefinition/&quot; and the tail must match the name</sch:assert>
      ...
      <sch:assert test="not(f:constrainedType/@value = 'extension') or (exists(f:context) and exists(f:contextType))">sdf-5: If the type is 'extension' then the structure must have context information</sch:assert>
