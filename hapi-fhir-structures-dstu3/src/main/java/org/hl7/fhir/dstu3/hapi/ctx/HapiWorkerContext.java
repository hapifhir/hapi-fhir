...
public final class HapiWorkerContext extends I18nBase implements IWorkerContext {
    ...
    @Override
    public ValueSetExpansionComponent expandVS(
            ...
            try {
                ...
                return (T)
                        myFetchedResourceCache.get(
                                ...
                                t -> {
                                    T resource =
                                            myValidationSupport.fetchResource(theClass, theUri);
                                    if (resource == null) {
    ...
    @Override
    public <T extends Resource> T fetchResourceWithException(Class<T> theClass_, String theUri)
    ...
    public ValueSetExpander.ValueSetExpansionOutcome expandVS(
            ValueSet source, boolean cacheOk, boolean heiarchical) {
