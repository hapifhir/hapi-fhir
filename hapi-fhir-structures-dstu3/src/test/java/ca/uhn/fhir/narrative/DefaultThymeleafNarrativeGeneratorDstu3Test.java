...
public class DefaultThymeleafNarrativeGeneratorDstu3Test {
	...
	public void testGenerateDiagnosticReport() throws DataFormatException {
		...
		assertThat(
				output,
				StringContains.containsString(value.getCode().getTextElement().getValue()));
	}
	...
	public void testDiagnosticReport() {
		...
		assertThat(
				output,
				StringContains.containsString("<div class=\"hapiHeaderText\"> Untitled Diagnostic Report </div>"));
	}
