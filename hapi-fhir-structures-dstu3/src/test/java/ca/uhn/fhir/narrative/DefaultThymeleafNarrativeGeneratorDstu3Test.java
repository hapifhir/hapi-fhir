...
public class DefaultThymeleafNarrativeGeneratorDstu3Test {
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(DefaultThymeleafNarrativeGeneratorDstu3Test.class);
    ...
    public void testGeneratePatient() throws DataFormatException {
        ...
        assertThat(
                ...
                StringContains.containsString(
                        "<div class=\"hapiHeaderText\">joe john <b>BLOW </b></div>"));
    }

    @Test
    public void testTranslations() throws DataFormatException {
        CustomThymeleafNarrativeGenerator customGen =
                new CustomThymeleafNarrativeGenerator("classpath:/testnarrative.properties");
        ...
        customGen.setMessageResolver(
                new StandardMessageResolver() {
                    @Override
    ...
    public void testGenerateDiagnosticReport() throws DataFormatException {
        ...
        ourLog.info(output);
        assertThat(
                output, StringContains.containsString(value.getCode().getTextElement().getValue()));
    }
    ...
    public void testGenerateOperationOutcome() {
        ...
        String parse =
                "<OperationOutcome xmlns=\"http://hl7.org/fhir\">\n"
                    ...
                    + "      <diagnostics"
                    + " value=\"ca.uhn.fhir.rest.server.exceptions.InternalErrorException: Failed"
                    + " to call access"
                    + " method&#xa;&#xa;ca.uhn.fhir.rest.server.exceptions.InternalErrorException:"
                    + " Failed to call access method&#xa;&#x9;at"
                    + " ca.uhn.fhir.rest.method.BaseMethodBinding.invokeServerMethod(BaseMethodBinding.java:199)&#xa;&#x9;at"
                    + " ca.uhn.fhir.rest.method.HistoryMethodBinding.invokeServer(HistoryMethodBinding.java:162)&#xa;&#x9;at"
                    + " ca.uhn.fhir.rest.method.BaseResourceReturningMethodBinding.invokeServer(BaseResourceReturningMethodBinding.java:228)&#xa;&#x9;at"
                    + " ca.uhn.fhir.rest.method.HistoryMethodBinding.invokeServer(HistoryMethodBinding.java:1)&#xa;&#x9;at"
                    + " ca.uhn.fhir.rest.server.RestfulServer.handleRequest(RestfulServer.java:534)&#xa;&#x9;at"
                    + " ca.uhn.fhir.rest.server.RestfulServer.doGet(RestfulServer.java:141)&#xa;&#x9;at"
                    ...
                    + " ca.uhn.fhir.rest.method.BaseMethodBinding.invokeServerMethod(BaseMethodBinding.java:194)&#xa;&#x9;..."
                    + " 40 more&#xa;Caused by: java.lang.NumberFormatException: For input string:"
                    + " &quot;3cb9a027-9e02-488d-8d01-952553d6be4e&quot;&#xa;&#x9;at"
                    + " java.lang.NumberFormatException.forInputString(NumberFormatException.java:65)&#xa;&#x9;at"
                    + " java.lang.Long.parseLong(Long.java:441)&#xa;&#x9;at"
                    + " java.lang.Long.parseLong(Long.java:483)&#xa;&#x9;at"
                    + " ca.uhn.fhir.model.primitive.IdDt.getIdPartAsLong(IdDt.java:194)&#xa;&#x9;at"
                    + " ca.uhn.fhir.jpa.provider.JpaResourceProvider.getHistoryForResourceInstance(JpaResourceProvider.java:81)&#xa;&#x9;..."
                    + " 45 more&#xa;\"/>\n"
                    + "   </issue>\n"
                    + "   <issue>\n"
    ...
    public void testGenerateDiagnosticReportWithObservations() throws DataFormatException {
        ...
        value.getCode().setText("Some & Diagnostic Report");
        {
            ...
            obs.addReferenceRange()
                    .setLow((SimpleQuantity) new SimpleQuantity().setValue(2.20))
                    .setHigh((SimpleQuantity) new SimpleQuantity().setValue(2.99));
        ...
        assertThat(
                output,
                StringContains.containsString(
                        "<div class=\"hapiHeaderText\"> Some &amp; Diagnostic Report </div>"));
    }
    ...
    public void testDiagnosticReport() {
        String input =
                "{\n"
                    ...
                    + "                  \"valueString\": \"Copyright 2014-2019 Michigan Health"
                    + " Information Network Shared Services. Licensed under the Apache License,"
                    ...
                    + "            \"subject\": {\n"
                    + "               \"reference\":"
                    + " \"http://localhost:8080/hapi-fhir-jpaserver/fhir/Patient/2940\"\n"
                    + "            },\n"
                    + "            \"encounter\": {\n"
                    ...
                    + "               {\n"
                    + "                  \"reference\":"
                    + " \"http://localhost:8080/hapi-fhir-jpaserver/fhir/Practitioner/1600\"\n"
                    + "               }\n"
                    + "            ],\n"
                    + "            \"result\": [\n"
                    + "               {\n"
        ...
        assertThat(
                output,
                StringContains.containsString(
                        "<div class=\"hapiHeaderText\"> Untitled Diagnostic Report </div>"));
    }
    ...
    public void testGenerateMedicationPrescription() {
        ...
        assertTrue(
                output.contains("ciprofloaxin"),
                "Expected medication name of ciprofloaxin within narrative: " + output);
        assertTrue(
                output.contains("ACTIVE"),
                "Expected string status of ACTIVE within narrative: " + output);
    }
