...
public class CustomTypeDstu3Test {
	...
	private static final org.slf4j.Logger ourLog =
				org.slf4j.LoggerFactory.getLogger(CustomTypeDstu3Test.class);
	...
	public static class PatientWithExtensionWithTwoTypes extends Patient {
		@Child(
					name = "foo",
					type = {DateTimeType.class, Period.class},
					min = 0,
					max = 1)
		@Extension(
					url = "http://example.com/extension#foo",
					definedLocally = true,
					isModifier = false)
	...
	public void testCustomTypeWithCustomDatatype() {
		...
		resource.setBaseValues(
					new CustomResource364CustomDate().setDate(new DateTimeType("2016-05-13")));
		...
		assertThat(
					...
					stringContainsInOrder(
								...
								"<meta><profile"
									+ " value=\"http://hl7.org/fhir/profiles/custom-resource\"/></meta>",
								"<baseValueCustomDate><date value=\"2016-05-13\"/></baseValueCustomDate>",
								"</CustomResource>"));
		// @formatter:on

		CustomResource364Dstu3 parsedResource =
					parser.parseResource(CustomResource364Dstu3.class, xml);
		assertEquals(
					"2016-05-13",
	...
	public void testCustomTypeWithPrimitiveType() {
		...
		CustomResource364Dstu3 parsedResource =
					parser.parseResource(CustomResource364Dstu3.class, xml);
		assertEquals(
					"2016-05-13", ((StringType) parsedResource.getBaseValues()).getValueAsString());
	}
	...
	public void parseBundleWithResourceDirective() {
		...
		List<org.hl7.fhir.dstu3.model.Extension> exts =
					res0.getExtensionsByUrl("http://example.com/Weight");
	...
	public void parseResourceWithDirective() {
		...
		List<org.hl7.fhir.dstu3.model.Extension> exts =
					parsed.getExtensionsByUrl("http://example.com/Weight");
		assertEquals(0, exts.size());
	...
	public void testEncodeWithCustomType() {
		...
		assertThat(
					messageString,
					stringContainsInOrder(
								"<meta>", "<profile value=\"http://example.com/foo\"/>", "</meta>"));
		// @formatter:on
	...
	public void testParseResourceWithContainedResourcesWithProfile() {
		// @formatter:off
		String input =
					"<MedicationRequest xmlns=\"http://hl7.org/fhir\"><id"
						+ " value=\"44cfa24c-52e1-a8ff-8428-4e7ce1165460-local\"/> <meta> <profile"
						+ " value=\"http://fhir.something.com/StructureDefinition/our-medication-order\"/>"
						+ " </meta> <contained> <Medication xmlns=\"http://hl7.org/fhir\"> <id"
						+ " value=\"1\"/><meta> <profile"
						+ " value=\"http://fhir.something.com/StructureDefinition/our-medication\"/>"
						+ " </meta> <code> <text value=\"medication\"/> </code> </Medication>"
						+ " </contained> <medication> <reference value=\"#1\"/> </medication> "
						+ "</MedicationRequest>";
		// @formatter:on
	...
	public static class MyCustomPatient extends Patient {
		...
		@Child(name = "bloodPressure") // once every 3 month. The average target is 130/80 mmHg or
		// less
		@Extension(
		...
		@Child(name = "cholesterol") // once a year. The target is triglycerides =< 2 mmol/l e
		...
		// Periodic Tests
		@Child(name = "hbA1c") // once every 6 month. The average target is 53 mmol/mol (or 7%) or
		// less.
