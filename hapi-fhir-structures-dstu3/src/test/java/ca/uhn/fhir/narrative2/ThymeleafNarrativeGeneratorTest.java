...
public class ThymeleafNarrativeGeneratorTest {
    ...
    private static final Logger ourLog =
            LoggerFactory.getLogger(ThymeleafNarrativeGeneratorTest.class);
    ...
    public void testTemplateCount() throws IOException {
        NarrativeTemplateManifest manifest =
                NarrativeTemplateManifest.forManifestFileLocation(
                        "classpath:narrative2/narratives.properties");
    ...
    public void testFragment() {
        ...
        assertEquals(
                "<html> This is some content <div> Fragment-1-content blah </div></html>", output);
    }
    ...
    public void testFhirPathWithResolve() {
        ...
        gen.setFhirPathEvaluationContext(
                new IFhirPathEvaluationContext() {
                    @Override
                    public IBase resolveReference(
                            @Nonnull IIdType theReference, @Nullable IBase theContext) {
