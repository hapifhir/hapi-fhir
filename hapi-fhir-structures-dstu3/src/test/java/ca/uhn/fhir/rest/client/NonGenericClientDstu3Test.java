...
public class NonGenericClientDstu3Test {
    ...
    private String extractBodyAsString(ArgumentCaptor<HttpUriRequest> capt, int theIdx)
            throws IOException {
        String body =
                IOUtils.toString(
    ...
    public void testValidateCustomTypeFromClientSearch() throws Exception {
        ...
        IClientWithCustomType client =
                ourCtx.newRestfulClient(IClientWithCustomType.class, "http://example.com/fhir");
