...
public class SearchDefaultMethodDstu3Test {
    ...
    public void testSearchOneOptionalParam() throws Exception {
        ...
        try {
            ...
            assertThat(
                    ourLastParam1.getValuesAsQueryTokens().get(0).getValuesAsQueryTokens(),
                    hasSize(1));
            assertEquals(
                    "val1",
                    ourLastParam1
    ...
    public void testSearchTwoOptionalParams() throws Exception {
        HttpGet httpGet =
                new HttpGet("http://localhost:" + ourPort + "/Patient?param1=val1&param2=val2");
        CloseableHttpResponse status = ourClient.execute(httpGet);
        try {
            String responseContent =
                    IOUtils.toString(status.getEntity().getContent(), StandardCharsets.UTF_8);
            ...
            assertThat(
                    ourLastParam2.getValuesAsQueryTokens().get(0).getValuesAsQueryTokens(),
                    hasSize(1));
            assertEquals(
                    "val2",
                    ourLastParam2
    ...
    public void testSearchTwoOptionalParamsAndExtraParam() throws Exception {
        HttpGet httpGet =
                new HttpGet(
                        "http://localhost:"
                                + ourPort
                                + "/Patient?param1=val1&param2=val2&param3=val3&_pretty=true");
        CloseableHttpResponse status = ourClient.execute(httpGet);
        try {
            String responseContent =
                    IOUtils.toString(status.getEntity().getContent(), StandardCharsets.UTF_8);
    ...
    public void testSearchTwoOptionalParamsWithQualifierAndExtraParam() throws Exception {
        ...
        try {
            ...
            assertThat(
                    ourLastParam2.toString(), ourLastParam2.getValuesAsQueryTokens(), hasSize(2));
            assertThat(
                    ourLastParam2.getValuesAsQueryTokens().get(0).getValuesAsQueryTokens(),
                    hasSize(1));
            assertEquals(
