...
public class CustomTypeServerDstu3 {
    ...
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(CustomTypeServerDstu3.class);
    ...
    public void testCreateWithIdInUrl() throws Exception {
        ...
        assertEquals(
                "HAPI-0365: Can not create resource with ID \"2\", ID must not be supplied on a"
                    + " create (POST) operation (use an HTTP PUT / update operation if you wish to"
                    + " supply an ID)",
