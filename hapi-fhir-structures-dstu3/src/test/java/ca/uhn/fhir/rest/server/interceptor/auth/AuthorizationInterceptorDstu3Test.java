...
public class AuthorizationInterceptorDstu3Test {
    ...
    private static final String ERR403 =
            "{\"resourceType\":\"OperationOutcome\",\"issue\":[{\"severity\":\"error\",\"code\":\"processing\",\"diagnostics\":\"Access"
                + " denied by default policy (no applicable rules)\"}]}";
    private static final Logger ourLog =
            LoggerFactory.getLogger(AuthorizationInterceptorDstu3Test.class);
