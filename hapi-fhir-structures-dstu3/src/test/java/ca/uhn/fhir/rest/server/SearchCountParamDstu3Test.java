...
public class SearchCountParamDstu3Test {
    ...
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(SearchCountParamDstu3Test.class);
    ...
    public void testSearchCount0() throws Exception {
        HttpGet httpGet =
                new HttpGet("http://localhost:" + ourPort + "/Patient?_count=0&_pretty=true");
        ...
        try (CloseableHttpResponse status = ourClient.execute(httpGet)) {
            ...
            assertThat(
                    responseContent,
                    stringContainsInOrder("<Bundle", "<total value=\"99\"/>", "</Bundle>"));
    ...
    public void testSearchWithNoCountParam() throws Exception {
        HttpGet httpGet =
                new HttpGet(
                        "http://localhost:"
                                + ourPort
                                + "/Patient?_query=searchWithNoCountParam&_count=2");
