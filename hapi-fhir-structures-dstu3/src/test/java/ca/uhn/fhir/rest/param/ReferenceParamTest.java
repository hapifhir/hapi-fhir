...
public class ReferenceParamTest {
    ...
    public void testValueWithSlashPersistsAcrossSerialization() {
        ...
        param.setValueAsQueryToken(
                ourCtx, "derived-from", ":DocumentReference.contenttype", "application/vnd.mfer");
    ...
    // TODO: verify this behavior is correct. Same case as
    // testWithResourceTypeAsQualifier_RelativeUrl()
    @Test
