...
public class UpdateDstu3Test {
    private static final org.slf4j.Logger ourLog =
            org.slf4j.LoggerFactory.getLogger(UpdateDstu3Test.class);
    ...
    public void testUpdateMissingIdInBody() throws Exception {
        ...
        assertEquals(
                Msg.code(419)
                        + "Can not update resource, resource body must contain an ID element for"
    ...
    public void testUpdateWrongIdInBody() throws Exception {
        ...
        assertThat(
                responseContent,
                containsString("Resource body ID of &quot;3&quot; does not match"));
    }
