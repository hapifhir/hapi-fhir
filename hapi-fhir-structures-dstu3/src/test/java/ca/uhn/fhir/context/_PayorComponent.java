...
public class _PayorComponent extends BackboneElement
    ...
    public static final String EXTURL_PAYORCODE =
            "http://myfhir.dk/x/MyEpisodeOfCare-payor/payorCode";
    ...
    @Description(
            shortDefinition = "",
            formalDefinition = "True if the payor information is defined by a user.")
    ...
    public static final String EXTURL_USERDEFINED =
            "http://myfhir.dk/x/MyEpisodeOfCare-payor/userDefined";
