...
public class ModelScannerDstu3Test {
    ...
    public void testBundleMustImplementIBaseBundle() throws DataFormatException {
        ...
        try {
            ...
            assertEquals(
                    Msg.code(1687)
                            + "Resource type declares resource name Bundle but does not implement"
                            + " IBaseBundle",
                    e.getMessage());
        }
    }
    ...
    public void testResourceWithNoDef() {
        try {
            ...
            assertEquals(
                    Msg.code(1716)
                            + "Resource"
                            + " class[ca.uhn.fhir.context.ModelScannerDstu3Test$NoResourceDef] does"
                            + " not contain any valid HAPI-FHIR annotations",
                    e.getMessage());
        }
    }
    ...
    public void testResourceWithInheritedDef() {
        try {
            ...
            fail(
                    "The InheritedResourceDef class should contain a valid HAPI-FHIR annotation"
    ...
    public void testScanExtensionTypes() throws DataFormatException {
        ...
        RuntimeResourceDefinition def =
                ctx.getResourceDefinition(ResourceWithExtensionsDstu3A.class);

        assertEquals(
                RuntimeChildCompositeDatatypeDefinition.class,
                def.getChildByNameOrThrowDataFormatException("identifier").getClass());

        RuntimeChildDeclaredExtensionDefinition ext =
                def.getDeclaredExtension("http://foo/#f1", "");
        assertNotNull(ext);
    ...
    public void testScanDstu3TypeWithDstu2Backend() throws DataFormatException {
        ...
        try {
            ...
            assertEquals(
                    Msg.code(1717)
                            + "@Block class for version DSTU3 should not extend"
                            + " BaseIdentifiableElement:"
                            + " ca.uhn.fhir.context.CustomDstu3ClassWithDstu2Base$Bar1",
                    e.getMessage());
        }
    }
    ...
    public void testSearchParamWithCompartmentForNonReferenceParam() {
        try {
            ...
            assertEquals(
                    "Search param foo provides compartment membershit but is not of type"
                            + " 'reference'",
                    e.getMessage());
        }
    }
    ...
    public void testSearchParamWithInvalidType() {
        try {
            ...
            assertEquals(
                    Msg.code(1721) + "Search param foo has an invalid type: bar", e.getMessage());
        }
    }
    ...
    public void testBinaryMayNotHaveExtensions() {
        ...
        try {
            ...
            assertEquals(
                    Msg.code(1733)
                            + "Class \"class"
                            + " ca.uhn.fhir.context.ModelScannerDstu3Test$LetterTemplate\" is"
                            + " invalid. This resource type is not a DomainResource, it must not"
                            + " have extensions",
                    e.getMessage());
        }
    }
    ...
    public void testScanInvalidResource() {
        ...
        try {
            ...
            assertEquals(
                    Msg.code(1714)
                            + "Resource type contains a @ResourceDef annotation but does not"
                            + " implement ca.uhn.fhir.model.api.IResource:"
                            + " ca.uhn.fhir.context.ModelScannerDstu3Test.BadPatient",
                    e.getMessage());
        }
    }
    ...
    public void testScanInvalidType() {
        ...
        try {
            ...
            assertEquals(
                    Msg.code(1716)
                            + "Resource class[java.lang.String] does not contain any valid"
    ...
    public void testScanInvalidBlock() {
        ...
        try {
            ...
            assertEquals(
                    Msg.code(1715)
                            + "Type contains a @Block annotation but does not implement"
                            + " ca.uhn.fhir.model.api.IResourceBlock:"
                            + " ca.uhn.fhir.context.ModelScannerDstu3Test.BadPatient.BadBlock",
                    e.getMessage());
        }
    }
    ...
    public static class LetterTemplate extends Binary {
        ...
        @Child(name = "name")
        @Extension(
                url = "http://example.com/dontuse#name",
