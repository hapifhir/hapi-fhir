...
public class _OtherReferrerComponent extends BackboneElement
	...
	public static final String EXTURL_ADDRESS =
				"http://myfhir.dk/x/MyReferrer/otherReferrer/address";
	...
	public static final String EXTURL_PHONENUMBER =
				"http://myfhir.dk/x/MyReferrer/otherReferrer/phoneNumber";
	...
	public boolean equalsShallow(Base other) {
		...
		_OtherReferrerComponent that = (_OtherReferrerComponent) other;
		return compareValues(ourName, that.ourName, true)
					&& compareValues(ourPhoneNumber, that.ourPhoneNumber, true);
	}
