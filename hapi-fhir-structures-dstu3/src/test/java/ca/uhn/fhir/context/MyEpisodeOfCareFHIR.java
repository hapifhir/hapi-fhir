...
@ResourceDef(
        ...
        id = MyEpisodeOfCareFHIR.FHIR_PROFILE_NAME,
        profile = MyEpisodeOfCareFHIR.FHIR_PROFILE_URI)
public class MyEpisodeOfCareFHIR extends EpisodeOfCare {
    ...
    public static final String EXTURL_DISCHARGETO =
            "http://myfhir.dk/x/MyEpisodeOfCare-discharge-to";
    public static final String FIELD_DISCHARGETO = "dischargeTo";

    /** dischargeDisposition (extension) */
    @Child(
            name = FIELD_DISCHARGEDISPOSITION,
            min = 0,
            max = 1,
            type = {Coding.class})
    @Description(
    ...
    public static final String EXTURL_DISCHARGEDISPOSITION =
            "http://myfhir.dk/x/MyEpisodeOfCare-discharge-disposition";
    ...
    @Child(
            ...
            min = 0,
            max = 1,
            type = {_PreviousComponent.class})
    @Description(
            shortDefinition = "",
            formalDefinition = "Previous reference between episode of care.")
    ...
    @Child(
            name = FIELD_REFERRALINFORMATION,
            min = 1,
            max = 1,
            type = {_MyReferralInformationComponent.class})
    @Description(
            shortDefinition = "",
            formalDefinition = "Referral information related to this episode of care.")
    ...
    public static final String EXTURL_REFERRALINFORMATION =
    ...
    @Child(
            name = FIELD_EVENTMARKER,
            min = 0,
            max = Child.MAX_UNLIMITED,
            type = {_EventMarkerComponent.class})
    @Description(
            shortDefinition = "",
            formalDefinition =
                    "Marks specific times on an episode of care with clinical or administrative"
                            + " relevance.")
    ...
    public static final String EXTURL_EVENTMARKER =
            "http://myfhir.dk/x/MyEpisodeOfCare-event-marker";
    ...
    @Child(
            name = FIELD_HEALTHISSUE,
            min = 0,
            max = 1,
            type = {Condition.class})
    @Description(
            shortDefinition = "",
            formalDefinition = "The health issue this episode of care is related to.")
    ...
    public static final String EXTURL_HEALTHISSUE =
            "http://myfhir.dk/x/MyEpisodeOfCare-health-issue";
    ...
    @Description(
            ...
            formalDefinition = "Identifiers which the episode of care is known by.")
    ...
    @Description(
            shortDefinition =
                    "planned | waitlist | active | onhold | finished | cancelled |"
                            + " entered-in-error",
            formalDefinition = "Status of the episode of care.")
    ...
    @Description(
            ...
            formalDefinition = "The patient who is the subject of this episode of care.")
    ...
    @Child(
            name = FIELD_MANAGINGORGANIZATION,
            min = 0,
            max = 1,
            order = Child.REPLACE_PARENT,
            summary = true,
    ...
    @Description(
            ...
            formalDefinition = "The organization that assumes care.")
    ...
    @Child(
            ...
            type = {Period.class})
    @Description(
            shortDefinition = "Interval during responsibility is assumed",
            formalDefinition = "The start and end time of the episode of care.")
    ...
    public boolean isEmpty() {
        return super.isEmpty()
                && ElementUtil.isEmpty(
                        ourDischargeTo,
                        ourDischargeDisposition,
                        ourPrevious,
                        ourReferralInformation,
                        ourEventMarker,
                        ourPayor,
                        ourHealthIssue,
                        ourIdentifier,
    ...
    public MyEpisodeOfCareFHIR copy() {
        ...
        dst.ourDischargeDisposition =
                ourDischargeDisposition == null ? null : ourDischargeDisposition.copy();
        dst.ourPrevious = ourPrevious == null ? null : ourPrevious.copy();
        dst.ourReferralInformation =
                ourReferralInformation == null ? null : ourReferralInformation.copy();
        ...
        dst.ourManagingOrganization =
                ourManagingOrganization == null ? null : ourManagingOrganization.copy();
    ...
    public boolean equalsDeep(Base other) {
        ...
        return compareDeep(ourDischargeTo, that.ourDischargeTo, true)
                && compareDeep(ourDischargeDisposition, that.ourDischargeDisposition, true)
                && compareDeep(ourPrevious, that.ourPrevious, true)
                && compareDeep(ourReferralInformation, that.ourReferralInformation, true)
                && compareDeep(ourEventMarker, that.ourEventMarker, true)
                && compareDeep(ourPayor, that.ourPayor, true)
                && compareDeep(ourHealthIssue, that.ourHealthIssue, true)
                && compareDeep(ourIdentifier, that.ourIdentifier, true)
                && compareDeep(ourStatus, that.ourStatus, true)
                && compareDeep(ourPatient, that.ourPatient, true)
                && compareDeep(ourManagingOrganization, that.ourManagingOrganization, true)
                && compareDeep(ourPeriod, that.ourPeriod, true)
                && compareDeep(ourCareManager, that.ourCareManager, true);
    }
    ...
    public boolean equalsShallow(Base other) {
        ...
        MyEpisodeOfCareFHIR that = (MyEpisodeOfCareFHIR) other;
        return compareValues(ourDischargeTo, that.ourDischargeTo, true)
                && compareValues(ourStatus, that.ourStatus, true);
    }

    public org.hl7.fhir.dstu3.model.StringType _getDischargeTo() {
        if (ourDischargeTo == null) ourDischargeTo = new org.hl7.fhir.dstu3.model.StringType();
    ...
    public _PreviousComponent _getPrevious() {
        if (ourPrevious == null) ourPrevious = new _PreviousComponent();
        return ourPrevious;
    }
    ...
    public List<_EventMarkerComponent> _getEventMarker() {
        if (ourEventMarker == null) ourEventMarker = new ArrayList<>();
    ...
    public List<_PayorComponent> _getPayor() {
        if (ourPayor == null) ourPayor = new ArrayList<>();
        return ourPayor;
    }
    ...
    public org.hl7.fhir.dstu3.model.Reference _getHealthIssue() {
        if (ourHealthIssue == null) ourHealthIssue = new org.hl7.fhir.dstu3.model.Reference();
    ...
    public List<org.hl7.fhir.dstu3.model.Identifier> _getIdentifier() {
        if (ourIdentifier == null) ourIdentifier = new ArrayList<>();
    ...
    public org.hl7.fhir.dstu3.model.Enumeration<EpisodeOfCareStatus> _getStatus() {
        if (ourStatus == null)
            ourStatus =
                    new org.hl7.fhir.dstu3.model.Enumeration<EpisodeOfCareStatus>(
                            new EpisodeOfCareStatusEnumFactory());
        return ourStatus;
    }

    public MyEpisodeOfCareFHIR _setStatus(
            org.hl7.fhir.dstu3.model.Enumeration<EpisodeOfCareStatus> theValue) {
        ourStatus = theValue;
        return this;
    }

    public org.hl7.fhir.dstu3.model.Reference _getPatient() {
        if (ourPatient == null) ourPatient = new org.hl7.fhir.dstu3.model.Reference();
        return ourPatient;
    }
    ...
    public MyEpisodeOfCareFHIR _setManagingOrganization(
    ...
    public org.hl7.fhir.dstu3.model.Reference _getCareManager() {
        if (ourCareManager == null) ourCareManager = new org.hl7.fhir.dstu3.model.Reference();
