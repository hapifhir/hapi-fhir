...
public class _MyReferrerComponent extends BackboneElement
    ...
    public static final String EXTURL_HOSPITALREFERRER =
            "http://myfhir.dk/x/MyReferrer/hospitalReferrer";
    ...
    @Description(
            shortDefinition = "",
            formalDefinition = "Reference to a medical practitioner or a specialist doctor.")
    ...
    public static final String EXTURL_DOCTORREFERRER =
            "http://myfhir.dk/x/MyReferrer/doctorReferrer";
    ...
    @Description(
            shortDefinition = "",
            formalDefinition = "Name, address and phone number of the referrer.")
    ...
    public boolean isEmpty() {
        return super.isEmpty()
                && ElementUtil.isEmpty(
                        ourReferrerType, ourHospitalReferrer, ourDoctorReferrer, ourOtherReferrer);
    }
