...
public class _EventMarkerComponent extends BackboneElement
	...
	@Description(
				shortDefinition = "",
				formalDefinition = "The type of event marker on an episode of care.")
	...
	public static final String EXTURL_EVENTTYPE =
				"http://myfhir.dk/x/MyEpisodeOfCare-event-marker/eventType";
	...
	@Description(
				shortDefinition = "",
				formalDefinition = "Time in which the event marker was created.")
	...
	public static final String EXTURL_EVENTTIMESTAMP =
				"http://myfhir.dk/x/MyEpisodeOfCare-event-marker/eventTimestamp";
	...
	public _EventMarkerComponent _setEventTimestamp(
