...
public class _MyReferralInformationComponent extends BackboneElement
    ...
    public static final String EXTURL_REFERRALTYPE =
            "http://myfhir.dk/x/MyReferralInformation/referralType";
    ...
    @Description(
            shortDefinition = "",
            formalDefinition = "The organization which the referral originates from.")
    ...
    @Description(
            shortDefinition = "",
            formalDefinition = "Type of free choice in relation to the referral decision.")
    ...
    public static final String EXTURL_FREECHOICE =
            "http://myfhir.dk/x/MyReferralInformation/freeChoice";
    ...
    @Description(
            shortDefinition = "",
            formalDefinition = "Time in which the referral was received.")
    ...
    public static final String EXTURL_RECEIVED =
            "http://myfhir.dk/x/MyReferralInformation/received";
    ...
    @Description(
            shortDefinition = "",
            formalDefinition = "Referring organization, doctor or other.")
    @Extension(url = EXTURL_REFERRER, definedLocally = false, isModifier = false)
    protected _MyReferrerComponent ourReferrer;

    public static final String EXTURL_REFERRER =
            "http://myfhir.dk/x/MyReferralInformation-referrer";
    ...
    public _MyReferralInformationComponent copy() {
        ...
        dst.ourReferringOrganisation =
                ourReferringOrganisation == null ? null : ourReferringOrganisation.copy();
    ...
    public _MyReferralInformationComponent _setReferralType(
            org.hl7.fhir.dstu3.model.Coding theValue) {
    ...
    public _MyReferralInformationComponent _setReferringOrganisation(
            org.hl7.fhir.dstu3.model.Reference theValue) {
    ...
    public _MyReferralInformationComponent _setFreeChoice(
            org.hl7.fhir.dstu3.model.Coding theValue) {
    ...
    public _MyReferralInformationComponent _setReceived(
            org.hl7.fhir.dstu3.model.DateTimeType theValue) {
