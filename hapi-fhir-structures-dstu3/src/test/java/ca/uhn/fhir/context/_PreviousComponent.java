...
public class _PreviousComponent extends BackboneElement
    ...
    @Description(
            shortDefinition = "",
            formalDefinition = "The type of reference to a previous episode of care.")
    ...
    public static final String EXTURL_REFERENCETYPE =
            "http://myfhir.dk/x/MyEpisodeOfCare-previous/referenceType";
    ...
    public _PreviousComponent copy() {
        ...
        copyValues(dst);
        dst.ourPreviousReference =
                ourPreviousReference == null ? null : ourPreviousReference.copy();
